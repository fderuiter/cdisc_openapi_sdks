...
**var_links** | [**CDASH_PRODUCT_LINKS**](CdashProductLinks.md) |  | [optional] [default to null]
**classes** | [**LIST [CDASH_CLASS]**](CdashClass.md) |  | [optional] [default to null]
**domains** | [**LIST [CDASH_DOMAIN]**](CdashDomain.md) |  | [optional] [default to null]
