...
> CdashClassField mdr_cdash_version_classes_class_fields_field_get(version, var_class, var_field)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    var_field = '--DAT' # str | CDASH Field Identifier

    try:
        api_response = api_instance.mdr_cdash_version_classes_class_fields_field_get(version, var_class, var_field)
 ...
 **version** | **str**| CDISC Library Product Version | 
 **var_class** | **str**| CDASH Class Identifier | 
 **var_field** | **str**| CDASH Field Identifier | 
...
> CdashDomainField mdr_cdash_version_domains_domain_fields_field_get(version, domain, var_field)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    var_field = 'AGE' # str | CDASH Field Identifier

    try:
        api_response = api_instance.mdr_cdash_version_domains_domain_fields_field_get(version, domain, var_field)
...
> RootCdashClassField mdr_root_cdash_classes_class_fields_field_get(var_class, var_field)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.mdr_root_cdash_classes_class_fields_field_get(var_class, var_field)
...
> RootCdashDomainField mdr_root_cdash_domains_domain_fields_field_get(domain, var_field)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.mdr_root_cdash_domains_domain_fields_field_get(domain, var_field)
