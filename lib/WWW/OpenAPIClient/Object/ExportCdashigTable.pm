...
#
package WWW::OpenAPIClient::Object::ExportCdashigTable;
...
__PACKAGE__->method_documentation({
    'domain_variables' => {
        datatype => 'ARRAY[ExportCdashigDomainVariablesRow]',
        base_name => 'domain-variables',
        description => '',
        format => '',
        read_only => '',
            },
    'scenario_variables' => {
        datatype => 'ARRAY[ExportCdashigScenarioVariablesRow]',
        base_name => 'scenario-variables',
        description => '',
        format => '',
        read_only => '',
            },
