...
#
package WWW::OpenAPIClient::Object::ExportCdashigScenarioVariablesRow;
...
__PACKAGE__->method_documentation({
    ...
    'data_collection_scenario' => {
        datatype => 'string',
        base_name => 'Data Collection Scenario',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'cdashig_variable_label' => {
        datatype => 'string',
        base_name => 'CDASHIG Variable Label',
        description => '',
        format => '',
        read_only => '',
            },
    'draft_cdashig_definition' => {
        datatype => 'string',
        base_name => 'DRAFT CDASHIG Definition',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'case_report_form_completion_instructions' => {
        datatype => 'string',
        base_name => 'Case Report Form Completion Instructions',
        description => '',
        format => '',
        read_only => '',
            },
