...
#
package WWW::OpenAPIClient::Object::ExportSdtmWorkbook;
...
__PACKAGE__->method_documentation({
    'class_variables' => {
        datatype => 'ARRAY[ExportSdtmClassVariablesRow]',
        base_name => 'class-variables',
        description => '',
        format => '',
        read_only => '',
            },
    'dataset_variables' => {
        datatype => 'ARRAY[ExportSdtmDatasetVariablesRow]',
        base_name => 'dataset-variables',
        description => '',
        format => '',
        read_only => '',
            },
    'datasets' => {
        datatype => 'ARRAY[ExportSdtmDatasetsRow]',
        base_name => 'datasets',
        description => '',
        format => '',
        read_only => '',
