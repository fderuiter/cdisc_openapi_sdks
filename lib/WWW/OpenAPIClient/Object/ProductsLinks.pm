...
#
package WWW::OpenAPIClient::Object::ProductsLinks;
...
__PACKAGE__->method_documentation({
    ...
    'data_collection' => {
        datatype => 'ProductgroupDataCollection',
        base_name => 'data-collection',
        description => '',
        format => '',
        read_only => '',
            },
    'data_tabulation' => {
        datatype => 'ProductgroupDataTabulation',
        base_name => 'data-tabulation',
        description => '',
        format => '',
        read_only => '',
            },
    'data_analysis' => {
        datatype => 'ProductgroupDataAnalysis',
        base_name => 'data-analysis',
        description => '',
        format => '',
        read_only => '',
            },
    'terminology' => {
        datatype => 'ProductgroupTerminology',
        base_name => 'terminology',
        description => '',
        format => '',
        read_only => '',
            },
    'measure' => {
        datatype => 'ProductgroupQrs',
        base_name => 'measure',
        description => '',
        format => '',
        read_only => '',
