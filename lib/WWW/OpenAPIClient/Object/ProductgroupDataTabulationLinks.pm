...
#
package WWW::OpenAPIClient::Object::ProductgroupDataTabulationLinks;
...
__PACKAGE__->method_documentation({
    ...
    'sdtm' => {
        datatype => 'ARRAY[SdtmProductRefElement]',
        base_name => 'sdtm',
        description => '',
        format => '',
        read_only => '',
    ...
    'sdtmig' => {
        datatype => 'ARRAY[SdtmigProductRefElement]',
        base_name => 'sdtmig',
        description => '',
        format => '',
        read_only => '',
    ...
    'sendig' => {
        datatype => 'ARRAY[SendigProductRefElement]',
        base_name => 'sendig',
        description => '',
        format => '',
        read_only => '',
