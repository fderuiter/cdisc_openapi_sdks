...
class ExportSdtmDatasetVariablesRow {
  /// Returns a new [ExportSdtmDatasetVariablesRow] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ExportSdtmDatasetVariablesRow &&
  ...
  /// Returns a new [ExportSdtmDatasetVariablesRow] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ExportSdtmDatasetVariablesRow? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ExportSdtmDatasetVariablesRow[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ExportSdtmDatasetVariablesRow[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ExportSdtmDatasetVariablesRow> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ExportSdtmDatasetVariablesRow>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ExportSdtmDatasetVariablesRow.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ExportSdtmDatasetVariablesRow> mapFromJson(dynamic json) {
    final map = <String, ExportSdtmDatasetVariablesRow>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ExportSdtmDatasetVariablesRow.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ExportSdtmDatasetVariablesRow-objects as value to a dart map
  static Map<String, List<ExportSdtmDatasetVariablesRow>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ExportSdtmDatasetVariablesRow>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ExportSdtmDatasetVariablesRow.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
