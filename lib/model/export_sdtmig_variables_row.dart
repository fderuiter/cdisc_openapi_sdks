...
class ExportSdtmigVariablesRow {
  /// Returns a new [ExportSdtmigVariablesRow] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ExportSdtmigVariablesRow &&
  ...
  /// Returns a new [ExportSdtmigVariablesRow] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ExportSdtmigVariablesRow? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ExportSdtmigVariablesRow[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ExportSdtmigVariablesRow[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ExportSdtmigVariablesRow> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ExportSdtmigVariablesRow>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ExportSdtmigVariablesRow.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ExportSdtmigVariablesRow> mapFromJson(dynamic json) {
    final map = <String, ExportSdtmigVariablesRow>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ExportSdtmigVariablesRow.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ExportSdtmigVariablesRow-objects as value to a dart map
  static Map<String, List<ExportSdtmigVariablesRow>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ExportSdtmigVariablesRow>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ExportSdtmigVariablesRow.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
