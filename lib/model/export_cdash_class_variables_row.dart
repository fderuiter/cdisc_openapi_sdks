...
class ExportCdashClassVariablesRow {
  /// Returns a new [ExportCdashClassVariablesRow] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ExportCdashClassVariablesRow &&
  ...
  /// Returns a new [ExportCdashClassVariablesRow] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ExportCdashClassVariablesRow? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ExportCdashClassVariablesRow[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ExportCdashClassVariablesRow[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ExportCdashClassVariablesRow> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ExportCdashClassVariablesRow>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ExportCdashClassVariablesRow.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ExportCdashClassVariablesRow> mapFromJson(dynamic json) {
    final map = <String, ExportCdashClassVariablesRow>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ExportCdashClassVariablesRow.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ExportCdashClassVariablesRow-objects as value to a dart map
  static Map<String, List<ExportCdashClassVariablesRow>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ExportCdashClassVariablesRow>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ExportCdashClassVariablesRow.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
