...
part 'export_cdash_domain_variables_row.g.dart';
...
/// * [implementationNotes] 
@BuiltValue()
abstract class ExportCdashDomainVariablesRow implements Built<ExportCdashDomainVariablesRow, ExportCdashDomainVariablesRowBuilder> {
  ...
  ExportCdashDomainVariablesRow._();

  factory ExportCdashDomainVariablesRow([void updates(ExportCdashDomainVariablesRowBuilder b)]) = _$ExportCdashDomainVariablesRow;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ExportCdashDomainVariablesRowBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ExportCdashDomainVariablesRow> get serializer => _$ExportCdashDomainVariablesRowSerializer();
}

class _$ExportCdashDomainVariablesRowSerializer implements PrimitiveSerializer<ExportCdashDomainVariablesRow> {
  @override
  final Iterable<Type> types = const [ExportCdashDomainVariablesRow, _$ExportCdashDomainVariablesRow];

  @override
  final String wireName = r'ExportCdashDomainVariablesRow';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ExportCdashDomainVariablesRow object, {
  ...
  void _deserializeProperties(
    ...
    required ExportCdashDomainVariablesRowBuilder result,
  ...
  @override
  ExportCdashDomainVariablesRow deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ExportCdashDomainVariablesRowBuilder();
