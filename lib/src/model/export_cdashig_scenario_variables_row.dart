...
part 'export_cdashig_scenario_variables_row.g.dart';
...
/// * [implementationNotes] 
@BuiltValue()
abstract class ExportCdashigScenarioVariablesRow implements Built<ExportCdashigScenarioVariablesRow, ExportCdashigScenarioVariablesRowBuilder> {
  ...
  ExportCdashigScenarioVariablesRow._();

  factory ExportCdashigScenarioVariablesRow([void updates(ExportCdashigScenarioVariablesRowBuilder b)]) = _$ExportCdashigScenarioVariablesRow;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ExportCdashigScenarioVariablesRowBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ExportCdashigScenarioVariablesRow> get serializer => _$ExportCdashigScenarioVariablesRowSerializer();
}

class _$ExportCdashigScenarioVariablesRowSerializer implements PrimitiveSerializer<ExportCdashigScenarioVariablesRow> {
  @override
  final Iterable<Type> types = const [ExportCdashigScenarioVariablesRow, _$ExportCdashigScenarioVariablesRow];

  @override
  final String wireName = r'ExportCdashigScenarioVariablesRow';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ExportCdashigScenarioVariablesRow object, {
  ...
  void _deserializeProperties(
    ...
    required ExportCdashigScenarioVariablesRowBuilder result,
  ...
  @override
  ExportCdashigScenarioVariablesRow deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ExportCdashigScenarioVariablesRowBuilder();
