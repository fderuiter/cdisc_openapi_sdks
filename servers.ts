...
const server1 = new ServerConfiguration<{  }>("https://library.cdisc.org/api", {  }, "Production server");
const server2 = new ServerConfiguration<{  }>("https://virtserver.swaggerhub.com/CDISC1/share-2.0/1.1.0", {  }, "SwaggerHub API Auto Mocking");
