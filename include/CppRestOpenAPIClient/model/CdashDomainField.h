...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CdashDomainField_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CdashDomainField_H_
...
public:
    ...
    std::shared_ptr<CdashDomainFieldLinks> getLinks() const;
    bool linksIsSet() const;
    void unset_links();
    void setLinks(const std::shared_ptr<CdashDomainFieldLinks>& value);
...
protected:
    ...
    utility::string_t m_DomainSpecific;
    bool m_DomainSpecificIsSet;
    ...
    std::shared_ptr<CdashDomainFieldLinks> m__links;
    bool m__linksIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CdashDomainField_H_ */
