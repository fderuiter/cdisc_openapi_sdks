...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CdashClassField_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CdashClassField_H_
...
public:
    ...
    std::shared_ptr<CdashClassFieldLinks> getLinks() const;
    bool linksIsSet() const;
    void unset_links();
    void setLinks(const std::shared_ptr<CdashClassFieldLinks>& value);
...
protected:
    ...
    std::shared_ptr<CdashClassFieldLinks> m__links;
    bool m__linksIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CdashClassField_H_ */
