...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_AdamVariable_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_AdamVariable_H_
...
public:
    ...
    std::shared_ptr<AdamVariableLinks> getLinks() const;
    bool linksIsSet() const;
    void unset_links();
    void setLinks(const std::shared_ptr<AdamVariableLinks>& value);
...
protected:
    ...
    std::shared_ptr<AdamVariableLinks> m__links;
    bool m__linksIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_AdamVariable_H_ */
