...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CdashigDomainField_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CdashigDomainField_H_
...
public:
    ...
    std::shared_ptr<CdashigDomainFieldLinks> getLinks() const;
    bool linksIsSet() const;
    void unset_links();
    void setLinks(const std::shared_ptr<CdashigDomainFieldLinks>& value);
...
protected:
    ...
    std::shared_ptr<CdashigDomainFieldLinks> m__links;
    bool m__linksIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CdashigDomainField_H_ */
