...
void SdtmClassDatasetsRef::validate()
{
    // TODO: implement validation
}

web::json::value SdtmClassDatasetsRef::toJson() const
{
...
bool SdtmClassDatasetsRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmClassDatasetsRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmClassDatasetsRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmClassDatasetsRef::getHref() const
{
    return m_Href;
}


void SdtmClassDatasetsRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmClassDatasetsRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmClassDatasetsRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmClassDatasetsRef::getTitle() const
{
    return m_Title;
}


void SdtmClassDatasetsRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmClassDatasetsRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmClassDatasetsRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmClassDatasetsRef::getType() const
{
    return m_Type;
}


void SdtmClassDatasetsRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmClassDatasetsRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmClassDatasetsRef::unsetType()
{
    m_TypeIsSet = false;
}
