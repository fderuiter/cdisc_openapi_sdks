...
void SdtmClassVariableRef::validate()
{
    // TODO: implement validation
}

web::json::value SdtmClassVariableRef::toJson() const
{
...
bool SdtmClassVariableRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmClassVariableRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmClassVariableRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmClassVariableRef::getHref() const
{
    return m_Href;
}


void SdtmClassVariableRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmClassVariableRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmClassVariableRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmClassVariableRef::getTitle() const
{
    return m_Title;
}


void SdtmClassVariableRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmClassVariableRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmClassVariableRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmClassVariableRef::getType() const
{
    return m_Type;
}


void SdtmClassVariableRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmClassVariableRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmClassVariableRef::unsetType()
{
    m_TypeIsSet = false;
}
