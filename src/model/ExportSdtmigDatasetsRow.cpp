...
void ExportSdtmigDatasetsRow::validate()
{
    // TODO: implement validation
}

web::json::value ExportSdtmigDatasetsRow::toJson() const
{
...
bool ExportSdtmigDatasetsRow::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ExportSdtmigDatasetsRow::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ExportSdtmigDatasetsRow::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ExportSdtmigDatasetsRow::getVersion() const
{
    return m_Version;
}


void ExportSdtmigDatasetsRow::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool ExportSdtmigDatasetsRow::versionIsSet() const
{
    return m_VersionIsSet;
}

void ExportSdtmigDatasetsRow::unsetVersion()
{
    m_VersionIsSet = false;
}
utility::string_t ExportSdtmigDatasetsRow::getRClass() const
{
    return m_r_Class;
}


void ExportSdtmigDatasetsRow::setRClass(const utility::string_t& value)
{
    m_r_Class = value;
    m_r_ClassIsSet = true;
}

bool ExportSdtmigDatasetsRow::rClassIsSet() const
{
    return m_r_ClassIsSet;
}

void ExportSdtmigDatasetsRow::unsetr_Class()
{
    m_r_ClassIsSet = false;
}
utility::string_t ExportSdtmigDatasetsRow::getDatasetName() const
{
    return m_Dataset_Name;
}


void ExportSdtmigDatasetsRow::setDatasetName(const utility::string_t& value)
{
    m_Dataset_Name = value;
    m_Dataset_NameIsSet = true;
}

bool ExportSdtmigDatasetsRow::datasetNameIsSet() const
{
    return m_Dataset_NameIsSet;
}

void ExportSdtmigDatasetsRow::unsetDataset_Name()
{
    m_Dataset_NameIsSet = false;
}
utility::string_t ExportSdtmigDatasetsRow::getDatasetLabel() const
{
    return m_Dataset_Label;
}


void ExportSdtmigDatasetsRow::setDatasetLabel(const utility::string_t& value)
{
    m_Dataset_Label = value;
    m_Dataset_LabelIsSet = true;
}

bool ExportSdtmigDatasetsRow::datasetLabelIsSet() const
{
    return m_Dataset_LabelIsSet;
}

void ExportSdtmigDatasetsRow::unsetDataset_Label()
{
    m_Dataset_LabelIsSet = false;
}
utility::string_t ExportSdtmigDatasetsRow::getStructure() const
{
    return m_Structure;
}


void ExportSdtmigDatasetsRow::setStructure(const utility::string_t& value)
{
    m_Structure = value;
    m_StructureIsSet = true;
}

bool ExportSdtmigDatasetsRow::structureIsSet() const
{
    return m_StructureIsSet;
}

void ExportSdtmigDatasetsRow::unsetStructure()
{
    m_StructureIsSet = false;
}
