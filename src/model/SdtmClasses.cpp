...
void SdtmClasses::validate()
{
    // TODO: implement validation
}

web::json::value SdtmClasses::toJson() const
{
...
bool SdtmClasses::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SdtmClassesLinks> refVal_setLinks;
...
void SdtmClasses::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmClasses::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmClasses::getName() const
{
    return m_Name;
}


void SdtmClasses::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool SdtmClasses::nameIsSet() const
{
    return m_NameIsSet;
}

void SdtmClasses::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t SdtmClasses::getLabel() const
{
    return m_Label;
}


void SdtmClasses::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool SdtmClasses::labelIsSet() const
{
    return m_LabelIsSet;
}

void SdtmClasses::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t SdtmClasses::getDescription() const
{
    return m_Description;
}


void SdtmClasses::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool SdtmClasses::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void SdtmClasses::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t SdtmClasses::getSource() const
{
    return m_Source;
}


void SdtmClasses::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool SdtmClasses::sourceIsSet() const
{
    return m_SourceIsSet;
}

void SdtmClasses::unsetSource()
{
    m_SourceIsSet = false;
}
utility::string_t SdtmClasses::getEffectiveDate() const
{
    return m_EffectiveDate;
}


void SdtmClasses::setEffectiveDate(const utility::string_t& value)
{
    m_EffectiveDate = value;
    m_EffectiveDateIsSet = true;
}

bool SdtmClasses::effectiveDateIsSet() const
{
    return m_EffectiveDateIsSet;
}

void SdtmClasses::unsetEffectiveDate()
{
    m_EffectiveDateIsSet = false;
}
utility::string_t SdtmClasses::getRegistrationStatus() const
{
    return m_RegistrationStatus;
}


void SdtmClasses::setRegistrationStatus(const utility::string_t& value)
{
    m_RegistrationStatus = value;
    m_RegistrationStatusIsSet = true;
}

bool SdtmClasses::registrationStatusIsSet() const
{
    return m_RegistrationStatusIsSet;
}

void SdtmClasses::unsetRegistrationStatus()
{
    m_RegistrationStatusIsSet = false;
}
utility::string_t SdtmClasses::getVersion() const
{
    return m_Version;
}


void SdtmClasses::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool SdtmClasses::versionIsSet() const
{
    return m_VersionIsSet;
}

void SdtmClasses::unsetVersion()
{
    m_VersionIsSet = false;
}
std::shared_ptr<SdtmClassesLinks> SdtmClasses::getLinks() const
{
    return m__links;
}


void SdtmClasses::setLinks(const std::shared_ptr<SdtmClassesLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool SdtmClasses::linksIsSet() const
{
    return m__linksIsSet;
}

void SdtmClasses::unset_links()
{
    m__linksIsSet = false;
}
