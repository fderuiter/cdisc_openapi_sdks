...
void SendigDatasetsRef::validate()
{
    // TODO: implement validation
}

web::json::value SendigDatasetsRef::toJson() const
{
...
bool SendigDatasetsRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SendigDatasetsRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendigDatasetsRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SendigDatasetsRef::getHref() const
{
    return m_Href;
}


void SendigDatasetsRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SendigDatasetsRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SendigDatasetsRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SendigDatasetsRef::getTitle() const
{
    return m_Title;
}


void SendigDatasetsRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SendigDatasetsRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SendigDatasetsRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SendigDatasetsRef::getType() const
{
    return m_Type;
}


void SendigDatasetsRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SendigDatasetsRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SendigDatasetsRef::unsetType()
{
    m_TypeIsSet = false;
}
