...
void SdtmClassesRef::validate()
{
    // TODO: implement validation
}

web::json::value SdtmClassesRef::toJson() const
{
...
bool SdtmClassesRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmClassesRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmClassesRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmClassesRef::getHref() const
{
    return m_Href;
}


void SdtmClassesRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmClassesRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmClassesRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmClassesRef::getTitle() const
{
    return m_Title;
}


void SdtmClassesRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmClassesRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmClassesRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmClassesRef::getType() const
{
    return m_Type;
}


void SdtmClassesRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmClassesRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmClassesRef::unsetType()
{
    m_TypeIsSet = false;
}
