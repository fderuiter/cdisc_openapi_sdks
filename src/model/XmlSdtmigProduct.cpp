...
void XmlSdtmigProduct::validate()
{
    // TODO: implement validation
}

web::json::value XmlSdtmigProduct::toJson() const
{
...
bool XmlSdtmigProduct::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<SdtmigProduct> refVal_setSelf;
...
void XmlSdtmigProduct::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlSdtmigProduct::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SdtmigProduct> XmlSdtmigProduct::getSelf() const
{
    return m_Self;
}


void XmlSdtmigProduct::setSelf(const std::shared_ptr<SdtmigProduct>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlSdtmigProduct::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlSdtmigProduct::unsetSelf()
{
    m_SelfIsSet = false;
}
