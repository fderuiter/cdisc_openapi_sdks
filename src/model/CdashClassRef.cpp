...
void CdashClassRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashClassRef::toJson() const
{
...
bool CdashClassRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashClassRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashClassRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashClassRef::getHref() const
{
    return m_Href;
}


void CdashClassRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashClassRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashClassRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashClassRef::getTitle() const
{
    return m_Title;
}


void CdashClassRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashClassRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashClassRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashClassRef::getType() const
{
    return m_Type;
}


void CdashClassRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashClassRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashClassRef::unsetType()
{
    m_TypeIsSet = false;
}
