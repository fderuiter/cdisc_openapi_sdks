...
void RootCtCodelistRefElement::validate()
{
    // TODO: implement validation
}

web::json::value RootCtCodelistRefElement::toJson() const
{
...
bool RootCtCodelistRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RootCtCodelistRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RootCtCodelistRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t RootCtCodelistRefElement::getHref() const
{
    return m_Href;
}


void RootCtCodelistRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool RootCtCodelistRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void RootCtCodelistRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t RootCtCodelistRefElement::getTitle() const
{
    return m_Title;
}


void RootCtCodelistRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool RootCtCodelistRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void RootCtCodelistRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t RootCtCodelistRefElement::getType() const
{
    return m_Type;
}


void RootCtCodelistRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool RootCtCodelistRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void RootCtCodelistRefElement::unsetType()
{
    m_TypeIsSet = false;
}
