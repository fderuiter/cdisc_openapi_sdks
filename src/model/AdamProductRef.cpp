...
void AdamProductRef::validate()
{
    // TODO: implement validation
}

web::json::value AdamProductRef::toJson() const
{
...
bool AdamProductRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AdamProductRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AdamProductRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AdamProductRef::getHref() const
{
    return m_Href;
}


void AdamProductRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool AdamProductRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void AdamProductRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t AdamProductRef::getTitle() const
{
    return m_Title;
}


void AdamProductRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool AdamProductRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void AdamProductRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t AdamProductRef::getType() const
{
    return m_Type;
}


void AdamProductRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool AdamProductRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void AdamProductRef::unsetType()
{
    m_TypeIsSet = false;
}
