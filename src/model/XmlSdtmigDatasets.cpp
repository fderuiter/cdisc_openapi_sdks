...
void XmlSdtmigDatasets::validate()
{
    // TODO: implement validation
}

web::json::value XmlSdtmigDatasets::toJson() const
{
...
bool XmlSdtmigDatasets::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<SdtmigDatasets> refVal_setSelf;
...
void XmlSdtmigDatasets::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlSdtmigDatasets::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SdtmigDatasets> XmlSdtmigDatasets::getSelf() const
{
    return m_Self;
}


void XmlSdtmigDatasets::setSelf(const std::shared_ptr<SdtmigDatasets>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlSdtmigDatasets::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlSdtmigDatasets::unsetSelf()
{
    m_SelfIsSet = false;
}
