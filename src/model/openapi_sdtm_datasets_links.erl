...
-export([openapi_sdtm_datasets_links/0]).

-export([openapi_sdtm_datasets_links/1]).
...
openapi_sdtm_datasets_links() ->
    openapi_sdtm_datasets_links([]).

openapi_sdtm_datasets_links(Fields) ->
  Default = [ {'self', openapi_sdtm_datasets_ref:openapi_sdtm_datasets_ref() }
            , {'parentProduct', openapi_sdtm_product_ref:openapi_sdtm_product_ref() }
            , {'priorVersion', openapi_sdtm_datasets_ref:openapi_sdtm_datasets_ref() }
            , {'datasets', list(openapi_sdtm_dataset_ref_element:openapi_sdtm_dataset_ref_element()) }
            ],
