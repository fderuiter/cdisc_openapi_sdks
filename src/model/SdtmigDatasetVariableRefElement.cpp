...
void SdtmigDatasetVariableRefElement::validate()
{
    // TODO: implement validation
}

web::json::value SdtmigDatasetVariableRefElement::toJson() const
{
...
bool SdtmigDatasetVariableRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmigDatasetVariableRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmigDatasetVariableRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmigDatasetVariableRefElement::getHref() const
{
    return m_Href;
}


void SdtmigDatasetVariableRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmigDatasetVariableRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmigDatasetVariableRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmigDatasetVariableRefElement::getTitle() const
{
    return m_Title;
}


void SdtmigDatasetVariableRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmigDatasetVariableRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmigDatasetVariableRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmigDatasetVariableRefElement::getType() const
{
    return m_Type;
}


void SdtmigDatasetVariableRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmigDatasetVariableRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmigDatasetVariableRefElement::unsetType()
{
    m_TypeIsSet = false;
}
