...
void CdashigScenarioRefElement::validate()
{
    // TODO: implement validation
}

web::json::value CdashigScenarioRefElement::toJson() const
{
...
bool CdashigScenarioRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigScenarioRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigScenarioRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigScenarioRefElement::getHref() const
{
    return m_Href;
}


void CdashigScenarioRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigScenarioRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigScenarioRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigScenarioRefElement::getTitle() const
{
    return m_Title;
}


void CdashigScenarioRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigScenarioRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigScenarioRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigScenarioRefElement::getType() const
{
    return m_Type;
}


void CdashigScenarioRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigScenarioRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigScenarioRefElement::unsetType()
{
    m_TypeIsSet = false;
}
