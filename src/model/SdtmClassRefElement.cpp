...
void SdtmClassRefElement::validate()
{
    // TODO: implement validation
}

web::json::value SdtmClassRefElement::toJson() const
{
...
bool SdtmClassRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmClassRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmClassRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmClassRefElement::getHref() const
{
    return m_Href;
}


void SdtmClassRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmClassRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmClassRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmClassRefElement::getTitle() const
{
    return m_Title;
}


void SdtmClassRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmClassRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmClassRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmClassRefElement::getType() const
{
    return m_Type;
}


void SdtmClassRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmClassRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmClassRefElement::unsetType()
{
    m_TypeIsSet = false;
}
