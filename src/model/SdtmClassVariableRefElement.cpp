...
void SdtmClassVariableRefElement::validate()
{
    // TODO: implement validation
}

web::json::value SdtmClassVariableRefElement::toJson() const
{
...
bool SdtmClassVariableRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmClassVariableRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmClassVariableRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmClassVariableRefElement::getHref() const
{
    return m_Href;
}


void SdtmClassVariableRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmClassVariableRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmClassVariableRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmClassVariableRefElement::getTitle() const
{
    return m_Title;
}


void SdtmClassVariableRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmClassVariableRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmClassVariableRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmClassVariableRefElement::getType() const
{
    return m_Type;
}


void SdtmClassVariableRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmClassVariableRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmClassVariableRefElement::unsetType()
{
    m_TypeIsSet = false;
}
