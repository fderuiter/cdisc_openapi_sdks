...
void AdamDatastructureRef::validate()
{
    // TODO: implement validation
}

web::json::value AdamDatastructureRef::toJson() const
{
...
bool AdamDatastructureRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AdamDatastructureRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AdamDatastructureRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AdamDatastructureRef::getHref() const
{
    return m_Href;
}


void AdamDatastructureRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool AdamDatastructureRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void AdamDatastructureRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t AdamDatastructureRef::getTitle() const
{
    return m_Title;
}


void AdamDatastructureRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool AdamDatastructureRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void AdamDatastructureRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t AdamDatastructureRef::getType() const
{
    return m_Type;
}


void AdamDatastructureRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool AdamDatastructureRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void AdamDatastructureRef::unsetType()
{
    m_TypeIsSet = false;
}
