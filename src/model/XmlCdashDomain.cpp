...
void XmlCdashDomain::validate()
{
    // TODO: implement validation
}

web::json::value XmlCdashDomain::toJson() const
{
...
bool XmlCdashDomain::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<CdashDomain> refVal_setSelf;
...
void XmlCdashDomain::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlCdashDomain::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<CdashDomain> XmlCdashDomain::getSelf() const
{
    return m_Self;
}


void XmlCdashDomain::setSelf(const std::shared_ptr<CdashDomain>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlCdashDomain::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlCdashDomain::unsetSelf()
{
    m_SelfIsSet = false;
}
