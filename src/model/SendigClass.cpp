...
void SendigClass::validate()
{
    // TODO: implement validation
}

web::json::value SendigClass::toJson() const
{
...
bool SendigClass::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SendigClassLinks> refVal_setLinks;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("datasets"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SendigDataset>> refVal_setDatasets;
...
void SendigClass::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendigClass::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SendigClass::getOrdinal() const
{
    return m_Ordinal;
}


void SendigClass::setOrdinal(const utility::string_t& value)
{
    m_Ordinal = value;
    m_OrdinalIsSet = true;
}

bool SendigClass::ordinalIsSet() const
{
    return m_OrdinalIsSet;
}

void SendigClass::unsetOrdinal()
{
    m_OrdinalIsSet = false;
}
utility::string_t SendigClass::getName() const
{
    return m_Name;
}


void SendigClass::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool SendigClass::nameIsSet() const
{
    return m_NameIsSet;
}

void SendigClass::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t SendigClass::getLabel() const
{
    return m_Label;
}


void SendigClass::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool SendigClass::labelIsSet() const
{
    return m_LabelIsSet;
}

void SendigClass::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t SendigClass::getDescription() const
{
    return m_Description;
}


void SendigClass::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool SendigClass::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void SendigClass::unsetDescription()
{
    m_DescriptionIsSet = false;
}
std::shared_ptr<SendigClassLinks> SendigClass::getLinks() const
{
    return m__links;
}


void SendigClass::setLinks(const std::shared_ptr<SendigClassLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool SendigClass::linksIsSet() const
{
    return m__linksIsSet;
}

void SendigClass::unset_links()
{
    m__linksIsSet = false;
}
std::vector<std::shared_ptr<SendigDataset>> SendigClass::getDatasets() const
{
    return m_Datasets;
}


void SendigClass::setDatasets(const std::vector<std::shared_ptr<SendigDataset>>& value)
{
    m_Datasets = value;
    m_DatasetsIsSet = true;
}

bool SendigClass::datasetsIsSet() const
{
    return m_DatasetsIsSet;
}

void SendigClass::unsetDatasets()
{
    m_DatasetsIsSet = false;
}
