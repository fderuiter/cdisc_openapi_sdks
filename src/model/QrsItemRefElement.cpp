...
void QrsItemRefElement::validate()
{
    // TODO: implement validation
}

web::json::value QrsItemRefElement::toJson() const
{
...
bool QrsItemRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void QrsItemRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool QrsItemRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t QrsItemRefElement::getHref() const
{
    return m_Href;
}


void QrsItemRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool QrsItemRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void QrsItemRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t QrsItemRefElement::getTitle() const
{
    return m_Title;
}


void QrsItemRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool QrsItemRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void QrsItemRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t QrsItemRefElement::getType() const
{
    return m_Type;
}


void QrsItemRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool QrsItemRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void QrsItemRefElement::unsetType()
{
    m_TypeIsSet = false;
}
