...
void CdashigClassRefSubclass::validate()
{
    // TODO: implement validation
}

web::json::value CdashigClassRefSubclass::toJson() const
{
...
bool CdashigClassRefSubclass::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigClassRefSubclass::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigClassRefSubclass::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigClassRefSubclass::getHref() const
{
    return m_Href;
}


void CdashigClassRefSubclass::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigClassRefSubclass::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigClassRefSubclass::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigClassRefSubclass::getTitle() const
{
    return m_Title;
}


void CdashigClassRefSubclass::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigClassRefSubclass::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigClassRefSubclass::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigClassRefSubclass::getType() const
{
    return m_Type;
}


void CdashigClassRefSubclass::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigClassRefSubclass::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigClassRefSubclass::unsetType()
{
    m_TypeIsSet = false;
}
