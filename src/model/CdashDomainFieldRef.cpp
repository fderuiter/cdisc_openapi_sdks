...
void CdashDomainFieldRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashDomainFieldRef::toJson() const
{
...
bool CdashDomainFieldRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashDomainFieldRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashDomainFieldRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashDomainFieldRef::getHref() const
{
    return m_Href;
}


void CdashDomainFieldRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashDomainFieldRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashDomainFieldRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashDomainFieldRef::getTitle() const
{
    return m_Title;
}


void CdashDomainFieldRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashDomainFieldRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashDomainFieldRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashDomainFieldRef::getType() const
{
    return m_Type;
}


void CdashDomainFieldRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashDomainFieldRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashDomainFieldRef::unsetType()
{
    m_TypeIsSet = false;
}
