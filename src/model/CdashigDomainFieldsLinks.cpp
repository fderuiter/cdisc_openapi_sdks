...
#include "CppRestOpenAPIClient/model/CdashigDomainFieldsLinks.h"
...
void CdashigDomainFieldsLinks::validate()
{
    // TODO: implement validation
}

web::json::value CdashigDomainFieldsLinks::toJson() const
{
...
bool CdashigDomainFieldsLinks::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<CdashigDomainFieldsRef> refVal_setSelf;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("fields"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CdashigDomainFieldRefElement>> refVal_setFields;
...
void CdashigDomainFieldsLinks::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigDomainFieldsLinks::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<CdashigDomainFieldsRef> CdashigDomainFieldsLinks::getSelf() const
{
    return m_Self;
}


void CdashigDomainFieldsLinks::setSelf(const std::shared_ptr<CdashigDomainFieldsRef>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool CdashigDomainFieldsLinks::selfIsSet() const
{
    return m_SelfIsSet;
}

void CdashigDomainFieldsLinks::unsetSelf()
{
    m_SelfIsSet = false;
}
std::shared_ptr<CdashigProductRef> CdashigDomainFieldsLinks::getParentProduct() const
{
    return m_ParentProduct;
}


void CdashigDomainFieldsLinks::setParentProduct(const std::shared_ptr<CdashigProductRef>& value)
{
    m_ParentProduct = value;
    m_ParentProductIsSet = true;
}

bool CdashigDomainFieldsLinks::parentProductIsSet() const
{
    return m_ParentProductIsSet;
}

void CdashigDomainFieldsLinks::unsetParentProduct()
{
    m_ParentProductIsSet = false;
}
std::shared_ptr<CdashigClassRef> CdashigDomainFieldsLinks::getParentClass() const
{
    return m_ParentClass;
}


void CdashigDomainFieldsLinks::setParentClass(const std::shared_ptr<CdashigClassRef>& value)
{
    m_ParentClass = value;
    m_ParentClassIsSet = true;
}

bool CdashigDomainFieldsLinks::parentClassIsSet() const
{
    return m_ParentClassIsSet;
}

void CdashigDomainFieldsLinks::unsetParentClass()
{
    m_ParentClassIsSet = false;
}
std::vector<std::shared_ptr<CdashigDomainFieldRefElement>> CdashigDomainFieldsLinks::getFields() const
{
    return m_Fields;
}


void CdashigDomainFieldsLinks::setFields(const std::vector<std::shared_ptr<CdashigDomainFieldRefElement>>& value)
{
    m_Fields = value;
    m_FieldsIsSet = true;
}

bool CdashigDomainFieldsLinks::fieldsIsSet() const
{
    return m_FieldsIsSet;
}

void CdashigDomainFieldsLinks::unsetFields()
{
    m_FieldsIsSet = false;
}
