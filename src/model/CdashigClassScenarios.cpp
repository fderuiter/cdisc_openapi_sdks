...
void CdashigClassScenarios::validate()
{
    // TODO: implement validation
}

web::json::value CdashigClassScenarios::toJson() const
{
...
bool CdashigClassScenarios::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CdashigClassScenariosLinks> refVal_setLinks;
...
void CdashigClassScenarios::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigClassScenarios::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigClassScenarios::getOrdinal() const
{
    return m_Ordinal;
}


void CdashigClassScenarios::setOrdinal(const utility::string_t& value)
{
    m_Ordinal = value;
    m_OrdinalIsSet = true;
}

bool CdashigClassScenarios::ordinalIsSet() const
{
    return m_OrdinalIsSet;
}

void CdashigClassScenarios::unsetOrdinal()
{
    m_OrdinalIsSet = false;
}
utility::string_t CdashigClassScenarios::getName() const
{
    return m_Name;
}


void CdashigClassScenarios::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool CdashigClassScenarios::nameIsSet() const
{
    return m_NameIsSet;
}

void CdashigClassScenarios::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t CdashigClassScenarios::getLabel() const
{
    return m_Label;
}


void CdashigClassScenarios::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool CdashigClassScenarios::labelIsSet() const
{
    return m_LabelIsSet;
}

void CdashigClassScenarios::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t CdashigClassScenarios::getDescription() const
{
    return m_Description;
}


void CdashigClassScenarios::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool CdashigClassScenarios::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void CdashigClassScenarios::unsetDescription()
{
    m_DescriptionIsSet = false;
}
std::shared_ptr<CdashigClassScenariosLinks> CdashigClassScenarios::getLinks() const
{
    return m__links;
}


void CdashigClassScenarios::setLinks(const std::shared_ptr<CdashigClassScenariosLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool CdashigClassScenarios::linksIsSet() const
{
    return m__linksIsSet;
}

void CdashigClassScenarios::unset_links()
{
    m__linksIsSet = false;
}
