...
void SendigClassRefSubclass::validate()
{
    // TODO: implement validation
}

web::json::value SendigClassRefSubclass::toJson() const
{
...
bool SendigClassRefSubclass::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SendigClassRefSubclass::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendigClassRefSubclass::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SendigClassRefSubclass::getHref() const
{
    return m_Href;
}


void SendigClassRefSubclass::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SendigClassRefSubclass::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SendigClassRefSubclass::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SendigClassRefSubclass::getTitle() const
{
    return m_Title;
}


void SendigClassRefSubclass::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SendigClassRefSubclass::titleIsSet() const
{
    return m_TitleIsSet;
}

void SendigClassRefSubclass::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SendigClassRefSubclass::getType() const
{
    return m_Type;
}


void SendigClassRefSubclass::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SendigClassRefSubclass::typeIsSet() const
{
    return m_TypeIsSet;
}

void SendigClassRefSubclass::unsetType()
{
    m_TypeIsSet = false;
}
