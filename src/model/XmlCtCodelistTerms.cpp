...
void XmlCtCodelistTerms::validate()
{
    // TODO: implement validation
}

web::json::value XmlCtCodelistTerms::toJson() const
{
...
bool XmlCtCodelistTerms::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<CtCodelistTerms> refVal_setSelf;
...
void XmlCtCodelistTerms::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlCtCodelistTerms::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<CtCodelistTerms> XmlCtCodelistTerms::getSelf() const
{
    return m_Self;
}


void XmlCtCodelistTerms::setSelf(const std::shared_ptr<CtCodelistTerms>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlCtCodelistTerms::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlCtCodelistTerms::unsetSelf()
{
    m_SelfIsSet = false;
}
