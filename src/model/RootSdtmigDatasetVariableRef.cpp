...
void RootSdtmigDatasetVariableRef::validate()
{
    // TODO: implement validation
}

web::json::value RootSdtmigDatasetVariableRef::toJson() const
{
...
bool RootSdtmigDatasetVariableRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RootSdtmigDatasetVariableRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RootSdtmigDatasetVariableRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t RootSdtmigDatasetVariableRef::getHref() const
{
    return m_Href;
}


void RootSdtmigDatasetVariableRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool RootSdtmigDatasetVariableRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void RootSdtmigDatasetVariableRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t RootSdtmigDatasetVariableRef::getTitle() const
{
    return m_Title;
}


void RootSdtmigDatasetVariableRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool RootSdtmigDatasetVariableRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void RootSdtmigDatasetVariableRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t RootSdtmigDatasetVariableRef::getType() const
{
    return m_Type;
}


void RootSdtmigDatasetVariableRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool RootSdtmigDatasetVariableRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void RootSdtmigDatasetVariableRef::unsetType()
{
    m_TypeIsSet = false;
}
