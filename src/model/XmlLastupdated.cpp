...
void XmlLastupdated::validate()
{
    // TODO: implement validation
}

web::json::value XmlLastupdated::toJson() const
{
...
bool XmlLastupdated::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<Lastupdated> refVal_setSelf;
...
void XmlLastupdated::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlLastupdated::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<Lastupdated> XmlLastupdated::getSelf() const
{
    return m_Self;
}


void XmlLastupdated::setSelf(const std::shared_ptr<Lastupdated>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlLastupdated::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlLastupdated::unsetSelf()
{
    m_SelfIsSet = false;
}
