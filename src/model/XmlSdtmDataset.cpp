...
void XmlSdtmDataset::validate()
{
    // TODO: implement validation
}

web::json::value XmlSdtmDataset::toJson() const
{
...
bool XmlSdtmDataset::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<SdtmDataset> refVal_setSelf;
...
void XmlSdtmDataset::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlSdtmDataset::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SdtmDataset> XmlSdtmDataset::getSelf() const
{
    return m_Self;
}


void XmlSdtmDataset::setSelf(const std::shared_ptr<SdtmDataset>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlSdtmDataset::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlSdtmDataset::unsetSelf()
{
    m_SelfIsSet = false;
}
