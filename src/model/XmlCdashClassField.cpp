...
void XmlCdashClassField::validate()
{
    // TODO: implement validation
}

web::json::value XmlCdashClassField::toJson() const
{
...
bool XmlCdashClassField::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<CdashClassField> refVal_setSelf;
...
void XmlCdashClassField::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlCdashClassField::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<CdashClassField> XmlCdashClassField::getSelf() const
{
    return m_Self;
}


void XmlCdashClassField::setSelf(const std::shared_ptr<CdashClassField>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlCdashClassField::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlCdashClassField::unsetSelf()
{
    m_SelfIsSet = false;
}
