...
void XmlCtPackage::validate()
{
    // TODO: implement validation
}

web::json::value XmlCtPackage::toJson() const
{
...
bool XmlCtPackage::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<CtPackage> refVal_setSelf;
...
void XmlCtPackage::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlCtPackage::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<CtPackage> XmlCtPackage::getSelf() const
{
    return m_Self;
}


void XmlCtPackage::setSelf(const std::shared_ptr<CtPackage>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlCtPackage::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlCtPackage::unsetSelf()
{
    m_SelfIsSet = false;
}
