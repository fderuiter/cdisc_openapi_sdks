...
void AdamDatastructureRefElement::validate()
{
    // TODO: implement validation
}

web::json::value AdamDatastructureRefElement::toJson() const
{
...
bool AdamDatastructureRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AdamDatastructureRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AdamDatastructureRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AdamDatastructureRefElement::getHref() const
{
    return m_Href;
}


void AdamDatastructureRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool AdamDatastructureRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void AdamDatastructureRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t AdamDatastructureRefElement::getTitle() const
{
    return m_Title;
}


void AdamDatastructureRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool AdamDatastructureRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void AdamDatastructureRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t AdamDatastructureRefElement::getType() const
{
    return m_Type;
}


void AdamDatastructureRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool AdamDatastructureRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void AdamDatastructureRefElement::unsetType()
{
    m_TypeIsSet = false;
}
