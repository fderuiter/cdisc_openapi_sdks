...
void CdashigDomainRefElement::validate()
{
    // TODO: implement validation
}

web::json::value CdashigDomainRefElement::toJson() const
{
...
bool CdashigDomainRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigDomainRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigDomainRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigDomainRefElement::getHref() const
{
    return m_Href;
}


void CdashigDomainRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigDomainRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigDomainRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigDomainRefElement::getTitle() const
{
    return m_Title;
}


void CdashigDomainRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigDomainRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigDomainRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigDomainRefElement::getType() const
{
    return m_Type;
}


void CdashigDomainRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigDomainRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigDomainRefElement::unsetType()
{
    m_TypeIsSet = false;
}
