...
void SendigClassDatasetsRef::validate()
{
    // TODO: implement validation
}

web::json::value SendigClassDatasetsRef::toJson() const
{
...
bool SendigClassDatasetsRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SendigClassDatasetsRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendigClassDatasetsRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SendigClassDatasetsRef::getHref() const
{
    return m_Href;
}


void SendigClassDatasetsRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SendigClassDatasetsRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SendigClassDatasetsRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SendigClassDatasetsRef::getTitle() const
{
    return m_Title;
}


void SendigClassDatasetsRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SendigClassDatasetsRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SendigClassDatasetsRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SendigClassDatasetsRef::getType() const
{
    return m_Type;
}


void SendigClassDatasetsRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SendigClassDatasetsRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SendigClassDatasetsRef::unsetType()
{
    m_TypeIsSet = false;
}
