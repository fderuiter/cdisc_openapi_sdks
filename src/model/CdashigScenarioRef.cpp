...
void CdashigScenarioRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashigScenarioRef::toJson() const
{
...
bool CdashigScenarioRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigScenarioRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigScenarioRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigScenarioRef::getHref() const
{
    return m_Href;
}


void CdashigScenarioRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigScenarioRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigScenarioRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigScenarioRef::getTitle() const
{
    return m_Title;
}


void CdashigScenarioRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigScenarioRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigScenarioRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigScenarioRef::getType() const
{
    return m_Type;
}


void CdashigScenarioRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigScenarioRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigScenarioRef::unsetType()
{
    m_TypeIsSet = false;
}
