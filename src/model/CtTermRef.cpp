...
void CtTermRef::validate()
{
    // TODO: implement validation
}

web::json::value CtTermRef::toJson() const
{
...
bool CtTermRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CtTermRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CtTermRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CtTermRef::getHref() const
{
    return m_Href;
}


void CtTermRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CtTermRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CtTermRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CtTermRef::getTitle() const
{
    return m_Title;
}


void CtTermRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CtTermRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CtTermRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CtTermRef::getType() const
{
    return m_Type;
}


void CtTermRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CtTermRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CtTermRef::unsetType()
{
    m_TypeIsSet = false;
}
