...
void AdamVarsetRef::validate()
{
    // TODO: implement validation
}

web::json::value AdamVarsetRef::toJson() const
{
...
bool AdamVarsetRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AdamVarsetRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AdamVarsetRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AdamVarsetRef::getHref() const
{
    return m_Href;
}


void AdamVarsetRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool AdamVarsetRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void AdamVarsetRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t AdamVarsetRef::getTitle() const
{
    return m_Title;
}


void AdamVarsetRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool AdamVarsetRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void AdamVarsetRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t AdamVarsetRef::getType() const
{
    return m_Type;
}


void AdamVarsetRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool AdamVarsetRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void AdamVarsetRef::unsetType()
{
    m_TypeIsSet = false;
}
