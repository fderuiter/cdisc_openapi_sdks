...
void SendigClassDatasets::validate()
{
    // TODO: implement validation
}

web::json::value SendigClassDatasets::toJson() const
{
...
bool SendigClassDatasets::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SendigClassDatasetsLinks> refVal_setLinks;
...
void SendigClassDatasets::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendigClassDatasets::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SendigClassDatasets::getOrdinal() const
{
    return m_Ordinal;
}


void SendigClassDatasets::setOrdinal(const utility::string_t& value)
{
    m_Ordinal = value;
    m_OrdinalIsSet = true;
}

bool SendigClassDatasets::ordinalIsSet() const
{
    return m_OrdinalIsSet;
}

void SendigClassDatasets::unsetOrdinal()
{
    m_OrdinalIsSet = false;
}
utility::string_t SendigClassDatasets::getName() const
{
    return m_Name;
}


void SendigClassDatasets::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool SendigClassDatasets::nameIsSet() const
{
    return m_NameIsSet;
}

void SendigClassDatasets::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t SendigClassDatasets::getLabel() const
{
    return m_Label;
}


void SendigClassDatasets::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool SendigClassDatasets::labelIsSet() const
{
    return m_LabelIsSet;
}

void SendigClassDatasets::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t SendigClassDatasets::getDescription() const
{
    return m_Description;
}


void SendigClassDatasets::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool SendigClassDatasets::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void SendigClassDatasets::unsetDescription()
{
    m_DescriptionIsSet = false;
}
std::shared_ptr<SendigClassDatasetsLinks> SendigClassDatasets::getLinks() const
{
    return m__links;
}


void SendigClassDatasets::setLinks(const std::shared_ptr<SendigClassDatasetsLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool SendigClassDatasets::linksIsSet() const
{
    return m__linksIsSet;
}

void SendigClassDatasets::unset_links()
{
    m__linksIsSet = false;
}
