...
void QrsProductRef::validate()
{
    // TODO: implement validation
}

web::json::value QrsProductRef::toJson() const
{
...
bool QrsProductRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void QrsProductRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool QrsProductRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t QrsProductRef::getHref() const
{
    return m_Href;
}


void QrsProductRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool QrsProductRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void QrsProductRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t QrsProductRef::getTitle() const
{
    return m_Title;
}


void QrsProductRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool QrsProductRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void QrsProductRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t QrsProductRef::getType() const
{
    return m_Type;
}


void QrsProductRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool QrsProductRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void QrsProductRef::unsetType()
{
    m_TypeIsSet = false;
}
