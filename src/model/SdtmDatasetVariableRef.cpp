...
void SdtmDatasetVariableRef::validate()
{
    // TODO: implement validation
}

web::json::value SdtmDatasetVariableRef::toJson() const
{
...
bool SdtmDatasetVariableRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmDatasetVariableRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmDatasetVariableRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmDatasetVariableRef::getHref() const
{
    return m_Href;
}


void SdtmDatasetVariableRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmDatasetVariableRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmDatasetVariableRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmDatasetVariableRef::getTitle() const
{
    return m_Title;
}


void SdtmDatasetVariableRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmDatasetVariableRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmDatasetVariableRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmDatasetVariableRef::getType() const
{
    return m_Type;
}


void SdtmDatasetVariableRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmDatasetVariableRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmDatasetVariableRef::unsetType()
{
    m_TypeIsSet = false;
}
