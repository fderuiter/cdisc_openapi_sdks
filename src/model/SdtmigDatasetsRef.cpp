...
void SdtmigDatasetsRef::validate()
{
    // TODO: implement validation
}

web::json::value SdtmigDatasetsRef::toJson() const
{
...
bool SdtmigDatasetsRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmigDatasetsRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmigDatasetsRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmigDatasetsRef::getHref() const
{
    return m_Href;
}


void SdtmigDatasetsRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmigDatasetsRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmigDatasetsRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmigDatasetsRef::getTitle() const
{
    return m_Title;
}


void SdtmigDatasetsRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmigDatasetsRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmigDatasetsRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmigDatasetsRef::getType() const
{
    return m_Type;
}


void SdtmigDatasetsRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmigDatasetsRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmigDatasetsRef::unsetType()
{
    m_TypeIsSet = false;
}
