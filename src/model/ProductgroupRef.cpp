...
void ProductgroupRef::validate()
{
    // TODO: implement validation
}

web::json::value ProductgroupRef::toJson() const
{
...
bool ProductgroupRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ProductgroupRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ProductgroupRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ProductgroupRef::getHref() const
{
    return m_Href;
}


void ProductgroupRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool ProductgroupRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void ProductgroupRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t ProductgroupRef::getTitle() const
{
    return m_Title;
}


void ProductgroupRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool ProductgroupRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void ProductgroupRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t ProductgroupRef::getType() const
{
    return m_Type;
}


void ProductgroupRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool ProductgroupRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void ProductgroupRef::unsetType()
{
    m_TypeIsSet = false;
}
