...
/**
 * The ExportSdtmigDatasetsRow model module.
 * @module model/ExportSdtmigDatasetsRow
 * @version 1.1.0
 */
class ExportSdtmigDatasetsRow {
    /**
     * Constructs a new <code>ExportSdtmigDatasetsRow</code>.
     * @alias module:model/ExportSdtmigDatasetsRow
     */
    constructor() { 
        
        ExportSdtmigDatasetsRow.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExportSdtmigDatasetsRow</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExportSdtmigDatasetsRow} obj Optional instance to populate.
     * @return {module:model/ExportSdtmigDatasetsRow} The populated <code>ExportSdtmigDatasetsRow</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExportSdtmigDatasetsRow();
    ...
    /**
     * Validates the JSON data with respect to <code>ExportSdtmigDatasetsRow</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExportSdtmigDatasetsRow</code>.
     */
 ...
 */
ExportSdtmigDatasetsRow.prototype['Version'] = undefined;

/**
 * @member {String} Class
 */
ExportSdtmigDatasetsRow.prototype['Class'] = undefined;

/**
 * @member {String} Dataset Name
 */
ExportSdtmigDatasetsRow.prototype['Dataset Name'] = undefined;

/**
 * @member {String} Dataset Label
 */
ExportSdtmigDatasetsRow.prototype['Dataset Label'] = undefined;

/**
 * @member {String} Structure
 */
ExportSdtmigDatasetsRow.prototype['Structure'] = undefined;
...
export default ExportSdtmigDatasetsRow;
