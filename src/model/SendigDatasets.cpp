...
void SendigDatasets::validate()
{
    // TODO: implement validation
}

web::json::value SendigDatasets::toJson() const
{
...
bool SendigDatasets::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SendigDatasetsLinks> refVal_setLinks;
...
void SendigDatasets::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendigDatasets::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SendigDatasets::getName() const
{
    return m_Name;
}


void SendigDatasets::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool SendigDatasets::nameIsSet() const
{
    return m_NameIsSet;
}

void SendigDatasets::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t SendigDatasets::getLabel() const
{
    return m_Label;
}


void SendigDatasets::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool SendigDatasets::labelIsSet() const
{
    return m_LabelIsSet;
}

void SendigDatasets::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t SendigDatasets::getDescription() const
{
    return m_Description;
}


void SendigDatasets::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool SendigDatasets::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void SendigDatasets::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t SendigDatasets::getSource() const
{
    return m_Source;
}


void SendigDatasets::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool SendigDatasets::sourceIsSet() const
{
    return m_SourceIsSet;
}

void SendigDatasets::unsetSource()
{
    m_SourceIsSet = false;
}
utility::string_t SendigDatasets::getEffectiveDate() const
{
    return m_EffectiveDate;
}


void SendigDatasets::setEffectiveDate(const utility::string_t& value)
{
    m_EffectiveDate = value;
    m_EffectiveDateIsSet = true;
}

bool SendigDatasets::effectiveDateIsSet() const
{
    return m_EffectiveDateIsSet;
}

void SendigDatasets::unsetEffectiveDate()
{
    m_EffectiveDateIsSet = false;
}
utility::string_t SendigDatasets::getRegistrationStatus() const
{
    return m_RegistrationStatus;
}


void SendigDatasets::setRegistrationStatus(const utility::string_t& value)
{
    m_RegistrationStatus = value;
    m_RegistrationStatusIsSet = true;
}

bool SendigDatasets::registrationStatusIsSet() const
{
    return m_RegistrationStatusIsSet;
}

void SendigDatasets::unsetRegistrationStatus()
{
    m_RegistrationStatusIsSet = false;
}
utility::string_t SendigDatasets::getVersion() const
{
    return m_Version;
}


void SendigDatasets::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool SendigDatasets::versionIsSet() const
{
    return m_VersionIsSet;
}

void SendigDatasets::unsetVersion()
{
    m_VersionIsSet = false;
}
std::shared_ptr<SendigDatasetsLinks> SendigDatasets::getLinks() const
{
    return m__links;
}


void SendigDatasets::setLinks(const std::shared_ptr<SendigDatasetsLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool SendigDatasets::linksIsSet() const
{
    return m__linksIsSet;
}

void SendigDatasets::unset_links()
{
    m__linksIsSet = false;
}
