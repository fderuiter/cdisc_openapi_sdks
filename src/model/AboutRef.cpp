...
void AboutRef::validate()
{
    // TODO: implement validation
}

web::json::value AboutRef::toJson() const
{
...
bool AboutRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AboutRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AboutRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AboutRef::getHref() const
{
    return m_Href;
}


void AboutRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool AboutRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void AboutRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t AboutRef::getTitle() const
{
    return m_Title;
}


void AboutRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool AboutRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void AboutRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t AboutRef::getType() const
{
    return m_Type;
}


void AboutRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool AboutRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void AboutRef::unsetType()
{
    m_TypeIsSet = false;
}
