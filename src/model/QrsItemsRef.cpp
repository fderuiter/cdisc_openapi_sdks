...
void QrsItemsRef::validate()
{
    // TODO: implement validation
}

web::json::value QrsItemsRef::toJson() const
{
...
bool QrsItemsRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void QrsItemsRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool QrsItemsRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t QrsItemsRef::getHref() const
{
    return m_Href;
}


void QrsItemsRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool QrsItemsRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void QrsItemsRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t QrsItemsRef::getTitle() const
{
    return m_Title;
}


void QrsItemsRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool QrsItemsRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void QrsItemsRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t QrsItemsRef::getType() const
{
    return m_Type;
}


void QrsItemsRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool QrsItemsRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void QrsItemsRef::unsetType()
{
    m_TypeIsSet = false;
}
