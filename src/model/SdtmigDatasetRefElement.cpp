...
void SdtmigDatasetRefElement::validate()
{
    // TODO: implement validation
}

web::json::value SdtmigDatasetRefElement::toJson() const
{
...
bool SdtmigDatasetRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmigDatasetRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmigDatasetRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmigDatasetRefElement::getHref() const
{
    return m_Href;
}


void SdtmigDatasetRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmigDatasetRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmigDatasetRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmigDatasetRefElement::getTitle() const
{
    return m_Title;
}


void SdtmigDatasetRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmigDatasetRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmigDatasetRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmigDatasetRefElement::getType() const
{
    return m_Type;
}


void SdtmigDatasetRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmigDatasetRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmigDatasetRefElement::unsetType()
{
    m_TypeIsSet = false;
}
