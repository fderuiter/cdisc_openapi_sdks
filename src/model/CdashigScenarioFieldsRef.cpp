...
void CdashigScenarioFieldsRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashigScenarioFieldsRef::toJson() const
{
...
bool CdashigScenarioFieldsRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigScenarioFieldsRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigScenarioFieldsRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigScenarioFieldsRef::getHref() const
{
    return m_Href;
}


void CdashigScenarioFieldsRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigScenarioFieldsRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigScenarioFieldsRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigScenarioFieldsRef::getTitle() const
{
    return m_Title;
}


void CdashigScenarioFieldsRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigScenarioFieldsRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigScenarioFieldsRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigScenarioFieldsRef::getType() const
{
    return m_Type;
}


void CdashigScenarioFieldsRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigScenarioFieldsRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigScenarioFieldsRef::unsetType()
{
    m_TypeIsSet = false;
}
