...
void SendigDatasetVariablesRef::validate()
{
    // TODO: implement validation
}

web::json::value SendigDatasetVariablesRef::toJson() const
{
...
bool SendigDatasetVariablesRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SendigDatasetVariablesRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendigDatasetVariablesRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SendigDatasetVariablesRef::getHref() const
{
    return m_Href;
}


void SendigDatasetVariablesRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SendigDatasetVariablesRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SendigDatasetVariablesRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SendigDatasetVariablesRef::getTitle() const
{
    return m_Title;
}


void SendigDatasetVariablesRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SendigDatasetVariablesRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SendigDatasetVariablesRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SendigDatasetVariablesRef::getType() const
{
    return m_Type;
}


void SendigDatasetVariablesRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SendigDatasetVariablesRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SendigDatasetVariablesRef::unsetType()
{
    m_TypeIsSet = false;
}
