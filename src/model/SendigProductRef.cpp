...
void SendigProductRef::validate()
{
    // TODO: implement validation
}

web::json::value SendigProductRef::toJson() const
{
...
bool SendigProductRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SendigProductRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendigProductRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SendigProductRef::getHref() const
{
    return m_Href;
}


void SendigProductRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SendigProductRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SendigProductRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SendigProductRef::getTitle() const
{
    return m_Title;
}


void SendigProductRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SendigProductRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SendigProductRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SendigProductRef::getType() const
{
    return m_Type;
}


void SendigProductRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SendigProductRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SendigProductRef::unsetType()
{
    m_TypeIsSet = false;
}
