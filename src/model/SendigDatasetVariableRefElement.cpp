...
void SendigDatasetVariableRefElement::validate()
{
    // TODO: implement validation
}

web::json::value SendigDatasetVariableRefElement::toJson() const
{
...
bool SendigDatasetVariableRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SendigDatasetVariableRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendigDatasetVariableRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SendigDatasetVariableRefElement::getHref() const
{
    return m_Href;
}


void SendigDatasetVariableRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SendigDatasetVariableRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SendigDatasetVariableRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SendigDatasetVariableRefElement::getTitle() const
{
    return m_Title;
}


void SendigDatasetVariableRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SendigDatasetVariableRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void SendigDatasetVariableRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SendigDatasetVariableRefElement::getType() const
{
    return m_Type;
}


void SendigDatasetVariableRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SendigDatasetVariableRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void SendigDatasetVariableRefElement::unsetType()
{
    m_TypeIsSet = false;
}
