...
void XmlSendigDatasets::validate()
{
    // TODO: implement validation
}

web::json::value XmlSendigDatasets::toJson() const
{
...
bool XmlSendigDatasets::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<SendigDatasets> refVal_setSelf;
...
void XmlSendigDatasets::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlSendigDatasets::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SendigDatasets> XmlSendigDatasets::getSelf() const
{
    return m_Self;
}


void XmlSendigDatasets::setSelf(const std::shared_ptr<SendigDatasets>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlSendigDatasets::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlSendigDatasets::unsetSelf()
{
    m_SelfIsSet = false;
}
