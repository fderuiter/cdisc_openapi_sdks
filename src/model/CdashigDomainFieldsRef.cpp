...
void CdashigDomainFieldsRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashigDomainFieldsRef::toJson() const
{
...
bool CdashigDomainFieldsRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigDomainFieldsRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigDomainFieldsRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigDomainFieldsRef::getHref() const
{
    return m_Href;
}


void CdashigDomainFieldsRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigDomainFieldsRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigDomainFieldsRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigDomainFieldsRef::getTitle() const
{
    return m_Title;
}


void CdashigDomainFieldsRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigDomainFieldsRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigDomainFieldsRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigDomainFieldsRef::getType() const
{
    return m_Type;
}


void CdashigDomainFieldsRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigDomainFieldsRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigDomainFieldsRef::unsetType()
{
    m_TypeIsSet = false;
}
