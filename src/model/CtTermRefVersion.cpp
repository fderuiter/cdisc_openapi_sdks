...
void CtTermRefVersion::validate()
{
    // TODO: implement validation
}

web::json::value CtTermRefVersion::toJson() const
{
...
bool CtTermRefVersion::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CtTermRefVersion::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CtTermRefVersion::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CtTermRefVersion::getHref() const
{
    return m_Href;
}


void CtTermRefVersion::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CtTermRefVersion::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CtTermRefVersion::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CtTermRefVersion::getTitle() const
{
    return m_Title;
}


void CtTermRefVersion::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CtTermRefVersion::titleIsSet() const
{
    return m_TitleIsSet;
}

void CtTermRefVersion::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CtTermRefVersion::getType() const
{
    return m_Type;
}


void CtTermRefVersion::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CtTermRefVersion::typeIsSet() const
{
    return m_TypeIsSet;
}

void CtTermRefVersion::unsetType()
{
    m_TypeIsSet = false;
}
