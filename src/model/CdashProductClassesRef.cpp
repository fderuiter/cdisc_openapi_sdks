...
void CdashProductClassesRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashProductClassesRef::toJson() const
{
...
bool CdashProductClassesRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashProductClassesRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashProductClassesRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashProductClassesRef::getHref() const
{
    return m_Href;
}


void CdashProductClassesRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashProductClassesRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashProductClassesRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashProductClassesRef::getTitle() const
{
    return m_Title;
}


void CdashProductClassesRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashProductClassesRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashProductClassesRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashProductClassesRef::getType() const
{
    return m_Type;
}


void CdashProductClassesRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashProductClassesRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashProductClassesRef::unsetType()
{
    m_TypeIsSet = false;
}
