...
void ExportCdashDomainVariablesRow::validate()
{
    // TODO: implement validation
}

web::json::value ExportCdashDomainVariablesRow::toJson() const
{
...
bool ExportCdashDomainVariablesRow::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ExportCdashDomainVariablesRow::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ExportCdashDomainVariablesRow::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ExportCdashDomainVariablesRow::getVersion() const
{
    return m_Version;
}


void ExportCdashDomainVariablesRow::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool ExportCdashDomainVariablesRow::versionIsSet() const
{
    return m_VersionIsSet;
}

void ExportCdashDomainVariablesRow::unsetVersion()
{
    m_VersionIsSet = false;
}
utility::string_t ExportCdashDomainVariablesRow::getRClass() const
{
    return m_r_Class;
}


void ExportCdashDomainVariablesRow::setRClass(const utility::string_t& value)
{
    m_r_Class = value;
    m_r_ClassIsSet = true;
}

bool ExportCdashDomainVariablesRow::rClassIsSet() const
{
    return m_r_ClassIsSet;
}

void ExportCdashDomainVariablesRow::unsetr_Class()
{
    m_r_ClassIsSet = false;
}
utility::string_t ExportCdashDomainVariablesRow::getDomain() const
{
    return m_Domain;
}


void ExportCdashDomainVariablesRow::setDomain(const utility::string_t& value)
{
    m_Domain = value;
    m_DomainIsSet = true;
}

bool ExportCdashDomainVariablesRow::domainIsSet() const
{
    return m_DomainIsSet;
}

void ExportCdashDomainVariablesRow::unsetDomain()
{
    m_DomainIsSet = false;
}
utility::string_t ExportCdashDomainVariablesRow::getVariableOrder() const
{
    return m_Variable_Order;
}


void ExportCdashDomainVariablesRow::setVariableOrder(const utility::string_t& value)
{
    m_Variable_Order = value;
    m_Variable_OrderIsSet = true;
}

bool ExportCdashDomainVariablesRow::variableOrderIsSet() const
{
    return m_Variable_OrderIsSet;
}

void ExportCdashDomainVariablesRow::unsetVariable_Order()
{
    m_Variable_OrderIsSet = false;
}
utility::string_t ExportCdashDomainVariablesRow::getCDASHVariable() const
{
    return m_CDASH_Variable;
}


void ExportCdashDomainVariablesRow::setCDASHVariable(const utility::string_t& value)
{
    m_CDASH_Variable = value;
    m_CDASH_VariableIsSet = true;
}

bool ExportCdashDomainVariablesRow::cDASHVariableIsSet() const
{
    return m_CDASH_VariableIsSet;
}

void ExportCdashDomainVariablesRow::unsetCDASH_Variable()
{
    m_CDASH_VariableIsSet = false;
}
utility::string_t ExportCdashDomainVariablesRow::getCDASHVariableLabel() const
{
    return m_CDASH_Variable_Label;
}


void ExportCdashDomainVariablesRow::setCDASHVariableLabel(const utility::string_t& value)
{
    m_CDASH_Variable_Label = value;
    m_CDASH_Variable_LabelIsSet = true;
}

bool ExportCdashDomainVariablesRow::cDASHVariableLabelIsSet() const
{
    return m_CDASH_Variable_LabelIsSet;
}

void ExportCdashDomainVariablesRow::unsetCDASH_Variable_Label()
{
    m_CDASH_Variable_LabelIsSet = false;
}
utility::string_t ExportCdashDomainVariablesRow::getDRAFTCDASHDefinition() const
{
    return m_DRAFT_CDASH_Definition;
}


void ExportCdashDomainVariablesRow::setDRAFTCDASHDefinition(const utility::string_t& value)
{
    m_DRAFT_CDASH_Definition = value;
    m_DRAFT_CDASH_DefinitionIsSet = true;
}

bool ExportCdashDomainVariablesRow::dRAFTCDASHDefinitionIsSet() const
{
    return m_DRAFT_CDASH_DefinitionIsSet;
}

void ExportCdashDomainVariablesRow::unsetDRAFT_CDASH_Definition()
{
    m_DRAFT_CDASH_DefinitionIsSet = false;
}
utility::string_t ExportCdashDomainVariablesRow::getDomainSpecific() const
{
    return m_Domain_Specific;
}


void ExportCdashDomainVariablesRow::setDomainSpecific(const utility::string_t& value)
{
    m_Domain_Specific = value;
    m_Domain_SpecificIsSet = true;
}

bool ExportCdashDomainVariablesRow::domainSpecificIsSet() const
{
    return m_Domain_SpecificIsSet;
}

void ExportCdashDomainVariablesRow::unsetDomain_Specific()
{
    m_Domain_SpecificIsSet = false;
}
utility::string_t ExportCdashDomainVariablesRow::getQuestionText() const
{
    return m_Question_Text;
}


void ExportCdashDomainVariablesRow::setQuestionText(const utility::string_t& value)
{
    m_Question_Text = value;
    m_Question_TextIsSet = true;
}

bool ExportCdashDomainVariablesRow::questionTextIsSet() const
{
    return m_Question_TextIsSet;
}

void ExportCdashDomainVariablesRow::unsetQuestion_Text()
{
    m_Question_TextIsSet = false;
}
utility::string_t ExportCdashDomainVariablesRow::getPrompt() const
{
    return m_Prompt;
}


void ExportCdashDomainVariablesRow::setPrompt(const utility::string_t& value)
{
    m_Prompt = value;
    m_PromptIsSet = true;
}

bool ExportCdashDomainVariablesRow::promptIsSet() const
{
    return m_PromptIsSet;
}

void ExportCdashDomainVariablesRow::unsetPrompt()
{
    m_PromptIsSet = false;
}
utility::string_t ExportCdashDomainVariablesRow::getType() const
{
    return m_Type;
}


void ExportCdashDomainVariablesRow::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool ExportCdashDomainVariablesRow::typeIsSet() const
{
    return m_TypeIsSet;
}

void ExportCdashDomainVariablesRow::unsetType()
{
    m_TypeIsSet = false;
}
std::vector<utility::string_t> ExportCdashDomainVariablesRow::getSDTMTarget() const
{
    return m_SDTM_Target;
}


void ExportCdashDomainVariablesRow::setSDTMTarget(const std::vector<utility::string_t>& value)
{
    m_SDTM_Target = value;
    m_SDTM_TargetIsSet = true;
}

bool ExportCdashDomainVariablesRow::sDTMTargetIsSet() const
{
    return m_SDTM_TargetIsSet;
}

void ExportCdashDomainVariablesRow::unsetSDTM_Target()
{
    m_SDTM_TargetIsSet = false;
}
utility::string_t ExportCdashDomainVariablesRow::getMappingInstructions() const
{
    return m_Mapping_Instructions;
}


void ExportCdashDomainVariablesRow::setMappingInstructions(const utility::string_t& value)
{
    m_Mapping_Instructions = value;
    m_Mapping_InstructionsIsSet = true;
}

bool ExportCdashDomainVariablesRow::mappingInstructionsIsSet() const
{
    return m_Mapping_InstructionsIsSet;
}

void ExportCdashDomainVariablesRow::unsetMapping_Instructions()
{
    m_Mapping_InstructionsIsSet = false;
}
utility::string_t ExportCdashDomainVariablesRow::getControlledTerminologyCodelistName() const
{
    return m_Controlled_Terminology_Codelist_Name;
}


void ExportCdashDomainVariablesRow::setControlledTerminologyCodelistName(const utility::string_t& value)
{
    m_Controlled_Terminology_Codelist_Name = value;
    m_Controlled_Terminology_Codelist_NameIsSet = true;
}

bool ExportCdashDomainVariablesRow::controlledTerminologyCodelistNameIsSet() const
{
    return m_Controlled_Terminology_Codelist_NameIsSet;
}

void ExportCdashDomainVariablesRow::unsetControlled_Terminology_Codelist_Name()
{
    m_Controlled_Terminology_Codelist_NameIsSet = false;
}
utility::string_t ExportCdashDomainVariablesRow::getImplementationNotes() const
{
    return m_Implementation_Notes;
}


void ExportCdashDomainVariablesRow::setImplementationNotes(const utility::string_t& value)
{
    m_Implementation_Notes = value;
    m_Implementation_NotesIsSet = true;
}

bool ExportCdashDomainVariablesRow::implementationNotesIsSet() const
{
    return m_Implementation_NotesIsSet;
}

void ExportCdashDomainVariablesRow::unsetImplementation_Notes()
{
    m_Implementation_NotesIsSet = false;
}
