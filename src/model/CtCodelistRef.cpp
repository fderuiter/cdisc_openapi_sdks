...
void CtCodelistRef::validate()
{
    // TODO: implement validation
}

web::json::value CtCodelistRef::toJson() const
{
...
bool CtCodelistRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CtCodelistRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CtCodelistRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CtCodelistRef::getHref() const
{
    return m_Href;
}


void CtCodelistRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CtCodelistRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CtCodelistRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CtCodelistRef::getTitle() const
{
    return m_Title;
}


void CtCodelistRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CtCodelistRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CtCodelistRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CtCodelistRef::getType() const
{
    return m_Type;
}


void CtCodelistRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CtCodelistRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CtCodelistRef::unsetType()
{
    m_TypeIsSet = false;
}
