...
void SendigClassRefElement::validate()
{
    // TODO: implement validation
}

web::json::value SendigClassRefElement::toJson() const
{
...
bool SendigClassRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SendigClassRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendigClassRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SendigClassRefElement::getHref() const
{
    return m_Href;
}


void SendigClassRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SendigClassRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SendigClassRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SendigClassRefElement::getTitle() const
{
    return m_Title;
}


void SendigClassRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SendigClassRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void SendigClassRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SendigClassRefElement::getType() const
{
    return m_Type;
}


void SendigClassRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SendigClassRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void SendigClassRefElement::unsetType()
{
    m_TypeIsSet = false;
}
