...
void LastupdatedRef::validate()
{
    // TODO: implement validation
}

web::json::value LastupdatedRef::toJson() const
{
...
bool LastupdatedRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void LastupdatedRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LastupdatedRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t LastupdatedRef::getHref() const
{
    return m_Href;
}


void LastupdatedRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool LastupdatedRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void LastupdatedRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t LastupdatedRef::getTitle() const
{
    return m_Title;
}


void LastupdatedRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool LastupdatedRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void LastupdatedRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t LastupdatedRef::getType() const
{
    return m_Type;
}


void LastupdatedRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool LastupdatedRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void LastupdatedRef::unsetType()
{
    m_TypeIsSet = false;
}
