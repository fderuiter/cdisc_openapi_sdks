...
void XmlSdtmClass::validate()
{
    // TODO: implement validation
}

web::json::value XmlSdtmClass::toJson() const
{
...
bool XmlSdtmClass::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<SdtmClass> refVal_setSelf;
...
void XmlSdtmClass::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlSdtmClass::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SdtmClass> XmlSdtmClass::getSelf() const
{
    return m_Self;
}


void XmlSdtmClass::setSelf(const std::shared_ptr<SdtmClass>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlSdtmClass::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlSdtmClass::unsetSelf()
{
    m_SelfIsSet = false;
}
