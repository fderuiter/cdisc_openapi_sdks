...
void CdashDomainRefElement::validate()
{
    // TODO: implement validation
}

web::json::value CdashDomainRefElement::toJson() const
{
...
bool CdashDomainRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashDomainRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashDomainRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashDomainRefElement::getHref() const
{
    return m_Href;
}


void CdashDomainRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashDomainRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashDomainRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashDomainRefElement::getTitle() const
{
    return m_Title;
}


void CdashDomainRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashDomainRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashDomainRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashDomainRefElement::getType() const
{
    return m_Type;
}


void CdashDomainRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashDomainRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashDomainRefElement::unsetType()
{
    m_TypeIsSet = false;
}
