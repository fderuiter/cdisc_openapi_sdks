...
void CdashigScenarioFieldRefElement::validate()
{
    // TODO: implement validation
}

web::json::value CdashigScenarioFieldRefElement::toJson() const
{
...
bool CdashigScenarioFieldRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigScenarioFieldRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigScenarioFieldRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigScenarioFieldRefElement::getHref() const
{
    return m_Href;
}


void CdashigScenarioFieldRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigScenarioFieldRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigScenarioFieldRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigScenarioFieldRefElement::getTitle() const
{
    return m_Title;
}


void CdashigScenarioFieldRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigScenarioFieldRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigScenarioFieldRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigScenarioFieldRefElement::getType() const
{
    return m_Type;
}


void CdashigScenarioFieldRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigScenarioFieldRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigScenarioFieldRefElement::unsetType()
{
    m_TypeIsSet = false;
}
