...
void QrsRefElement::validate()
{
    // TODO: implement validation
}

web::json::value QrsRefElement::toJson() const
{
...
bool QrsRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void QrsRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool QrsRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t QrsRefElement::getHref() const
{
    return m_Href;
}


void QrsRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool QrsRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void QrsRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t QrsRefElement::getTitle() const
{
    return m_Title;
}


void QrsRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool QrsRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void QrsRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t QrsRefElement::getType() const
{
    return m_Type;
}


void QrsRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool QrsRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void QrsRefElement::unsetType()
{
    m_TypeIsSet = false;
}
