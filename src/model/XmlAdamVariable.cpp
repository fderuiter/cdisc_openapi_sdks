...
void XmlAdamVariable::validate()
{
    // TODO: implement validation
}

web::json::value XmlAdamVariable::toJson() const
{
...
bool XmlAdamVariable::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<AdamVariable> refVal_setSelf;
...
void XmlAdamVariable::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlAdamVariable::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<AdamVariable> XmlAdamVariable::getSelf() const
{
    return m_Self;
}


void XmlAdamVariable::setSelf(const std::shared_ptr<AdamVariable>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlAdamVariable::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlAdamVariable::unsetSelf()
{
    m_SelfIsSet = false;
}
