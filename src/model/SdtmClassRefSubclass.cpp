...
void SdtmClassRefSubclass::validate()
{
    // TODO: implement validation
}

web::json::value SdtmClassRefSubclass::toJson() const
{
...
bool SdtmClassRefSubclass::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmClassRefSubclass::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmClassRefSubclass::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmClassRefSubclass::getHref() const
{
    return m_Href;
}


void SdtmClassRefSubclass::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmClassRefSubclass::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmClassRefSubclass::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmClassRefSubclass::getTitle() const
{
    return m_Title;
}


void SdtmClassRefSubclass::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmClassRefSubclass::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmClassRefSubclass::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmClassRefSubclass::getType() const
{
    return m_Type;
}


void SdtmClassRefSubclass::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmClassRefSubclass::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmClassRefSubclass::unsetType()
{
    m_TypeIsSet = false;
}
