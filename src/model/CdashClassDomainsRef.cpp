...
void CdashClassDomainsRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashClassDomainsRef::toJson() const
{
...
bool CdashClassDomainsRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashClassDomainsRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashClassDomainsRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashClassDomainsRef::getHref() const
{
    return m_Href;
}


void CdashClassDomainsRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashClassDomainsRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashClassDomainsRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashClassDomainsRef::getTitle() const
{
    return m_Title;
}


void CdashClassDomainsRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashClassDomainsRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashClassDomainsRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashClassDomainsRef::getType() const
{
    return m_Type;
}


void CdashClassDomainsRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashClassDomainsRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashClassDomainsRef::unsetType()
{
    m_TypeIsSet = false;
}
