...
void XmlCtTerm::validate()
{
    // TODO: implement validation
}

web::json::value XmlCtTerm::toJson() const
{
...
bool XmlCtTerm::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<CtTerm> refVal_setSelf;
...
void XmlCtTerm::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlCtTerm::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<CtTerm> XmlCtTerm::getSelf() const
{
    return m_Self;
}


void XmlCtTerm::setSelf(const std::shared_ptr<CtTerm>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlCtTerm::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlCtTerm::unsetSelf()
{
    m_SelfIsSet = false;
}
