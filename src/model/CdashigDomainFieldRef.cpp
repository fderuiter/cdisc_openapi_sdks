...
void CdashigDomainFieldRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashigDomainFieldRef::toJson() const
{
...
bool CdashigDomainFieldRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigDomainFieldRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigDomainFieldRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigDomainFieldRef::getHref() const
{
    return m_Href;
}


void CdashigDomainFieldRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigDomainFieldRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigDomainFieldRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigDomainFieldRef::getTitle() const
{
    return m_Title;
}


void CdashigDomainFieldRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigDomainFieldRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigDomainFieldRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigDomainFieldRef::getType() const
{
    return m_Type;
}


void CdashigDomainFieldRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigDomainFieldRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigDomainFieldRef::unsetType()
{
    m_TypeIsSet = false;
}
