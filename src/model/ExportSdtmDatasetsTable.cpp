...
void ExportSdtmDatasetsTable::validate()
{
    // TODO: implement validation
}

web::json::value ExportSdtmDatasetsTable::toJson() const
{
...
bool ExportSdtmDatasetsTable::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ExportSdtmDatasetsTable::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ExportSdtmDatasetsTable::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<ExportSdtmDatasetsRow>> ExportSdtmDatasetsTable::getDatasets() const
{
    return m_Datasets;
}


void ExportSdtmDatasetsTable::setDatasets(const std::vector<std::shared_ptr<ExportSdtmDatasetsRow>>& value)
{
    m_Datasets = value;
    m_DatasetsIsSet = true;
}

bool ExportSdtmDatasetsTable::datasetsIsSet() const
{
    return m_DatasetsIsSet;
}

void ExportSdtmDatasetsTable::unsetDatasets()
{
    m_DatasetsIsSet = false;
}
