...
void AdamDatastructureVarsetsRef::validate()
{
    // TODO: implement validation
}

web::json::value AdamDatastructureVarsetsRef::toJson() const
{
...
bool AdamDatastructureVarsetsRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AdamDatastructureVarsetsRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AdamDatastructureVarsetsRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AdamDatastructureVarsetsRef::getHref() const
{
    return m_Href;
}


void AdamDatastructureVarsetsRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool AdamDatastructureVarsetsRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void AdamDatastructureVarsetsRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t AdamDatastructureVarsetsRef::getTitle() const
{
    return m_Title;
}


void AdamDatastructureVarsetsRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool AdamDatastructureVarsetsRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void AdamDatastructureVarsetsRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t AdamDatastructureVarsetsRef::getType() const
{
    return m_Type;
}


void AdamDatastructureVarsetsRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool AdamDatastructureVarsetsRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void AdamDatastructureVarsetsRef::unsetType()
{
    m_TypeIsSet = false;
}
