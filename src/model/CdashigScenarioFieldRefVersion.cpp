...
#include "CppRestOpenAPIClient/model/CdashigScenarioFieldRefVersion.h"
...
void CdashigScenarioFieldRefVersion::validate()
{
    // TODO: implement validation
}

web::json::value CdashigScenarioFieldRefVersion::toJson() const
{
...
bool CdashigScenarioFieldRefVersion::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigScenarioFieldRefVersion::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigScenarioFieldRefVersion::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigScenarioFieldRefVersion::getHref() const
{
    return m_Href;
}


void CdashigScenarioFieldRefVersion::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigScenarioFieldRefVersion::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigScenarioFieldRefVersion::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigScenarioFieldRefVersion::getTitle() const
{
    return m_Title;
}


void CdashigScenarioFieldRefVersion::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigScenarioFieldRefVersion::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigScenarioFieldRefVersion::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigScenarioFieldRefVersion::getType() const
{
    return m_Type;
}


void CdashigScenarioFieldRefVersion::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigScenarioFieldRefVersion::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigScenarioFieldRefVersion::unsetType()
{
    m_TypeIsSet = false;
}
