...
void RootSdtmClassVariableRef::validate()
{
    // TODO: implement validation
}

web::json::value RootSdtmClassVariableRef::toJson() const
{
...
bool RootSdtmClassVariableRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RootSdtmClassVariableRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RootSdtmClassVariableRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t RootSdtmClassVariableRef::getHref() const
{
    return m_Href;
}


void RootSdtmClassVariableRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool RootSdtmClassVariableRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void RootSdtmClassVariableRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t RootSdtmClassVariableRef::getTitle() const
{
    return m_Title;
}


void RootSdtmClassVariableRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool RootSdtmClassVariableRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void RootSdtmClassVariableRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t RootSdtmClassVariableRef::getType() const
{
    return m_Type;
}


void RootSdtmClassVariableRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool RootSdtmClassVariableRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void RootSdtmClassVariableRef::unsetType()
{
    m_TypeIsSet = false;
}
