...
void XmlAdamVarset::validate()
{
    // TODO: implement validation
}

web::json::value XmlAdamVarset::toJson() const
{
...
bool XmlAdamVarset::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<AdamVarset> refVal_setSelf;
...
void XmlAdamVarset::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlAdamVarset::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<AdamVarset> XmlAdamVarset::getSelf() const
{
    return m_Self;
}


void XmlAdamVarset::setSelf(const std::shared_ptr<AdamVarset>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlAdamVarset::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlAdamVarset::unsetSelf()
{
    m_SelfIsSet = false;
}
