...
void XmlSendigClass::validate()
{
    // TODO: implement validation
}

web::json::value XmlSendigClass::toJson() const
{
...
bool XmlSendigClass::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<SendigClass> refVal_setSelf;
...
void XmlSendigClass::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlSendigClass::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SendigClass> XmlSendigClass::getSelf() const
{
    return m_Self;
}


void XmlSendigClass::setSelf(const std::shared_ptr<SendigClass>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlSendigClass::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlSendigClass::unsetSelf()
{
    m_SelfIsSet = false;
}
