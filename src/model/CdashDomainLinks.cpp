...
#include "CppRestOpenAPIClient/model/CdashDomainLinks.h"
...
void CdashDomainLinks::validate()
{
    // TODO: implement validation
}

web::json::value CdashDomainLinks::toJson() const
{
...
bool CdashDomainLinks::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<CdashDomainRef> refVal_setSelf;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("priorVersion"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CdashDomainRef> refVal_setPriorVersion;
...
void CdashDomainLinks::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashDomainLinks::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<CdashDomainRef> CdashDomainLinks::getSelf() const
{
    return m_Self;
}


void CdashDomainLinks::setSelf(const std::shared_ptr<CdashDomainRef>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool CdashDomainLinks::selfIsSet() const
{
    return m_SelfIsSet;
}

void CdashDomainLinks::unsetSelf()
{
    m_SelfIsSet = false;
}
std::shared_ptr<CdashProductRef> CdashDomainLinks::getParentProduct() const
{
    return m_ParentProduct;
}


void CdashDomainLinks::setParentProduct(const std::shared_ptr<CdashProductRef>& value)
{
    m_ParentProduct = value;
    m_ParentProductIsSet = true;
}

bool CdashDomainLinks::parentProductIsSet() const
{
    return m_ParentProductIsSet;
}

void CdashDomainLinks::unsetParentProduct()
{
    m_ParentProductIsSet = false;
}
std::shared_ptr<CdashClassRef> CdashDomainLinks::getParentClass() const
{
    return m_ParentClass;
}


void CdashDomainLinks::setParentClass(const std::shared_ptr<CdashClassRef>& value)
{
    m_ParentClass = value;
    m_ParentClassIsSet = true;
}

bool CdashDomainLinks::parentClassIsSet() const
{
    return m_ParentClassIsSet;
}

void CdashDomainLinks::unsetParentClass()
{
    m_ParentClassIsSet = false;
}
std::shared_ptr<CdashDomainRef> CdashDomainLinks::getPriorVersion() const
{
    return m_PriorVersion;
}


void CdashDomainLinks::setPriorVersion(const std::shared_ptr<CdashDomainRef>& value)
{
    m_PriorVersion = value;
    m_PriorVersionIsSet = true;
}

bool CdashDomainLinks::priorVersionIsSet() const
{
    return m_PriorVersionIsSet;
}

void CdashDomainLinks::unsetPriorVersion()
{
    m_PriorVersionIsSet = false;
}
