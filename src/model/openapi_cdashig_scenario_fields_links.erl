...
-export([openapi_cdashig_scenario_fields_links/0]).

-export([openapi_cdashig_scenario_fields_links/1]).
...
-type openapi_cdashig_scenario_fields_links() ::
  ...
  | {'fields', list(openapi_cdashig_scenario_field_ref_element:openapi_cdashig_scenario_field_ref_element()) }
  ].


openapi_cdashig_scenario_fields_links() ->
    openapi_cdashig_scenario_fields_links([]).

openapi_cdashig_scenario_fields_links(Fields) ->
  Default = [ {'self', openapi_cdashig_scenario_fields_ref:openapi_cdashig_scenario_fields_ref() }
            , {'parentProduct', openapi_cdashig_product_ref:openapi_cdashig_product_ref() }
            , {'parentClass', openapi_cdashig_class_ref:openapi_cdashig_class_ref() }
            , {'parentDomain', openapi_cdashig_domain_ref:openapi_cdashig_domain_ref() }
            , {'fields', list(openapi_cdashig_scenario_field_ref_element:openapi_cdashig_scenario_field_ref_element()) }
