...
void CdashProductRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashProductRef::toJson() const
{
...
bool CdashProductRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashProductRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashProductRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashProductRef::getHref() const
{
    return m_Href;
}


void CdashProductRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashProductRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashProductRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashProductRef::getTitle() const
{
    return m_Title;
}


void CdashProductRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashProductRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashProductRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashProductRef::getType() const
{
    return m_Type;
}


void CdashProductRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashProductRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashProductRef::unsetType()
{
    m_TypeIsSet = false;
}
