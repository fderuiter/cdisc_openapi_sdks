...
void SdtmigDatasetVariableRefTarget::validate()
{
    // TODO: implement validation
}

web::json::value SdtmigDatasetVariableRefTarget::toJson() const
{
...
bool SdtmigDatasetVariableRefTarget::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmigDatasetVariableRefTarget::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmigDatasetVariableRefTarget::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmigDatasetVariableRefTarget::getHref() const
{
    return m_Href;
}


void SdtmigDatasetVariableRefTarget::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmigDatasetVariableRefTarget::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmigDatasetVariableRefTarget::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmigDatasetVariableRefTarget::getTitle() const
{
    return m_Title;
}


void SdtmigDatasetVariableRefTarget::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmigDatasetVariableRefTarget::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmigDatasetVariableRefTarget::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmigDatasetVariableRefTarget::getType() const
{
    return m_Type;
}


void SdtmigDatasetVariableRefTarget::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmigDatasetVariableRefTarget::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmigDatasetVariableRefTarget::unsetType()
{
    m_TypeIsSet = false;
}
