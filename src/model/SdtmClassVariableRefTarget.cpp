...
void SdtmClassVariableRefTarget::validate()
{
    // TODO: implement validation
}

web::json::value SdtmClassVariableRefTarget::toJson() const
{
...
bool SdtmClassVariableRefTarget::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmClassVariableRefTarget::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmClassVariableRefTarget::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmClassVariableRefTarget::getHref() const
{
    return m_Href;
}


void SdtmClassVariableRefTarget::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmClassVariableRefTarget::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmClassVariableRefTarget::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmClassVariableRefTarget::getTitle() const
{
    return m_Title;
}


void SdtmClassVariableRefTarget::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmClassVariableRefTarget::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmClassVariableRefTarget::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmClassVariableRefTarget::getType() const
{
    return m_Type;
}


void SdtmClassVariableRefTarget::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmClassVariableRefTarget::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmClassVariableRefTarget::unsetType()
{
    m_TypeIsSet = false;
}
