...
void SdtmClassVariableRefQualifies::validate()
{
    // TODO: implement validation
}

web::json::value SdtmClassVariableRefQualifies::toJson() const
{
...
bool SdtmClassVariableRefQualifies::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmClassVariableRefQualifies::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmClassVariableRefQualifies::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmClassVariableRefQualifies::getHref() const
{
    return m_Href;
}


void SdtmClassVariableRefQualifies::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmClassVariableRefQualifies::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmClassVariableRefQualifies::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmClassVariableRefQualifies::getTitle() const
{
    return m_Title;
}


void SdtmClassVariableRefQualifies::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmClassVariableRefQualifies::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmClassVariableRefQualifies::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmClassVariableRefQualifies::getType() const
{
    return m_Type;
}


void SdtmClassVariableRefQualifies::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmClassVariableRefQualifies::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmClassVariableRefQualifies::unsetType()
{
    m_TypeIsSet = false;
}
