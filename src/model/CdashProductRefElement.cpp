...
void CdashProductRefElement::validate()
{
    // TODO: implement validation
}

web::json::value CdashProductRefElement::toJson() const
{
...
bool CdashProductRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashProductRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashProductRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashProductRefElement::getHref() const
{
    return m_Href;
}


void CdashProductRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashProductRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashProductRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashProductRefElement::getTitle() const
{
    return m_Title;
}


void CdashProductRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashProductRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashProductRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashProductRefElement::getType() const
{
    return m_Type;
}


void CdashProductRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashProductRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashProductRefElement::unsetType()
{
    m_TypeIsSet = false;
}
