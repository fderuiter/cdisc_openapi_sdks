...
void SendigDatasetRefElement::validate()
{
    // TODO: implement validation
}

web::json::value SendigDatasetRefElement::toJson() const
{
...
bool SendigDatasetRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SendigDatasetRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendigDatasetRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SendigDatasetRefElement::getHref() const
{
    return m_Href;
}


void SendigDatasetRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SendigDatasetRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SendigDatasetRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SendigDatasetRefElement::getTitle() const
{
    return m_Title;
}


void SendigDatasetRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SendigDatasetRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void SendigDatasetRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SendigDatasetRefElement::getType() const
{
    return m_Type;
}


void SendigDatasetRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SendigDatasetRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void SendigDatasetRefElement::unsetType()
{
    m_TypeIsSet = false;
}
