...
void SdtmigProduct::validate()
{
    // TODO: implement validation
}

web::json::value SdtmigProduct::toJson() const
{
...
bool SdtmigProduct::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SdtmigProductLinks> refVal_setLinks;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("classes"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SdtmigClass>> refVal_setClasses;
...
void SdtmigProduct::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmigProduct::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmigProduct::getName() const
{
    return m_Name;
}


void SdtmigProduct::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool SdtmigProduct::nameIsSet() const
{
    return m_NameIsSet;
}

void SdtmigProduct::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t SdtmigProduct::getLabel() const
{
    return m_Label;
}


void SdtmigProduct::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool SdtmigProduct::labelIsSet() const
{
    return m_LabelIsSet;
}

void SdtmigProduct::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t SdtmigProduct::getDescription() const
{
    return m_Description;
}


void SdtmigProduct::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool SdtmigProduct::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void SdtmigProduct::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t SdtmigProduct::getSource() const
{
    return m_Source;
}


void SdtmigProduct::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool SdtmigProduct::sourceIsSet() const
{
    return m_SourceIsSet;
}

void SdtmigProduct::unsetSource()
{
    m_SourceIsSet = false;
}
utility::string_t SdtmigProduct::getEffectiveDate() const
{
    return m_EffectiveDate;
}


void SdtmigProduct::setEffectiveDate(const utility::string_t& value)
{
    m_EffectiveDate = value;
    m_EffectiveDateIsSet = true;
}

bool SdtmigProduct::effectiveDateIsSet() const
{
    return m_EffectiveDateIsSet;
}

void SdtmigProduct::unsetEffectiveDate()
{
    m_EffectiveDateIsSet = false;
}
utility::string_t SdtmigProduct::getRegistrationStatus() const
{
    return m_RegistrationStatus;
}


void SdtmigProduct::setRegistrationStatus(const utility::string_t& value)
{
    m_RegistrationStatus = value;
    m_RegistrationStatusIsSet = true;
}

bool SdtmigProduct::registrationStatusIsSet() const
{
    return m_RegistrationStatusIsSet;
}

void SdtmigProduct::unsetRegistrationStatus()
{
    m_RegistrationStatusIsSet = false;
}
utility::string_t SdtmigProduct::getVersion() const
{
    return m_Version;
}


void SdtmigProduct::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool SdtmigProduct::versionIsSet() const
{
    return m_VersionIsSet;
}

void SdtmigProduct::unsetVersion()
{
    m_VersionIsSet = false;
}
std::shared_ptr<SdtmigProductLinks> SdtmigProduct::getLinks() const
{
    return m__links;
}


void SdtmigProduct::setLinks(const std::shared_ptr<SdtmigProductLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool SdtmigProduct::linksIsSet() const
{
    return m__linksIsSet;
}

void SdtmigProduct::unset_links()
{
    m__linksIsSet = false;
}
std::vector<std::shared_ptr<SdtmigClass>> SdtmigProduct::getClasses() const
{
    return m_Classes;
}


void SdtmigProduct::setClasses(const std::vector<std::shared_ptr<SdtmigClass>>& value)
{
    m_Classes = value;
    m_ClassesIsSet = true;
}

bool SdtmigProduct::classesIsSet() const
{
    return m_ClassesIsSet;
}

void SdtmigProduct::unsetClasses()
{
    m_ClassesIsSet = false;
}
