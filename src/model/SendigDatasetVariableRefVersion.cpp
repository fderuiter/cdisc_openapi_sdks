...
void SendigDatasetVariableRefVersion::validate()
{
    // TODO: implement validation
}

web::json::value SendigDatasetVariableRefVersion::toJson() const
{
...
bool SendigDatasetVariableRefVersion::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SendigDatasetVariableRefVersion::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendigDatasetVariableRefVersion::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SendigDatasetVariableRefVersion::getHref() const
{
    return m_Href;
}


void SendigDatasetVariableRefVersion::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SendigDatasetVariableRefVersion::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SendigDatasetVariableRefVersion::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SendigDatasetVariableRefVersion::getTitle() const
{
    return m_Title;
}


void SendigDatasetVariableRefVersion::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SendigDatasetVariableRefVersion::titleIsSet() const
{
    return m_TitleIsSet;
}

void SendigDatasetVariableRefVersion::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SendigDatasetVariableRefVersion::getType() const
{
    return m_Type;
}


void SendigDatasetVariableRefVersion::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SendigDatasetVariableRefVersion::typeIsSet() const
{
    return m_TypeIsSet;
}

void SendigDatasetVariableRefVersion::unsetType()
{
    m_TypeIsSet = false;
}
