...
#include "CppRestOpenAPIClient/model/CdashigProductDomainsLinks.h"
...
void CdashigProductDomainsLinks::validate()
{
    // TODO: implement validation
}

web::json::value CdashigProductDomainsLinks::toJson() const
{
...
bool CdashigProductDomainsLinks::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<CdashigProductDomainsRef> refVal_setSelf;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("domains"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CdashigDomainRefElement>> refVal_setDomains;
...
void CdashigProductDomainsLinks::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigProductDomainsLinks::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<CdashigProductDomainsRef> CdashigProductDomainsLinks::getSelf() const
{
    return m_Self;
}


void CdashigProductDomainsLinks::setSelf(const std::shared_ptr<CdashigProductDomainsRef>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool CdashigProductDomainsLinks::selfIsSet() const
{
    return m_SelfIsSet;
}

void CdashigProductDomainsLinks::unsetSelf()
{
    m_SelfIsSet = false;
}
std::shared_ptr<CdashigProductRef> CdashigProductDomainsLinks::getParentProduct() const
{
    return m_ParentProduct;
}


void CdashigProductDomainsLinks::setParentProduct(const std::shared_ptr<CdashigProductRef>& value)
{
    m_ParentProduct = value;
    m_ParentProductIsSet = true;
}

bool CdashigProductDomainsLinks::parentProductIsSet() const
{
    return m_ParentProductIsSet;
}

void CdashigProductDomainsLinks::unsetParentProduct()
{
    m_ParentProductIsSet = false;
}
std::vector<std::shared_ptr<CdashigDomainRefElement>> CdashigProductDomainsLinks::getDomains() const
{
    return m_Domains;
}


void CdashigProductDomainsLinks::setDomains(const std::vector<std::shared_ptr<CdashigDomainRefElement>>& value)
{
    m_Domains = value;
    m_DomainsIsSet = true;
}

bool CdashigProductDomainsLinks::domainsIsSet() const
{
    return m_DomainsIsSet;
}

void CdashigProductDomainsLinks::unsetDomains()
{
    m_DomainsIsSet = false;
}
