...
void RootSdtmDatasetVariableRef::validate()
{
    // TODO: implement validation
}

web::json::value RootSdtmDatasetVariableRef::toJson() const
{
...
bool RootSdtmDatasetVariableRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RootSdtmDatasetVariableRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RootSdtmDatasetVariableRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t RootSdtmDatasetVariableRef::getHref() const
{
    return m_Href;
}


void RootSdtmDatasetVariableRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool RootSdtmDatasetVariableRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void RootSdtmDatasetVariableRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t RootSdtmDatasetVariableRef::getTitle() const
{
    return m_Title;
}


void RootSdtmDatasetVariableRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool RootSdtmDatasetVariableRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void RootSdtmDatasetVariableRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t RootSdtmDatasetVariableRef::getType() const
{
    return m_Type;
}


void RootSdtmDatasetVariableRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool RootSdtmDatasetVariableRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void RootSdtmDatasetVariableRef::unsetType()
{
    m_TypeIsSet = false;
}
