...
void CdashigProductClassesRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashigProductClassesRef::toJson() const
{
...
bool CdashigProductClassesRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigProductClassesRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigProductClassesRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigProductClassesRef::getHref() const
{
    return m_Href;
}


void CdashigProductClassesRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigProductClassesRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigProductClassesRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigProductClassesRef::getTitle() const
{
    return m_Title;
}


void CdashigProductClassesRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigProductClassesRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigProductClassesRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigProductClassesRef::getType() const
{
    return m_Type;
}


void CdashigProductClassesRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigProductClassesRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigProductClassesRef::unsetType()
{
    m_TypeIsSet = false;
}
