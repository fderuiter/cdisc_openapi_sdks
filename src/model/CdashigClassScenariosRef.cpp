...
void CdashigClassScenariosRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashigClassScenariosRef::toJson() const
{
...
bool CdashigClassScenariosRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigClassScenariosRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigClassScenariosRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigClassScenariosRef::getHref() const
{
    return m_Href;
}


void CdashigClassScenariosRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigClassScenariosRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigClassScenariosRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigClassScenariosRef::getTitle() const
{
    return m_Title;
}


void CdashigClassScenariosRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigClassScenariosRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigClassScenariosRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigClassScenariosRef::getType() const
{
    return m_Type;
}


void CdashigClassScenariosRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigClassScenariosRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigClassScenariosRef::unsetType()
{
    m_TypeIsSet = false;
}
