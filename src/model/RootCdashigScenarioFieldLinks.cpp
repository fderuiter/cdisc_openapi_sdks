...
#include "CppRestOpenAPIClient/model/RootCdashigScenarioFieldLinks.h"
...
void RootCdashigScenarioFieldLinks::validate()
{
    // TODO: implement validation
}

web::json::value RootCdashigScenarioFieldLinks::toJson() const
{
...
bool RootCdashigScenarioFieldLinks::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<RootCdashigScenarioFieldRef> refVal_setSelf;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("versions"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CdashigScenarioFieldRefVersion>> refVal_setVersions;
...
void RootCdashigScenarioFieldLinks::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RootCdashigScenarioFieldLinks::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<RootCdashigScenarioFieldRef> RootCdashigScenarioFieldLinks::getSelf() const
{
    return m_Self;
}


void RootCdashigScenarioFieldLinks::setSelf(const std::shared_ptr<RootCdashigScenarioFieldRef>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool RootCdashigScenarioFieldLinks::selfIsSet() const
{
    return m_SelfIsSet;
}

void RootCdashigScenarioFieldLinks::unsetSelf()
{
    m_SelfIsSet = false;
}
std::vector<std::shared_ptr<CdashigScenarioFieldRefVersion>> RootCdashigScenarioFieldLinks::getVersions() const
{
    return m_Versions;
}


void RootCdashigScenarioFieldLinks::setVersions(const std::vector<std::shared_ptr<CdashigScenarioFieldRefVersion>>& value)
{
    m_Versions = value;
    m_VersionsIsSet = true;
}

bool RootCdashigScenarioFieldLinks::versionsIsSet() const
{
    return m_VersionsIsSet;
}

void RootCdashigScenarioFieldLinks::unsetVersions()
{
    m_VersionsIsSet = false;
}
