...
void CtPackageRef::validate()
{
    // TODO: implement validation
}

web::json::value CtPackageRef::toJson() const
{
...
bool CtPackageRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CtPackageRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CtPackageRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CtPackageRef::getHref() const
{
    return m_Href;
}


void CtPackageRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CtPackageRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CtPackageRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CtPackageRef::getTitle() const
{
    return m_Title;
}


void CtPackageRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CtPackageRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CtPackageRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CtPackageRef::getType() const
{
    return m_Type;
}


void CtPackageRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CtPackageRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CtPackageRef::unsetType()
{
    m_TypeIsSet = false;
}
