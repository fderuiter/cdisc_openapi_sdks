...
void RootCdashClassFieldLinks::validate()
{
    // TODO: implement validation
}

web::json::value RootCdashClassFieldLinks::toJson() const
{
...
bool RootCdashClassFieldLinks::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<RootCdashClassFieldRef> refVal_setSelf;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("versions"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CdashClassFieldRefVersion>> refVal_setVersions;
...
void RootCdashClassFieldLinks::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RootCdashClassFieldLinks::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<RootCdashClassFieldRef> RootCdashClassFieldLinks::getSelf() const
{
    return m_Self;
}


void RootCdashClassFieldLinks::setSelf(const std::shared_ptr<RootCdashClassFieldRef>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool RootCdashClassFieldLinks::selfIsSet() const
{
    return m_SelfIsSet;
}

void RootCdashClassFieldLinks::unsetSelf()
{
    m_SelfIsSet = false;
}
std::vector<std::shared_ptr<CdashClassFieldRefVersion>> RootCdashClassFieldLinks::getVersions() const
{
    return m_Versions;
}


void RootCdashClassFieldLinks::setVersions(const std::vector<std::shared_ptr<CdashClassFieldRefVersion>>& value)
{
    m_Versions = value;
    m_VersionsIsSet = true;
}

bool RootCdashClassFieldLinks::versionsIsSet() const
{
    return m_VersionsIsSet;
}

void RootCdashClassFieldLinks::unsetVersions()
{
    m_VersionsIsSet = false;
}
