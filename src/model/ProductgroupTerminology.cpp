...
void ProductgroupTerminology::validate()
{
    // TODO: implement validation
}

web::json::value ProductgroupTerminology::toJson() const
{
...
bool ProductgroupTerminology::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        {
            std::shared_ptr<ProductgroupTerminologyLinks> refVal_setLinks;
...
void ProductgroupTerminology::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ProductgroupTerminology::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<ProductgroupTerminologyLinks> ProductgroupTerminology::getLinks() const
{
    return m__links;
}


void ProductgroupTerminology::setLinks(const std::shared_ptr<ProductgroupTerminologyLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool ProductgroupTerminology::linksIsSet() const
{
    return m__linksIsSet;
}

void ProductgroupTerminology::unset_links()
{
    m__linksIsSet = false;
}
