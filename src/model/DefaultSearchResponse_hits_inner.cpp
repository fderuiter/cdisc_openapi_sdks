...
void DefaultSearchResponse_hits_inner::validate()
{
    // TODO: implement validation
}

web::json::value DefaultSearchResponse_hits_inner::toJson() const
{
...
bool DefaultSearchResponse_hits_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DefaultSearchResponse_hits_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DefaultSearchResponse_hits_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t DefaultSearchResponse_hits_inner::getHref() const
{
    return m_Href;
}


void DefaultSearchResponse_hits_inner::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool DefaultSearchResponse_hits_inner::hrefIsSet() const
{
    return m_HrefIsSet;
}

void DefaultSearchResponse_hits_inner::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t DefaultSearchResponse_hits_inner::getType() const
{
    return m_Type;
}


void DefaultSearchResponse_hits_inner::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool DefaultSearchResponse_hits_inner::typeIsSet() const
{
    return m_TypeIsSet;
}

void DefaultSearchResponse_hits_inner::unsetType()
{
    m_TypeIsSet = false;
}
