...
void CtCodelistRefVersion::validate()
{
    // TODO: implement validation
}

web::json::value CtCodelistRefVersion::toJson() const
{
...
bool CtCodelistRefVersion::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CtCodelistRefVersion::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CtCodelistRefVersion::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CtCodelistRefVersion::getHref() const
{
    return m_Href;
}


void CtCodelistRefVersion::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CtCodelistRefVersion::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CtCodelistRefVersion::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CtCodelistRefVersion::getTitle() const
{
    return m_Title;
}


void CtCodelistRefVersion::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CtCodelistRefVersion::titleIsSet() const
{
    return m_TitleIsSet;
}

void CtCodelistRefVersion::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CtCodelistRefVersion::getType() const
{
    return m_Type;
}


void CtCodelistRefVersion::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CtCodelistRefVersion::typeIsSet() const
{
    return m_TypeIsSet;
}

void CtCodelistRefVersion::unsetType()
{
    m_TypeIsSet = false;
}
