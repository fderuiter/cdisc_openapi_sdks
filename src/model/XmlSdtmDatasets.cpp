...
void XmlSdtmDatasets::validate()
{
    // TODO: implement validation
}

web::json::value XmlSdtmDatasets::toJson() const
{
...
bool XmlSdtmDatasets::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<SdtmDatasets> refVal_setSelf;
...
void XmlSdtmDatasets::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlSdtmDatasets::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SdtmDatasets> XmlSdtmDatasets::getSelf() const
{
    return m_Self;
}


void XmlSdtmDatasets::setSelf(const std::shared_ptr<SdtmDatasets>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlSdtmDatasets::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlSdtmDatasets::unsetSelf()
{
    m_SelfIsSet = false;
}
