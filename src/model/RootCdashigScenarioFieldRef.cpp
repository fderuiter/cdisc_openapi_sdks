...
void RootCdashigScenarioFieldRef::validate()
{
    // TODO: implement validation
}

web::json::value RootCdashigScenarioFieldRef::toJson() const
{
...
bool RootCdashigScenarioFieldRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RootCdashigScenarioFieldRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RootCdashigScenarioFieldRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t RootCdashigScenarioFieldRef::getHref() const
{
    return m_Href;
}


void RootCdashigScenarioFieldRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool RootCdashigScenarioFieldRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void RootCdashigScenarioFieldRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t RootCdashigScenarioFieldRef::getTitle() const
{
    return m_Title;
}


void RootCdashigScenarioFieldRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool RootCdashigScenarioFieldRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void RootCdashigScenarioFieldRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t RootCdashigScenarioFieldRef::getType() const
{
    return m_Type;
}


void RootCdashigScenarioFieldRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool RootCdashigScenarioFieldRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void RootCdashigScenarioFieldRef::unsetType()
{
    m_TypeIsSet = false;
}
