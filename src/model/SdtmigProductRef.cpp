...
void SdtmigProductRef::validate()
{
    // TODO: implement validation
}

web::json::value SdtmigProductRef::toJson() const
{
...
bool SdtmigProductRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmigProductRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmigProductRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmigProductRef::getHref() const
{
    return m_Href;
}


void SdtmigProductRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmigProductRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmigProductRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmigProductRef::getTitle() const
{
    return m_Title;
}


void SdtmigProductRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmigProductRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmigProductRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmigProductRef::getType() const
{
    return m_Type;
}


void SdtmigProductRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmigProductRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmigProductRef::unsetType()
{
    m_TypeIsSet = false;
}
