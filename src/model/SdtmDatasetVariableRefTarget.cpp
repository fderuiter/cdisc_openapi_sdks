...
void SdtmDatasetVariableRefTarget::validate()
{
    // TODO: implement validation
}

web::json::value SdtmDatasetVariableRefTarget::toJson() const
{
...
bool SdtmDatasetVariableRefTarget::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmDatasetVariableRefTarget::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmDatasetVariableRefTarget::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmDatasetVariableRefTarget::getHref() const
{
    return m_Href;
}


void SdtmDatasetVariableRefTarget::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmDatasetVariableRefTarget::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmDatasetVariableRefTarget::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmDatasetVariableRefTarget::getTitle() const
{
    return m_Title;
}


void SdtmDatasetVariableRefTarget::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmDatasetVariableRefTarget::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmDatasetVariableRefTarget::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmDatasetVariableRefTarget::getType() const
{
    return m_Type;
}


void SdtmDatasetVariableRefTarget::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmDatasetVariableRefTarget::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmDatasetVariableRefTarget::unsetType()
{
    m_TypeIsSet = false;
}
