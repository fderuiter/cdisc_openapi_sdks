...
#include "CppRestOpenAPIClient/model/CdashigClassDomainsLinks.h"
...
void CdashigClassDomainsLinks::validate()
{
    // TODO: implement validation
}

web::json::value CdashigClassDomainsLinks::toJson() const
{
...
bool CdashigClassDomainsLinks::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<CdashigClassDomainsRef> refVal_setSelf;
...
void CdashigClassDomainsLinks::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigClassDomainsLinks::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<CdashigClassDomainsRef> CdashigClassDomainsLinks::getSelf() const
{
    return m_Self;
}


void CdashigClassDomainsLinks::setSelf(const std::shared_ptr<CdashigClassDomainsRef>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool CdashigClassDomainsLinks::selfIsSet() const
{
    return m_SelfIsSet;
}

void CdashigClassDomainsLinks::unsetSelf()
{
    m_SelfIsSet = false;
}
std::vector<std::shared_ptr<CdashigDomainRefElement>> CdashigClassDomainsLinks::getDomains() const
{
    return m_Domains;
}


void CdashigClassDomainsLinks::setDomains(const std::vector<std::shared_ptr<CdashigDomainRefElement>>& value)
{
    m_Domains = value;
    m_DomainsIsSet = true;
}

bool CdashigClassDomainsLinks::domainsIsSet() const
{
    return m_DomainsIsSet;
}

void CdashigClassDomainsLinks::unsetDomains()
{
    m_DomainsIsSet = false;
}
