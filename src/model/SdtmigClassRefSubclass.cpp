...
void SdtmigClassRefSubclass::validate()
{
    // TODO: implement validation
}

web::json::value SdtmigClassRefSubclass::toJson() const
{
...
bool SdtmigClassRefSubclass::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmigClassRefSubclass::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmigClassRefSubclass::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmigClassRefSubclass::getHref() const
{
    return m_Href;
}


void SdtmigClassRefSubclass::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmigClassRefSubclass::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmigClassRefSubclass::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmigClassRefSubclass::getTitle() const
{
    return m_Title;
}


void SdtmigClassRefSubclass::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmigClassRefSubclass::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmigClassRefSubclass::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmigClassRefSubclass::getType() const
{
    return m_Type;
}


void SdtmigClassRefSubclass::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmigClassRefSubclass::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmigClassRefSubclass::unsetType()
{
    m_TypeIsSet = false;
}
