...
void SdtmigDatasetVariableRef::validate()
{
    // TODO: implement validation
}

web::json::value SdtmigDatasetVariableRef::toJson() const
{
...
bool SdtmigDatasetVariableRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmigDatasetVariableRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmigDatasetVariableRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmigDatasetVariableRef::getHref() const
{
    return m_Href;
}


void SdtmigDatasetVariableRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmigDatasetVariableRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmigDatasetVariableRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmigDatasetVariableRef::getTitle() const
{
    return m_Title;
}


void SdtmigDatasetVariableRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmigDatasetVariableRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmigDatasetVariableRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmigDatasetVariableRef::getType() const
{
    return m_Type;
}


void SdtmigDatasetVariableRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmigDatasetVariableRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmigDatasetVariableRef::unsetType()
{
    m_TypeIsSet = false;
}
