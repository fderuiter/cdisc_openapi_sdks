...
void XmlSdtmClasses::validate()
{
    // TODO: implement validation
}

web::json::value XmlSdtmClasses::toJson() const
{
...
bool XmlSdtmClasses::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<SdtmClasses> refVal_setSelf;
...
void XmlSdtmClasses::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlSdtmClasses::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SdtmClasses> XmlSdtmClasses::getSelf() const
{
    return m_Self;
}


void XmlSdtmClasses::setSelf(const std::shared_ptr<SdtmClasses>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlSdtmClasses::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlSdtmClasses::unsetSelf()
{
    m_SelfIsSet = false;
}
