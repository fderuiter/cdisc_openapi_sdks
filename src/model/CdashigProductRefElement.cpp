...
void CdashigProductRefElement::validate()
{
    // TODO: implement validation
}

web::json::value CdashigProductRefElement::toJson() const
{
...
bool CdashigProductRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigProductRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigProductRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigProductRefElement::getHref() const
{
    return m_Href;
}


void CdashigProductRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigProductRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigProductRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigProductRefElement::getTitle() const
{
    return m_Title;
}


void CdashigProductRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigProductRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigProductRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigProductRefElement::getType() const
{
    return m_Type;
}


void CdashigProductRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigProductRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigProductRefElement::unsetType()
{
    m_TypeIsSet = false;
}
