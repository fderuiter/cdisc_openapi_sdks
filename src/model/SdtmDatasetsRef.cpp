...
void SdtmDatasetsRef::validate()
{
    // TODO: implement validation
}

web::json::value SdtmDatasetsRef::toJson() const
{
...
bool SdtmDatasetsRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmDatasetsRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmDatasetsRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmDatasetsRef::getHref() const
{
    return m_Href;
}


void SdtmDatasetsRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmDatasetsRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmDatasetsRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmDatasetsRef::getTitle() const
{
    return m_Title;
}


void SdtmDatasetsRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmDatasetsRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmDatasetsRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmDatasetsRef::getType() const
{
    return m_Type;
}


void SdtmDatasetsRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmDatasetsRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmDatasetsRef::unsetType()
{
    m_TypeIsSet = false;
}
