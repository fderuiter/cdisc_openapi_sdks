...
void XmlAdamProduct::validate()
{
    // TODO: implement validation
}

web::json::value XmlAdamProduct::toJson() const
{
...
bool XmlAdamProduct::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<AdamProduct> refVal_setSelf;
...
void XmlAdamProduct::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlAdamProduct::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<AdamProduct> XmlAdamProduct::getSelf() const
{
    return m_Self;
}


void XmlAdamProduct::setSelf(const std::shared_ptr<AdamProduct>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlAdamProduct::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlAdamProduct::unsetSelf()
{
    m_SelfIsSet = false;
}
