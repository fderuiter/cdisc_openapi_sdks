...
void XmlRootCtTerm::validate()
{
    // TODO: implement validation
}

web::json::value XmlRootCtTerm::toJson() const
{
...
bool XmlRootCtTerm::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<RootCtTerm> refVal_setSelf;
...
void XmlRootCtTerm::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlRootCtTerm::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<RootCtTerm> XmlRootCtTerm::getSelf() const
{
    return m_Self;
}


void XmlRootCtTerm::setSelf(const std::shared_ptr<RootCtTerm>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlRootCtTerm::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlRootCtTerm::unsetSelf()
{
    m_SelfIsSet = false;
}
