...
void CtPackagesRef::validate()
{
    // TODO: implement validation
}

web::json::value CtPackagesRef::toJson() const
{
...
bool CtPackagesRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CtPackagesRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CtPackagesRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CtPackagesRef::getHref() const
{
    return m_Href;
}


void CtPackagesRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CtPackagesRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CtPackagesRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CtPackagesRef::getTitle() const
{
    return m_Title;
}


void CtPackagesRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CtPackagesRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CtPackagesRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CtPackagesRef::getType() const
{
    return m_Type;
}


void CtPackagesRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CtPackagesRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CtPackagesRef::unsetType()
{
    m_TypeIsSet = false;
}
