...
void SdtmigClassDatasetsRef::validate()
{
    // TODO: implement validation
}

web::json::value SdtmigClassDatasetsRef::toJson() const
{
...
bool SdtmigClassDatasetsRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmigClassDatasetsRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmigClassDatasetsRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmigClassDatasetsRef::getHref() const
{
    return m_Href;
}


void SdtmigClassDatasetsRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmigClassDatasetsRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmigClassDatasetsRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmigClassDatasetsRef::getTitle() const
{
    return m_Title;
}


void SdtmigClassDatasetsRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmigClassDatasetsRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmigClassDatasetsRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmigClassDatasetsRef::getType() const
{
    return m_Type;
}


void SdtmigClassDatasetsRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmigClassDatasetsRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmigClassDatasetsRef::unsetType()
{
    m_TypeIsSet = false;
}
