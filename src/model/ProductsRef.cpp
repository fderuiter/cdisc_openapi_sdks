...
void ProductsRef::validate()
{
    // TODO: implement validation
}

web::json::value ProductsRef::toJson() const
{
...
bool ProductsRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ProductsRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ProductsRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ProductsRef::getHref() const
{
    return m_Href;
}


void ProductsRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool ProductsRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void ProductsRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t ProductsRef::getTitle() const
{
    return m_Title;
}


void ProductsRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool ProductsRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void ProductsRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t ProductsRef::getType() const
{
    return m_Type;
}


void ProductsRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool ProductsRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void ProductsRef::unsetType()
{
    m_TypeIsSet = false;
}
