...
void SdtmClassVariablesRef::validate()
{
    // TODO: implement validation
}

web::json::value SdtmClassVariablesRef::toJson() const
{
...
bool SdtmClassVariablesRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmClassVariablesRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmClassVariablesRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmClassVariablesRef::getHref() const
{
    return m_Href;
}


void SdtmClassVariablesRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmClassVariablesRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmClassVariablesRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmClassVariablesRef::getTitle() const
{
    return m_Title;
}


void SdtmClassVariablesRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmClassVariablesRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmClassVariablesRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmClassVariablesRef::getType() const
{
    return m_Type;
}


void SdtmClassVariablesRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmClassVariablesRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmClassVariablesRef::unsetType()
{
    m_TypeIsSet = false;
}
