...
void RootCtTerm::validate()
{
    // TODO: implement validation
}

web::json::value RootCtTerm::toJson() const
{
...
bool RootCtTerm::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        {
            std::shared_ptr<RootCtTermLinks> refVal_setLinks;
...
void RootCtTerm::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RootCtTerm::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<RootCtTermLinks> RootCtTerm::getLinks() const
{
    return m__links;
}


void RootCtTerm::setLinks(const std::shared_ptr<RootCtTermLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool RootCtTerm::linksIsSet() const
{
    return m__linksIsSet;
}

void RootCtTerm::unset_links()
{
    m__linksIsSet = false;
}
