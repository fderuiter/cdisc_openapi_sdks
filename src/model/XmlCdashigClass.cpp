...
void XmlCdashigClass::validate()
{
    // TODO: implement validation
}

web::json::value XmlCdashigClass::toJson() const
{
...
bool XmlCdashigClass::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<CdashigClass> refVal_setSelf;
...
void XmlCdashigClass::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlCdashigClass::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<CdashigClass> XmlCdashigClass::getSelf() const
{
    return m_Self;
}


void XmlCdashigClass::setSelf(const std::shared_ptr<CdashigClass>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlCdashigClass::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlCdashigClass::unsetSelf()
{
    m_SelfIsSet = false;
}
