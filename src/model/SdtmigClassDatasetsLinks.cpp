...
#include "CppRestOpenAPIClient/model/SdtmigClassDatasetsLinks.h"
...
void SdtmigClassDatasetsLinks::validate()
{
    // TODO: implement validation
}

web::json::value SdtmigClassDatasetsLinks::toJson() const
{
...
bool SdtmigClassDatasetsLinks::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<SdtmigClassDatasetsRef> refVal_setSelf;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("priorVersion"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SdtmigClassDatasetsRef> refVal_setPriorVersion;
...
void SdtmigClassDatasetsLinks::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmigClassDatasetsLinks::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SdtmigClassDatasetsRef> SdtmigClassDatasetsLinks::getSelf() const
{
    return m_Self;
}


void SdtmigClassDatasetsLinks::setSelf(const std::shared_ptr<SdtmigClassDatasetsRef>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool SdtmigClassDatasetsLinks::selfIsSet() const
{
    return m_SelfIsSet;
}

void SdtmigClassDatasetsLinks::unsetSelf()
{
    m_SelfIsSet = false;
}
std::shared_ptr<SdtmigProductRef> SdtmigClassDatasetsLinks::getParentProduct() const
{
    return m_ParentProduct;
}


void SdtmigClassDatasetsLinks::setParentProduct(const std::shared_ptr<SdtmigProductRef>& value)
{
    m_ParentProduct = value;
    m_ParentProductIsSet = true;
}

bool SdtmigClassDatasetsLinks::parentProductIsSet() const
{
    return m_ParentProductIsSet;
}

void SdtmigClassDatasetsLinks::unsetParentProduct()
{
    m_ParentProductIsSet = false;
}
std::shared_ptr<SdtmigClassDatasetsRef> SdtmigClassDatasetsLinks::getPriorVersion() const
{
    return m_PriorVersion;
}


void SdtmigClassDatasetsLinks::setPriorVersion(const std::shared_ptr<SdtmigClassDatasetsRef>& value)
{
    m_PriorVersion = value;
    m_PriorVersionIsSet = true;
}

bool SdtmigClassDatasetsLinks::priorVersionIsSet() const
{
    return m_PriorVersionIsSet;
}

void SdtmigClassDatasetsLinks::unsetPriorVersion()
{
    m_PriorVersionIsSet = false;
}
std::vector<std::shared_ptr<SdtmigDatasetRefElement>> SdtmigClassDatasetsLinks::getDatasets() const
{
    return m_Datasets;
}


void SdtmigClassDatasetsLinks::setDatasets(const std::vector<std::shared_ptr<SdtmigDatasetRefElement>>& value)
{
    m_Datasets = value;
    m_DatasetsIsSet = true;
}

bool SdtmigClassDatasetsLinks::datasetsIsSet() const
{
    return m_DatasetsIsSet;
}

void SdtmigClassDatasetsLinks::unsetDatasets()
{
    m_DatasetsIsSet = false;
}
