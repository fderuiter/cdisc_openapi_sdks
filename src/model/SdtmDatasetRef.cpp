...
void SdtmDatasetRef::validate()
{
    // TODO: implement validation
}

web::json::value SdtmDatasetRef::toJson() const
{
...
bool SdtmDatasetRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmDatasetRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmDatasetRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmDatasetRef::getHref() const
{
    return m_Href;
}


void SdtmDatasetRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmDatasetRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmDatasetRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmDatasetRef::getTitle() const
{
    return m_Title;
}


void SdtmDatasetRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmDatasetRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmDatasetRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmDatasetRef::getType() const
{
    return m_Type;
}


void SdtmDatasetRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmDatasetRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmDatasetRef::unsetType()
{
    m_TypeIsSet = false;
}
