-module(openapi_export_cdash_domain_variables_row).

-include("openapi.hrl").

-export([openapi_export_cdash_domain_variables_row/0]).

-export([openapi_export_cdash_domain_variables_row/1]).

-export_type([openapi_export_cdash_domain_variables_row/0]).

-type openapi_export_cdash_domain_variables_row() ::
  [ {'Version', binary() }
  | {'Class', binary() }
  | {'Domain', binary() }
...
openapi_export_cdash_domain_variables_row() ->
    openapi_export_cdash_domain_variables_row([]).

openapi_export_cdash_domain_variables_row(Fields) ->
