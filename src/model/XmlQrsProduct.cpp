...
void XmlQrsProduct::validate()
{
    // TODO: implement validation
}

web::json::value XmlQrsProduct::toJson() const
{
...
bool XmlQrsProduct::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<QrsProduct> refVal_setSelf;
...
void XmlQrsProduct::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlQrsProduct::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<QrsProduct> XmlQrsProduct::getSelf() const
{
    return m_Self;
}


void XmlQrsProduct::setSelf(const std::shared_ptr<QrsProduct>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlQrsProduct::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlQrsProduct::unsetSelf()
{
    m_SelfIsSet = false;
}
