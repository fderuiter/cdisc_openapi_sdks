...
#ifndef _SdtmClasses_H_
#define _SdtmClasses_H_
...
class SdtmClasses : public Object {
public:
	/*! \brief Constructor.
	 */
	SdtmClasses();
	SdtmClasses(char* str);
	...
	/*! \brief Get 
	 */
	SdtmClassesLinks getLinks();

	/*! \brief Set 
	 */
	void setLinks(SdtmClassesLinks  _links);
