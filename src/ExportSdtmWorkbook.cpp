...
void
ExportSdtmWorkbook::fromJson(char* jsonStr)
{
...
ExportSdtmWorkbook::ExportSdtmWorkbook(char* json)
{
	this->fromJson(json);
}

char*
ExportSdtmWorkbook::toJson()
{
...
ExportSdtmWorkbook::getClassvariables()
{
	return classvariables;
}

void
ExportSdtmWorkbook::setClassvariables(std::list <ExportSdtmClassVariablesRow> classvariables)
{
	this->classvariables = classvariables;
}

std::list<ExportSdtmDatasetVariablesRow>
ExportSdtmWorkbook::getDatasetvariables()
{
	return datasetvariables;
}

void
ExportSdtmWorkbook::setDatasetvariables(std::list <ExportSdtmDatasetVariablesRow> datasetvariables)
{
	this->datasetvariables = datasetvariables;
}

std::list<ExportSdtmDatasetsRow>
ExportSdtmWorkbook::getDatasets()
{
	return datasets;
}

void
ExportSdtmWorkbook::setDatasets(std::list <ExportSdtmDatasetsRow> datasets)
{
