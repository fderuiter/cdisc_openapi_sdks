...
#ifndef _SdtmigClasses_H_
#define _SdtmigClasses_H_
...
class SdtmigClasses : public Object {
public:
	/*! \brief Constructor.
	 */
	SdtmigClasses();
	SdtmigClasses(char* str);

	/*! \brief Destructor.
	 */
	virtual ~SdtmigClasses();
	...
	/*! \brief Get 
	 */
	SdtmigClassesLinks getLinks();

	/*! \brief Set 
	 */
	void setLinks(SdtmigClassesLinks  _links);
