...
#ifndef _ExportSdtmigVariablesRow_H_
#define _ExportSdtmigVariablesRow_H_
...
class ExportSdtmigVariablesRow : public Object {
public:
	/*! \brief Constructor.
	 */
	ExportSdtmigVariablesRow();
	ExportSdtmigVariablesRow(char* str);

	/*! \brief Destructor.
	 */
	virtual ~ExportSdtmigVariablesRow();
...
#endif /* _ExportSdtmigVariablesRow_H_ */
