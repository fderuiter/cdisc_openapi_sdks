...
void
CtTermRef::fromJson(char* jsonStr)
{
...
void
CtTermRef::setHref(std::string  href)
{
	this->href = href;
}
...
void
CtTermRef::setTitle(std::string  title)
{
	this->title = title;
}
...
void
CtTermRef::setType(std::string  type)
{
	this->type = type;
}
