...
object ExportSdtmDatasetsRow {
  given encoderExportSdtmDatasetsRow: Encoder[ExportSdtmDatasetsRow] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderExportSdtmDatasetsRow: Decoder[ExportSdtmDatasetsRow] = Decoder.instance { c =>
    for {
