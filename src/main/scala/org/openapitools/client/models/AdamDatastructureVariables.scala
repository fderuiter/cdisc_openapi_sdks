...
case class AdamDatastructureVariables(
    ...
    links: Option[AdamDatastructureVariablesLinks] = None
)
  
object AdamDatastructureVariables {
  given encoderAdamDatastructureVariables: Encoder[AdamDatastructureVariables] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderAdamDatastructureVariables: Decoder[AdamDatastructureVariables] = Decoder.instance { c =>
    for {
      ...
      links <- c.downField("_links").as[Option[AdamDatastructureVariablesLinks]]
    } yield AdamDatastructureVariables(
      ordinal = ordinal,
      name = name,
      label = label,
