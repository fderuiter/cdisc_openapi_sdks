...
object QrsResponsegroups {
  given encoderQrsResponsegroups: Encoder[QrsResponsegroups] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderQrsResponsegroups: Decoder[QrsResponsegroups] = Decoder.instance { c =>
    for {
      ...
      links <- c.downField("_links").as[Option[QrsResponsegroupsLinks]]
    } yield QrsResponsegroups(
      name = name,
      label = label,
