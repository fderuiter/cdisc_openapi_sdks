...
case class CdashigProduct(
    ...
    links: Option[CdashigProductLinks] = None,
    classes: Option[Seq[CdashigClass]] = None
)
  
object CdashigProduct {
  given encoderCdashigProduct: Encoder[CdashigProduct] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderCdashigProduct: Decoder[CdashigProduct] = Decoder.instance { c =>
    for {
      ...
      links <- c.downField("_links").as[Option[CdashigProductLinks]]
      classes <- c.downField("classes").as[Option[Seq[CdashigClass]]]
    } yield CdashigProduct(
      name = name,
      label = label,
