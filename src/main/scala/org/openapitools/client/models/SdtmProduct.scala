...
case class SdtmProduct(
    ...
    links: Option[SdtmProductLinks] = None,
    classes: Option[Seq[SdtmClass]] = None,
    datasets: Option[Seq[SdtmDataset]] = None
)
  
object SdtmProduct {
  given encoderSdtmProduct: Encoder[SdtmProduct] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderSdtmProduct: Decoder[SdtmProduct] = Decoder.instance { c =>
    for {
      ...
      links <- c.downField("_links").as[Option[SdtmProductLinks]]
      classes <- c.downField("classes").as[Option[Seq[SdtmClass]]]
