...
case class SendigClassDatasets(
    ...
    links: Option[SendigClassDatasetsLinks] = None
)
  
object SendigClassDatasets {
  given encoderSendigClassDatasets: Encoder[SendigClassDatasets] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderSendigClassDatasets: Decoder[SendigClassDatasets] = Decoder.instance { c =>
    for {
      ordinal <- c.downField("ordinal").as[Option[String]]
      name <- c.downField("name").as[Option[String]]
      label <- c.downField("label").as[Option[String]]
      description <- c.downField("description").as[Option[String]]
      links <- c.downField("_links").as[Option[SendigClassDatasetsLinks]]
    } yield SendigClassDatasets(
      ordinal = ordinal,
      name = name,
      label = label,
