...
case class CdashigClassScenarios(
    ...
    links: Option[CdashigClassScenariosLinks] = None
)
  
object CdashigClassScenarios {
  given encoderCdashigClassScenarios: Encoder[CdashigClassScenarios] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderCdashigClassScenarios: Decoder[CdashigClassScenarios] = Decoder.instance { c =>
    for {
      ordinal <- c.downField("ordinal").as[Option[String]]
      name <- c.downField("name").as[Option[String]]
      label <- c.downField("label").as[Option[String]]
      description <- c.downField("description").as[Option[String]]
      links <- c.downField("_links").as[Option[CdashigClassScenariosLinks]]
    } yield CdashigClassScenarios(
      ordinal = ordinal,
      name = name,
      label = label,
