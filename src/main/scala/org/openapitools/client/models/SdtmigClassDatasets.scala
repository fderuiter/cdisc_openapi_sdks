...
case class SdtmigClassDatasets(
    ...
    links: Option[SdtmigClassDatasetsLinks] = None
)
  
object SdtmigClassDatasets {
  given encoderSdtmigClassDatasets: Encoder[SdtmigClassDatasets] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderSdtmigClassDatasets: Decoder[SdtmigClassDatasets] = Decoder.instance { c =>
    for {
      ordinal <- c.downField("ordinal").as[Option[String]]
      name <- c.downField("name").as[Option[String]]
      label <- c.downField("label").as[Option[String]]
      description <- c.downField("description").as[Option[String]]
      links <- c.downField("_links").as[Option[SdtmigClassDatasetsLinks]]
    } yield SdtmigClassDatasets(
      ordinal = ordinal,
      name = name,
      label = label,
