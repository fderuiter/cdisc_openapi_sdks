...
case class SdtmigClasses(
    ...
    links: Option[SdtmigClassesLinks] = None
)
  
object SdtmigClasses {
  given encoderSdtmigClasses: Encoder[SdtmigClasses] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderSdtmigClasses: Decoder[SdtmigClasses] = Decoder.instance { c =>
    for {
      ...
      links <- c.downField("_links").as[Option[SdtmigClassesLinks]]
    } yield SdtmigClasses(
      name = name,
      label = label,
