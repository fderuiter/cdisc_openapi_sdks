...
public class SdtmigDatasetVariable {
  ...
  private SdtmigDatasetVariableLinks links = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.ordinal == null ? sdtmigDatasetVariable.ordinal == null : this.ordinal.equals(sdtmigDatasetVariable.ordinal)) &&
        (this.name == null ? sdtmigDatasetVariable.name == null : this.name.equals(sdtmigDatasetVariable.name)) &&
        (this.label == null ? sdtmigDatasetVariable.label == null : this.label.equals(sdtmigDatasetVariable.label)) &&
        (this.description == null ? sdtmigDatasetVariable.description == null : this.description.equals(sdtmigDatasetVariable.description)) &&
        (this.role == null ? sdtmigDatasetVariable.role == null : this.role.equals(sdtmigDatasetVariable.role)) &&
        (this.simpleDatatype == null ? sdtmigDatasetVariable.simpleDatatype == null : this.simpleDatatype.equals(sdtmigDatasetVariable.simpleDatatype)) &&
        (this.core == null ? sdtmigDatasetVariable.core == null : this.core.equals(sdtmigDatasetVariable.core)) &&
        (this.describedValueDomain == null ? sdtmigDatasetVariable.describedValueDomain == null : this.describedValueDomain.equals(sdtmigDatasetVariable.describedValueDomain)) &&
        (this.valueList == null ? sdtmigDatasetVariable.valueList == null : this.valueList.equals(sdtmigDatasetVariable.valueList)) &&
        (this.links == null ? sdtmigDatasetVariable.links == null : this.links.equals(sdtmigDatasetVariable.links));
  }
