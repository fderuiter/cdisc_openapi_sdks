...
public class ExportSdtmDatasetsRow {
  ...
  public ExportSdtmDatasetsRow() {
  }

  public ExportSdtmDatasetsRow version(@javax.annotation.Nullable String version) {
  ...
  public ExportSdtmDatasetsRow propertyClass(@javax.annotation.Nullable String propertyClass) {
  ...
  public ExportSdtmDatasetsRow datasetName(@javax.annotation.Nullable String datasetName) {
  ...
  public ExportSdtmDatasetsRow datasetLabel(@javax.annotation.Nullable String datasetLabel) {
  ...
  public ExportSdtmDatasetsRow structure(@javax.annotation.Nullable String structure) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExportSdtmDatasetsRow
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportSdtmDatasetsRow.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExportSdtmDatasetsRow is not found in the empty JSON string", ExportSdtmDatasetsRow.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportSdtmDatasetsRow.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExportSdtmDatasetsRow` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportSdtmDatasetsRow.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportSdtmDatasetsRow' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportSdtmDatasetsRow> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportSdtmDatasetsRow.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportSdtmDatasetsRow>() {
           @Override
           public void write(JsonWriter out, ExportSdtmDatasetsRow value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportSdtmDatasetsRow read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExportSdtmDatasetsRow given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExportSdtmDatasetsRow
   * @throws IOException if the JSON string is invalid with respect to ExportSdtmDatasetsRow
   */
  public static ExportSdtmDatasetsRow fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportSdtmDatasetsRow.class);
  }

  /**
   * Convert an instance of ExportSdtmDatasetsRow to an JSON string
   *
   * @return JSON string
   */
