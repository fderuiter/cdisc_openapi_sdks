...
public class SdtmigDatasetVariablesLinks {
  ...
  public SdtmigDatasetVariablesLinks() {
  }

  public SdtmigDatasetVariablesLinks self(@javax.annotation.Nullable SdtmigDatasetVariablesRef self) {
    this.self = self;
    return this;
  }
  ...
  public void setSelf(@javax.annotation.Nullable SdtmigDatasetVariablesRef self) {
    this.self = self;
  }


  public SdtmigDatasetVariablesLinks modelDataset(@javax.annotation.Nullable SdtmDatasetRef modelDataset) {
  ...
  public SdtmigDatasetVariablesLinks parentProduct(@javax.annotation.Nullable SdtmigProductRef parentProduct) {
  ...
  public SdtmigDatasetVariablesLinks parentClass(@javax.annotation.Nullable SdtmigClassRef parentClass) {
  ...
  public SdtmigDatasetVariablesLinks priorVersion(@javax.annotation.Nullable SdtmigDatasetVariablesRef priorVersion) {
  ...
  public void setPriorVersion(@javax.annotation.Nullable SdtmigDatasetVariablesRef priorVersion) {
    this.priorVersion = priorVersion;
  }


  public SdtmigDatasetVariablesLinks datasetVariables(@javax.annotation.Nullable List<SdtmigDatasetVariableRefElement> datasetVariables) {
  ...
  public void setDatasetVariables(@javax.annotation.Nullable List<SdtmigDatasetVariableRefElement> datasetVariables) {
    this.datasetVariables = datasetVariables;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SdtmigDatasetVariablesLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SdtmigDatasetVariablesLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SdtmigDatasetVariablesLinks is not found in the empty JSON string", SdtmigDatasetVariablesLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SdtmigDatasetVariablesLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SdtmigDatasetVariablesLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `self`
      if (jsonObj.get("self") != null && !jsonObj.get("self").isJsonNull()) {
        SdtmigDatasetVariablesRef.validateJsonElement(jsonObj.get("self"));
      }
      ...
      if (jsonObj.get("priorVersion") != null && !jsonObj.get("priorVersion").isJsonNull()) {
        SdtmigDatasetVariablesRef.validateJsonElement(jsonObj.get("priorVersion"));
      }
      if (jsonObj.get("datasetVariables") != null && !jsonObj.get("datasetVariables").isJsonNull()) {
        ...
        if (jsonArraydatasetVariables != null) {
          ...
          for (int i = 0; i < jsonArraydatasetVariables.size(); i++) {
            SdtmigDatasetVariableRefElement.validateJsonElement(jsonArraydatasetVariables.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SdtmigDatasetVariablesLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SdtmigDatasetVariablesLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SdtmigDatasetVariablesLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SdtmigDatasetVariablesLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<SdtmigDatasetVariablesLinks>() {
           @Override
           public void write(JsonWriter out, SdtmigDatasetVariablesLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SdtmigDatasetVariablesLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SdtmigDatasetVariablesLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SdtmigDatasetVariablesLinks
   * @throws IOException if the JSON string is invalid with respect to SdtmigDatasetVariablesLinks
   */
  public static SdtmigDatasetVariablesLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SdtmigDatasetVariablesLinks.class);
  }

  /**
   * Convert an instance of SdtmigDatasetVariablesLinks to an JSON string
   *
   * @return JSON string
   */
