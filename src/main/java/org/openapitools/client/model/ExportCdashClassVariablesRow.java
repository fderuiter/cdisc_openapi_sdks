...
public class ExportCdashClassVariablesRow {
  ...
  public boolean equals(Object o) {
    ...
    return (this.version == null ? exportCdashClassVariablesRow.version == null : this.version.equals(exportCdashClassVariablesRow.version)) &&
        (this._class == null ? exportCdashClassVariablesRow._class == null : this._class.equals(exportCdashClassVariablesRow._class)) &&
        (this.domain == null ? exportCdashClassVariablesRow.domain == null : this.domain.equals(exportCdashClassVariablesRow.domain)) &&
        (this.variableOrder == null ? exportCdashClassVariablesRow.variableOrder == null : this.variableOrder.equals(exportCdashClassVariablesRow.variableOrder)) &&
        (this.cDASHVariable == null ? exportCdashClassVariablesRow.cDASHVariable == null : this.cDASHVariable.equals(exportCdashClassVariablesRow.cDASHVariable)) &&
        (this.cDASHVariableLabel == null ? exportCdashClassVariablesRow.cDASHVariableLabel == null : this.cDASHVariableLabel.equals(exportCdashClassVariablesRow.cDASHVariableLabel)) &&
        (this.dRAFTCDASHDefinition == null ? exportCdashClassVariablesRow.dRAFTCDASHDefinition == null : this.dRAFTCDASHDefinition.equals(exportCdashClassVariablesRow.dRAFTCDASHDefinition)) &&
        (this.domainSpecific == null ? exportCdashClassVariablesRow.domainSpecific == null : this.domainSpecific.equals(exportCdashClassVariablesRow.domainSpecific)) &&
        (this.questionText == null ? exportCdashClassVariablesRow.questionText == null : this.questionText.equals(exportCdashClassVariablesRow.questionText)) &&
        (this.prompt == null ? exportCdashClassVariablesRow.prompt == null : this.prompt.equals(exportCdashClassVariablesRow.prompt)) &&
        (this.type == null ? exportCdashClassVariablesRow.type == null : this.type.equals(exportCdashClassVariablesRow.type)) &&
        (this.sDTMTarget == null ? exportCdashClassVariablesRow.sDTMTarget == null : this.sDTMTarget.equals(exportCdashClassVariablesRow.sDTMTarget)) &&
        (this.mappingInstructions == null ? exportCdashClassVariablesRow.mappingInstructions == null : this.mappingInstructions.equals(exportCdashClassVariablesRow.mappingInstructions)) &&
        (this.controlledTerminologyCodelistName == null ? exportCdashClassVariablesRow.controlledTerminologyCodelistName == null : this.controlledTerminologyCodelistName.equals(exportCdashClassVariablesRow.controlledTerminologyCodelistName)) &&
        (this.implementationNotes == null ? exportCdashClassVariablesRow.implementationNotes == null : this.implementationNotes.equals(exportCdashClassVariablesRow.implementationNotes));
  }
