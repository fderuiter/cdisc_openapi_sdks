(ns cdisc-library-api.api.study-data-tabulation-model-sdtm-
...
(defn-spec mdr-root-sdtm-classes-class-variables-var-get-with-http-info any?
  "
  Get Root of SDTM Class Variable"
  [class string?, var string?]
  (check-required-params class var)
  (call-api "/mdr/root/sdtm/classes/{class}/variables/{var}" :get
            {:path-params   {"class" class "var" var }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec mdr-root-sdtm-classes-class-variables-var-get root-sdtm-class-variable-spec
  "
  Get Root of SDTM Class Variable"
  [class string?, var string?]
  (let [res (:data (mdr-root-sdtm-classes-class-variables-var-get-with-http-info class var))]
    (if (:decode-models *api-context*)
       (st/decode root-sdtm-class-variable-spec res st/string-transformer)
       res)))


(defn-spec mdr-root-sdtm-datasets-dataset-variables-var-get-with-http-info any?
  "
  Get Root SDTM Dataset Variable"
  [dataset string?, var string?]
  (check-required-params dataset var)
  (call-api "/mdr/root/sdtm/datasets/{dataset}/variables/{var}" :get
            {:path-params   {"dataset" dataset "var" var }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec mdr-root-sdtm-datasets-dataset-variables-var-get root-sdtm-dataset-variable-spec
  "
  Get Root SDTM Dataset Variable"
  [dataset string?, var string?]
  (let [res (:data (mdr-root-sdtm-datasets-dataset-variables-var-get-with-http-info dataset var))]
    (if (:decode-models *api-context*)
       (st/decode root-sdtm-dataset-variable-spec res st/string-transformer)
       res)))


(defn-spec mdr-sdtm-version-classes-class-datasets-get-with-http-info any?
  "
  Get SDTM Class Dataset List"
  [version string?, class string?]
  (check-required-params version class)
  (call-api "/mdr/sdtm/{version}/classes/{class}/datasets" :get
...
(defn-spec mdr-sdtm-version-classes-class-datasets-get sdtm-class-datasets-spec
  "
  Get SDTM Class Dataset List"
  [version string?, class string?]
  (let [res (:data (mdr-sdtm-version-classes-class-datasets-get-with-http-info version class))]
    (if (:decode-models *api-context*)
       (st/decode sdtm-class-datasets-spec res st/string-transformer)
       res)))


(defn-spec mdr-sdtm-version-classes-class-get-with-http-info any?
  "
  Get SDTM Class"
  [version string?, class string?]
  (check-required-params version class)
  (call-api "/mdr/sdtm/{version}/classes/{class}" :get
            {:path-params   {"version" version "class" class }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-sdtm-version-classes-class-get sdtm-class-spec
  "
  Get SDTM Class"
  [version string?, class string?]
  (let [res (:data (mdr-sdtm-version-classes-class-get-with-http-info version class))]
    (if (:decode-models *api-context*)
       (st/decode sdtm-class-spec res st/string-transformer)
       res)))


(defn-spec mdr-sdtm-version-classes-class-variables-get-with-http-info any?
  "
  Get SDTM Class Variable List"
  [version string?, class string?]
  (check-required-params version class)
  (call-api "/mdr/sdtm/{version}/classes/{class}/variables" :get
            {:path-params   {"version" version "class" class }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-sdtm-version-classes-class-variables-get sdtm-class-variables-spec
  "
  Get SDTM Class Variable List"
  [version string?, class string?]
  (let [res (:data (mdr-sdtm-version-classes-class-variables-get-with-http-info version class))]
    (if (:decode-models *api-context*)
       (st/decode sdtm-class-variables-spec res st/string-transformer)
       res)))


(defn-spec mdr-sdtm-version-classes-class-variables-var-get-with-http-info any?
  "
  Get SDTM Class Variable"
  [version string?, class string?, var string?]
  (check-required-params version class var)
  (call-api "/mdr/sdtm/{version}/classes/{class}/variables/{var}" :get
            {:path-params   {"version" version "class" class "var" var }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec mdr-sdtm-version-classes-class-variables-var-get sdtm-class-variable-spec
  "
  Get SDTM Class Variable"
  [version string?, class string?, var string?]
  (let [res (:data (mdr-sdtm-version-classes-class-variables-var-get-with-http-info version class var))]
    (if (:decode-models *api-context*)
       (st/decode sdtm-class-variable-spec res st/string-transformer)
       res)))


(defn-spec mdr-sdtm-version-classes-get-with-http-info any?
  "
  Get SDTM Class List"
  [version string?]
  (check-required-params version)
  (call-api "/mdr/sdtm/{version}/classes" :get
...
(defn-spec mdr-sdtm-version-classes-get sdtm-classes-spec
  "
  Get SDTM Class List"
  [version string?]
  (let [res (:data (mdr-sdtm-version-classes-get-with-http-info version))]
    (if (:decode-models *api-context*)
       (st/decode sdtm-classes-spec res st/string-transformer)
       res)))


(defn-spec mdr-sdtm-version-datasets-dataset-get-with-http-info any?
  "
  Get SDTM Dataset"
  [version string?, dataset string?]
  (check-required-params version dataset)
  (call-api "/mdr/sdtm/{version}/datasets/{dataset}" :get
            {:path-params   {"version" version "dataset" dataset }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec mdr-sdtm-version-datasets-dataset-get sdtm-dataset-spec
  "
  Get SDTM Dataset"
  [version string?, dataset string?]
  (let [res (:data (mdr-sdtm-version-datasets-dataset-get-with-http-info version dataset))]
    (if (:decode-models *api-context*)
       (st/decode sdtm-dataset-spec res st/string-transformer)
       res)))


(defn-spec mdr-sdtm-version-datasets-dataset-variables-get-with-http-info any?
  "
  Get SDTM Dataset Variable List"
  [version string?, dataset string?]
  (check-required-params version dataset)
  (call-api "/mdr/sdtm/{version}/datasets/{dataset}/variables" :get
            {:path-params   {"version" version "dataset" dataset }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-sdtm-version-datasets-dataset-variables-get sdtm-dataset-variables-spec
  "
  Get SDTM Dataset Variable List"
  [version string?, dataset string?]
  (let [res (:data (mdr-sdtm-version-datasets-dataset-variables-get-with-http-info version dataset))]
    (if (:decode-models *api-context*)
       (st/decode sdtm-dataset-variables-spec res st/string-transformer)
       res)))


(defn-spec mdr-sdtm-version-datasets-dataset-variables-var-get-with-http-info any?
  "
  Get SDTM Dataset Variable"
  [version string?, dataset string?, var string?]
  (check-required-params version dataset var)
  (call-api "/mdr/sdtm/{version}/datasets/{dataset}/variables/{var}" :get
            {:path-params   {"version" version "dataset" dataset "var" var }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec mdr-sdtm-version-datasets-dataset-variables-var-get sdtm-dataset-variable-spec
  "
  Get SDTM Dataset Variable"
  [version string?, dataset string?, var string?]
  (let [res (:data (mdr-sdtm-version-datasets-dataset-variables-var-get-with-http-info version dataset var))]
    (if (:decode-models *api-context*)
       (st/decode sdtm-dataset-variable-spec res st/string-transformer)
       res)))


(defn-spec mdr-sdtm-version-datasets-get-with-http-info any?
  "
  Get SDTM Dataset List"
  [version string?]
  (check-required-params version)
  (call-api "/mdr/sdtm/{version}/datasets" :get
            {:path-params   {"version" version }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-sdtm-version-datasets-get sdtm-datasets-spec
  "
  Get SDTM Dataset List"
  [version string?]
  (let [res (:data (mdr-sdtm-version-datasets-get-with-http-info version))]
    (if (:decode-models *api-context*)
       (st/decode sdtm-datasets-spec res st/string-transformer)
       res)))


(defn-spec mdr-sdtm-version-get-with-http-info any?
  "
  Get SDTM product"
  [version string?]
  (check-required-params version)
  (call-api "/mdr/sdtm/{version}" :get
            {:path-params   {"version" version }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-sdtm-version-get sdtm-product-spec
  "
  Get SDTM product"
  [version string?]
  (let [res (:data (mdr-sdtm-version-get-with-http-info version))]
    (if (:decode-models *api-context*)
       (st/decode sdtm-product-spec res st/string-transformer)
       res)))
