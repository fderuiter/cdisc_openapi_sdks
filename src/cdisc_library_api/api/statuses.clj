(ns cdisc-library-api.api.statuses
...
(defn-spec health-get-with-http-info any?
  "
...
(defn-spec health-get health-spec
  "
  Check health of system components"
  []
  (let [res (:data (health-get-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode health-spec res st/string-transformer)
       res)))


(defn-spec mdr-maintenance-get-with-http-info any?
  "
  Set maintenance mode and message"
  []
  (call-api "/mdr/maintenance" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-maintenance-get maintenance-body-spec
  "
  Set maintenance mode and message"
  []
  (let [res (:data (mdr-maintenance-get-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode maintenance-body-spec res st/string-transformer)
       res)))
