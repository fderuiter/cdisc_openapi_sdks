(ns cdisc-library-api.api.default
...
(defn-spec mdr-about-get-with-http-info any?
  "
  Get Information About CDISC Library"
  []
  (call-api "/mdr/about" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-about-get about-spec
  "
  Get Information About CDISC Library"
  []
  (let [res (:data (mdr-about-get-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode about-spec res st/string-transformer)
       res)))


(defn-spec mdr-lastupdated-get-with-http-info any?
  "
  Get CDISC Library Last Updated"
  []
  (call-api "/mdr/lastupdated" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-lastupdated-get lastupdated-spec
  "
  Get CDISC Library Last Updated"
  []
  (let [res (:data (mdr-lastupdated-get-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode lastupdated-spec res st/string-transformer)
       res)))


(defn-spec mdr-products-data-analysis-get-with-http-info any?
  "
  Get CDISC Library Product Group Data Analysis"
  []
  (call-api "/mdr/products/DataAnalysis" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-products-data-analysis-get productgroup-data-analysis-spec
  "
  Get CDISC Library Product Group Data Analysis"
  []
  (let [res (:data (mdr-products-data-analysis-get-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode productgroup-data-analysis-spec res st/string-transformer)
       res)))


(defn-spec mdr-products-data-collection-get-with-http-info any?
  "
  Get CDISC Library Product Group Data Collection"
  []
  (call-api "/mdr/products/DataCollection" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-products-data-collection-get productgroup-data-collection-spec
  "
  Get CDISC Library Product Group Data Collection"
  []
  (let [res (:data (mdr-products-data-collection-get-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode productgroup-data-collection-spec res st/string-transformer)
       res)))


(defn-spec mdr-products-data-tabulation-get-with-http-info any?
  "
  Get CDISC Library Product Group Data Tabulation"
  []
  (call-api "/mdr/products/DataTabulation" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-products-data-tabulation-get productgroup-data-tabulation-spec
  "
  Get CDISC Library Product Group Data Tabulation"
  []
  (let [res (:data (mdr-products-data-tabulation-get-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode productgroup-data-tabulation-spec res st/string-transformer)
       res)))


(defn-spec mdr-products-get-with-http-info any?
  "
  Get CDISC Library Products"
  []
  (call-api "/mdr/products" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-products-get products-spec
  "
  Get CDISC Library Products"
  []
  (let [res (:data (mdr-products-get-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode products-spec res st/string-transformer)
       res)))


(defn-spec mdr-products-measures-get-with-http-info any?
  "
  Get CDISC Library Product Group QRS"
  []
  (call-api "/mdr/products/Measures" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-products-measures-get productgroup-qrs-spec
  "
  Get CDISC Library Product Group QRS"
  []
  (let [res (:data (mdr-products-measures-get-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode productgroup-qrs-spec res st/string-transformer)
       res)))


(defn-spec mdr-products-terminology-get-with-http-info any?
  "
  Get CDISC Library Product Group Terminology"
  []
  (call-api "/mdr/products/Terminology" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-products-terminology-get productgroup-terminology-spec
  "
  Get CDISC Library Product Group Terminology"
  []
  (let [res (:data (mdr-products-terminology-get-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode productgroup-terminology-spec res st/string-transformer)
       res)))
