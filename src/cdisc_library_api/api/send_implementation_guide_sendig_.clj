(ns cdisc-library-api.api.send-implementation-guide-sendig-
...
(defn-spec mdr-root-sendig-datasets-dataset-variables-var-get-with-http-info any?
  "
  Get Root SENDIG Dataset Variable"
  [dataset string?, var string?]
  (check-required-params dataset var)
  (call-api "/mdr/root/sendig/datasets/{dataset}/variables/{var}" :get
...
(defn-spec mdr-root-sendig-datasets-dataset-variables-var-get root-sendig-dataset-variable-spec
  "
  Get Root SENDIG Dataset Variable"
  [dataset string?, var string?]
  (let [res (:data (mdr-root-sendig-datasets-dataset-variables-var-get-with-http-info dataset var))]
    (if (:decode-models *api-context*)
       (st/decode root-sendig-dataset-variable-spec res st/string-transformer)
       res)))


(defn-spec mdr-sendig-version-classes-class-datasets-get-with-http-info any?
  "
  Get SENDIG Class Dataset List"
  [version string?, class string?]
  (check-required-params version class)
  (call-api "/mdr/sendig/{version}/classes/{class}/datasets" :get
...
(defn-spec mdr-sendig-version-classes-class-datasets-get sendig-class-datasets-spec
  "
  Get SENDIG Class Dataset List"
  [version string?, class string?]
  (let [res (:data (mdr-sendig-version-classes-class-datasets-get-with-http-info version class))]
    (if (:decode-models *api-context*)
       (st/decode sendig-class-datasets-spec res st/string-transformer)
       res)))


(defn-spec mdr-sendig-version-classes-class-get-with-http-info any?
  "
  Get SENDIG Class"
  [version string?, class string?]
  (check-required-params version class)
  (call-api "/mdr/sendig/{version}/classes/{class}" :get
            {:path-params   {"version" version "class" class }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-sendig-version-classes-class-get sendig-class-spec
  "
  Get SENDIG Class"
  [version string?, class string?]
  (let [res (:data (mdr-sendig-version-classes-class-get-with-http-info version class))]
    (if (:decode-models *api-context*)
       (st/decode sendig-class-spec res st/string-transformer)
       res)))


(defn-spec mdr-sendig-version-classes-get-with-http-info any?
  "
  Get SENDIG Class List"
  [version string?]
  (check-required-params version)
  (call-api "/mdr/sendig/{version}/classes" :get
...
(defn-spec mdr-sendig-version-classes-get sendig-classes-spec
  "
  Get SENDIG Class List"
  [version string?]
  (let [res (:data (mdr-sendig-version-classes-get-with-http-info version))]
    (if (:decode-models *api-context*)
       (st/decode sendig-classes-spec res st/string-transformer)
       res)))


(defn-spec mdr-sendig-version-datasets-dataset-get-with-http-info any?
  "
  Get SENDIG Dataset"
  [version string?, dataset string?]
  (check-required-params version dataset)
  (call-api "/mdr/sendig/{version}/datasets/{dataset}" :get
...
(defn-spec mdr-sendig-version-datasets-dataset-get sendig-dataset-spec
  "
  Get SENDIG Dataset"
  [version string?, dataset string?]
  (let [res (:data (mdr-sendig-version-datasets-dataset-get-with-http-info version dataset))]
    (if (:decode-models *api-context*)
       (st/decode sendig-dataset-spec res st/string-transformer)
       res)))


(defn-spec mdr-sendig-version-datasets-dataset-variables-get-with-http-info any?
  "
  Get SENDIG Dataset Variable List"
  [version string?, dataset string?]
  (check-required-params version dataset)
  (call-api "/mdr/sendig/{version}/datasets/{dataset}/variables" :get
            {:path-params   {"version" version "dataset" dataset }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-sendig-version-datasets-dataset-variables-get sendig-dataset-variables-spec
  "
  Get SENDIG Dataset Variable List"
  [version string?, dataset string?]
  (let [res (:data (mdr-sendig-version-datasets-dataset-variables-get-with-http-info version dataset))]
    (if (:decode-models *api-context*)
       (st/decode sendig-dataset-variables-spec res st/string-transformer)
       res)))


(defn-spec mdr-sendig-version-datasets-dataset-variables-var-get-with-http-info any?
  "
  Get SENDIG Dataset Variable"
  [version string?, dataset string?, var string?]
  (check-required-params version dataset var)
  (call-api "/mdr/sendig/{version}/datasets/{dataset}/variables/{var}" :get
...
(defn-spec mdr-sendig-version-datasets-dataset-variables-var-get sendig-dataset-variable-spec
  "
  Get SENDIG Dataset Variable"
  [version string?, dataset string?, var string?]
  (let [res (:data (mdr-sendig-version-datasets-dataset-variables-var-get-with-http-info version dataset var))]
    (if (:decode-models *api-context*)
       (st/decode sendig-dataset-variable-spec res st/string-transformer)
       res)))


(defn-spec mdr-sendig-version-datasets-get-with-http-info any?
  "
  Get SENDIG Dataset List"
  [version string?]
  (check-required-params version)
  (call-api "/mdr/sendig/{version}/datasets" :get
            {:path-params   {"version" version }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-sendig-version-datasets-get sendig-datasets-spec
  "
  Get SENDIG Dataset List"
  [version string?]
  (let [res (:data (mdr-sendig-version-datasets-get-with-http-info version))]
    (if (:decode-models *api-context*)
       (st/decode sendig-datasets-spec res st/string-transformer)
       res)))


(defn-spec mdr-sendig-version-get-with-http-info any?
  "
  Get SENDIG product"
  [version string?]
  (check-required-params version)
  (call-api "/mdr/sendig/{version}" :get
            {:path-params   {"version" version }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-sendig-version-get sendig-product-spec
  "
  Get SENDIG product"
  [version string?]
  (let [res (:data (mdr-sendig-version-get-with-http-info version))]
    (if (:decode-models *api-context*)
       (st/decode sendig-product-spec res st/string-transformer)
       res)))
