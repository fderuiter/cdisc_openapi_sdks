(ns cdisc-library-api.api.cdash-implementation-guide-cdashig-
...
(defn-spec mdr-cdashig-version-classes-class-domains-get-with-http-info any?
  "
  Get CDASHIG Class Domain List"
  [version string?, class string?]
  (check-required-params version class)
  (call-api "/mdr/cdashig/{version}/classes/{class}/domains" :get
...
(defn-spec mdr-cdashig-version-classes-class-domains-get cdashig-class-domains-spec
  "
  Get CDASHIG Class Domain List"
  [version string?, class string?]
  (let [res (:data (mdr-cdashig-version-classes-class-domains-get-with-http-info version class))]
    (if (:decode-models *api-context*)
       (st/decode cdashig-class-domains-spec res st/string-transformer)
       res)))


(defn-spec mdr-cdashig-version-classes-class-get-with-http-info any?
  "
  Get CDASHIG Class"
  [version string?, class string?]
  (check-required-params version class)
  (call-api "/mdr/cdashig/{version}/classes/{class}" :get
            {:path-params   {"version" version "class" class }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-cdashig-version-classes-class-get cdashig-class-spec
  "
  Get CDASHIG Class"
  [version string?, class string?]
  (let [res (:data (mdr-cdashig-version-classes-class-get-with-http-info version class))]
    (if (:decode-models *api-context*)
       (st/decode cdashig-class-spec res st/string-transformer)
       res)))


(defn-spec mdr-cdashig-version-classes-class-scenarios-get-with-http-info any?
  "
  Get CDASHIG Class Scenario List"
  [version string?, class string?]
  (check-required-params version class)
  (call-api "/mdr/cdashig/{version}/classes/{class}/scenarios" :get
            {:path-params   {"version" version "class" class }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-cdashig-version-classes-class-scenarios-get cdashig-class-scenarios-spec
  "
  Get CDASHIG Class Scenario List"
  [version string?, class string?]
  (let [res (:data (mdr-cdashig-version-classes-class-scenarios-get-with-http-info version class))]
    (if (:decode-models *api-context*)
       (st/decode cdashig-class-scenarios-spec res st/string-transformer)
       res)))


(defn-spec mdr-cdashig-version-classes-get-with-http-info any?
  "
  Get CDASHIG Class List"
  [version string?]
  (check-required-params version)
  (call-api "/mdr/cdashig/{version}/classes" :get
...
(defn-spec mdr-cdashig-version-classes-get cdashig-product-classes-spec
  "
  Get CDASHIG Class List"
  [version string?]
  (let [res (:data (mdr-cdashig-version-classes-get-with-http-info version))]
    (if (:decode-models *api-context*)
       (st/decode cdashig-product-classes-spec res st/string-transformer)
       res)))


(defn-spec mdr-cdashig-version-domains-domain-fields-field-get-with-http-info any?
  "
  Get CDASHIG Domain Field"
  [version string?, domain string?, field string?]
  (check-required-params version domain field)
  (call-api "/mdr/cdashig/{version}/domains/{domain}/fields/{field}" :get
...
(defn-spec mdr-cdashig-version-domains-domain-fields-field-get cdashig-domain-field-spec
  "
  Get CDASHIG Domain Field"
  [version string?, domain string?, field string?]
  (let [res (:data (mdr-cdashig-version-domains-domain-fields-field-get-with-http-info version domain field))]
    (if (:decode-models *api-context*)
       (st/decode cdashig-domain-field-spec res st/string-transformer)
       res)))


(defn-spec mdr-cdashig-version-domains-domain-fields-get-with-http-info any?
  "
  Get CDASHIG Domain Field List"
  [version string?, domain string?]
  (check-required-params version domain)
  (call-api "/mdr/cdashig/{version}/domains/{domain}/fields" :get
...
(defn-spec mdr-cdashig-version-domains-domain-fields-get cdashig-domain-fields-spec
  "
  Get CDASHIG Domain Field List"
  [version string?, domain string?]
  (let [res (:data (mdr-cdashig-version-domains-domain-fields-get-with-http-info version domain))]
    (if (:decode-models *api-context*)
       (st/decode cdashig-domain-fields-spec res st/string-transformer)
       res)))


(defn-spec mdr-cdashig-version-domains-domain-get-with-http-info any?
  "
  Get CDASHIG Domain"
  [version string?, domain string?]
  (check-required-params version domain)
  (call-api "/mdr/cdashig/{version}/domains/{domain}" :get
            {:path-params   {"version" version "domain" domain }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-cdashig-version-domains-domain-get cdashig-domain-spec
  "
  Get CDASHIG Domain"
  [version string?, domain string?]
  (let [res (:data (mdr-cdashig-version-domains-domain-get-with-http-info version domain))]
    (if (:decode-models *api-context*)
       (st/decode cdashig-domain-spec res st/string-transformer)
       res)))


(defn-spec mdr-cdashig-version-domains-get-with-http-info any?
  "
  Get CDASHIG Domain List"
  [version string?]
  (check-required-params version)
  (call-api "/mdr/cdashig/{version}/domains" :get
            {:path-params   {"version" version }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-cdashig-version-domains-get cdashig-product-domains-spec
  "
  Get CDASHIG Domain List"
  [version string?]
  (let [res (:data (mdr-cdashig-version-domains-get-with-http-info version))]
    (if (:decode-models *api-context*)
       (st/decode cdashig-product-domains-spec res st/string-transformer)
       res)))


(defn-spec mdr-cdashig-version-get-with-http-info any?
  "
  Get CDASHIG Product"
  [version string?]
  (check-required-params version)
  (call-api "/mdr/cdashig/{version}" :get
            {:path-params   {"version" version }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-cdashig-version-get cdashig-product-spec
  "
  Get CDASHIG Product"
  [version string?]
  (let [res (:data (mdr-cdashig-version-get-with-http-info version))]
    (if (:decode-models *api-context*)
       (st/decode cdashig-product-spec res st/string-transformer)
       res)))


(defn-spec mdr-cdashig-version-scenarios-domain-scenario-fields-field-get-with-http-info any?
  "
  Get CDASHIG Scenario Field"
  [version string?, domain string?, scenario string?, field string?]
  (check-required-params version domain scenario field)
  (call-api "/mdr/cdashig/{version}/scenarios/{domain}.{scenario}/fields/{field}" :get
            {:path-params   {"version" version "domain" domain "scenario" scenario "field" field }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec mdr-cdashig-version-scenarios-domain-scenario-fields-field-get cdashig-scenario-field-spec
  "
  Get CDASHIG Scenario Field"
  [version string?, domain string?, scenario string?, field string?]
  (let [res (:data (mdr-cdashig-version-scenarios-domain-scenario-fields-field-get-with-http-info version domain scenario field))]
    (if (:decode-models *api-context*)
       (st/decode cdashig-scenario-field-spec res st/string-transformer)
       res)))


(defn-spec mdr-cdashig-version-scenarios-domain-scenario-fields-get-with-http-info any?
  "
  Get CDASHIG Scenario Field List"
  [version string?, domain string?, scenario string?]
  (check-required-params version domain scenario)
  (call-api "/mdr/cdashig/{version}/scenarios/{domain}.{scenario}/fields" :get
            {:path-params   {"version" version "domain" domain "scenario" scenario }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec mdr-cdashig-version-scenarios-domain-scenario-fields-get cdashig-scenario-fields-spec
  "
  Get CDASHIG Scenario Field List"
  [version string?, domain string?, scenario string?]
  (let [res (:data (mdr-cdashig-version-scenarios-domain-scenario-fields-get-with-http-info version domain scenario))]
    (if (:decode-models *api-context*)
       (st/decode cdashig-scenario-fields-spec res st/string-transformer)
       res)))


(defn-spec mdr-cdashig-version-scenarios-domain-scenario-get-with-http-info any?
  "
  Get CDASHIG Scenario"
  [version string?, domain string?, scenario string?]
  (check-required-params version domain scenario)
  (call-api "/mdr/cdashig/{version}/scenarios/{domain}.{scenario}" :get
            {:path-params   {"version" version "domain" domain "scenario" scenario }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-cdashig-version-scenarios-domain-scenario-get cdashig-scenario-spec
  "
  Get CDASHIG Scenario"
  [version string?, domain string?, scenario string?]
  (let [res (:data (mdr-cdashig-version-scenarios-domain-scenario-get-with-http-info version domain scenario))]
    (if (:decode-models *api-context*)
       (st/decode cdashig-scenario-spec res st/string-transformer)
       res)))


(defn-spec mdr-cdashig-version-scenarios-get-with-http-info any?
  "
  Get CDASHIG Scenario List"
  [version string?]
  (check-required-params version)
  (call-api "/mdr/cdashig/{version}/scenarios" :get
            {:path-params   {"version" version }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-cdashig-version-scenarios-get cdashig-product-scenarios-spec
  "
  Get CDASHIG Scenario List"
  [version string?]
  (let [res (:data (mdr-cdashig-version-scenarios-get-with-http-info version))]
    (if (:decode-models *api-context*)
       (st/decode cdashig-product-scenarios-spec res st/string-transformer)
       res)))


(defn-spec mdr-root-cdashig-domains-domain-fields-field-get-with-http-info any?
  "
  Get Root CDASHIG Domain Field"
  [domain string?, field string?]
  (check-required-params domain field)
  (call-api "/mdr/root/cdashig/domains/{domain}/fields/{field}" :get
...
(defn-spec mdr-root-cdashig-domains-domain-fields-field-get root-cdashig-domain-field-spec
  "
  Get Root CDASHIG Domain Field"
  [domain string?, field string?]
  (let [res (:data (mdr-root-cdashig-domains-domain-fields-field-get-with-http-info domain field))]
    (if (:decode-models *api-context*)
       (st/decode root-cdashig-domain-field-spec res st/string-transformer)
       res)))


(defn-spec mdr-root-cdashig-scenarios-domain-scenario-fields-field-get-with-http-info any?
  "
  Get Root CDASHIG Scenario Field"
  [domain string?, scenario string?, field string?]
  (check-required-params domain scenario field)
  (call-api "/mdr/root/cdashig/scenarios/{domain}.{scenario}/fields/{field}" :get
            {:path-params   {"domain" domain "scenario" scenario "field" field }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec mdr-root-cdashig-scenarios-domain-scenario-fields-field-get root-cdashig-scenario-field-spec
  "
  Get Root CDASHIG Scenario Field"
  [domain string?, scenario string?, field string?]
  (let [res (:data (mdr-root-cdashig-scenarios-domain-scenario-fields-field-get-with-http-info domain scenario field))]
    (if (:decode-models *api-context*)
       (st/decode root-cdashig-scenario-field-spec res st/string-transformer)
       res)))
