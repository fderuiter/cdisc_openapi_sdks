(ns cdisc-library-api.api.sdtm-implementation-guide-sdtmig-
...
(defn-spec mdr-root-sdtmig-datasets-dataset-variables-var-get-with-http-info any?
  "
  Get Root SDTMIG Dataset Variable"
  [dataset string?, var string?]
  (check-required-params dataset var)
  (call-api "/mdr/root/sdtmig/datasets/{dataset}/variables/{var}" :get
...
(defn-spec mdr-root-sdtmig-datasets-dataset-variables-var-get root-sdtmig-dataset-variable-spec
  "
  Get Root SDTMIG Dataset Variable"
  [dataset string?, var string?]
  (let [res (:data (mdr-root-sdtmig-datasets-dataset-variables-var-get-with-http-info dataset var))]
    (if (:decode-models *api-context*)
       (st/decode root-sdtmig-dataset-variable-spec res st/string-transformer)
       res)))


(defn-spec mdr-sdtmig-version-classes-class-datasets-get-with-http-info any?
  "
  Get SDTMIG Class Dataset List"
  [version string?, class string?]
  (check-required-params version class)
  (call-api "/mdr/sdtmig/{version}/classes/{class}/datasets" :get
...
(defn-spec mdr-sdtmig-version-classes-class-datasets-get sdtmig-class-datasets-spec
  "
  Get SDTMIG Class Dataset List"
  [version string?, class string?]
  (let [res (:data (mdr-sdtmig-version-classes-class-datasets-get-with-http-info version class))]
    (if (:decode-models *api-context*)
       (st/decode sdtmig-class-datasets-spec res st/string-transformer)
       res)))


(defn-spec mdr-sdtmig-version-classes-class-get-with-http-info any?
  "
  Get SDTMIG Class"
  [version string?, class string?]
  (check-required-params version class)
  (call-api "/mdr/sdtmig/{version}/classes/{class}" :get
            {:path-params   {"version" version "class" class }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-sdtmig-version-classes-class-get sdtmig-class-spec
  "
  Get SDTMIG Class"
  [version string?, class string?]
  (let [res (:data (mdr-sdtmig-version-classes-class-get-with-http-info version class))]
    (if (:decode-models *api-context*)
       (st/decode sdtmig-class-spec res st/string-transformer)
       res)))


(defn-spec mdr-sdtmig-version-classes-get-with-http-info any?
  "
  Get SDTMIG Class List"
  [version string?]
  (check-required-params version)
  (call-api "/mdr/sdtmig/{version}/classes" :get
...
(defn-spec mdr-sdtmig-version-classes-get sdtmig-classes-spec
  "
  Get SDTMIG Class List"
  [version string?]
  (let [res (:data (mdr-sdtmig-version-classes-get-with-http-info version))]
    (if (:decode-models *api-context*)
       (st/decode sdtmig-classes-spec res st/string-transformer)
       res)))


(defn-spec mdr-sdtmig-version-datasets-dataset-get-with-http-info any?
  "
  Get SDTMIG Dataset"
  [version string?, dataset string?]
  (check-required-params version dataset)
  (call-api "/mdr/sdtmig/{version}/datasets/{dataset}" :get
...
(defn-spec mdr-sdtmig-version-datasets-dataset-get sdtmig-dataset-spec
  "
  Get SDTMIG Dataset"
  [version string?, dataset string?]
  (let [res (:data (mdr-sdtmig-version-datasets-dataset-get-with-http-info version dataset))]
    (if (:decode-models *api-context*)
       (st/decode sdtmig-dataset-spec res st/string-transformer)
       res)))


(defn-spec mdr-sdtmig-version-datasets-dataset-variables-get-with-http-info any?
  "
  Get SDTMIG Dataset Variable List"
  [version string?, dataset string?]
  (check-required-params version dataset)
  (call-api "/mdr/sdtmig/{version}/datasets/{dataset}/variables" :get
            {:path-params   {"version" version "dataset" dataset }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-sdtmig-version-datasets-dataset-variables-get sdtmig-dataset-variables-spec
  "
  Get SDTMIG Dataset Variable List"
  [version string?, dataset string?]
  (let [res (:data (mdr-sdtmig-version-datasets-dataset-variables-get-with-http-info version dataset))]
    (if (:decode-models *api-context*)
       (st/decode sdtmig-dataset-variables-spec res st/string-transformer)
       res)))


(defn-spec mdr-sdtmig-version-datasets-dataset-variables-var-get-with-http-info any?
  "
  Get SDTMIG Dataset Variable"
  [version string?, dataset string?, var string?]
  (check-required-params version dataset var)
  (call-api "/mdr/sdtmig/{version}/datasets/{dataset}/variables/{var}" :get
...
(defn-spec mdr-sdtmig-version-datasets-dataset-variables-var-get sdtmig-dataset-variable-spec
  "
  Get SDTMIG Dataset Variable"
  [version string?, dataset string?, var string?]
  (let [res (:data (mdr-sdtmig-version-datasets-dataset-variables-var-get-with-http-info version dataset var))]
    (if (:decode-models *api-context*)
       (st/decode sdtmig-dataset-variable-spec res st/string-transformer)
       res)))


(defn-spec mdr-sdtmig-version-datasets-get-with-http-info any?
  "
  Get SDTMIG Dataset List"
  [version string?]
  (check-required-params version)
  (call-api "/mdr/sdtmig/{version}/datasets" :get
            {:path-params   {"version" version }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-sdtmig-version-datasets-get sdtmig-datasets-spec
  "
  Get SDTMIG Dataset List"
  [version string?]
  (let [res (:data (mdr-sdtmig-version-datasets-get-with-http-info version))]
    (if (:decode-models *api-context*)
       (st/decode sdtmig-datasets-spec res st/string-transformer)
       res)))


(defn-spec mdr-sdtmig-version-get-with-http-info any?
  "
  Get SDTMIG product"
  [version string?]
  (check-required-params version)
  (call-api "/mdr/sdtmig/{version}" :get
            {:path-params   {"version" version }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-sdtmig-version-get sdtmig-product-spec
  "
  Get SDTMIG product"
  [version string?]
  (let [res (:data (mdr-sdtmig-version-get-with-http-info version))]
    (if (:decode-models *api-context*)
       (st/decode sdtmig-product-spec res st/string-transformer)
       res)))
