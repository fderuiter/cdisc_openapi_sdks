...
SdtmDatasets::__init()
{
	...
	//version = std::string();
	//_links = new SdtmDatasetsLinks();
}

void
SdtmDatasets::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
SdtmDatasets::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("SdtmDatasetsLinks")) {
			jsonToValue(&_links, node, "SdtmDatasetsLinks", "SdtmDatasetsLinks");
		} else {
			
			SdtmDatasetsLinks* obj = static_cast<SdtmDatasetsLinks*> (&_links);
...
SdtmDatasets::SdtmDatasets(char* json)
{
	this->fromJson(json);
}
...
SdtmDatasets::toJson()
{
	...
	if (isprimitive("SdtmDatasetsLinks")) {
		SdtmDatasetsLinks obj = getLinks();
		node = converttoJson(&obj, "SdtmDatasetsLinks", "");
	}
	else {
		
		SdtmDatasetsLinks obj = static_cast<SdtmDatasetsLinks> (getLinks());
		GError *mygerror;
		mygerror = NULL;
...
std::string
SdtmDatasets::getName()
{
	return name;
}

void
SdtmDatasets::setName(std::string  name)
{
	this->name = name;
}

std::string
SdtmDatasets::getLabel()
{
	return label;
}

void
SdtmDatasets::setLabel(std::string  label)
{
	this->label = label;
}

std::string
SdtmDatasets::getDescription()
{
	return description;
}

void
SdtmDatasets::setDescription(std::string  description)
{
	this->description = description;
}

std::string
SdtmDatasets::getSource()
{
	return source;
}

void
SdtmDatasets::setSource(std::string  source)
{
	this->source = source;
}

std::string
SdtmDatasets::getEffectiveDate()
{
	return effectiveDate;
}

void
SdtmDatasets::setEffectiveDate(std::string  effectiveDate)
{
	this->effectiveDate = effectiveDate;
}

std::string
SdtmDatasets::getRegistrationStatus()
{
	return registrationStatus;
}

void
SdtmDatasets::setRegistrationStatus(std::string  registrationStatus)
{
	this->registrationStatus = registrationStatus;
}

std::string
SdtmDatasets::getVersion()
{
	return version;
}

void
SdtmDatasets::setVersion(std::string  version)
{
	this->version = version;
}

SdtmDatasetsLinks
SdtmDatasets::getLinks()
{
	return _links;
}

void
SdtmDatasets::setLinks(SdtmDatasetsLinks  _links)
{
	this->_links = _links;
}
