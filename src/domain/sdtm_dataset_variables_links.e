...
class SDTM_DATASET_VARIABLES_LINKS
...
feature --Access
    ...
    self: detachable SDTM_DATASET_VARIABLES_REF
      
    parent_product: detachable SDTM_PRODUCT_REF
      
    parent_class: detachable SDTM_CLASS_REF
      
    prior_version: detachable SDTM_DATASET_VARIABLES_REF
      
    dataset_variables: detachable LIST [SDTM_DATASET_VARIABLE_REF_ELEMENT]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass SDTM_DATASET_VARIABLES_LINKS%N")
