...
class CDASH_DOMAIN_FIELDS_LINKS
...
feature --Access
    ...
    self: detachable CDASH_DOMAIN_FIELDS_REF
      
    parent_product: detachable CDASH_PRODUCT_REF
      
    parent_class: detachable CDASH_CLASS_REF
      
    fields: detachable LIST [CDASH_DOMAIN_FIELD_REF_ELEMENT]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CDASH_DOMAIN_FIELDS_LINKS%N")
