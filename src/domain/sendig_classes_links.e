...
feature --Access
    ...
    self: detachable SENDIG_CLASSES_REF
      
    prior_version: detachable SENDIG_CLASSES_REF
      
    classes: detachable LIST [SENDIG_CLASS_REF_ELEMENT]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass SENDIG_CLASSES_LINKS%N")
