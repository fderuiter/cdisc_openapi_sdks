...
class SDTM_CLASS_DATASETS_LINKS
...
feature --Access
    ...
    self: detachable SDTM_CLASS_DATASETS_REF
      
    parent_product: detachable SDTM_PRODUCT_REF
      
    prior_version: detachable SDTM_CLASS_DATASETS_REF
      
    datasets: detachable LIST [SDTM_DATASET_REF_ELEMENT]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass SDTM_CLASS_DATASETS_LINKS%N")
