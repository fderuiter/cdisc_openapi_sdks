...
feature --Access
    ...
    completion_instructions: detachable STRING_32
    ...
    var_links: detachable CDASHIG_SCENARIO_FIELD_LINKS
...
feature -- Change Element
    ...
    set_completion_instructions (a_name: like completion_instructions)
        -- Set 'completion_instructions' with 'a_name'.
      do
        completion_instructions := a_name
      ensure
        completion_instructions_set: completion_instructions = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CDASHIG_SCENARIO_FIELD%N")
        ...
        if attached completion_instructions as l_completion_instructions then
          Result.append ("%Ncompletion_instructions:")
          Result.append (l_completion_instructions.out)
          Result.append ("%N")
        end
