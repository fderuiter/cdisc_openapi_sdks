...
feature --Access
    ...
    self: detachable ROOT_CT_CODELIST_REF
      
    versions: detachable LIST [CT_CODELIST_REF_VERSION]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass ROOT_CT_CODELIST_LINKS%N")
