...
class ROOT_SDTMIG_DATASET_VARIABLE_LINKS
...
feature --Access
    ...
    self: detachable ROOT_SDTMIG_DATASET_VARIABLE_REF
      
    versions: detachable LIST [SDTMIG_DATASET_VARIABLE_REF_VERSION]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass ROOT_SDTMIG_DATASET_VARIABLE_LINKS%N")
