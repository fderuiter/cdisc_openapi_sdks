...
class ROOT_SDTM_CLASS_VARIABLE_LINKS
...
feature --Access
    ...
    self: detachable ROOT_SDTM_CLASS_VARIABLE_REF
      
    versions: detachable LIST [SDTM_CLASS_VARIABLE_REF_VERSION]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass ROOT_SDTM_CLASS_VARIABLE_LINKS%N")
