...
feature --Access
    ...
    var_links: detachable CT_PACKAGE_LINKS
      
    codelists: detachable LIST [CT_PACKAGE_CODELISTS]
...
feature -- Change Element
    ...
    set_codelists (a_name: like codelists)
        -- Set 'codelists' with 'a_name'.
      do
        codelists := a_name
      ensure
        codelists_set: codelists = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CT_PACKAGE%N")
        ...
        if attached codelists as l_codelists then
          across l_codelists as ic loop
            Result.append ("%N codelists:")
