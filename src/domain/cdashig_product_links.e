...
feature --Access
    ...
    self: detachable CDASHIG_PRODUCT_REF
      
    model: detachable CDASH_PRODUCT_REF
      
    prior_version: detachable CDASHIG_PRODUCT_REF
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CDASHIG_PRODUCT_LINKS%N")
