...
class CDASH_PRODUCT_CLASSES_LINKS
...
feature --Access
    ...
    self: detachable CDASH_PRODUCT_CLASSES_REF
      
    parent_product: detachable CDASH_PRODUCT_REF
      
    classes: detachable LIST [CDASH_CLASS_REF_ELEMENT]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CDASH_PRODUCT_CLASSES_LINKS%N")
