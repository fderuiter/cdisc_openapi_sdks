...
class EXPORT_QRS_CSV_ITEMS_ROW
...
feature --Access
    ...
    q_rs__measure__name: detachable STRING_32
      
    q_rs__measure__label: detachable STRING_32
      
    q_rs__measure__type: detachable STRING_32
...
feature -- Change Element
    ...
    set_q_rs__measure__name (a_name: like q_rs__measure__name)
        -- Set 'q_rs__measure__name' with 'a_name'.
      do
        q_rs__measure__name := a_name
      ensure
        q_rs__measure__name_set: q_rs__measure__name = a_name
      end

    set_q_rs__measure__label (a_name: like q_rs__measure__label)
        -- Set 'q_rs__measure__label' with 'a_name'.
      do
        q_rs__measure__label := a_name
      ensure
        q_rs__measure__label_set: q_rs__measure__label = a_name
      end

    set_q_rs__measure__type (a_name: like q_rs__measure__type)
        -- Set 'q_rs__measure__type' with 'a_name'.
      do
        q_rs__measure__type := a_name
      ensure
        q_rs__measure__type_set: q_rs__measure__type = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass EXPORT_QRS_CSV_ITEMS_ROW%N")
        if attached q_rs__measure__name as l_q_rs__measure__name then
          Result.append ("%Nq_rs__measure__name:")
          Result.append (l_q_rs__measure__name.out)
          Result.append ("%N")
        end
        if attached q_rs__measure__label as l_q_rs__measure__label then
          Result.append ("%Nq_rs__measure__label:")
          Result.append (l_q_rs__measure__label.out)
          Result.append ("%N")
        end
        if attached q_rs__measure__type as l_q_rs__measure__type then
          Result.append ("%Nq_rs__measure__type:")
          Result.append (l_q_rs__measure__type.out)
          Result.append ("%N")
        end
