...
class CDASHIG_DOMAIN_FIELDS_LINKS
...
feature --Access
    ...
    self: detachable CDASHIG_DOMAIN_FIELDS_REF
      
    parent_product: detachable CDASHIG_PRODUCT_REF
      
    parent_class: detachable CDASHIG_CLASS_REF
      
    fields: detachable LIST [CDASHIG_DOMAIN_FIELD_REF_ELEMENT]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CDASHIG_DOMAIN_FIELDS_LINKS%N")
