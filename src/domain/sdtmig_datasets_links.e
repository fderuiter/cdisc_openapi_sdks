...
feature --Access
    ...
    self: detachable SDTMIG_DATASETS_REF
      
    parent_product: detachable SDTMIG_PRODUCT_REF
      
    prior_version: detachable SDTMIG_DATASETS_REF
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass SDTMIG_DATASETS_LINKS%N")
