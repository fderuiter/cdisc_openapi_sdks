...
class CdashClassTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CdashClass
        //val modelInstance = CdashClass()
        ...
        // to test the property `cdashModelFields`
        should("test cdashModelFields") {
            // uncomment below to test the property
            //modelInstance.cdashModelFields shouldBe ("TODO")
        }
