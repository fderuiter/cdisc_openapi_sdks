...
void
ExportCdashClassVariablesRow::__init()
{
	//version = std::string();
	//r_class = std::string();
	//domain = std::string();
...
void
ExportCdashClassVariablesRow::__cleanup()
{
	//if(version != NULL) {
	//
	//delete version;
...
void
ExportCdashClassVariablesRow::fromJson(char* jsonStr)
{
...
ExportCdashClassVariablesRow::ExportCdashClassVariablesRow(char* json)
{
	this->fromJson(json);
}

char*
ExportCdashClassVariablesRow::toJson()
{
...
std::string
ExportCdashClassVariablesRow::getVersion()
{
	return version;
}

void
ExportCdashClassVariablesRow::setVersion(std::string  version)
{
	this->version = version;
}

std::string
ExportCdashClassVariablesRow::getRClass()
{
	return r_class;
}

void
ExportCdashClassVariablesRow::setRClass(std::string  r_class)
{
	this->r_class = r_class;
}

std::string
ExportCdashClassVariablesRow::getDomain()
{
	return domain;
}

void
ExportCdashClassVariablesRow::setDomain(std::string  domain)
{
	this->domain = domain;
}

std::string
ExportCdashClassVariablesRow::getVariableOrder()
{
	return variableOrder;
}

void
ExportCdashClassVariablesRow::setVariableOrder(std::string  variableOrder)
{
	this->variableOrder = variableOrder;
}

std::string
ExportCdashClassVariablesRow::getCDASHVariable()
{
	return cDASHVariable;
}

void
ExportCdashClassVariablesRow::setCDASHVariable(std::string  cDASHVariable)
{
	this->cDASHVariable = cDASHVariable;
}

std::string
ExportCdashClassVariablesRow::getCDASHVariableLabel()
{
	return cDASHVariableLabel;
}

void
ExportCdashClassVariablesRow::setCDASHVariableLabel(std::string  cDASHVariableLabel)
{
	this->cDASHVariableLabel = cDASHVariableLabel;
}

std::string
ExportCdashClassVariablesRow::getDRAFTCDASHDefinition()
{
	return dRAFTCDASHDefinition;
}

void
ExportCdashClassVariablesRow::setDRAFTCDASHDefinition(std::string  dRAFTCDASHDefinition)
{
	this->dRAFTCDASHDefinition = dRAFTCDASHDefinition;
}

std::string
ExportCdashClassVariablesRow::getDomainSpecific()
{
	return domainSpecific;
}

void
ExportCdashClassVariablesRow::setDomainSpecific(std::string  domainSpecific)
{
	this->domainSpecific = domainSpecific;
}

std::string
ExportCdashClassVariablesRow::getQuestionText()
{
	return questionText;
}

void
ExportCdashClassVariablesRow::setQuestionText(std::string  questionText)
{
	this->questionText = questionText;
}

std::string
ExportCdashClassVariablesRow::getPrompt()
{
	return prompt;
}

void
ExportCdashClassVariablesRow::setPrompt(std::string  prompt)
{
	this->prompt = prompt;
}

std::string
ExportCdashClassVariablesRow::getType()
{
	return type;
}

void
ExportCdashClassVariablesRow::setType(std::string  type)
{
	this->type = type;
}

std::list<std::string>
ExportCdashClassVariablesRow::getSDTMTarget()
{
	return sDTMTarget;
}

void
ExportCdashClassVariablesRow::setSDTMTarget(std::list <std::string> sDTMTarget)
{
	this->sDTMTarget = sDTMTarget;
}

std::string
ExportCdashClassVariablesRow::getMappingInstructions()
{
	return mappingInstructions;
}

void
ExportCdashClassVariablesRow::setMappingInstructions(std::string  mappingInstructions)
{
	this->mappingInstructions = mappingInstructions;
}

std::string
ExportCdashClassVariablesRow::getControlledTerminologyCodelistName()
{
	return controlledTerminologyCodelistName;
}

void
ExportCdashClassVariablesRow::setControlledTerminologyCodelistName(std::string  controlledTerminologyCodelistName)
{
	this->controlledTerminologyCodelistName = controlledTerminologyCodelistName;
}

std::string
ExportCdashClassVariablesRow::getImplementationNotes()
{
	return implementationNotes;
}

void
ExportCdashClassVariablesRow::setImplementationNotes(std::string  implementationNotes)
{
