...
void
ExportCdashigDomainVariablesRow::__init()
{
	//version = std::string();
	//r_class = std::string();
	//domain = std::string();
...
void
ExportCdashigDomainVariablesRow::__cleanup()
{
	//if(version != NULL) {
	//
	//delete version;
...
void
ExportCdashigDomainVariablesRow::fromJson(char* jsonStr)
{
...
ExportCdashigDomainVariablesRow::ExportCdashigDomainVariablesRow(char* json)
{
	this->fromJson(json);
}

char*
ExportCdashigDomainVariablesRow::toJson()
{
...
std::string
ExportCdashigDomainVariablesRow::getVersion()
{
	return version;
}

void
ExportCdashigDomainVariablesRow::setVersion(std::string  version)
{
	this->version = version;
}

std::string
ExportCdashigDomainVariablesRow::getRClass()
{
	return r_class;
}

void
ExportCdashigDomainVariablesRow::setRClass(std::string  r_class)
{
	this->r_class = r_class;
}

std::string
ExportCdashigDomainVariablesRow::getDomain()
{
	return domain;
}

void
ExportCdashigDomainVariablesRow::setDomain(std::string  domain)
{
	this->domain = domain;
}

std::string
ExportCdashigDomainVariablesRow::getDataCollectionScenario()
{
	return dataCollectionScenario;
}

void
ExportCdashigDomainVariablesRow::setDataCollectionScenario(std::string  dataCollectionScenario)
{
	this->dataCollectionScenario = dataCollectionScenario;
}

std::string
ExportCdashigDomainVariablesRow::getVariableOrder()
{
	return variableOrder;
}

void
ExportCdashigDomainVariablesRow::setVariableOrder(std::string  variableOrder)
{
	this->variableOrder = variableOrder;
}

std::string
ExportCdashigDomainVariablesRow::getCDASHIGVariable()
{
	return cDASHIGVariable;
}

void
ExportCdashigDomainVariablesRow::setCDASHIGVariable(std::string  cDASHIGVariable)
{
	this->cDASHIGVariable = cDASHIGVariable;
}

std::string
ExportCdashigDomainVariablesRow::getCDASHIGVariableLabel()
{
	return cDASHIGVariableLabel;
}

void
ExportCdashigDomainVariablesRow::setCDASHIGVariableLabel(std::string  cDASHIGVariableLabel)
{
	this->cDASHIGVariableLabel = cDASHIGVariableLabel;
}

std::string
ExportCdashigDomainVariablesRow::getDRAFTCDASHIGDefinition()
{
	return dRAFTCDASHIGDefinition;
}

void
ExportCdashigDomainVariablesRow::setDRAFTCDASHIGDefinition(std::string  dRAFTCDASHIGDefinition)
{
	this->dRAFTCDASHIGDefinition = dRAFTCDASHIGDefinition;
}

std::string
ExportCdashigDomainVariablesRow::getQuestionText()
{
	return questionText;
}

void
ExportCdashigDomainVariablesRow::setQuestionText(std::string  questionText)
{
	this->questionText = questionText;
}

std::string
ExportCdashigDomainVariablesRow::getPrompt()
{
	return prompt;
}

void
ExportCdashigDomainVariablesRow::setPrompt(std::string  prompt)
{
	this->prompt = prompt;
}

std::string
ExportCdashigDomainVariablesRow::getType()
{
	return type;
}

void
ExportCdashigDomainVariablesRow::setType(std::string  type)
{
	this->type = type;
}

std::string
ExportCdashigDomainVariablesRow::getCDASHIGCore()
{
	return cDASHIGCore;
}

void
ExportCdashigDomainVariablesRow::setCDASHIGCore(std::string  cDASHIGCore)
{
	this->cDASHIGCore = cDASHIGCore;
}

std::string
ExportCdashigDomainVariablesRow::getCaseReportFormCompletionInstructions()
{
	return caseReportFormCompletionInstructions;
}

void
ExportCdashigDomainVariablesRow::setCaseReportFormCompletionInstructions(std::string  caseReportFormCompletionInstructions)
{
	this->caseReportFormCompletionInstructions = caseReportFormCompletionInstructions;
}

std::list<std::string>
ExportCdashigDomainVariablesRow::getSDTMIGTarget()
{
	return sDTMIGTarget;
}

void
ExportCdashigDomainVariablesRow::setSDTMIGTarget(std::list <std::string> sDTMIGTarget)
{
	this->sDTMIGTarget = sDTMIGTarget;
}

std::string
ExportCdashigDomainVariablesRow::getMappingInstructions()
{
	return mappingInstructions;
}

void
ExportCdashigDomainVariablesRow::setMappingInstructions(std::string  mappingInstructions)
{
	this->mappingInstructions = mappingInstructions;
}

std::string
ExportCdashigDomainVariablesRow::getControlledTerminologyCodelistName()
{
	return controlledTerminologyCodelistName;
}

void
ExportCdashigDomainVariablesRow::setControlledTerminologyCodelistName(std::string  controlledTerminologyCodelistName)
{
	this->controlledTerminologyCodelistName = controlledTerminologyCodelistName;
}

std::string
ExportCdashigDomainVariablesRow::getImplementationNotes()
{
	return implementationNotes;
}

void
ExportCdashigDomainVariablesRow::setImplementationNotes(std::string  implementationNotes)
{
