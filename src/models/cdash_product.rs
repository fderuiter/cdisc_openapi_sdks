...
pub struct CdashProduct {
    ...
    pub _links: Option<Box<models::CdashProductLinks>>,
    #[serde(rename = "classes", skip_serializing_if = "Option::is_none")]
    pub classes: Option<Vec<models::CdashClass>>,
    #[serde(rename = "domains", skip_serializing_if = "Option::is_none")]
    pub domains: Option<Vec<models::CdashDomain>>,
}

impl CdashProduct {
    pub fn new() -> CdashProduct {
        CdashProduct {
            name: None,
            label: None,
            description: None,
