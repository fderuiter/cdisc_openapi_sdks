...
pub struct CdashigDomainLinks {
    #[serde(rename = "self", skip_serializing_if = "Option::is_none")]
    pub param_self: Option<Box<models::CdashigDomainRef>>,
