...
class QrsItem(BaseModel):
    ...
    links: Optional[QrsItemLinks] = Field(default=None, alias="_links")
    __properties = ["ordinal", "label", "questionText", "_links"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QrsItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QrsItem:
        """Create an instance of QrsItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QrsItem.parse_obj(obj)

        _obj = QrsItem.parse_obj({
            "ordinal": obj.get("ordinal"),
            "label": obj.get("label"),
            "question_text": obj.get("questionText"),
            "links": QrsItemLinks.from_dict(obj.get("_links")) if obj.get("_links") is not None else None
        })
        return _obj
