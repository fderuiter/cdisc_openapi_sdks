...
class CdashDomainFieldsLinks(BaseModel):
    """
    CdashDomainFieldsLinks
    """
    var_self: Optional[CdashDomainFieldsRef] = Field(default=None, alias="self")
    ...
    fields: Optional[conlist(CdashDomainFieldRefElement)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CdashDomainFieldsLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CdashDomainFieldsLinks:
        """Create an instance of CdashDomainFieldsLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CdashDomainFieldsLinks.parse_obj(obj)

        _obj = CdashDomainFieldsLinks.parse_obj({
            "var_self": CdashDomainFieldsRef.from_dict(obj.get("self")) if obj.get("self") is not None else None,
            ...
            "fields": [CdashDomainFieldRefElement.from_dict(_item) for _item in obj.get("fields")] if obj.get("fields") is not None else None
        })
        return _obj
