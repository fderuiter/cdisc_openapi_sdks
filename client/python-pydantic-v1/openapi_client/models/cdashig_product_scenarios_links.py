...
class CdashigProductScenariosLinks(BaseModel):
    """
    CdashigProductScenariosLinks
    """
    var_self: Optional[CdashigProductScenariosRef] = Field(default=None, alias="self")
    ...
    __properties = ["self", "parentProduct", "scenarios"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CdashigProductScenariosLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CdashigProductScenariosLinks:
        """Create an instance of CdashigProductScenariosLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CdashigProductScenariosLinks.parse_obj(obj)

        _obj = CdashigProductScenariosLinks.parse_obj({
            "var_self": CdashigProductScenariosRef.from_dict(obj.get("self")) if obj.get("self") is not None else None,
