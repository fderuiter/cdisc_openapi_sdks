...
class CdashigScenarioLinks(BaseModel):
    ...
    __properties = ["self", "parentProduct", "parentClass", "parentDomain", "priorVersion"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CdashigScenarioLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CdashigScenarioLinks:
        """Create an instance of CdashigScenarioLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CdashigScenarioLinks.parse_obj(obj)

        _obj = CdashigScenarioLinks.parse_obj({
            "var_self": CdashigScenarioRef.from_dict(obj.get("self")) if obj.get("self") is not None else None,
            ...
            "prior_version": CdashigScenarioRef.from_dict(obj.get("priorVersion")) if obj.get("priorVersion") is not None else None
        })
        return _obj
