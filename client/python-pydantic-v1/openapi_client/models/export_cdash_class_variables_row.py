...
class ExportCdashClassVariablesRow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportCdashClassVariablesRow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportCdashClassVariablesRow:
        """Create an instance of ExportCdashClassVariablesRow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportCdashClassVariablesRow.parse_obj(obj)

        _obj = ExportCdashClassVariablesRow.parse_obj({
