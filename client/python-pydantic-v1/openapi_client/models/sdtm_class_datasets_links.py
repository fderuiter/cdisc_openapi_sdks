...
class SdtmClassDatasetsLinks(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SdtmClassDatasetsLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SdtmClassDatasetsLinks:
        """Create an instance of SdtmClassDatasetsLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SdtmClassDatasetsLinks.parse_obj(obj)

        _obj = SdtmClassDatasetsLinks.parse_obj({
            "var_self": SdtmClassDatasetsRef.from_dict(obj.get("self")) if obj.get("self") is not None else None,
            "parent_product": SdtmProductRef.from_dict(obj.get("parentProduct")) if obj.get("parentProduct") is not None else None,
            "prior_version": SdtmClassDatasetsRef.from_dict(obj.get("priorVersion")) if obj.get("priorVersion") is not None else None,
