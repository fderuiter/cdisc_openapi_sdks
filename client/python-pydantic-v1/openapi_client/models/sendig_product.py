...
class SendigProduct(BaseModel):
    ...
    links: Optional[SendigProductLinks] = Field(default=None, alias="_links")
    classes: Optional[conlist(SendigClass)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SendigProduct:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SendigProduct:
        """Create an instance of SendigProduct from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SendigProduct.parse_obj(obj)

        _obj = SendigProduct.parse_obj({
            "name": obj.get("name"),
            "label": obj.get("label"),
            ...
            "links": SendigProductLinks.from_dict(obj.get("_links")) if obj.get("_links") is not None else None,
            "classes": [SendigClass.from_dict(_item) for _item in obj.get("classes")] if obj.get("classes") is not None else None
        })
        return _obj
