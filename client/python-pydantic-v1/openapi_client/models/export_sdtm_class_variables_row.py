...
class ExportSdtmClassVariablesRow(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportSdtmClassVariablesRow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportSdtmClassVariablesRow:
        """Create an instance of ExportSdtmClassVariablesRow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportSdtmClassVariablesRow.parse_obj(obj)

        _obj = ExportSdtmClassVariablesRow.parse_obj({
