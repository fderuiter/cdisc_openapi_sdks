...
class ExportSendigVariablesRow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportSendigVariablesRow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportSendigVariablesRow:
        """Create an instance of ExportSendigVariablesRow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportSendigVariablesRow.parse_obj(obj)

        _obj = ExportSendigVariablesRow.parse_obj({
