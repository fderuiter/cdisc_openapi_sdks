...
class ExportSdtmWorkbook(BaseModel):
    ...
    __properties = ["class-variables", "dataset-variables", "datasets"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportSdtmWorkbook:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportSdtmWorkbook:
        """Create an instance of ExportSdtmWorkbook from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportSdtmWorkbook.parse_obj(obj)

        _obj = ExportSdtmWorkbook.parse_obj({
