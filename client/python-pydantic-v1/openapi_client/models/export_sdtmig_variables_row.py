...
class ExportSdtmigVariablesRow(BaseModel):
    """
    ...
    __properties = ["Version", "Variable Order", "Class", "Dataset Name", "Variable Name", "Variable Label", "Type", "Controlled Terms, Codelist or Format", "Role", "CDISC Notes", "Core"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportSdtmigVariablesRow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportSdtmigVariablesRow:
        """Create an instance of ExportSdtmigVariablesRow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportSdtmigVariablesRow.parse_obj(obj)

        _obj = ExportSdtmigVariablesRow.parse_obj({
