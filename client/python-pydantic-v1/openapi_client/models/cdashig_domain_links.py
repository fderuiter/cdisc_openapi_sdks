...
class CdashigDomainLinks(BaseModel):
    ...
    __properties = ["self", "parentProduct", "parentClass", "priorVersion", "scenarios"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CdashigDomainLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CdashigDomainLinks:
        """Create an instance of CdashigDomainLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CdashigDomainLinks.parse_obj(obj)

        _obj = CdashigDomainLinks.parse_obj({
            "var_self": CdashigDomainRef.from_dict(obj.get("self")) if obj.get("self") is not None else None,
            ...
            "prior_version": CdashigDomainRef.from_dict(obj.get("priorVersion")) if obj.get("priorVersion") is not None else None,
