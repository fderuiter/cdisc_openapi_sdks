...
from openapi_client.models.productgroup_data_tabulation import ProductgroupDataTabulation  # noqa: E501

class TestProductgroupDataTabulation(unittest.TestCase):
    """ProductgroupDataTabulation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductgroupDataTabulation:
        """Test ProductgroupDataTabulation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductgroupDataTabulation`
        """
        model = ProductgroupDataTabulation()  # noqa: E501
        if include_optional:
            return ProductgroupDataTabulation(
                links = openapi_client.models.productgroup_data_tabulation_links.ProductgroupDataTabulationLinks(
    ...
    def testProductgroupDataTabulation(self):
        """Test ProductgroupDataTabulation"""
