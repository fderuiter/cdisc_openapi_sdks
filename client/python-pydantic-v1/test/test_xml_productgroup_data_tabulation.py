...
from openapi_client.models.xml_productgroup_data_tabulation import XmlProductgroupDataTabulation  # noqa: E501

class TestXmlProductgroupDataTabulation(unittest.TestCase):
    """XmlProductgroupDataTabulation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XmlProductgroupDataTabulation:
        """Test XmlProductgroupDataTabulation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XmlProductgroupDataTabulation`
        """
        model = XmlProductgroupDataTabulation()  # noqa: E501
        if include_optional:
            return XmlProductgroupDataTabulation(
                var_self = openapi_client.models.productgroup_data_tabulation.ProductgroupDataTabulation(
    ...
    def testXmlProductgroupDataTabulation(self):
        """Test XmlProductgroupDataTabulation"""
