...
from openapi_client.models.sdtm_datasets import SdtmDatasets  # noqa: E501

class TestSdtmDatasets(unittest.TestCase):
    """SdtmDatasets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SdtmDatasets:
        """Test SdtmDatasets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SdtmDatasets`
        """
        model = SdtmDatasets()  # noqa: E501
        if include_optional:
            return SdtmDatasets(
                name = 'SDTM v1.8',
                ...
                version = '1.8',
                links = openapi_client.models.sdtm_datasets_links.SdtmDatasetsLinks(
