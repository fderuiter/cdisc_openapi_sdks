...
from openapi_client.models.xml_cdash_class import XmlCdashClass  # noqa: E501

class TestXmlCdashClass(unittest.TestCase):
    """XmlCdashClass unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XmlCdashClass:
        """Test XmlCdashClass
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XmlCdashClass`
        """
        model = XmlCdashClass()  # noqa: E501
        if include_optional:
            return XmlCdashClass(
                var_self = openapi_client.models.cdash_class.CdashClass(
                    ordinal = '5', 
                    name = 'Timing', 
                    label = 'Timing Class', 
                    description = 'Timing class variables', 
                    _links = openapi_client.models.cdash_class_links.CdashClassLinks(
