...
from openapi_client.models.xml_sendig_datasets import XmlSendigDatasets  # noqa: E501

class TestXmlSendigDatasets(unittest.TestCase):
    """XmlSendigDatasets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XmlSendigDatasets:
        """Test XmlSendigDatasets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XmlSendigDatasets`
        """
        model = XmlSendigDatasets()  # noqa: E501
        if include_optional:
            return XmlSendigDatasets(
                var_self = openapi_client.models.sendig_datasets.SendigDatasets(
                    name = 'SENDIG v3.1', 
                    ...
                    version = '3.1', 
                    _links = openapi_client.models.sendig_datasets_links.SendigDatasetsLinks(
    ...
    def testXmlSendigDatasets(self):
        """Test XmlSendigDatasets"""
