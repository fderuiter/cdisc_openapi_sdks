...
from openapi_client.models.xml_sdtmig_class import XmlSdtmigClass  # noqa: E501

class TestXmlSdtmigClass(unittest.TestCase):
    """XmlSdtmigClass unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XmlSdtmigClass:
        """Test XmlSdtmigClass
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XmlSdtmigClass`
        """
        model = XmlSdtmigClass()  # noqa: E501
        if include_optional:
            return XmlSdtmigClass(
                var_self = openapi_client.models.sdtmig_class.SdtmigClass(
                    ordinal = '5', 
                    name = 'Findings', 
