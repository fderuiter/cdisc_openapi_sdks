...
from openapi_client.models.xml_qrs_product import XmlQrsProduct  # noqa: E501

class TestXmlQrsProduct(unittest.TestCase):
    """XmlQrsProduct unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XmlQrsProduct:
        """Test XmlQrsProduct
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XmlQrsProduct`
        """
        model = XmlQrsProduct()  # noqa: E501
        if include_optional:
            return XmlQrsProduct(
                var_self = openapi_client.models.qrs_product.QrsProduct(
                    name = 'AIMS v1.0', 
                    ...
                    _links = openapi_client.models.qrs_product_links.QrsProductLinks(
