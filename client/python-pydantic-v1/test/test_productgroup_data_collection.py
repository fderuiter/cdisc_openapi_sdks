...
from openapi_client.models.productgroup_data_collection import ProductgroupDataCollection  # noqa: E501

class TestProductgroupDataCollection(unittest.TestCase):
    """ProductgroupDataCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductgroupDataCollection:
        """Test ProductgroupDataCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductgroupDataCollection`
        """
        model = ProductgroupDataCollection()  # noqa: E501
        if include_optional:
            return ProductgroupDataCollection(
                links = openapi_client.models.productgroup_data_collection_links.ProductgroupDataCollectionLinks(
    ...
    def testProductgroupDataCollection(self):
        """Test ProductgroupDataCollection"""
