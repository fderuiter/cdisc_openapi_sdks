...
#ifndef OAICtPackageTerm_H
#define OAICtPackageTerm_H
...
class OAICtPackageTerm : public OAIObject {
public:
    OAICtPackageTerm();
    OAICtPackageTerm(QString json);
    ~OAICtPackageTerm() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICtPackageTerm)

#endif // OAICtPackageTerm_H
