...
public class CtPackageTerm {
  ...
  public CtPackageTerm() {
  }

  public CtPackageTerm conceptId(@javax.annotation.Nullable String conceptId) {
  ...
  public CtPackageTerm submissionValue(@javax.annotation.Nullable String submissionValue) {
  ...
  public CtPackageTerm definition(@javax.annotation.Nullable String definition) {
  ...
  public CtPackageTerm preferredTerm(@javax.annotation.Nullable String preferredTerm) {
  ...
  public CtPackageTerm synonyms(@javax.annotation.Nullable List<String> synonyms) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("conceptId", "submissionValue", "definition", "preferredTerm", "synonyms"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CtPackageTerm
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CtPackageTerm.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CtPackageTerm is not found in the empty JSON string", CtPackageTerm.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CtPackageTerm.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CtPackageTerm` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CtPackageTerm.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CtPackageTerm' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CtPackageTerm> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CtPackageTerm.class));

       return (TypeAdapter<T>) new TypeAdapter<CtPackageTerm>() {
           @Override
           public void write(JsonWriter out, CtPackageTerm value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CtPackageTerm read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CtPackageTerm given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CtPackageTerm
   * @throws IOException if the JSON string is invalid with respect to CtPackageTerm
   */
  public static CtPackageTerm fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CtPackageTerm.class);
  }

  /**
   * Convert an instance of CtPackageTerm to an JSON string
   *
   * @return JSON string
   */
