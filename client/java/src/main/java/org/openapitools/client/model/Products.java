...
public class Products {
  ...
  public Products links(@javax.annotation.Nullable ProductsLinks links) {
    this.links = links;
    return this;
  }
  ...
  public void setLinks(@javax.annotation.Nullable ProductsLinks links) {
    this.links = links;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("_links") != null && !jsonObj.get("_links").isJsonNull()) {
        ProductsLinks.validateJsonElement(jsonObj.get("_links"));
      }
  }
