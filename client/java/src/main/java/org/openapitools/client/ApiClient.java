...
public class ApiClient {
    ...
    protected String basePath = "https://library.cdisc.org/api";
    ...
    new ServerConfiguration(
      "https://virtserver.swaggerhub.com/CDISC1/share-2.0/1.1.0",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://library.cdisc.org/api
