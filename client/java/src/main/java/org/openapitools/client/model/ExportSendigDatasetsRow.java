...
public class ExportSendigDatasetsRow {
  ...
  public ExportSendigDatasetsRow() {
  }

  public ExportSendigDatasetsRow version(@javax.annotation.Nullable String version) {
  ...
  public ExportSendigDatasetsRow propertyClass(@javax.annotation.Nullable String propertyClass) {
  ...
  public ExportSendigDatasetsRow datasetName(@javax.annotation.Nullable String datasetName) {
  ...
  public ExportSendigDatasetsRow datasetLabel(@javax.annotation.Nullable String datasetLabel) {
  ...
  public ExportSendigDatasetsRow structure(@javax.annotation.Nullable String structure) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExportSendigDatasetsRow
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportSendigDatasetsRow.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExportSendigDatasetsRow is not found in the empty JSON string", ExportSendigDatasetsRow.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportSendigDatasetsRow.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExportSendigDatasetsRow` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportSendigDatasetsRow.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportSendigDatasetsRow' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportSendigDatasetsRow> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportSendigDatasetsRow.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportSendigDatasetsRow>() {
           @Override
           public void write(JsonWriter out, ExportSendigDatasetsRow value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportSendigDatasetsRow read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExportSendigDatasetsRow given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExportSendigDatasetsRow
   * @throws IOException if the JSON string is invalid with respect to ExportSendigDatasetsRow
   */
  public static ExportSendigDatasetsRow fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportSendigDatasetsRow.class);
  }

  /**
   * Convert an instance of ExportSendigDatasetsRow to an JSON string
   *
   * @return JSON string
   */
