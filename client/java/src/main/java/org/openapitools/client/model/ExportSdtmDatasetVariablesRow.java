...
public class ExportSdtmDatasetVariablesRow {
  ...
  public ExportSdtmDatasetVariablesRow() {
  }

  public ExportSdtmDatasetVariablesRow version(@javax.annotation.Nullable String version) {
  ...
  public ExportSdtmDatasetVariablesRow variableOrder(@javax.annotation.Nullable String variableOrder) {
  ...
  public ExportSdtmDatasetVariablesRow propertyClass(@javax.annotation.Nullable String propertyClass) {
  ...
  public ExportSdtmDatasetVariablesRow datasetName(@javax.annotation.Nullable String datasetName) {
  ...
  public ExportSdtmDatasetVariablesRow variableName(@javax.annotation.Nullable String variableName) {
  ...
  public ExportSdtmDatasetVariablesRow variableLabel(@javax.annotation.Nullable String variableLabel) {
  ...
  public ExportSdtmDatasetVariablesRow type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public ExportSdtmDatasetVariablesRow controlledTermsCommaCodelistOrFormat(@javax.annotation.Nullable String controlledTermsCommaCodelistOrFormat) {
  ...
  public ExportSdtmDatasetVariablesRow role(@javax.annotation.Nullable String role) {
    this.role = role;
    return this;
  }
  ...
  public ExportSdtmDatasetVariablesRow roleDescription(@javax.annotation.Nullable String roleDescription) {
  ...
  public ExportSdtmDatasetVariablesRow description(@javax.annotation.Nullable String description) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExportSdtmDatasetVariablesRow
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportSdtmDatasetVariablesRow.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExportSdtmDatasetVariablesRow is not found in the empty JSON string", ExportSdtmDatasetVariablesRow.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportSdtmDatasetVariablesRow.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExportSdtmDatasetVariablesRow` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportSdtmDatasetVariablesRow.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportSdtmDatasetVariablesRow' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportSdtmDatasetVariablesRow> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportSdtmDatasetVariablesRow.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportSdtmDatasetVariablesRow>() {
           @Override
           public void write(JsonWriter out, ExportSdtmDatasetVariablesRow value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportSdtmDatasetVariablesRow read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExportSdtmDatasetVariablesRow given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExportSdtmDatasetVariablesRow
   * @throws IOException if the JSON string is invalid with respect to ExportSdtmDatasetVariablesRow
   */
  public static ExportSdtmDatasetVariablesRow fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportSdtmDatasetVariablesRow.class);
  }

  /**
   * Convert an instance of ExportSdtmDatasetVariablesRow to an JSON string
   *
   * @return JSON string
   */
