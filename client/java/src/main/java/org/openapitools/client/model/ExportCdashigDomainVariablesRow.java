...
public class ExportCdashigDomainVariablesRow {
  ...
  public ExportCdashigDomainVariablesRow() {
  }

  public ExportCdashigDomainVariablesRow version(@javax.annotation.Nullable String version) {
  ...
  public ExportCdashigDomainVariablesRow propertyClass(@javax.annotation.Nullable String propertyClass) {
  ...
  public ExportCdashigDomainVariablesRow domain(@javax.annotation.Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ExportCdashigDomainVariablesRow dataCollectionScenario(@javax.annotation.Nullable String dataCollectionScenario) {
  ...
  public ExportCdashigDomainVariablesRow variableOrder(@javax.annotation.Nullable String variableOrder) {
  ...
  public ExportCdashigDomainVariablesRow cdASHIGVariable(@javax.annotation.Nullable String cdASHIGVariable) {
  ...
  public ExportCdashigDomainVariablesRow cdASHIGVariableLabel(@javax.annotation.Nullable String cdASHIGVariableLabel) {
  ...
  public ExportCdashigDomainVariablesRow drAFTCDASHIGDefinition(@javax.annotation.Nullable String drAFTCDASHIGDefinition) {
  ...
  public ExportCdashigDomainVariablesRow questionText(@javax.annotation.Nullable String questionText) {
  ...
  public ExportCdashigDomainVariablesRow prompt(@javax.annotation.Nullable String prompt) {
    this.prompt = prompt;
    return this;
  }
  ...
  public ExportCdashigDomainVariablesRow type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public ExportCdashigDomainVariablesRow cdASHIGCore(@javax.annotation.Nullable String cdASHIGCore) {
  ...
  public ExportCdashigDomainVariablesRow caseReportFormCompletionInstructions(@javax.annotation.Nullable String caseReportFormCompletionInstructions) {
  ...
  public ExportCdashigDomainVariablesRow sdTMIGTarget(@javax.annotation.Nullable List<String> sdTMIGTarget) {
  ...
  public ExportCdashigDomainVariablesRow mappingInstructions(@javax.annotation.Nullable String mappingInstructions) {
  ...
  public ExportCdashigDomainVariablesRow controlledTerminologyCodelistName(@javax.annotation.Nullable String controlledTerminologyCodelistName) {
  ...
  public ExportCdashigDomainVariablesRow implementationNotes(@javax.annotation.Nullable String implementationNotes) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExportCdashigDomainVariablesRow
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportCdashigDomainVariablesRow.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExportCdashigDomainVariablesRow is not found in the empty JSON string", ExportCdashigDomainVariablesRow.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportCdashigDomainVariablesRow.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExportCdashigDomainVariablesRow` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportCdashigDomainVariablesRow.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportCdashigDomainVariablesRow' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportCdashigDomainVariablesRow> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportCdashigDomainVariablesRow.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportCdashigDomainVariablesRow>() {
           @Override
           public void write(JsonWriter out, ExportCdashigDomainVariablesRow value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportCdashigDomainVariablesRow read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExportCdashigDomainVariablesRow given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExportCdashigDomainVariablesRow
   * @throws IOException if the JSON string is invalid with respect to ExportCdashigDomainVariablesRow
   */
  public static ExportCdashigDomainVariablesRow fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportCdashigDomainVariablesRow.class);
  }

  /**
   * Convert an instance of ExportCdashigDomainVariablesRow to an JSON string
   *
   * @return JSON string
   */
