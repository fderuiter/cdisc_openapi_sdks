...
public class ExportCdashClassVariablesRow {
  ...
  public ExportCdashClassVariablesRow() {
  }

  public ExportCdashClassVariablesRow version(@javax.annotation.Nullable String version) {
  ...
  public ExportCdashClassVariablesRow propertyClass(@javax.annotation.Nullable String propertyClass) {
  ...
  public ExportCdashClassVariablesRow domain(@javax.annotation.Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ExportCdashClassVariablesRow variableOrder(@javax.annotation.Nullable String variableOrder) {
  ...
  public ExportCdashClassVariablesRow cdASHVariable(@javax.annotation.Nullable String cdASHVariable) {
  ...
  public ExportCdashClassVariablesRow cdASHVariableLabel(@javax.annotation.Nullable String cdASHVariableLabel) {
  ...
  public ExportCdashClassVariablesRow drAFTCDASHDefinition(@javax.annotation.Nullable String drAFTCDASHDefinition) {
  ...
  public ExportCdashClassVariablesRow domainSpecific(@javax.annotation.Nullable String domainSpecific) {
  ...
  public ExportCdashClassVariablesRow questionText(@javax.annotation.Nullable String questionText) {
  ...
  public ExportCdashClassVariablesRow prompt(@javax.annotation.Nullable String prompt) {
    this.prompt = prompt;
    return this;
  }
  ...
  public ExportCdashClassVariablesRow type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public ExportCdashClassVariablesRow sdTMTarget(@javax.annotation.Nullable List<String> sdTMTarget) {
  ...
  public ExportCdashClassVariablesRow mappingInstructions(@javax.annotation.Nullable String mappingInstructions) {
  ...
  public ExportCdashClassVariablesRow controlledTerminologyCodelistName(@javax.annotation.Nullable String controlledTerminologyCodelistName) {
  ...
  public ExportCdashClassVariablesRow implementationNotes(@javax.annotation.Nullable String implementationNotes) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExportCdashClassVariablesRow
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportCdashClassVariablesRow.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExportCdashClassVariablesRow is not found in the empty JSON string", ExportCdashClassVariablesRow.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportCdashClassVariablesRow.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExportCdashClassVariablesRow` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportCdashClassVariablesRow.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportCdashClassVariablesRow' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportCdashClassVariablesRow> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportCdashClassVariablesRow.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportCdashClassVariablesRow>() {
           @Override
           public void write(JsonWriter out, ExportCdashClassVariablesRow value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportCdashClassVariablesRow read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExportCdashClassVariablesRow given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExportCdashClassVariablesRow
   * @throws IOException if the JSON string is invalid with respect to ExportCdashClassVariablesRow
   */
  public static ExportCdashClassVariablesRow fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportCdashClassVariablesRow.class);
  }

  /**
   * Convert an instance of ExportCdashClassVariablesRow to an JSON string
   *
   * @return JSON string
   */
