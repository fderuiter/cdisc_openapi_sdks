...
# Required: False
# Example: Study Data Tabulation Model Version 1.8 (Final)
# isArray: false
...
# Required: False
# Example: This document describes the Study Data Tabulation Model (SDTM), which defines a standard structure for study data tabulations.
# isArray: false
...
# Required: False
# Example: CDISC Submission Data Standards Team and CDISC SDTM Governance Committee
# isArray: false
...
# Required: False
# isArray: false
@export var Underscorelinks: SdtmProductLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = SdtmProductLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	if from_dict.has("classes"):
		me.classes = SdtmClass.bzz_denormalize_multiple(from_dict["classes"])
