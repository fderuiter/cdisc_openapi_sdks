extends Resource
class_name SendigDatasetsLinks
...
# SendigDatasetsLinks Model


# Required: False
# isArray: false
@export var some_self: SendigDatasetsRef:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("some_self"):
		me.some_self = SendigDatasetsRef.bzz_denormalize_single(from_dict["some_self"])
