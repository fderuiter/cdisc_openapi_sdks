...
# SdtmDatasetLinks Model


# Required: False
# isArray: false
@export var some_self: SdtmDatasetRef:
	set(value):
...
# Required: False
# isArray: false
@export var priorVersion: SdtmDatasetRef:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("some_self"):
		me.some_self = SdtmDatasetRef.bzz_denormalize_single(from_dict["some_self"])
	...
	if from_dict.has("priorVersion"):
		me.priorVersion = SdtmDatasetRef.bzz_denormalize_single(from_dict["priorVersion"])
	return me
