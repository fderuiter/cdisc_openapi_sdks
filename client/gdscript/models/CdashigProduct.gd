...
# CdashigProduct Model


# Required: False
# Example: CDASHIG v2.1
# isArray: false
...
# Required: False
# Example: Clinical Data Acquisition Standards Harmonization Implementation Guide for Human Clinical Trials Version 2.1
# isArray: false
...
# Required: False
# Example: The Clinical Data Acquisition Standards Harmonization (CDASH) Model, the CDASH Implementation Guide (CDASHIG), and the CDASHIG Metadata Table define basic standards for the collection of clinical trial data and how to implement the standard for specific case report forms (CRFs).
# isArray: false
...
# Required: False
# Example: Prepared by the CDISC CDASH Team
# isArray: false
...
# Required: False
# isArray: false
@export var Underscorelinks: CdashigProductLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = CdashigProductLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	if from_dict.has("classes"):
		me.classes = CdashigClass.bzz_denormalize_multiple(from_dict["classes"])
	return me
