extends Resource
class_name RootCdashClassField
...
# RootCdashClassField Model


# Required: False
# isArray: false
@export var Underscorelinks: RootCdashClassFieldLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = RootCdashClassFieldLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
