...
# Required: False
# Example: Standard for Exchange of Nonclinical Data Implementation Guide: Nonclinical Studies Version 3.1 (Final)
# isArray: false
...
# Required: False
# Example: The SENDIG is intended to guide the organization, structure, and format of standard nonclinical tabulation datasets for interchange between organizations such as sponsors and CROs, and for submission to regulatory authorities such as the U.S. Food and Drug Administration (FDA).
# isArray: false
...
# Required: False
# Example: Prepared by the CDISC Standard for Exchange of Nonclinical Data Team
# isArray: false
...
# Required: False
# isArray: false
@export var Underscorelinks: SendigDatasetsLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = SendigDatasetsLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
