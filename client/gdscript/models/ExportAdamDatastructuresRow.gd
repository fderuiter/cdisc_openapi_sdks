extends Resource
class_name ExportAdamDatastructuresRow
...
# ExportAdamDatastructuresRow Model
...
# Required: False
# isArray: false
@export var Dataset Description: String = "":
	set(value):
		__Dataset Description__was__set = true
		Dataset Description = value
var __Dataset Description__was__set := false
...
func bzz_normalize() -> Dictionary:
	...
	if self.__Dataset Description__was__set:
		bzz_dictionary["Dataset Description"] = self.Dataset Description
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Dataset Description"):
		me.Dataset Description = from_dict["Dataset Description"]
