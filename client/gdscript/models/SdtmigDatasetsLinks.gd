extends Resource
class_name SdtmigDatasetsLinks
...
# SdtmigDatasetsLinks Model


# Required: False
# isArray: false
@export var some_self: SdtmigDatasetsRef:
	set(value):
...
# Required: False
# isArray: false
@export var priorVersion: SdtmigDatasetsRef:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("some_self"):
		me.some_self = SdtmigDatasetsRef.bzz_denormalize_single(from_dict["some_self"])
	...
	if from_dict.has("priorVersion"):
		me.priorVersion = SdtmigDatasetsRef.bzz_denormalize_single(from_dict["priorVersion"])
