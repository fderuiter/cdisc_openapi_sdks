...
# Required: False
# Example: Timing class variables
# isArray: false
...
# Required: False
# isArray: false
@export var Underscorelinks: CdashClassLinks:
	set(value):
...
# Required: False
# isArray: true
@export var cdashModelFields: Array:
	set(value):
		__cdashModelFields__was__set = true
		cdashModelFields = value
var __cdashModelFields__was__set := false
...
func bzz_normalize() -> Dictionary:
	...
	if self.__cdashModelFields__was__set:
		bzz_dictionary["cdashModelFields"] = self.cdashModelFields
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = CdashClassLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	if from_dict.has("cdashModelFields"):
		me.cdashModelFields = CdashClassField.bzz_denormalize_multiple(from_dict["cdashModelFields"])
	return me
