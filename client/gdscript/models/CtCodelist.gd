...
# Required: False
# isArray: false
@export var Underscorelinks: CtCodelistLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = CtCodelistLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	if from_dict.has("terms"):
		me.terms = CtPackageTerm.bzz_denormalize_multiple(from_dict["terms"])
	return me
