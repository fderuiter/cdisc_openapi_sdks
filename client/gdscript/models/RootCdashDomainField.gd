extends Resource
class_name RootCdashDomainField
...
# RootCdashDomainField Model


# Required: False
# isArray: false
@export var Underscorelinks: RootCdashDomainFieldLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = RootCdashDomainFieldLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
