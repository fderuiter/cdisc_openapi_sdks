extends Resource
class_name CdashigClassScenarios
...
# Required: False
# isArray: false
@export var Underscorelinks: CdashigClassScenariosLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = CdashigClassScenariosLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
