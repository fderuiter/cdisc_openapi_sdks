extends Resource
class_name CdashProductDomains
...
# Required: False
# isArray: false
@export var Underscorelinks: CdashProductDomainsLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = CdashProductDomainsLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
