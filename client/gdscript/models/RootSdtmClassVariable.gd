extends Resource
class_name RootSdtmClassVariable
...
# RootSdtmClassVariable Model


# Required: False
# isArray: false
@export var Underscorelinks: RootSdtmClassVariableLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = RootSdtmClassVariableLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
