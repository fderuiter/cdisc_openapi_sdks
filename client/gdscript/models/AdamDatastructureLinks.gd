extends Resource
class_name AdamDatastructureLinks
...
# AdamDatastructureLinks Model


# Required: False
# isArray: false
@export var some_self: AdamDatastructureRef:
	set(value):
...
# Required: False
# isArray: false
@export var priorVersion: AdamDatastructureRef:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("some_self"):
		me.some_self = AdamDatastructureRef.bzz_denormalize_single(from_dict["some_self"])
	...
	if from_dict.has("priorVersion"):
		me.priorVersion = AdamDatastructureRef.bzz_denormalize_single(from_dict["priorVersion"])
	return me
