extends Resource
class_name CdashProductDomainsLinks
...
# CdashProductDomainsLinks Model


# Required: False
# isArray: false
@export var some_self: CdashProductDomainsRef:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("some_self"):
		me.some_self = CdashProductDomainsRef.bzz_denormalize_single(from_dict["some_self"])
	...
	if from_dict.has("domains"):
		me.domains = CdashDomainRefElement.bzz_denormalize_multiple(from_dict["domains"])
	return me
