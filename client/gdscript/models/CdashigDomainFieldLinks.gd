extends Resource
class_name CdashigDomainFieldLinks
...
# CdashigDomainFieldLinks Model


# Required: False
# isArray: false
@export var some_self: CdashigDomainFieldRef:
	set(value):
...
# Required: False
# isArray: false
@export var rootItem: RootCdashigDomainFieldRef:
	set(value):
...
# Required: False
# isArray: false
@export var priorVersion: CdashigDomainFieldRef:
	set(value):
...
# Required: False
# isArray: true
@export var sdtmClassMappingTargets: Array:
	set(value):
		__sdtmClassMappingTargets__was__set = true
		sdtmClassMappingTargets = value
var __sdtmClassMappingTargets__was__set := false
...
func bzz_normalize() -> Dictionary:
	...
	if self.__sdtmClassMappingTargets__was__set:
		bzz_dictionary["sdtmClassMappingTargets"] = self.sdtmClassMappingTargets
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("some_self"):
		me.some_self = CdashigDomainFieldRef.bzz_denormalize_single(from_dict["some_self"])
	...
	if from_dict.has("rootItem"):
		me.rootItem = RootCdashigDomainFieldRef.bzz_denormalize_single(from_dict["rootItem"])
	if from_dict.has("priorVersion"):
		me.priorVersion = CdashigDomainFieldRef.bzz_denormalize_single(from_dict["priorVersion"])
	if from_dict.has("sdtmClassMappingTargets"):
		me.sdtmClassMappingTargets = SdtmClassVariableRefTarget.bzz_denormalize_multiple(from_dict["sdtmClassMappingTargets"])
