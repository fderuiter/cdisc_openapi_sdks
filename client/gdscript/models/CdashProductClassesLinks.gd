extends Resource
class_name CdashProductClassesLinks
...
# CdashProductClassesLinks Model


# Required: False
# isArray: false
@export var some_self: CdashProductClassesRef:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("some_self"):
		me.some_self = CdashProductClassesRef.bzz_denormalize_single(from_dict["some_self"])
	...
	if from_dict.has("classes"):
		me.classes = CdashClassRefElement.bzz_denormalize_multiple(from_dict["classes"])
	return me
