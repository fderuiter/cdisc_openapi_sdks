...
# CdashProductLinks Model


# Required: False
# isArray: false
@export var some_self: CdashProductRef:
	set(value):
...
# Required: False
# isArray: false
@export var priorVersion: CdashProductRef:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("some_self"):
		me.some_self = CdashProductRef.bzz_denormalize_single(from_dict["some_self"])
	if from_dict.has("priorVersion"):
		me.priorVersion = CdashProductRef.bzz_denormalize_single(from_dict["priorVersion"])
	return me
