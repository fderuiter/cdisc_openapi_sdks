...
# Required: False
# Example: Standard for Exchange ofâ€¦ies Version 3.1 (Final)
# isArray: false
...
# Required: False
# Example: Prepared by the CDISC Stâ€¦f Nonclinical Data Team
# isArray: false
...
# Required: False
# isArray: false
@export var Underscorelinks: SendigProductLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = SendigProductLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	if from_dict.has("classes"):
		me.classes = SendigClass.bzz_denormalize_multiple(from_dict["classes"])
	return me
