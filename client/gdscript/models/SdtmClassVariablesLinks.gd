extends Resource
class_name SdtmClassVariablesLinks
...
# SdtmClassVariablesLinks Model


# Required: False
# isArray: false
@export var some_self: SdtmClassVariablesRef:
	set(value):
...
# Required: False
# isArray: false
@export var priorVersion: SdtmClassVariablesRef:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("some_self"):
		me.some_self = SdtmClassVariablesRef.bzz_denormalize_single(from_dict["some_self"])
	...
	if from_dict.has("priorVersion"):
		me.priorVersion = SdtmClassVariablesRef.bzz_denormalize_single(from_dict["priorVersion"])
	if from_dict.has("classVariables"):
		me.classVariables = SdtmClassVariableRefElement.bzz_denormalize_multiple(from_dict["classVariables"])
	return me
