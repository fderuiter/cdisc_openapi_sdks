extends Resource
class_name CdashigScenarioFieldLinks
...
# CdashigScenarioFieldLinks Model


# Required: False
# isArray: false
@export var some_self: CdashigScenarioFieldRef:
	set(value):
...
# Required: False
# isArray: false
@export var parentScenario: CdashigScenarioRef:
	set(value):
		__parentScenario__was__set = true
		parentScenario = value
var __parentScenario__was__set := false

# Required: False
# isArray: false
@export var rootItem: RootCdashigScenarioFieldRef:
	set(value):
...
# Required: False
# isArray: false
@export var priorVersion: CdashigScenarioFieldRef:
	set(value):
...
func bzz_normalize() -> Dictionary:
	...
	if self.__parentScenario__was__set:
		bzz_dictionary["parentScenario"] = self.parentScenario
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("some_self"):
		me.some_self = CdashigScenarioFieldRef.bzz_denormalize_single(from_dict["some_self"])
	...
	if from_dict.has("parentScenario"):
		me.parentScenario = CdashigScenarioRef.bzz_denormalize_single(from_dict["parentScenario"])
	if from_dict.has("rootItem"):
		me.rootItem = RootCdashigScenarioFieldRef.bzz_denormalize_single(from_dict["rootItem"])
	if from_dict.has("priorVersion"):
		me.priorVersion = CdashigScenarioFieldRef.bzz_denormalize_single(from_dict["priorVersion"])
