extends Resource
class_name SendigDatasetVariables
...
# Required: False
# isArray: false
@export var Underscorelinks: SendigDatasetVariablesLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = SendigDatasetVariablesLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
