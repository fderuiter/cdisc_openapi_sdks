...
# Required: False
# Example: The percentage of a whole blood specimen that is composed of red blood cells (erythrocytes).
# isArray: false
...
# Required: False
# Example: Hematocrit Measurement
# isArray: false
...
# Required: False
# Example: [\"EVF\",\"Erythrocyte Volume Fraction\",\"Hematocrit\",\"PCV\",\"Packed Cell Volume\"]
# isArray: true
...
# Required: False
# isArray: false
@export var Underscorelinks: CtTermLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = CtTermLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
