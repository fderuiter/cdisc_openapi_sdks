extends Resource
class_name CdashigScenarioFields
...
# Required: False
# isArray: false
@export var Underscorelinks: CdashigScenarioFieldsLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = CdashigScenarioFieldsLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
