extends Resource
class_name SdtmigClassRefSubclass
...
# SdtmigClassRefSubclass Model


# Required: False
# Example: /mdr/sdtmig/3-3/classes/FindingsAbout
# isArray: false
...
# Required: False
# Example: Findings About Events or Interventions
# isArray: false
