...
# Required: False
# isArray: false
@export var Underscorelinks: SdtmigClassLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = SdtmigClassLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	if from_dict.has("datasets"):
		me.datasets = SdtmigDataset.bzz_denormalize_multiple(from_dict["datasets"])
	return me
