...
# Required: False
# isArray: false
@export var Underscorelinks: SendigClassesLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = SendigClassesLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
