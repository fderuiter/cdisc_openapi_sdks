...
# Required: False
# isArray: false
@export var Underscorelinks: AdamVarsetLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = AdamVarsetLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	if from_dict.has("analysisVariables"):
		me.analysisVariables = AdamVariable.bzz_denormalize_multiple(from_dict["analysisVariables"])
	return me
