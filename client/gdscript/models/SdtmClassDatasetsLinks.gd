extends Resource
class_name SdtmClassDatasetsLinks
...
# SdtmClassDatasetsLinks Model


# Required: False
# isArray: false
@export var some_self: SdtmClassDatasetsRef:
	set(value):
...
# Required: False
# isArray: false
@export var priorVersion: SdtmClassDatasetsRef:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("some_self"):
		me.some_self = SdtmClassDatasetsRef.bzz_denormalize_single(from_dict["some_self"])
	...
	if from_dict.has("priorVersion"):
		me.priorVersion = SdtmClassDatasetsRef.bzz_denormalize_single(from_dict["priorVersion"])
