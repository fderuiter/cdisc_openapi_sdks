...
# Required: False
# Example: Clinical Data Acquisition Standards Harmonization Model Version 1.1
# isArray: false
...
# Required: False
# isArray: false
@export var Underscorelinks: CdashProductLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = CdashProductLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	if from_dict.has("classes"):
		me.classes = CdashClass.bzz_denormalize_multiple(from_dict["classes"])
	if from_dict.has("domains"):
		me.domains = CdashDomain.bzz_denormalize_multiple(from_dict["domains"])
	return me
