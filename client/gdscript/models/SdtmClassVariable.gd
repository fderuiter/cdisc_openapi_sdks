...
# Required: False
# Example: Collection date and time of an observation.
# isArray: false
...
# Required: False
# isArray: false
@export var Underscorelinks: SdtmClassVariableLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = SdtmClassVariableLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
