extends Resource
class_name CdashProductClasses
...
# Required: False
# isArray: false
@export var Underscorelinks: CdashProductClassesLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = CdashProductClassesLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
