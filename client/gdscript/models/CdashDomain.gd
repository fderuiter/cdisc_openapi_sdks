...
# Required: False
# isArray: false
@export var Underscorelinks: CdashDomainLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = CdashDomainLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	if from_dict.has("fields"):
		me.fields = CdashDomainField.bzz_denormalize_multiple(from_dict["fields"])
	return me
