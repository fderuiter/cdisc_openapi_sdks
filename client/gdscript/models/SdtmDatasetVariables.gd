extends Resource
class_name SdtmDatasetVariables
...
# Required: False
# isArray: false
@export var Underscorelinks: SdtmDatasetVariablesLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = SdtmDatasetVariablesLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
