...
# Required: False
# Example: What was the date of the vital signs measurement?
# isArray: false
...
# Required: False
# Example: The date of measurement can be determined from a collected date of visit (VISDAT) and in such cases a separate measurement date field is not required.
# isArray: false
...
# Required: False
# isArray: false
@export var Underscorelinks: CdashigDomainFieldLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = CdashigDomainFieldLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
