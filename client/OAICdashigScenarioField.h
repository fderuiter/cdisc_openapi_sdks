...
/*
 * OAICdashigScenarioField.h
 *
 * 
 */

#ifndef OAICdashigScenarioField_H
#define OAICdashigScenarioField_H
...
class OAICdashigScenarioField : public OAIObject {
public:
    OAICdashigScenarioField();
    OAICdashigScenarioField(QString json);
    ~OAICdashigScenarioField() override;
    ...
    QString getCompletionInstructions() const;
    void setCompletionInstructions(const QString &completion_instructions);
    bool is_completion_instructions_Set() const;
    bool is_completion_instructions_Valid() const;
    ...
    OAICdashigScenarioFieldLinks getLinks() const;
    void setLinks(const OAICdashigScenarioFieldLinks &_links);
...
private:
    ...
    QString m_completion_instructions;
    bool m_completion_instructions_isSet;
    bool m_completion_instructions_isValid;
    ...
    OAICdashigScenarioFieldLinks m__links;
    bool m__links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICdashigScenarioField)

#endif // OAICdashigScenarioField_H
