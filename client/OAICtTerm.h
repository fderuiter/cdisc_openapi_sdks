...
class OAICtTerm : public OAIObject {
public:
    OAICtTerm();
    OAICtTerm(QString json);
    ~OAICtTerm() override;
    ...
    OAICtTermLinks getLinks() const;
    void setLinks(const OAICtTermLinks &_links);
...
Q_DECLARE_METATYPE(OpenAPI::OAICtTerm)
