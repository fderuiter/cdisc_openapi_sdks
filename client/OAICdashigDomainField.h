...
/*
 * OAICdashigDomainField.h
 *
 * 
 */

#ifndef OAICdashigDomainField_H
#define OAICdashigDomainField_H
...
class OAICdashigDomainField : public OAIObject {
public:
    OAICdashigDomainField();
    OAICdashigDomainField(QString json);
    ~OAICdashigDomainField() override;
    ...
    OAICdashigDomainFieldLinks getLinks() const;
    void setLinks(const OAICdashigDomainFieldLinks &_links);
...
private:
    ...
    OAICdashigDomainFieldLinks m__links;
    bool m__links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICdashigDomainField)

#endif // OAICdashigDomainField_H
