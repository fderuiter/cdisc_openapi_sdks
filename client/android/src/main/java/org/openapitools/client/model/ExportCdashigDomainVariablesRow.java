...
public class ExportCdashigDomainVariablesRow {
  ...
  public boolean equals(Object o) {
    ...
    return (this.version == null ? exportCdashigDomainVariablesRow.version == null : this.version.equals(exportCdashigDomainVariablesRow.version)) &&
        (this._class == null ? exportCdashigDomainVariablesRow._class == null : this._class.equals(exportCdashigDomainVariablesRow._class)) &&
        (this.domain == null ? exportCdashigDomainVariablesRow.domain == null : this.domain.equals(exportCdashigDomainVariablesRow.domain)) &&
        (this.dataCollectionScenario == null ? exportCdashigDomainVariablesRow.dataCollectionScenario == null : this.dataCollectionScenario.equals(exportCdashigDomainVariablesRow.dataCollectionScenario)) &&
        (this.variableOrder == null ? exportCdashigDomainVariablesRow.variableOrder == null : this.variableOrder.equals(exportCdashigDomainVariablesRow.variableOrder)) &&
        (this.cDASHIGVariable == null ? exportCdashigDomainVariablesRow.cDASHIGVariable == null : this.cDASHIGVariable.equals(exportCdashigDomainVariablesRow.cDASHIGVariable)) &&
        (this.cDASHIGVariableLabel == null ? exportCdashigDomainVariablesRow.cDASHIGVariableLabel == null : this.cDASHIGVariableLabel.equals(exportCdashigDomainVariablesRow.cDASHIGVariableLabel)) &&
        (this.dRAFTCDASHIGDefinition == null ? exportCdashigDomainVariablesRow.dRAFTCDASHIGDefinition == null : this.dRAFTCDASHIGDefinition.equals(exportCdashigDomainVariablesRow.dRAFTCDASHIGDefinition)) &&
        (this.questionText == null ? exportCdashigDomainVariablesRow.questionText == null : this.questionText.equals(exportCdashigDomainVariablesRow.questionText)) &&
        (this.prompt == null ? exportCdashigDomainVariablesRow.prompt == null : this.prompt.equals(exportCdashigDomainVariablesRow.prompt)) &&
        (this.type == null ? exportCdashigDomainVariablesRow.type == null : this.type.equals(exportCdashigDomainVariablesRow.type)) &&
        (this.cDASHIGCore == null ? exportCdashigDomainVariablesRow.cDASHIGCore == null : this.cDASHIGCore.equals(exportCdashigDomainVariablesRow.cDASHIGCore)) &&
        (this.caseReportFormCompletionInstructions == null ? exportCdashigDomainVariablesRow.caseReportFormCompletionInstructions == null : this.caseReportFormCompletionInstructions.equals(exportCdashigDomainVariablesRow.caseReportFormCompletionInstructions)) &&
        (this.sDTMIGTarget == null ? exportCdashigDomainVariablesRow.sDTMIGTarget == null : this.sDTMIGTarget.equals(exportCdashigDomainVariablesRow.sDTMIGTarget)) &&
        (this.mappingInstructions == null ? exportCdashigDomainVariablesRow.mappingInstructions == null : this.mappingInstructions.equals(exportCdashigDomainVariablesRow.mappingInstructions)) &&
        (this.controlledTerminologyCodelistName == null ? exportCdashigDomainVariablesRow.controlledTerminologyCodelistName == null : this.controlledTerminologyCodelistName.equals(exportCdashigDomainVariablesRow.controlledTerminologyCodelistName)) &&
        (this.implementationNotes == null ? exportCdashigDomainVariablesRow.implementationNotes == null : this.implementationNotes.equals(exportCdashigDomainVariablesRow.implementationNotes));
  }
