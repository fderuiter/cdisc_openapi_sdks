...
public class CtCodelist {
  ...
  private CtCodelistLinks links = null;
  @SerializedName("terms")
  private List<CtPackageTerm> terms = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.conceptId == null ? ctCodelist.conceptId == null : this.conceptId.equals(ctCodelist.conceptId)) &&
        (this.extensible == null ? ctCodelist.extensible == null : this.extensible.equals(ctCodelist.extensible)) &&
        (this.name == null ? ctCodelist.name == null : this.name.equals(ctCodelist.name)) &&
        (this.submissionValue == null ? ctCodelist.submissionValue == null : this.submissionValue.equals(ctCodelist.submissionValue)) &&
        (this.definition == null ? ctCodelist.definition == null : this.definition.equals(ctCodelist.definition)) &&
        (this.preferredTerm == null ? ctCodelist.preferredTerm == null : this.preferredTerm.equals(ctCodelist.preferredTerm)) &&
        (this.synonyms == null ? ctCodelist.synonyms == null : this.synonyms.equals(ctCodelist.synonyms)) &&
        (this.links == null ? ctCodelist.links == null : this.links.equals(ctCodelist.links)) &&
        (this.terms == null ? ctCodelist.terms == null : this.terms.equals(ctCodelist.terms));
  }
