...
void CdashDomainFieldRefVersion::validate()
{
    // TODO: implement validation
}

web::json::value CdashDomainFieldRefVersion::toJson() const
{
...
bool CdashDomainFieldRefVersion::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashDomainFieldRefVersion::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashDomainFieldRefVersion::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashDomainFieldRefVersion::getHref() const
{
    return m_Href;
}


void CdashDomainFieldRefVersion::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashDomainFieldRefVersion::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashDomainFieldRefVersion::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashDomainFieldRefVersion::getTitle() const
{
    return m_Title;
}


void CdashDomainFieldRefVersion::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashDomainFieldRefVersion::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashDomainFieldRefVersion::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashDomainFieldRefVersion::getType() const
{
    return m_Type;
}


void CdashDomainFieldRefVersion::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashDomainFieldRefVersion::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashDomainFieldRefVersion::unsetType()
{
    m_TypeIsSet = false;
}
