...
void CdashigDomainFieldRefVersion::validate()
{
    // TODO: implement validation
}

web::json::value CdashigDomainFieldRefVersion::toJson() const
{
...
bool CdashigDomainFieldRefVersion::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigDomainFieldRefVersion::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigDomainFieldRefVersion::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigDomainFieldRefVersion::getHref() const
{
    return m_Href;
}


void CdashigDomainFieldRefVersion::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigDomainFieldRefVersion::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigDomainFieldRefVersion::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigDomainFieldRefVersion::getTitle() const
{
    return m_Title;
}


void CdashigDomainFieldRefVersion::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigDomainFieldRefVersion::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigDomainFieldRefVersion::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigDomainFieldRefVersion::getType() const
{
    return m_Type;
}


void CdashigDomainFieldRefVersion::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigDomainFieldRefVersion::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigDomainFieldRefVersion::unsetType()
{
    m_TypeIsSet = false;
}
