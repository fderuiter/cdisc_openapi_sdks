...
#include "CppRestOpenAPIClient/model/CdashigProductScenariosRef.h"
...
void CdashigProductScenariosRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashigProductScenariosRef::toJson() const
{
...
bool CdashigProductScenariosRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigProductScenariosRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigProductScenariosRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigProductScenariosRef::getHref() const
{
    return m_Href;
}


void CdashigProductScenariosRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigProductScenariosRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigProductScenariosRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigProductScenariosRef::getTitle() const
{
    return m_Title;
}


void CdashigProductScenariosRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigProductScenariosRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigProductScenariosRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigProductScenariosRef::getType() const
{
    return m_Type;
}


void CdashigProductScenariosRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigProductScenariosRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigProductScenariosRef::unsetType()
{
    m_TypeIsSet = false;
}
