...
void CtPackageRefElement::validate()
{
    // TODO: implement validation
}

web::json::value CtPackageRefElement::toJson() const
{
...
bool CtPackageRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CtPackageRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CtPackageRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CtPackageRefElement::getHref() const
{
    return m_Href;
}


void CtPackageRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CtPackageRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CtPackageRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CtPackageRefElement::getTitle() const
{
    return m_Title;
}


void CtPackageRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CtPackageRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void CtPackageRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CtPackageRefElement::getType() const
{
    return m_Type;
}


void CtPackageRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CtPackageRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void CtPackageRefElement::unsetType()
{
    m_TypeIsSet = false;
}
