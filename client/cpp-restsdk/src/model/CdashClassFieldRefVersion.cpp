...
#include "CppRestOpenAPIClient/model/CdashClassFieldRefVersion.h"
...
void CdashClassFieldRefVersion::validate()
{
    // TODO: implement validation
}

web::json::value CdashClassFieldRefVersion::toJson() const
{
...
bool CdashClassFieldRefVersion::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashClassFieldRefVersion::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashClassFieldRefVersion::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashClassFieldRefVersion::getHref() const
{
    return m_Href;
}


void CdashClassFieldRefVersion::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashClassFieldRefVersion::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashClassFieldRefVersion::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashClassFieldRefVersion::getTitle() const
{
    return m_Title;
}


void CdashClassFieldRefVersion::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashClassFieldRefVersion::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashClassFieldRefVersion::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashClassFieldRefVersion::getType() const
{
    return m_Type;
}


void CdashClassFieldRefVersion::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashClassFieldRefVersion::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashClassFieldRefVersion::unsetType()
{
    m_TypeIsSet = false;
}
