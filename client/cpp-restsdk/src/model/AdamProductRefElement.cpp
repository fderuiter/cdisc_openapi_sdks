...
void AdamProductRefElement::validate()
{
    // TODO: implement validation
}

web::json::value AdamProductRefElement::toJson() const
{
...
bool AdamProductRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AdamProductRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AdamProductRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AdamProductRefElement::getHref() const
{
    return m_Href;
}


void AdamProductRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool AdamProductRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void AdamProductRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t AdamProductRefElement::getTitle() const
{
    return m_Title;
}


void AdamProductRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool AdamProductRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void AdamProductRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t AdamProductRefElement::getType() const
{
    return m_Type;
}


void AdamProductRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool AdamProductRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void AdamProductRefElement::unsetType()
{
    m_TypeIsSet = false;
}
