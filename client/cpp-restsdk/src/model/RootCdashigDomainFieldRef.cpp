...
void RootCdashigDomainFieldRef::validate()
{
    // TODO: implement validation
}

web::json::value RootCdashigDomainFieldRef::toJson() const
{
...
bool RootCdashigDomainFieldRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RootCdashigDomainFieldRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RootCdashigDomainFieldRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t RootCdashigDomainFieldRef::getHref() const
{
    return m_Href;
}


void RootCdashigDomainFieldRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool RootCdashigDomainFieldRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void RootCdashigDomainFieldRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t RootCdashigDomainFieldRef::getTitle() const
{
    return m_Title;
}


void RootCdashigDomainFieldRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool RootCdashigDomainFieldRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void RootCdashigDomainFieldRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t RootCdashigDomainFieldRef::getType() const
{
    return m_Type;
}


void RootCdashigDomainFieldRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool RootCdashigDomainFieldRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void RootCdashigDomainFieldRef::unsetType()
{
    m_TypeIsSet = false;
}
