...
void SdtmigClass::validate()
{
    // TODO: implement validation
}

web::json::value SdtmigClass::toJson() const
{
...
bool SdtmigClass::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SdtmigClassLinks> refVal_setLinks;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("datasets"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SdtmigDataset>> refVal_setDatasets;
...
void SdtmigClass::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmigClass::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmigClass::getOrdinal() const
{
    return m_Ordinal;
}


void SdtmigClass::setOrdinal(const utility::string_t& value)
{
    m_Ordinal = value;
    m_OrdinalIsSet = true;
}

bool SdtmigClass::ordinalIsSet() const
{
    return m_OrdinalIsSet;
}

void SdtmigClass::unsetOrdinal()
{
    m_OrdinalIsSet = false;
}
utility::string_t SdtmigClass::getName() const
{
    return m_Name;
}


void SdtmigClass::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool SdtmigClass::nameIsSet() const
{
    return m_NameIsSet;
}

void SdtmigClass::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t SdtmigClass::getLabel() const
{
    return m_Label;
}


void SdtmigClass::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool SdtmigClass::labelIsSet() const
{
    return m_LabelIsSet;
}

void SdtmigClass::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t SdtmigClass::getDescription() const
{
    return m_Description;
}


void SdtmigClass::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool SdtmigClass::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void SdtmigClass::unsetDescription()
{
    m_DescriptionIsSet = false;
}
std::shared_ptr<SdtmigClassLinks> SdtmigClass::getLinks() const
{
    return m__links;
}


void SdtmigClass::setLinks(const std::shared_ptr<SdtmigClassLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool SdtmigClass::linksIsSet() const
{
    return m__linksIsSet;
}

void SdtmigClass::unset_links()
{
    m__linksIsSet = false;
}
std::vector<std::shared_ptr<SdtmigDataset>> SdtmigClass::getDatasets() const
{
    return m_Datasets;
}


void SdtmigClass::setDatasets(const std::vector<std::shared_ptr<SdtmigDataset>>& value)
{
    m_Datasets = value;
    m_DatasetsIsSet = true;
}

bool SdtmigClass::datasetsIsSet() const
{
    return m_DatasetsIsSet;
}

void SdtmigClass::unsetDatasets()
{
    m_DatasetsIsSet = false;
}
