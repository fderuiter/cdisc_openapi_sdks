...
#include "CppRestOpenAPIClient/model/SdtmClassDatasetsLinks.h"
...
void SdtmClassDatasetsLinks::validate()
{
    // TODO: implement validation
}

web::json::value SdtmClassDatasetsLinks::toJson() const
{
...
bool SdtmClassDatasetsLinks::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<SdtmClassDatasetsRef> refVal_setSelf;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("priorVersion"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SdtmClassDatasetsRef> refVal_setPriorVersion;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("datasets"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SdtmDatasetRefElement>> refVal_setDatasets;
...
void SdtmClassDatasetsLinks::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmClassDatasetsLinks::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SdtmClassDatasetsRef> SdtmClassDatasetsLinks::getSelf() const
{
    return m_Self;
}


void SdtmClassDatasetsLinks::setSelf(const std::shared_ptr<SdtmClassDatasetsRef>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool SdtmClassDatasetsLinks::selfIsSet() const
{
    return m_SelfIsSet;
}

void SdtmClassDatasetsLinks::unsetSelf()
{
    m_SelfIsSet = false;
}
std::shared_ptr<SdtmProductRef> SdtmClassDatasetsLinks::getParentProduct() const
{
    return m_ParentProduct;
}


void SdtmClassDatasetsLinks::setParentProduct(const std::shared_ptr<SdtmProductRef>& value)
{
    m_ParentProduct = value;
    m_ParentProductIsSet = true;
}

bool SdtmClassDatasetsLinks::parentProductIsSet() const
{
    return m_ParentProductIsSet;
}

void SdtmClassDatasetsLinks::unsetParentProduct()
{
    m_ParentProductIsSet = false;
}
std::shared_ptr<SdtmClassDatasetsRef> SdtmClassDatasetsLinks::getPriorVersion() const
{
    return m_PriorVersion;
}


void SdtmClassDatasetsLinks::setPriorVersion(const std::shared_ptr<SdtmClassDatasetsRef>& value)
{
    m_PriorVersion = value;
    m_PriorVersionIsSet = true;
}

bool SdtmClassDatasetsLinks::priorVersionIsSet() const
{
    return m_PriorVersionIsSet;
}

void SdtmClassDatasetsLinks::unsetPriorVersion()
{
    m_PriorVersionIsSet = false;
}
std::vector<std::shared_ptr<SdtmDatasetRefElement>> SdtmClassDatasetsLinks::getDatasets() const
{
    return m_Datasets;
}


void SdtmClassDatasetsLinks::setDatasets(const std::vector<std::shared_ptr<SdtmDatasetRefElement>>& value)
{
    m_Datasets = value;
    m_DatasetsIsSet = true;
}

bool SdtmClassDatasetsLinks::datasetsIsSet() const
{
    return m_DatasetsIsSet;
}

void SdtmClassDatasetsLinks::unsetDatasets()
{
    m_DatasetsIsSet = false;
}
