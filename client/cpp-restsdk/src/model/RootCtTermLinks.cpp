...
void RootCtTermLinks::validate()
{
    // TODO: implement validation
}

web::json::value RootCtTermLinks::toJson() const
{
...
bool RootCtTermLinks::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<RootCtTermRef> refVal_setSelf;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("versions"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CtTermRefVersion>> refVal_setVersions;
...
void RootCtTermLinks::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RootCtTermLinks::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<RootCtTermRef> RootCtTermLinks::getSelf() const
{
    return m_Self;
}


void RootCtTermLinks::setSelf(const std::shared_ptr<RootCtTermRef>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool RootCtTermLinks::selfIsSet() const
{
    return m_SelfIsSet;
}

void RootCtTermLinks::unsetSelf()
{
    m_SelfIsSet = false;
}
std::vector<std::shared_ptr<CtTermRefVersion>> RootCtTermLinks::getVersions() const
{
    return m_Versions;
}


void RootCtTermLinks::setVersions(const std::vector<std::shared_ptr<CtTermRefVersion>>& value)
{
    m_Versions = value;
    m_VersionsIsSet = true;
}

bool RootCtTermLinks::versionsIsSet() const
{
    return m_VersionsIsSet;
}

void RootCtTermLinks::unsetVersions()
{
    m_VersionsIsSet = false;
}
