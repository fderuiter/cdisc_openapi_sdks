...
void SdtmigDatasetVariableRefVersion::validate()
{
    // TODO: implement validation
}

web::json::value SdtmigDatasetVariableRefVersion::toJson() const
{
...
bool SdtmigDatasetVariableRefVersion::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmigDatasetVariableRefVersion::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmigDatasetVariableRefVersion::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmigDatasetVariableRefVersion::getHref() const
{
    return m_Href;
}


void SdtmigDatasetVariableRefVersion::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmigDatasetVariableRefVersion::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmigDatasetVariableRefVersion::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmigDatasetVariableRefVersion::getTitle() const
{
    return m_Title;
}


void SdtmigDatasetVariableRefVersion::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmigDatasetVariableRefVersion::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmigDatasetVariableRefVersion::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmigDatasetVariableRefVersion::getType() const
{
    return m_Type;
}


void SdtmigDatasetVariableRefVersion::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmigDatasetVariableRefVersion::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmigDatasetVariableRefVersion::unsetType()
{
    m_TypeIsSet = false;
}
