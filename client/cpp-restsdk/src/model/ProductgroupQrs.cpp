...
void ProductgroupQrs::validate()
{
    // TODO: implement validation
}

web::json::value ProductgroupQrs::toJson() const
{
...
bool ProductgroupQrs::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        {
            std::shared_ptr<ProductgroupQrsLinks> refVal_setLinks;
...
void ProductgroupQrs::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ProductgroupQrs::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<ProductgroupQrsLinks> ProductgroupQrs::getLinks() const
{
    return m__links;
}


void ProductgroupQrs::setLinks(const std::shared_ptr<ProductgroupQrsLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool ProductgroupQrs::linksIsSet() const
{
    return m__linksIsSet;
}

void ProductgroupQrs::unset_links()
{
    m__linksIsSet = false;
}
