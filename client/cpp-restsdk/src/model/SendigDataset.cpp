...
void SendigDataset::validate()
{
    // TODO: implement validation
}

web::json::value SendigDataset::toJson() const
{
...
bool SendigDataset::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SendigDatasetLinks> refVal_setLinks;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("datasetVariables"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SendigDatasetVariable>> refVal_setDatasetVariables;
...
void SendigDataset::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendigDataset::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SendigDataset::getOrdinal() const
{
    return m_Ordinal;
}


void SendigDataset::setOrdinal(const utility::string_t& value)
{
    m_Ordinal = value;
    m_OrdinalIsSet = true;
}

bool SendigDataset::ordinalIsSet() const
{
    return m_OrdinalIsSet;
}

void SendigDataset::unsetOrdinal()
{
    m_OrdinalIsSet = false;
}
utility::string_t SendigDataset::getName() const
{
    return m_Name;
}


void SendigDataset::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool SendigDataset::nameIsSet() const
{
    return m_NameIsSet;
}

void SendigDataset::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t SendigDataset::getLabel() const
{
    return m_Label;
}


void SendigDataset::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool SendigDataset::labelIsSet() const
{
    return m_LabelIsSet;
}

void SendigDataset::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t SendigDataset::getDescription() const
{
    return m_Description;
}


void SendigDataset::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool SendigDataset::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void SendigDataset::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t SendigDataset::getDatasetStructure() const
{
    return m_DatasetStructure;
}


void SendigDataset::setDatasetStructure(const utility::string_t& value)
{
    m_DatasetStructure = value;
    m_DatasetStructureIsSet = true;
}

bool SendigDataset::datasetStructureIsSet() const
{
    return m_DatasetStructureIsSet;
}

void SendigDataset::unsetDatasetStructure()
{
    m_DatasetStructureIsSet = false;
}
std::shared_ptr<SendigDatasetLinks> SendigDataset::getLinks() const
{
    return m__links;
}


void SendigDataset::setLinks(const std::shared_ptr<SendigDatasetLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool SendigDataset::linksIsSet() const
{
    return m__linksIsSet;
}

void SendigDataset::unset_links()
{
    m__linksIsSet = false;
}
std::vector<std::shared_ptr<SendigDatasetVariable>> SendigDataset::getDatasetVariables() const
{
    return m_DatasetVariables;
}


void SendigDataset::setDatasetVariables(const std::vector<std::shared_ptr<SendigDatasetVariable>>& value)
{
    m_DatasetVariables = value;
    m_DatasetVariablesIsSet = true;
}

bool SendigDataset::datasetVariablesIsSet() const
{
    return m_DatasetVariablesIsSet;
}

void SendigDataset::unsetDatasetVariables()
{
    m_DatasetVariablesIsSet = false;
}
