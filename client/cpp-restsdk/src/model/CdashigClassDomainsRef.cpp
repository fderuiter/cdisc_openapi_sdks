...
void CdashigClassDomainsRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashigClassDomainsRef::toJson() const
{
...
bool CdashigClassDomainsRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigClassDomainsRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigClassDomainsRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigClassDomainsRef::getHref() const
{
    return m_Href;
}


void CdashigClassDomainsRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigClassDomainsRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigClassDomainsRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigClassDomainsRef::getTitle() const
{
    return m_Title;
}


void CdashigClassDomainsRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigClassDomainsRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigClassDomainsRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigClassDomainsRef::getType() const
{
    return m_Type;
}


void CdashigClassDomainsRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigClassDomainsRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigClassDomainsRef::unsetType()
{
    m_TypeIsSet = false;
}
