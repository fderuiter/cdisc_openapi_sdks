...
void SendigClassesRef::validate()
{
    // TODO: implement validation
}

web::json::value SendigClassesRef::toJson() const
{
...
bool SendigClassesRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SendigClassesRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendigClassesRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SendigClassesRef::getHref() const
{
    return m_Href;
}


void SendigClassesRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SendigClassesRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SendigClassesRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SendigClassesRef::getTitle() const
{
    return m_Title;
}


void SendigClassesRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SendigClassesRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SendigClassesRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SendigClassesRef::getType() const
{
    return m_Type;
}


void SendigClassesRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SendigClassesRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SendigClassesRef::unsetType()
{
    m_TypeIsSet = false;
}
