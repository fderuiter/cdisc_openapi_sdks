...
void SdtmDatasetVariablesRef::validate()
{
    // TODO: implement validation
}

web::json::value SdtmDatasetVariablesRef::toJson() const
{
...
bool SdtmDatasetVariablesRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmDatasetVariablesRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmDatasetVariablesRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmDatasetVariablesRef::getHref() const
{
    return m_Href;
}


void SdtmDatasetVariablesRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmDatasetVariablesRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmDatasetVariablesRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmDatasetVariablesRef::getTitle() const
{
    return m_Title;
}


void SdtmDatasetVariablesRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmDatasetVariablesRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmDatasetVariablesRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmDatasetVariablesRef::getType() const
{
    return m_Type;
}


void SdtmDatasetVariablesRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmDatasetVariablesRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmDatasetVariablesRef::unsetType()
{
    m_TypeIsSet = false;
}
