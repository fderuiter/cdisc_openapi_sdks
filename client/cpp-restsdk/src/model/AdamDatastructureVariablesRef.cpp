...
void AdamDatastructureVariablesRef::validate()
{
    // TODO: implement validation
}

web::json::value AdamDatastructureVariablesRef::toJson() const
{
...
bool AdamDatastructureVariablesRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AdamDatastructureVariablesRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AdamDatastructureVariablesRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AdamDatastructureVariablesRef::getHref() const
{
    return m_Href;
}


void AdamDatastructureVariablesRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool AdamDatastructureVariablesRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void AdamDatastructureVariablesRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t AdamDatastructureVariablesRef::getTitle() const
{
    return m_Title;
}


void AdamDatastructureVariablesRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool AdamDatastructureVariablesRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void AdamDatastructureVariablesRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t AdamDatastructureVariablesRef::getType() const
{
    return m_Type;
}


void AdamDatastructureVariablesRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool AdamDatastructureVariablesRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void AdamDatastructureVariablesRef::unsetType()
{
    m_TypeIsSet = false;
}
