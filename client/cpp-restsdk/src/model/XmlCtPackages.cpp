...
void XmlCtPackages::validate()
{
    // TODO: implement validation
}

web::json::value XmlCtPackages::toJson() const
{
...
bool XmlCtPackages::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<CtPackages> refVal_setSelf;
...
void XmlCtPackages::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlCtPackages::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<CtPackages> XmlCtPackages::getSelf() const
{
    return m_Self;
}


void XmlCtPackages::setSelf(const std::shared_ptr<CtPackages>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlCtPackages::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlCtPackages::unsetSelf()
{
    m_SelfIsSet = false;
}
