...
void SdtmProductRef::validate()
{
    // TODO: implement validation
}

web::json::value SdtmProductRef::toJson() const
{
...
bool SdtmProductRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmProductRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmProductRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmProductRef::getHref() const
{
    return m_Href;
}


void SdtmProductRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmProductRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmProductRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmProductRef::getTitle() const
{
    return m_Title;
}


void SdtmProductRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmProductRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmProductRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmProductRef::getType() const
{
    return m_Type;
}


void SdtmProductRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmProductRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmProductRef::unsetType()
{
    m_TypeIsSet = false;
}
