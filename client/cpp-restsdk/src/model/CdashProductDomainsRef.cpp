...
void CdashProductDomainsRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashProductDomainsRef::toJson() const
{
...
bool CdashProductDomainsRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashProductDomainsRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashProductDomainsRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashProductDomainsRef::getHref() const
{
    return m_Href;
}


void CdashProductDomainsRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashProductDomainsRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashProductDomainsRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashProductDomainsRef::getTitle() const
{
    return m_Title;
}


void CdashProductDomainsRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashProductDomainsRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashProductDomainsRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashProductDomainsRef::getType() const
{
    return m_Type;
}


void CdashProductDomainsRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashProductDomainsRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashProductDomainsRef::unsetType()
{
    m_TypeIsSet = false;
}
