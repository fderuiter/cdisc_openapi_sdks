...
void SdtmDatasetsLinks::validate()
{
    // TODO: implement validation
}

web::json::value SdtmDatasetsLinks::toJson() const
{
...
bool SdtmDatasetsLinks::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<SdtmDatasetsRef> refVal_setSelf;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("priorVersion"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SdtmDatasetsRef> refVal_setPriorVersion;
...
void SdtmDatasetsLinks::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmDatasetsLinks::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SdtmDatasetsRef> SdtmDatasetsLinks::getSelf() const
{
    return m_Self;
}


void SdtmDatasetsLinks::setSelf(const std::shared_ptr<SdtmDatasetsRef>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool SdtmDatasetsLinks::selfIsSet() const
{
    return m_SelfIsSet;
}

void SdtmDatasetsLinks::unsetSelf()
{
    m_SelfIsSet = false;
}
std::shared_ptr<SdtmProductRef> SdtmDatasetsLinks::getParentProduct() const
{
    return m_ParentProduct;
}


void SdtmDatasetsLinks::setParentProduct(const std::shared_ptr<SdtmProductRef>& value)
{
    m_ParentProduct = value;
    m_ParentProductIsSet = true;
}

bool SdtmDatasetsLinks::parentProductIsSet() const
{
    return m_ParentProductIsSet;
}

void SdtmDatasetsLinks::unsetParentProduct()
{
    m_ParentProductIsSet = false;
}
std::shared_ptr<SdtmDatasetsRef> SdtmDatasetsLinks::getPriorVersion() const
{
    return m_PriorVersion;
}


void SdtmDatasetsLinks::setPriorVersion(const std::shared_ptr<SdtmDatasetsRef>& value)
{
    m_PriorVersion = value;
    m_PriorVersionIsSet = true;
}

bool SdtmDatasetsLinks::priorVersionIsSet() const
{
    return m_PriorVersionIsSet;
}

void SdtmDatasetsLinks::unsetPriorVersion()
{
    m_PriorVersionIsSet = false;
}
std::vector<std::shared_ptr<SdtmDatasetRefElement>> SdtmDatasetsLinks::getDatasets() const
{
    return m_Datasets;
}


void SdtmDatasetsLinks::setDatasets(const std::vector<std::shared_ptr<SdtmDatasetRefElement>>& value)
{
    m_Datasets = value;
    m_DatasetsIsSet = true;
}

bool SdtmDatasetsLinks::datasetsIsSet() const
{
    return m_DatasetsIsSet;
}

void SdtmDatasetsLinks::unsetDatasets()
{
    m_DatasetsIsSet = false;
}
