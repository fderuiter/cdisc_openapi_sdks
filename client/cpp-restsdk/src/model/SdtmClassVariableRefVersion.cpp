...
void SdtmClassVariableRefVersion::validate()
{
    // TODO: implement validation
}

web::json::value SdtmClassVariableRefVersion::toJson() const
{
...
bool SdtmClassVariableRefVersion::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmClassVariableRefVersion::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmClassVariableRefVersion::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmClassVariableRefVersion::getHref() const
{
    return m_Href;
}


void SdtmClassVariableRefVersion::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmClassVariableRefVersion::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmClassVariableRefVersion::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmClassVariableRefVersion::getTitle() const
{
    return m_Title;
}


void SdtmClassVariableRefVersion::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmClassVariableRefVersion::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmClassVariableRefVersion::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmClassVariableRefVersion::getType() const
{
    return m_Type;
}


void SdtmClassVariableRefVersion::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmClassVariableRefVersion::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmClassVariableRefVersion::unsetType()
{
    m_TypeIsSet = false;
}
