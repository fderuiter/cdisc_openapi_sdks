...
void CdashigScenarioFieldRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashigScenarioFieldRef::toJson() const
{
...
bool CdashigScenarioFieldRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigScenarioFieldRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigScenarioFieldRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigScenarioFieldRef::getHref() const
{
    return m_Href;
}


void CdashigScenarioFieldRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigScenarioFieldRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigScenarioFieldRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigScenarioFieldRef::getTitle() const
{
    return m_Title;
}


void CdashigScenarioFieldRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigScenarioFieldRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigScenarioFieldRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigScenarioFieldRef::getType() const
{
    return m_Type;
}


void CdashigScenarioFieldRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigScenarioFieldRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigScenarioFieldRef::unsetType()
{
    m_TypeIsSet = false;
}
