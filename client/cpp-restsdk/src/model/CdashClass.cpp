...
void CdashClass::validate()
{
    // TODO: implement validation
}

web::json::value CdashClass::toJson() const
{
    ...
    if(m_CdashModelFieldsIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("cdashModelFields"))] = ModelBase::toJson(m_CdashModelFields);
    }

    return val;
}

bool CdashClass::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CdashClassLinks> refVal_setLinks;
            ok &= ModelBase::fromJson(fieldValue, refVal_setLinks);
            setLinks(refVal_setLinks);
            
        }
    }
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("cdashModelFields"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("cdashModelFields")));
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CdashClassField>> refVal_setCdashModelFields;
            ok &= ModelBase::fromJson(fieldValue, refVal_setCdashModelFields);
            setCdashModelFields(refVal_setCdashModelFields);
...
void CdashClass::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_CdashModelFieldsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("cdashModelFields")), m_CdashModelFields));
    }
}

bool CdashClass::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("cdashModelFields"))))
    {
        std::vector<std::shared_ptr<CdashClassField>> refVal_setCdashModelFields;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("cdashModelFields"))), refVal_setCdashModelFields );
        setCdashModelFields(refVal_setCdashModelFields);
    }
    return ok;
}
...
utility::string_t CdashClass::getOrdinal() const
{
    return m_Ordinal;
}


void CdashClass::setOrdinal(const utility::string_t& value)
{
    m_Ordinal = value;
    m_OrdinalIsSet = true;
}

bool CdashClass::ordinalIsSet() const
{
    return m_OrdinalIsSet;
}

void CdashClass::unsetOrdinal()
{
    m_OrdinalIsSet = false;
}
utility::string_t CdashClass::getName() const
{
    return m_Name;
}


void CdashClass::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool CdashClass::nameIsSet() const
{
    return m_NameIsSet;
}

void CdashClass::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t CdashClass::getLabel() const
{
    return m_Label;
}


void CdashClass::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool CdashClass::labelIsSet() const
{
    return m_LabelIsSet;
}

void CdashClass::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t CdashClass::getDescription() const
{
    return m_Description;
}


void CdashClass::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool CdashClass::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void CdashClass::unsetDescription()
{
    m_DescriptionIsSet = false;
}
std::shared_ptr<CdashClassLinks> CdashClass::getLinks() const
{
    return m__links;
}


void CdashClass::setLinks(const std::shared_ptr<CdashClassLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool CdashClass::linksIsSet() const
{
    return m__linksIsSet;
}

void CdashClass::unset_links()
{
    m__linksIsSet = false;
}
std::vector<std::shared_ptr<CdashClassField>> CdashClass::getCdashModelFields() const
{
    return m_CdashModelFields;
}


void CdashClass::setCdashModelFields(const std::vector<std::shared_ptr<CdashClassField>>& value)
{
    m_CdashModelFields = value;
    m_CdashModelFieldsIsSet = true;
}

bool CdashClass::cdashModelFieldsIsSet() const
{
    return m_CdashModelFieldsIsSet;
}

void CdashClass::unsetCdashModelFields()
{
    m_CdashModelFieldsIsSet = false;
}
