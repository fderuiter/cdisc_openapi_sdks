...
void CdashigProductScenarios::validate()
{
    // TODO: implement validation
}

web::json::value CdashigProductScenarios::toJson() const
{
...
bool CdashigProductScenarios::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CdashigProductScenariosLinks> refVal_setLinks;
...
void CdashigProductScenarios::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigProductScenarios::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigProductScenarios::getName() const
{
    return m_Name;
}


void CdashigProductScenarios::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool CdashigProductScenarios::nameIsSet() const
{
    return m_NameIsSet;
}

void CdashigProductScenarios::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t CdashigProductScenarios::getLabel() const
{
    return m_Label;
}


void CdashigProductScenarios::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool CdashigProductScenarios::labelIsSet() const
{
    return m_LabelIsSet;
}

void CdashigProductScenarios::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t CdashigProductScenarios::getDescription() const
{
    return m_Description;
}


void CdashigProductScenarios::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool CdashigProductScenarios::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void CdashigProductScenarios::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t CdashigProductScenarios::getSource() const
{
    return m_Source;
}


void CdashigProductScenarios::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool CdashigProductScenarios::sourceIsSet() const
{
    return m_SourceIsSet;
}

void CdashigProductScenarios::unsetSource()
{
    m_SourceIsSet = false;
}
utility::string_t CdashigProductScenarios::getEffectiveDate() const
{
    return m_EffectiveDate;
}


void CdashigProductScenarios::setEffectiveDate(const utility::string_t& value)
{
    m_EffectiveDate = value;
    m_EffectiveDateIsSet = true;
}

bool CdashigProductScenarios::effectiveDateIsSet() const
{
    return m_EffectiveDateIsSet;
}

void CdashigProductScenarios::unsetEffectiveDate()
{
    m_EffectiveDateIsSet = false;
}
utility::string_t CdashigProductScenarios::getRegistrationStatus() const
{
    return m_RegistrationStatus;
}


void CdashigProductScenarios::setRegistrationStatus(const utility::string_t& value)
{
    m_RegistrationStatus = value;
    m_RegistrationStatusIsSet = true;
}

bool CdashigProductScenarios::registrationStatusIsSet() const
{
    return m_RegistrationStatusIsSet;
}

void CdashigProductScenarios::unsetRegistrationStatus()
{
    m_RegistrationStatusIsSet = false;
}
utility::string_t CdashigProductScenarios::getVersion() const
{
    return m_Version;
}


void CdashigProductScenarios::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool CdashigProductScenarios::versionIsSet() const
{
    return m_VersionIsSet;
}

void CdashigProductScenarios::unsetVersion()
{
    m_VersionIsSet = false;
}
std::shared_ptr<CdashigProductScenariosLinks> CdashigProductScenarios::getLinks() const
{
    return m__links;
}


void CdashigProductScenarios::setLinks(const std::shared_ptr<CdashigProductScenariosLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool CdashigProductScenarios::linksIsSet() const
{
    return m__linksIsSet;
}

void CdashigProductScenarios::unset_links()
{
    m__linksIsSet = false;
}
