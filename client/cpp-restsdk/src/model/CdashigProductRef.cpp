...
void CdashigProductRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashigProductRef::toJson() const
{
...
bool CdashigProductRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigProductRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigProductRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigProductRef::getHref() const
{
    return m_Href;
}


void CdashigProductRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigProductRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigProductRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigProductRef::getTitle() const
{
    return m_Title;
}


void CdashigProductRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigProductRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigProductRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigProductRef::getType() const
{
    return m_Type;
}


void CdashigProductRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigProductRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigProductRef::unsetType()
{
    m_TypeIsSet = false;
}
