...
void CdashDomainFieldRefElement::validate()
{
    // TODO: implement validation
}

web::json::value CdashDomainFieldRefElement::toJson() const
{
...
bool CdashDomainFieldRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashDomainFieldRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashDomainFieldRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashDomainFieldRefElement::getHref() const
{
    return m_Href;
}


void CdashDomainFieldRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashDomainFieldRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashDomainFieldRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashDomainFieldRefElement::getTitle() const
{
    return m_Title;
}


void CdashDomainFieldRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashDomainFieldRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashDomainFieldRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashDomainFieldRefElement::getType() const
{
    return m_Type;
}


void CdashDomainFieldRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashDomainFieldRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashDomainFieldRefElement::unsetType()
{
    m_TypeIsSet = false;
}
