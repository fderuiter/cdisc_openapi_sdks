...
void CdashDomainRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashDomainRef::toJson() const
{
...
bool CdashDomainRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashDomainRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashDomainRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashDomainRef::getHref() const
{
    return m_Href;
}


void CdashDomainRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashDomainRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashDomainRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashDomainRef::getTitle() const
{
    return m_Title;
}


void CdashDomainRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashDomainRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashDomainRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashDomainRef::getType() const
{
    return m_Type;
}


void CdashDomainRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashDomainRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashDomainRef::unsetType()
{
    m_TypeIsSet = false;
}
