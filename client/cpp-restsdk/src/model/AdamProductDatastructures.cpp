...
void AdamProductDatastructures::validate()
{
    // TODO: implement validation
}

web::json::value AdamProductDatastructures::toJson() const
{
...
bool AdamProductDatastructures::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AdamProductDatastructuresLinks> refVal_setLinks;
...
void AdamProductDatastructures::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AdamProductDatastructures::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AdamProductDatastructures::getName() const
{
    return m_Name;
}


void AdamProductDatastructures::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool AdamProductDatastructures::nameIsSet() const
{
    return m_NameIsSet;
}

void AdamProductDatastructures::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t AdamProductDatastructures::getLabel() const
{
    return m_Label;
}


void AdamProductDatastructures::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool AdamProductDatastructures::labelIsSet() const
{
    return m_LabelIsSet;
}

void AdamProductDatastructures::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t AdamProductDatastructures::getDescription() const
{
    return m_Description;
}


void AdamProductDatastructures::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool AdamProductDatastructures::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void AdamProductDatastructures::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t AdamProductDatastructures::getSource() const
{
    return m_Source;
}


void AdamProductDatastructures::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool AdamProductDatastructures::sourceIsSet() const
{
    return m_SourceIsSet;
}

void AdamProductDatastructures::unsetSource()
{
    m_SourceIsSet = false;
}
utility::string_t AdamProductDatastructures::getEffectiveDate() const
{
    return m_EffectiveDate;
}


void AdamProductDatastructures::setEffectiveDate(const utility::string_t& value)
{
    m_EffectiveDate = value;
    m_EffectiveDateIsSet = true;
}

bool AdamProductDatastructures::effectiveDateIsSet() const
{
    return m_EffectiveDateIsSet;
}

void AdamProductDatastructures::unsetEffectiveDate()
{
    m_EffectiveDateIsSet = false;
}
utility::string_t AdamProductDatastructures::getRegistrationStatus() const
{
    return m_RegistrationStatus;
}


void AdamProductDatastructures::setRegistrationStatus(const utility::string_t& value)
{
    m_RegistrationStatus = value;
    m_RegistrationStatusIsSet = true;
}

bool AdamProductDatastructures::registrationStatusIsSet() const
{
    return m_RegistrationStatusIsSet;
}

void AdamProductDatastructures::unsetRegistrationStatus()
{
    m_RegistrationStatusIsSet = false;
}
utility::string_t AdamProductDatastructures::getVersion() const
{
    return m_Version;
}


void AdamProductDatastructures::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool AdamProductDatastructures::versionIsSet() const
{
    return m_VersionIsSet;
}

void AdamProductDatastructures::unsetVersion()
{
    m_VersionIsSet = false;
}
std::shared_ptr<AdamProductDatastructuresLinks> AdamProductDatastructures::getLinks() const
{
    return m__links;
}


void AdamProductDatastructures::setLinks(const std::shared_ptr<AdamProductDatastructuresLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool AdamProductDatastructures::linksIsSet() const
{
    return m__linksIsSet;
}

void AdamProductDatastructures::unset_links()
{
    m__linksIsSet = false;
}
