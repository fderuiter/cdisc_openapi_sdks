...
void SdtmigClassRef::validate()
{
    // TODO: implement validation
}

web::json::value SdtmigClassRef::toJson() const
{
...
bool SdtmigClassRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmigClassRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmigClassRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmigClassRef::getHref() const
{
    return m_Href;
}


void SdtmigClassRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmigClassRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmigClassRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmigClassRef::getTitle() const
{
    return m_Title;
}


void SdtmigClassRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmigClassRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmigClassRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmigClassRef::getType() const
{
    return m_Type;
}


void SdtmigClassRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmigClassRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmigClassRef::unsetType()
{
    m_TypeIsSet = false;
}
