...
void SdtmigDatasetVariablesRef::validate()
{
    // TODO: implement validation
}

web::json::value SdtmigDatasetVariablesRef::toJson() const
{
...
bool SdtmigDatasetVariablesRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmigDatasetVariablesRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmigDatasetVariablesRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmigDatasetVariablesRef::getHref() const
{
    return m_Href;
}


void SdtmigDatasetVariablesRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmigDatasetVariablesRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmigDatasetVariablesRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmigDatasetVariablesRef::getTitle() const
{
    return m_Title;
}


void SdtmigDatasetVariablesRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmigDatasetVariablesRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmigDatasetVariablesRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmigDatasetVariablesRef::getType() const
{
    return m_Type;
}


void SdtmigDatasetVariablesRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmigDatasetVariablesRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmigDatasetVariablesRef::unsetType()
{
    m_TypeIsSet = false;
}
