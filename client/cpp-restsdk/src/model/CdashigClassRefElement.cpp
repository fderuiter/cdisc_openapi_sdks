...
void CdashigClassRefElement::validate()
{
    // TODO: implement validation
}

web::json::value CdashigClassRefElement::toJson() const
{
...
bool CdashigClassRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigClassRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigClassRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigClassRefElement::getHref() const
{
    return m_Href;
}


void CdashigClassRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigClassRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigClassRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigClassRefElement::getTitle() const
{
    return m_Title;
}


void CdashigClassRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigClassRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigClassRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigClassRefElement::getType() const
{
    return m_Type;
}


void CdashigClassRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigClassRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigClassRefElement::unsetType()
{
    m_TypeIsSet = false;
}
