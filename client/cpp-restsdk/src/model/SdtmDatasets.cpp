...
void SdtmDatasets::validate()
{
    // TODO: implement validation
}

web::json::value SdtmDatasets::toJson() const
{
...
bool SdtmDatasets::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SdtmDatasetsLinks> refVal_setLinks;
...
void SdtmDatasets::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmDatasets::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmDatasets::getName() const
{
    return m_Name;
}


void SdtmDatasets::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool SdtmDatasets::nameIsSet() const
{
    return m_NameIsSet;
}

void SdtmDatasets::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t SdtmDatasets::getLabel() const
{
    return m_Label;
}


void SdtmDatasets::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool SdtmDatasets::labelIsSet() const
{
    return m_LabelIsSet;
}

void SdtmDatasets::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t SdtmDatasets::getDescription() const
{
    return m_Description;
}


void SdtmDatasets::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool SdtmDatasets::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void SdtmDatasets::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t SdtmDatasets::getSource() const
{
    return m_Source;
}


void SdtmDatasets::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool SdtmDatasets::sourceIsSet() const
{
    return m_SourceIsSet;
}

void SdtmDatasets::unsetSource()
{
    m_SourceIsSet = false;
}
utility::string_t SdtmDatasets::getEffectiveDate() const
{
    return m_EffectiveDate;
}


void SdtmDatasets::setEffectiveDate(const utility::string_t& value)
{
    m_EffectiveDate = value;
    m_EffectiveDateIsSet = true;
}

bool SdtmDatasets::effectiveDateIsSet() const
{
    return m_EffectiveDateIsSet;
}

void SdtmDatasets::unsetEffectiveDate()
{
    m_EffectiveDateIsSet = false;
}
utility::string_t SdtmDatasets::getRegistrationStatus() const
{
    return m_RegistrationStatus;
}


void SdtmDatasets::setRegistrationStatus(const utility::string_t& value)
{
    m_RegistrationStatus = value;
    m_RegistrationStatusIsSet = true;
}

bool SdtmDatasets::registrationStatusIsSet() const
{
    return m_RegistrationStatusIsSet;
}

void SdtmDatasets::unsetRegistrationStatus()
{
    m_RegistrationStatusIsSet = false;
}
utility::string_t SdtmDatasets::getVersion() const
{
    return m_Version;
}


void SdtmDatasets::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool SdtmDatasets::versionIsSet() const
{
    return m_VersionIsSet;
}

void SdtmDatasets::unsetVersion()
{
    m_VersionIsSet = false;
}
std::shared_ptr<SdtmDatasetsLinks> SdtmDatasets::getLinks() const
{
    return m__links;
}


void SdtmDatasets::setLinks(const std::shared_ptr<SdtmDatasetsLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool SdtmDatasets::linksIsSet() const
{
    return m__linksIsSet;
}

void SdtmDatasets::unset_links()
{
    m__linksIsSet = false;
}
