...
void SendigProduct::validate()
{
    // TODO: implement validation
}

web::json::value SendigProduct::toJson() const
{
...
bool SendigProduct::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SendigProductLinks> refVal_setLinks;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("classes"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SendigClass>> refVal_setClasses;
...
void SendigProduct::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendigProduct::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SendigProduct::getName() const
{
    return m_Name;
}


void SendigProduct::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool SendigProduct::nameIsSet() const
{
    return m_NameIsSet;
}

void SendigProduct::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t SendigProduct::getLabel() const
{
    return m_Label;
}


void SendigProduct::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool SendigProduct::labelIsSet() const
{
    return m_LabelIsSet;
}

void SendigProduct::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t SendigProduct::getDescription() const
{
    return m_Description;
}


void SendigProduct::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool SendigProduct::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void SendigProduct::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t SendigProduct::getSource() const
{
    return m_Source;
}


void SendigProduct::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool SendigProduct::sourceIsSet() const
{
    return m_SourceIsSet;
}

void SendigProduct::unsetSource()
{
    m_SourceIsSet = false;
}
utility::string_t SendigProduct::getEffectiveDate() const
{
    return m_EffectiveDate;
}


void SendigProduct::setEffectiveDate(const utility::string_t& value)
{
    m_EffectiveDate = value;
    m_EffectiveDateIsSet = true;
}

bool SendigProduct::effectiveDateIsSet() const
{
    return m_EffectiveDateIsSet;
}

void SendigProduct::unsetEffectiveDate()
{
    m_EffectiveDateIsSet = false;
}
utility::string_t SendigProduct::getRegistrationStatus() const
{
    return m_RegistrationStatus;
}


void SendigProduct::setRegistrationStatus(const utility::string_t& value)
{
    m_RegistrationStatus = value;
    m_RegistrationStatusIsSet = true;
}

bool SendigProduct::registrationStatusIsSet() const
{
    return m_RegistrationStatusIsSet;
}

void SendigProduct::unsetRegistrationStatus()
{
    m_RegistrationStatusIsSet = false;
}
utility::string_t SendigProduct::getVersion() const
{
    return m_Version;
}


void SendigProduct::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool SendigProduct::versionIsSet() const
{
    return m_VersionIsSet;
}

void SendigProduct::unsetVersion()
{
    m_VersionIsSet = false;
}
std::shared_ptr<SendigProductLinks> SendigProduct::getLinks() const
{
    return m__links;
}


void SendigProduct::setLinks(const std::shared_ptr<SendigProductLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool SendigProduct::linksIsSet() const
{
    return m__linksIsSet;
}

void SendigProduct::unset_links()
{
    m__linksIsSet = false;
}
std::vector<std::shared_ptr<SendigClass>> SendigProduct::getClasses() const
{
    return m_Classes;
}


void SendigProduct::setClasses(const std::vector<std::shared_ptr<SendigClass>>& value)
{
    m_Classes = value;
    m_ClassesIsSet = true;
}

bool SendigProduct::classesIsSet() const
{
    return m_ClassesIsSet;
}

void SendigProduct::unsetClasses()
{
    m_ClassesIsSet = false;
}
