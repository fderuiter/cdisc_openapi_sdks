...
void CdashClassRefElement::validate()
{
    // TODO: implement validation
}

web::json::value CdashClassRefElement::toJson() const
{
...
bool CdashClassRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashClassRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashClassRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashClassRefElement::getHref() const
{
    return m_Href;
}


void CdashClassRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashClassRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashClassRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashClassRefElement::getTitle() const
{
    return m_Title;
}


void CdashClassRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashClassRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashClassRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashClassRefElement::getType() const
{
    return m_Type;
}


void CdashClassRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashClassRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashClassRefElement::unsetType()
{
    m_TypeIsSet = false;
}
