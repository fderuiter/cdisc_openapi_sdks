...
void SdtmDatasetRefElement::validate()
{
    // TODO: implement validation
}

web::json::value SdtmDatasetRefElement::toJson() const
{
...
bool SdtmDatasetRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmDatasetRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmDatasetRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmDatasetRefElement::getHref() const
{
    return m_Href;
}


void SdtmDatasetRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmDatasetRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmDatasetRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmDatasetRefElement::getTitle() const
{
    return m_Title;
}


void SdtmDatasetRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmDatasetRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmDatasetRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmDatasetRefElement::getType() const
{
    return m_Type;
}


void SdtmDatasetRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmDatasetRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmDatasetRefElement::unsetType()
{
    m_TypeIsSet = false;
}
