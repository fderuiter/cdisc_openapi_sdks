...
#include "CppRestOpenAPIClient/model/RootSendigDatasetVariableLinks.h"
...
void RootSendigDatasetVariableLinks::validate()
{
    // TODO: implement validation
}

web::json::value RootSendigDatasetVariableLinks::toJson() const
{
...
bool RootSendigDatasetVariableLinks::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<RootSendigDatasetVariableRef> refVal_setSelf;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("versions"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SendigDatasetVariableRefVersion>> refVal_setVersions;
...
void RootSendigDatasetVariableLinks::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RootSendigDatasetVariableLinks::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<RootSendigDatasetVariableRef> RootSendigDatasetVariableLinks::getSelf() const
{
    return m_Self;
}


void RootSendigDatasetVariableLinks::setSelf(const std::shared_ptr<RootSendigDatasetVariableRef>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool RootSendigDatasetVariableLinks::selfIsSet() const
{
    return m_SelfIsSet;
}

void RootSendigDatasetVariableLinks::unsetSelf()
{
    m_SelfIsSet = false;
}
std::vector<std::shared_ptr<SendigDatasetVariableRefVersion>> RootSendigDatasetVariableLinks::getVersions() const
{
    return m_Versions;
}


void RootSendigDatasetVariableLinks::setVersions(const std::vector<std::shared_ptr<SendigDatasetVariableRefVersion>>& value)
{
    m_Versions = value;
    m_VersionsIsSet = true;
}

bool RootSendigDatasetVariableLinks::versionsIsSet() const
{
    return m_VersionsIsSet;
}

void RootSendigDatasetVariableLinks::unsetVersions()
{
    m_VersionsIsSet = false;
}
