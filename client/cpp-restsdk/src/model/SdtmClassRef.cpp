...
void SdtmClassRef::validate()
{
    // TODO: implement validation
}

web::json::value SdtmClassRef::toJson() const
{
...
bool SdtmClassRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmClassRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmClassRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmClassRef::getHref() const
{
    return m_Href;
}


void SdtmClassRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmClassRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmClassRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmClassRef::getTitle() const
{
    return m_Title;
}


void SdtmClassRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmClassRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmClassRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmClassRef::getType() const
{
    return m_Type;
}


void SdtmClassRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmClassRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmClassRef::unsetType()
{
    m_TypeIsSet = false;
}
