...
void CdashClassFieldRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashClassFieldRef::toJson() const
{
...
bool CdashClassFieldRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashClassFieldRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashClassFieldRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashClassFieldRef::getHref() const
{
    return m_Href;
}


void CdashClassFieldRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashClassFieldRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashClassFieldRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashClassFieldRef::getTitle() const
{
    return m_Title;
}


void CdashClassFieldRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashClassFieldRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashClassFieldRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashClassFieldRef::getType() const
{
    return m_Type;
}


void CdashClassFieldRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashClassFieldRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashClassFieldRef::unsetType()
{
    m_TypeIsSet = false;
}
