...
void XmlSendigClasses::validate()
{
    // TODO: implement validation
}

web::json::value XmlSendigClasses::toJson() const
{
...
bool XmlSendigClasses::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<SendigClasses> refVal_setSelf;
...
void XmlSendigClasses::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlSendigClasses::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SendigClasses> XmlSendigClasses::getSelf() const
{
    return m_Self;
}


void XmlSendigClasses::setSelf(const std::shared_ptr<SendigClasses>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlSendigClasses::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlSendigClasses::unsetSelf()
{
    m_SelfIsSet = false;
}
