...
void QrsResponsegroups::validate()
{
    // TODO: implement validation
}

web::json::value QrsResponsegroups::toJson() const
{
...
bool QrsResponsegroups::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<QrsResponsegroupsLinks> refVal_setLinks;
...
void QrsResponsegroups::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool QrsResponsegroups::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t QrsResponsegroups::getName() const
{
    return m_Name;
}


void QrsResponsegroups::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool QrsResponsegroups::nameIsSet() const
{
    return m_NameIsSet;
}

void QrsResponsegroups::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t QrsResponsegroups::getLabel() const
{
    return m_Label;
}


void QrsResponsegroups::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool QrsResponsegroups::labelIsSet() const
{
    return m_LabelIsSet;
}

void QrsResponsegroups::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t QrsResponsegroups::getDescription() const
{
    return m_Description;
}


void QrsResponsegroups::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool QrsResponsegroups::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void QrsResponsegroups::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t QrsResponsegroups::getEffectiveDate() const
{
    return m_EffectiveDate;
}


void QrsResponsegroups::setEffectiveDate(const utility::string_t& value)
{
    m_EffectiveDate = value;
    m_EffectiveDateIsSet = true;
}

bool QrsResponsegroups::effectiveDateIsSet() const
{
    return m_EffectiveDateIsSet;
}

void QrsResponsegroups::unsetEffectiveDate()
{
    m_EffectiveDateIsSet = false;
}
utility::string_t QrsResponsegroups::getUntilDate() const
{
    return m_UntilDate;
}


void QrsResponsegroups::setUntilDate(const utility::string_t& value)
{
    m_UntilDate = value;
    m_UntilDateIsSet = true;
}

bool QrsResponsegroups::untilDateIsSet() const
{
    return m_UntilDateIsSet;
}

void QrsResponsegroups::unsetUntilDate()
{
    m_UntilDateIsSet = false;
}
utility::string_t QrsResponsegroups::getRegistrationStatus() const
{
    return m_RegistrationStatus;
}


void QrsResponsegroups::setRegistrationStatus(const utility::string_t& value)
{
    m_RegistrationStatus = value;
    m_RegistrationStatusIsSet = true;
}

bool QrsResponsegroups::registrationStatusIsSet() const
{
    return m_RegistrationStatusIsSet;
}

void QrsResponsegroups::unsetRegistrationStatus()
{
    m_RegistrationStatusIsSet = false;
}
utility::string_t QrsResponsegroups::getVersion() const
{
    return m_Version;
}


void QrsResponsegroups::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool QrsResponsegroups::versionIsSet() const
{
    return m_VersionIsSet;
}

void QrsResponsegroups::unsetVersion()
{
    m_VersionIsSet = false;
}
utility::string_t QrsResponsegroups::getQrsType() const
{
    return m_QrsType;
}


void QrsResponsegroups::setQrsType(const utility::string_t& value)
{
    m_QrsType = value;
    m_QrsTypeIsSet = true;
}

bool QrsResponsegroups::qrsTypeIsSet() const
{
    return m_QrsTypeIsSet;
}

void QrsResponsegroups::unsetQrsType()
{
    m_QrsTypeIsSet = false;
}
std::shared_ptr<QrsResponsegroupsLinks> QrsResponsegroups::getLinks() const
{
    return m__links;
}


void QrsResponsegroups::setLinks(const std::shared_ptr<QrsResponsegroupsLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool QrsResponsegroups::linksIsSet() const
{
    return m__linksIsSet;
}

void QrsResponsegroups::unset_links()
{
    m__linksIsSet = false;
}
