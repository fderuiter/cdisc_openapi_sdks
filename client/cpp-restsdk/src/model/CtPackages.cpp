...
void CtPackages::validate()
{
    // TODO: implement validation
}

web::json::value CtPackages::toJson() const
{
...
bool CtPackages::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        {
            std::shared_ptr<CtPackagesLinks> refVal_setLinks;
...
void CtPackages::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CtPackages::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<CtPackagesLinks> CtPackages::getLinks() const
{
    return m__links;
}


void CtPackages::setLinks(const std::shared_ptr<CtPackagesLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool CtPackages::linksIsSet() const
{
    return m__linksIsSet;
}

void CtPackages::unset_links()
{
    m__linksIsSet = false;
}
