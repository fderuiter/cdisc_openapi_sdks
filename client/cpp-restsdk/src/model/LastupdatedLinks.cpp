...
void LastupdatedLinks::validate()
{
    // TODO: implement validation
}

web::json::value LastupdatedLinks::toJson() const
{
...
bool LastupdatedLinks::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<LastupdatedRef> refVal_setSelf;
...
void LastupdatedLinks::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LastupdatedLinks::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<LastupdatedRef> LastupdatedLinks::getSelf() const
{
    return m_Self;
}


void LastupdatedLinks::setSelf(const std::shared_ptr<LastupdatedRef>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool LastupdatedLinks::selfIsSet() const
{
    return m_SelfIsSet;
}

void LastupdatedLinks::unsetSelf()
{
    m_SelfIsSet = false;
}
