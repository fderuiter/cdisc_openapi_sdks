...
void XmlQrsResponsegroup::validate()
{
    // TODO: implement validation
}

web::json::value XmlQrsResponsegroup::toJson() const
{
...
bool XmlQrsResponsegroup::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<QrsResponsegroup> refVal_setSelf;
...
void XmlQrsResponsegroup::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlQrsResponsegroup::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<QrsResponsegroup> XmlQrsResponsegroup::getSelf() const
{
    return m_Self;
}


void XmlQrsResponsegroup::setSelf(const std::shared_ptr<QrsResponsegroup>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlQrsResponsegroup::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlQrsResponsegroup::unsetSelf()
{
    m_SelfIsSet = false;
}
