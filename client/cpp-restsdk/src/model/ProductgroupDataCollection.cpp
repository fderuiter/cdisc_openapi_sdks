...
void ProductgroupDataCollection::validate()
{
    // TODO: implement validation
}

web::json::value ProductgroupDataCollection::toJson() const
{
...
bool ProductgroupDataCollection::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        {
            std::shared_ptr<ProductgroupDataCollectionLinks> refVal_setLinks;
...
void ProductgroupDataCollection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ProductgroupDataCollection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<ProductgroupDataCollectionLinks> ProductgroupDataCollection::getLinks() const
{
    return m__links;
}


void ProductgroupDataCollection::setLinks(const std::shared_ptr<ProductgroupDataCollectionLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool ProductgroupDataCollection::linksIsSet() const
{
    return m__linksIsSet;
}

void ProductgroupDataCollection::unset_links()
{
    m__linksIsSet = false;
}
