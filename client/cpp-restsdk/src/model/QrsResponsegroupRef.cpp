...
void QrsResponsegroupRef::validate()
{
    // TODO: implement validation
}

web::json::value QrsResponsegroupRef::toJson() const
{
...
bool QrsResponsegroupRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void QrsResponsegroupRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool QrsResponsegroupRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t QrsResponsegroupRef::getHref() const
{
    return m_Href;
}


void QrsResponsegroupRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool QrsResponsegroupRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void QrsResponsegroupRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t QrsResponsegroupRef::getTitle() const
{
    return m_Title;
}


void QrsResponsegroupRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool QrsResponsegroupRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void QrsResponsegroupRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t QrsResponsegroupRef::getType() const
{
    return m_Type;
}


void QrsResponsegroupRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool QrsResponsegroupRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void QrsResponsegroupRef::unsetType()
{
    m_TypeIsSet = false;
}
