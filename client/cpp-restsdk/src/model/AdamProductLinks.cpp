...
void AdamProductLinks::validate()
{
    // TODO: implement validation
}

web::json::value AdamProductLinks::toJson() const
{
...
bool AdamProductLinks::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<AdamProductRef> refVal_setSelf;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("model"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AdamProductRef> refVal_setModel;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("priorVersion"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AdamProductRef> refVal_setPriorVersion;
...
void AdamProductLinks::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AdamProductLinks::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<AdamProductRef> AdamProductLinks::getSelf() const
{
    return m_Self;
}


void AdamProductLinks::setSelf(const std::shared_ptr<AdamProductRef>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool AdamProductLinks::selfIsSet() const
{
    return m_SelfIsSet;
}

void AdamProductLinks::unsetSelf()
{
    m_SelfIsSet = false;
}
std::shared_ptr<AdamProductRef> AdamProductLinks::getModel() const
{
    return m_Model;
}


void AdamProductLinks::setModel(const std::shared_ptr<AdamProductRef>& value)
{
    m_Model = value;
    m_ModelIsSet = true;
}

bool AdamProductLinks::modelIsSet() const
{
    return m_ModelIsSet;
}

void AdamProductLinks::unsetModel()
{
    m_ModelIsSet = false;
}
std::shared_ptr<AdamProductRef> AdamProductLinks::getPriorVersion() const
{
    return m_PriorVersion;
}


void AdamProductLinks::setPriorVersion(const std::shared_ptr<AdamProductRef>& value)
{
    m_PriorVersion = value;
    m_PriorVersionIsSet = true;
}

bool AdamProductLinks::priorVersionIsSet() const
{
    return m_PriorVersionIsSet;
}

void AdamProductLinks::unsetPriorVersion()
{
    m_PriorVersionIsSet = false;
}
