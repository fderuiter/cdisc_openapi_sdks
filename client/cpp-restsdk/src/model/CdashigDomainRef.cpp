...
void CdashigDomainRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashigDomainRef::toJson() const
{
...
bool CdashigDomainRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigDomainRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigDomainRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigDomainRef::getHref() const
{
    return m_Href;
}


void CdashigDomainRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigDomainRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigDomainRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigDomainRef::getTitle() const
{
    return m_Title;
}


void CdashigDomainRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigDomainRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigDomainRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigDomainRef::getType() const
{
    return m_Type;
}


void CdashigDomainRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigDomainRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigDomainRef::unsetType()
{
    m_TypeIsSet = false;
}
