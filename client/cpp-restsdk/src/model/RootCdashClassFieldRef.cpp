...
void RootCdashClassFieldRef::validate()
{
    // TODO: implement validation
}

web::json::value RootCdashClassFieldRef::toJson() const
{
...
bool RootCdashClassFieldRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RootCdashClassFieldRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RootCdashClassFieldRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t RootCdashClassFieldRef::getHref() const
{
    return m_Href;
}


void RootCdashClassFieldRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool RootCdashClassFieldRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void RootCdashClassFieldRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t RootCdashClassFieldRef::getTitle() const
{
    return m_Title;
}


void RootCdashClassFieldRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool RootCdashClassFieldRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void RootCdashClassFieldRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t RootCdashClassFieldRef::getType() const
{
    return m_Type;
}


void RootCdashClassFieldRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool RootCdashClassFieldRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void RootCdashClassFieldRef::unsetType()
{
    m_TypeIsSet = false;
}
