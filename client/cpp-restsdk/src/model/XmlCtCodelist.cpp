...
void XmlCtCodelist::validate()
{
    // TODO: implement validation
}

web::json::value XmlCtCodelist::toJson() const
{
...
bool XmlCtCodelist::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<CtCodelist> refVal_setSelf;
...
void XmlCtCodelist::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlCtCodelist::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<CtCodelist> XmlCtCodelist::getSelf() const
{
    return m_Self;
}


void XmlCtCodelist::setSelf(const std::shared_ptr<CtCodelist>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlCtCodelist::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlCtCodelist::unsetSelf()
{
    m_SelfIsSet = false;
}
