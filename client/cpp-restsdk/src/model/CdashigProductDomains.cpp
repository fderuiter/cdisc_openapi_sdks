...
void CdashigProductDomains::validate()
{
    // TODO: implement validation
}

web::json::value CdashigProductDomains::toJson() const
{
...
bool CdashigProductDomains::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CdashigProductDomainsLinks> refVal_setLinks;
...
void CdashigProductDomains::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigProductDomains::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigProductDomains::getName() const
{
    return m_Name;
}


void CdashigProductDomains::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool CdashigProductDomains::nameIsSet() const
{
    return m_NameIsSet;
}

void CdashigProductDomains::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t CdashigProductDomains::getLabel() const
{
    return m_Label;
}


void CdashigProductDomains::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool CdashigProductDomains::labelIsSet() const
{
    return m_LabelIsSet;
}

void CdashigProductDomains::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t CdashigProductDomains::getDescription() const
{
    return m_Description;
}


void CdashigProductDomains::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool CdashigProductDomains::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void CdashigProductDomains::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t CdashigProductDomains::getSource() const
{
    return m_Source;
}


void CdashigProductDomains::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool CdashigProductDomains::sourceIsSet() const
{
    return m_SourceIsSet;
}

void CdashigProductDomains::unsetSource()
{
    m_SourceIsSet = false;
}
utility::string_t CdashigProductDomains::getEffectiveDate() const
{
    return m_EffectiveDate;
}


void CdashigProductDomains::setEffectiveDate(const utility::string_t& value)
{
    m_EffectiveDate = value;
    m_EffectiveDateIsSet = true;
}

bool CdashigProductDomains::effectiveDateIsSet() const
{
    return m_EffectiveDateIsSet;
}

void CdashigProductDomains::unsetEffectiveDate()
{
    m_EffectiveDateIsSet = false;
}
utility::string_t CdashigProductDomains::getRegistrationStatus() const
{
    return m_RegistrationStatus;
}


void CdashigProductDomains::setRegistrationStatus(const utility::string_t& value)
{
    m_RegistrationStatus = value;
    m_RegistrationStatusIsSet = true;
}

bool CdashigProductDomains::registrationStatusIsSet() const
{
    return m_RegistrationStatusIsSet;
}

void CdashigProductDomains::unsetRegistrationStatus()
{
    m_RegistrationStatusIsSet = false;
}
utility::string_t CdashigProductDomains::getVersion() const
{
    return m_Version;
}


void CdashigProductDomains::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool CdashigProductDomains::versionIsSet() const
{
    return m_VersionIsSet;
}

void CdashigProductDomains::unsetVersion()
{
    m_VersionIsSet = false;
}
std::shared_ptr<CdashigProductDomainsLinks> CdashigProductDomains::getLinks() const
{
    return m__links;
}


void CdashigProductDomains::setLinks(const std::shared_ptr<CdashigProductDomainsLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool CdashigProductDomains::linksIsSet() const
{
    return m__linksIsSet;
}

void CdashigProductDomains::unset_links()
{
    m__linksIsSet = false;
}
