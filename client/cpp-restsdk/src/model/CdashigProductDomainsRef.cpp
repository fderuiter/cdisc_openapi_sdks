...
void CdashigProductDomainsRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashigProductDomainsRef::toJson() const
{
...
bool CdashigProductDomainsRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigProductDomainsRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigProductDomainsRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigProductDomainsRef::getHref() const
{
    return m_Href;
}


void CdashigProductDomainsRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigProductDomainsRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigProductDomainsRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigProductDomainsRef::getTitle() const
{
    return m_Title;
}


void CdashigProductDomainsRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigProductDomainsRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigProductDomainsRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigProductDomainsRef::getType() const
{
    return m_Type;
}


void CdashigProductDomainsRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigProductDomainsRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigProductDomainsRef::unsetType()
{
    m_TypeIsSet = false;
}
