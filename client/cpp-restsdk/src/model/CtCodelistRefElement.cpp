...
void CtCodelistRefElement::validate()
{
    // TODO: implement validation
}

web::json::value CtCodelistRefElement::toJson() const
{
...
bool CtCodelistRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CtCodelistRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CtCodelistRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CtCodelistRefElement::getHref() const
{
    return m_Href;
}


void CtCodelistRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CtCodelistRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CtCodelistRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CtCodelistRefElement::getTitle() const
{
    return m_Title;
}


void CtCodelistRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CtCodelistRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void CtCodelistRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CtCodelistRefElement::getType() const
{
    return m_Type;
}


void CtCodelistRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CtCodelistRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void CtCodelistRefElement::unsetType()
{
    m_TypeIsSet = false;
}
