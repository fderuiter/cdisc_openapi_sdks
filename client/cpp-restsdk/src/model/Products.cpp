...
web::json::value Products::toJson() const
{
...
bool Products::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        {
            std::shared_ptr<ProductsLinks> refVal_setLinks;
...
void Products::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Products::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<ProductsLinks> Products::getLinks() const
{
    return m__links;
}


void Products::setLinks(const std::shared_ptr<ProductsLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool Products::linksIsSet() const
{
    return m__linksIsSet;
}

void Products::unset_links()
{
    m__linksIsSet = false;
}
