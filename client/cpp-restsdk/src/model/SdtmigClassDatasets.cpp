...
void SdtmigClassDatasets::validate()
{
    // TODO: implement validation
}

web::json::value SdtmigClassDatasets::toJson() const
{
...
bool SdtmigClassDatasets::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SdtmigClassDatasetsLinks> refVal_setLinks;
...
void SdtmigClassDatasets::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmigClassDatasets::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmigClassDatasets::getOrdinal() const
{
    return m_Ordinal;
}


void SdtmigClassDatasets::setOrdinal(const utility::string_t& value)
{
    m_Ordinal = value;
    m_OrdinalIsSet = true;
}

bool SdtmigClassDatasets::ordinalIsSet() const
{
    return m_OrdinalIsSet;
}

void SdtmigClassDatasets::unsetOrdinal()
{
    m_OrdinalIsSet = false;
}
utility::string_t SdtmigClassDatasets::getName() const
{
    return m_Name;
}


void SdtmigClassDatasets::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool SdtmigClassDatasets::nameIsSet() const
{
    return m_NameIsSet;
}

void SdtmigClassDatasets::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t SdtmigClassDatasets::getLabel() const
{
    return m_Label;
}


void SdtmigClassDatasets::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool SdtmigClassDatasets::labelIsSet() const
{
    return m_LabelIsSet;
}

void SdtmigClassDatasets::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t SdtmigClassDatasets::getDescription() const
{
    return m_Description;
}


void SdtmigClassDatasets::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool SdtmigClassDatasets::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void SdtmigClassDatasets::unsetDescription()
{
    m_DescriptionIsSet = false;
}
std::shared_ptr<SdtmigClassDatasetsLinks> SdtmigClassDatasets::getLinks() const
{
    return m__links;
}


void SdtmigClassDatasets::setLinks(const std::shared_ptr<SdtmigClassDatasetsLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool SdtmigClassDatasets::linksIsSet() const
{
    return m__linksIsSet;
}

void SdtmigClassDatasets::unset_links()
{
    m__linksIsSet = false;
}
