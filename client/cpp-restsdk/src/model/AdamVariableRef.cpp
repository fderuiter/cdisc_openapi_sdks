...
void AdamVariableRef::validate()
{
    // TODO: implement validation
}

web::json::value AdamVariableRef::toJson() const
{
...
bool AdamVariableRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AdamVariableRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AdamVariableRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AdamVariableRef::getHref() const
{
    return m_Href;
}


void AdamVariableRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool AdamVariableRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void AdamVariableRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t AdamVariableRef::getTitle() const
{
    return m_Title;
}


void AdamVariableRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool AdamVariableRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void AdamVariableRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t AdamVariableRef::getType() const
{
    return m_Type;
}


void AdamVariableRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool AdamVariableRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void AdamVariableRef::unsetType()
{
    m_TypeIsSet = false;
}
