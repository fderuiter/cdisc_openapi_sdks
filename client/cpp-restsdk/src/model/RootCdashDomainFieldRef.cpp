...
void RootCdashDomainFieldRef::validate()
{
    // TODO: implement validation
}

web::json::value RootCdashDomainFieldRef::toJson() const
{
...
bool RootCdashDomainFieldRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RootCdashDomainFieldRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RootCdashDomainFieldRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t RootCdashDomainFieldRef::getHref() const
{
    return m_Href;
}


void RootCdashDomainFieldRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool RootCdashDomainFieldRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void RootCdashDomainFieldRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t RootCdashDomainFieldRef::getTitle() const
{
    return m_Title;
}


void RootCdashDomainFieldRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool RootCdashDomainFieldRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void RootCdashDomainFieldRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t RootCdashDomainFieldRef::getType() const
{
    return m_Type;
}


void RootCdashDomainFieldRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool RootCdashDomainFieldRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void RootCdashDomainFieldRef::unsetType()
{
    m_TypeIsSet = false;
}
