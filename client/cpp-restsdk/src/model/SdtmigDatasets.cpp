...
void SdtmigDatasets::validate()
{
    // TODO: implement validation
}

web::json::value SdtmigDatasets::toJson() const
{
...
bool SdtmigDatasets::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SdtmigDatasetsLinks> refVal_setLinks;
...
void SdtmigDatasets::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmigDatasets::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmigDatasets::getName() const
{
    return m_Name;
}


void SdtmigDatasets::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool SdtmigDatasets::nameIsSet() const
{
    return m_NameIsSet;
}

void SdtmigDatasets::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t SdtmigDatasets::getLabel() const
{
    return m_Label;
}


void SdtmigDatasets::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool SdtmigDatasets::labelIsSet() const
{
    return m_LabelIsSet;
}

void SdtmigDatasets::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t SdtmigDatasets::getDescription() const
{
    return m_Description;
}


void SdtmigDatasets::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool SdtmigDatasets::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void SdtmigDatasets::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t SdtmigDatasets::getSource() const
{
    return m_Source;
}


void SdtmigDatasets::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool SdtmigDatasets::sourceIsSet() const
{
    return m_SourceIsSet;
}

void SdtmigDatasets::unsetSource()
{
    m_SourceIsSet = false;
}
utility::string_t SdtmigDatasets::getEffectiveDate() const
{
    return m_EffectiveDate;
}


void SdtmigDatasets::setEffectiveDate(const utility::string_t& value)
{
    m_EffectiveDate = value;
    m_EffectiveDateIsSet = true;
}

bool SdtmigDatasets::effectiveDateIsSet() const
{
    return m_EffectiveDateIsSet;
}

void SdtmigDatasets::unsetEffectiveDate()
{
    m_EffectiveDateIsSet = false;
}
utility::string_t SdtmigDatasets::getRegistrationStatus() const
{
    return m_RegistrationStatus;
}


void SdtmigDatasets::setRegistrationStatus(const utility::string_t& value)
{
    m_RegistrationStatus = value;
    m_RegistrationStatusIsSet = true;
}

bool SdtmigDatasets::registrationStatusIsSet() const
{
    return m_RegistrationStatusIsSet;
}

void SdtmigDatasets::unsetRegistrationStatus()
{
    m_RegistrationStatusIsSet = false;
}
utility::string_t SdtmigDatasets::getVersion() const
{
    return m_Version;
}


void SdtmigDatasets::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool SdtmigDatasets::versionIsSet() const
{
    return m_VersionIsSet;
}

void SdtmigDatasets::unsetVersion()
{
    m_VersionIsSet = false;
}
std::shared_ptr<SdtmigDatasetsLinks> SdtmigDatasets::getLinks() const
{
    return m__links;
}


void SdtmigDatasets::setLinks(const std::shared_ptr<SdtmigDatasetsLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool SdtmigDatasets::linksIsSet() const
{
    return m__linksIsSet;
}

void SdtmigDatasets::unset_links()
{
    m__linksIsSet = false;
}
