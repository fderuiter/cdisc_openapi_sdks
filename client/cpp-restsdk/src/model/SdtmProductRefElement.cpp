...
void SdtmProductRefElement::validate()
{
    // TODO: implement validation
}

web::json::value SdtmProductRefElement::toJson() const
{
...
bool SdtmProductRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmProductRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmProductRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmProductRefElement::getHref() const
{
    return m_Href;
}


void SdtmProductRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmProductRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmProductRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmProductRefElement::getTitle() const
{
    return m_Title;
}


void SdtmProductRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmProductRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmProductRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmProductRefElement::getType() const
{
    return m_Type;
}


void SdtmProductRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmProductRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmProductRefElement::unsetType()
{
    m_TypeIsSet = false;
}
