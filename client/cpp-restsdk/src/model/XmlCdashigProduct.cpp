...
void XmlCdashigProduct::validate()
{
    // TODO: implement validation
}

web::json::value XmlCdashigProduct::toJson() const
{
...
bool XmlCdashigProduct::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<CdashigProduct> refVal_setSelf;
...
void XmlCdashigProduct::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlCdashigProduct::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<CdashigProduct> XmlCdashigProduct::getSelf() const
{
    return m_Self;
}


void XmlCdashigProduct::setSelf(const std::shared_ptr<CdashigProduct>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlCdashigProduct::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlCdashigProduct::unsetSelf()
{
    m_SelfIsSet = false;
}
