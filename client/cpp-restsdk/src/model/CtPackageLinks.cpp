...
void CtPackageLinks::validate()
{
    // TODO: implement validation
}

web::json::value CtPackageLinks::toJson() const
{
...
bool CtPackageLinks::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<CtPackageRef> refVal_setSelf;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("priorVersion"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CtPackageRef> refVal_setPriorVersion;
...
void CtPackageLinks::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CtPackageLinks::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<CtPackageRef> CtPackageLinks::getSelf() const
{
    return m_Self;
}


void CtPackageLinks::setSelf(const std::shared_ptr<CtPackageRef>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool CtPackageLinks::selfIsSet() const
{
    return m_SelfIsSet;
}

void CtPackageLinks::unsetSelf()
{
    m_SelfIsSet = false;
}
std::shared_ptr<CtPackageRef> CtPackageLinks::getPriorVersion() const
{
    return m_PriorVersion;
}


void CtPackageLinks::setPriorVersion(const std::shared_ptr<CtPackageRef>& value)
{
    m_PriorVersion = value;
    m_PriorVersionIsSet = true;
}

bool CtPackageLinks::priorVersionIsSet() const
{
    return m_PriorVersionIsSet;
}

void CtPackageLinks::unsetPriorVersion()
{
    m_PriorVersionIsSet = false;
}
