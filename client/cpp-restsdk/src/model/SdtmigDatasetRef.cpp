...
void SdtmigDatasetRef::validate()
{
    // TODO: implement validation
}

web::json::value SdtmigDatasetRef::toJson() const
{
...
bool SdtmigDatasetRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmigDatasetRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmigDatasetRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmigDatasetRef::getHref() const
{
    return m_Href;
}


void SdtmigDatasetRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmigDatasetRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmigDatasetRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmigDatasetRef::getTitle() const
{
    return m_Title;
}


void SdtmigDatasetRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmigDatasetRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmigDatasetRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmigDatasetRef::getType() const
{
    return m_Type;
}


void SdtmigDatasetRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmigDatasetRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmigDatasetRef::unsetType()
{
    m_TypeIsSet = false;
}
