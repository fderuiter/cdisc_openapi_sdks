...
void SendigDatasetRef::validate()
{
    // TODO: implement validation
}

web::json::value SendigDatasetRef::toJson() const
{
...
bool SendigDatasetRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SendigDatasetRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendigDatasetRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SendigDatasetRef::getHref() const
{
    return m_Href;
}


void SendigDatasetRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SendigDatasetRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SendigDatasetRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SendigDatasetRef::getTitle() const
{
    return m_Title;
}


void SendigDatasetRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SendigDatasetRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SendigDatasetRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SendigDatasetRef::getType() const
{
    return m_Type;
}


void SendigDatasetRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SendigDatasetRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SendigDatasetRef::unsetType()
{
    m_TypeIsSet = false;
}
