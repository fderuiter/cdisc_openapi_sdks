...
void CdashigClassDomains::validate()
{
    // TODO: implement validation
}

web::json::value CdashigClassDomains::toJson() const
{
...
bool CdashigClassDomains::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CdashigClassDomainsLinks> refVal_setLinks;
...
void CdashigClassDomains::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigClassDomains::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigClassDomains::getOrdinal() const
{
    return m_Ordinal;
}


void CdashigClassDomains::setOrdinal(const utility::string_t& value)
{
    m_Ordinal = value;
    m_OrdinalIsSet = true;
}

bool CdashigClassDomains::ordinalIsSet() const
{
    return m_OrdinalIsSet;
}

void CdashigClassDomains::unsetOrdinal()
{
    m_OrdinalIsSet = false;
}
utility::string_t CdashigClassDomains::getName() const
{
    return m_Name;
}


void CdashigClassDomains::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool CdashigClassDomains::nameIsSet() const
{
    return m_NameIsSet;
}

void CdashigClassDomains::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t CdashigClassDomains::getLabel() const
{
    return m_Label;
}


void CdashigClassDomains::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool CdashigClassDomains::labelIsSet() const
{
    return m_LabelIsSet;
}

void CdashigClassDomains::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t CdashigClassDomains::getDescription() const
{
    return m_Description;
}


void CdashigClassDomains::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool CdashigClassDomains::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void CdashigClassDomains::unsetDescription()
{
    m_DescriptionIsSet = false;
}
std::shared_ptr<CdashigClassDomainsLinks> CdashigClassDomains::getLinks() const
{
    return m__links;
}


void CdashigClassDomains::setLinks(const std::shared_ptr<CdashigClassDomainsLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool CdashigClassDomains::linksIsSet() const
{
    return m__linksIsSet;
}

void CdashigClassDomains::unset_links()
{
    m__linksIsSet = false;
}
