...
void QrsResponsegroupsRef::validate()
{
    // TODO: implement validation
}

web::json::value QrsResponsegroupsRef::toJson() const
{
...
bool QrsResponsegroupsRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void QrsResponsegroupsRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool QrsResponsegroupsRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t QrsResponsegroupsRef::getHref() const
{
    return m_Href;
}


void QrsResponsegroupsRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool QrsResponsegroupsRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void QrsResponsegroupsRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t QrsResponsegroupsRef::getTitle() const
{
    return m_Title;
}


void QrsResponsegroupsRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool QrsResponsegroupsRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void QrsResponsegroupsRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t QrsResponsegroupsRef::getType() const
{
    return m_Type;
}


void QrsResponsegroupsRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool QrsResponsegroupsRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void QrsResponsegroupsRef::unsetType()
{
    m_TypeIsSet = false;
}
