...
void CdashProductClasses::validate()
{
    // TODO: implement validation
}

web::json::value CdashProductClasses::toJson() const
{
...
bool CdashProductClasses::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CdashProductClassesLinks> refVal_setLinks;
...
void CdashProductClasses::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashProductClasses::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashProductClasses::getName() const
{
    return m_Name;
}


void CdashProductClasses::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool CdashProductClasses::nameIsSet() const
{
    return m_NameIsSet;
}

void CdashProductClasses::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t CdashProductClasses::getLabel() const
{
    return m_Label;
}


void CdashProductClasses::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool CdashProductClasses::labelIsSet() const
{
    return m_LabelIsSet;
}

void CdashProductClasses::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t CdashProductClasses::getDescription() const
{
    return m_Description;
}


void CdashProductClasses::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool CdashProductClasses::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void CdashProductClasses::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t CdashProductClasses::getSource() const
{
    return m_Source;
}


void CdashProductClasses::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool CdashProductClasses::sourceIsSet() const
{
    return m_SourceIsSet;
}

void CdashProductClasses::unsetSource()
{
    m_SourceIsSet = false;
}
utility::string_t CdashProductClasses::getEffectiveDate() const
{
    return m_EffectiveDate;
}


void CdashProductClasses::setEffectiveDate(const utility::string_t& value)
{
    m_EffectiveDate = value;
    m_EffectiveDateIsSet = true;
}

bool CdashProductClasses::effectiveDateIsSet() const
{
    return m_EffectiveDateIsSet;
}

void CdashProductClasses::unsetEffectiveDate()
{
    m_EffectiveDateIsSet = false;
}
utility::string_t CdashProductClasses::getRegistrationStatus() const
{
    return m_RegistrationStatus;
}


void CdashProductClasses::setRegistrationStatus(const utility::string_t& value)
{
    m_RegistrationStatus = value;
    m_RegistrationStatusIsSet = true;
}

bool CdashProductClasses::registrationStatusIsSet() const
{
    return m_RegistrationStatusIsSet;
}

void CdashProductClasses::unsetRegistrationStatus()
{
    m_RegistrationStatusIsSet = false;
}
utility::string_t CdashProductClasses::getVersion() const
{
    return m_Version;
}


void CdashProductClasses::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool CdashProductClasses::versionIsSet() const
{
    return m_VersionIsSet;
}

void CdashProductClasses::unsetVersion()
{
    m_VersionIsSet = false;
}
std::shared_ptr<CdashProductClassesLinks> CdashProductClasses::getLinks() const
{
    return m__links;
}


void CdashProductClasses::setLinks(const std::shared_ptr<CdashProductClassesLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool CdashProductClasses::linksIsSet() const
{
    return m__linksIsSet;
}

void CdashProductClasses::unset_links()
{
    m__linksIsSet = false;
}
