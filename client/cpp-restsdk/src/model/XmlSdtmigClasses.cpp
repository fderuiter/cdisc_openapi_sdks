...
void XmlSdtmigClasses::validate()
{
    // TODO: implement validation
}

web::json::value XmlSdtmigClasses::toJson() const
{
...
bool XmlSdtmigClasses::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<SdtmigClasses> refVal_setSelf;
...
void XmlSdtmigClasses::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlSdtmigClasses::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SdtmigClasses> XmlSdtmigClasses::getSelf() const
{
    return m_Self;
}


void XmlSdtmigClasses::setSelf(const std::shared_ptr<SdtmigClasses>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlSdtmigClasses::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlSdtmigClasses::unsetSelf()
{
    m_SelfIsSet = false;
}
