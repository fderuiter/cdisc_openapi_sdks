...
#include "CppRestOpenAPIClient/model/SdtmDatasetVariablesLinks.h"
...
void SdtmDatasetVariablesLinks::validate()
{
    // TODO: implement validation
}

web::json::value SdtmDatasetVariablesLinks::toJson() const
{
...
bool SdtmDatasetVariablesLinks::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<SdtmDatasetVariablesRef> refVal_setSelf;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("priorVersion"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SdtmDatasetVariablesRef> refVal_setPriorVersion;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("datasetVariables"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SdtmDatasetVariableRefElement>> refVal_setDatasetVariables;
...
void SdtmDatasetVariablesLinks::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmDatasetVariablesLinks::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SdtmDatasetVariablesRef> SdtmDatasetVariablesLinks::getSelf() const
{
    return m_Self;
}


void SdtmDatasetVariablesLinks::setSelf(const std::shared_ptr<SdtmDatasetVariablesRef>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool SdtmDatasetVariablesLinks::selfIsSet() const
{
    return m_SelfIsSet;
}

void SdtmDatasetVariablesLinks::unsetSelf()
{
    m_SelfIsSet = false;
}
std::shared_ptr<SdtmProductRef> SdtmDatasetVariablesLinks::getParentProduct() const
{
    return m_ParentProduct;
}


void SdtmDatasetVariablesLinks::setParentProduct(const std::shared_ptr<SdtmProductRef>& value)
{
    m_ParentProduct = value;
    m_ParentProductIsSet = true;
}

bool SdtmDatasetVariablesLinks::parentProductIsSet() const
{
    return m_ParentProductIsSet;
}

void SdtmDatasetVariablesLinks::unsetParentProduct()
{
    m_ParentProductIsSet = false;
}
std::shared_ptr<SdtmClassRef> SdtmDatasetVariablesLinks::getParentClass() const
{
    return m_ParentClass;
}


void SdtmDatasetVariablesLinks::setParentClass(const std::shared_ptr<SdtmClassRef>& value)
{
    m_ParentClass = value;
    m_ParentClassIsSet = true;
}

bool SdtmDatasetVariablesLinks::parentClassIsSet() const
{
    return m_ParentClassIsSet;
}

void SdtmDatasetVariablesLinks::unsetParentClass()
{
    m_ParentClassIsSet = false;
}
std::shared_ptr<SdtmDatasetVariablesRef> SdtmDatasetVariablesLinks::getPriorVersion() const
{
    return m_PriorVersion;
}


void SdtmDatasetVariablesLinks::setPriorVersion(const std::shared_ptr<SdtmDatasetVariablesRef>& value)
{
    m_PriorVersion = value;
    m_PriorVersionIsSet = true;
}

bool SdtmDatasetVariablesLinks::priorVersionIsSet() const
{
    return m_PriorVersionIsSet;
}

void SdtmDatasetVariablesLinks::unsetPriorVersion()
{
    m_PriorVersionIsSet = false;
}
std::vector<std::shared_ptr<SdtmDatasetVariableRefElement>> SdtmDatasetVariablesLinks::getDatasetVariables() const
{
    return m_DatasetVariables;
}


void SdtmDatasetVariablesLinks::setDatasetVariables(const std::vector<std::shared_ptr<SdtmDatasetVariableRefElement>>& value)
{
    m_DatasetVariables = value;
    m_DatasetVariablesIsSet = true;
}

bool SdtmDatasetVariablesLinks::datasetVariablesIsSet() const
{
    return m_DatasetVariablesIsSet;
}

void SdtmDatasetVariablesLinks::unsetDatasetVariables()
{
    m_DatasetVariablesIsSet = false;
}
