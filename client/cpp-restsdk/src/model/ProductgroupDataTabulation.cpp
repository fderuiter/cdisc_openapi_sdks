...
void ProductgroupDataTabulation::validate()
{
    // TODO: implement validation
}

web::json::value ProductgroupDataTabulation::toJson() const
{
...
bool ProductgroupDataTabulation::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        {
            std::shared_ptr<ProductgroupDataTabulationLinks> refVal_setLinks;
...
void ProductgroupDataTabulation::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ProductgroupDataTabulation::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<ProductgroupDataTabulationLinks> ProductgroupDataTabulation::getLinks() const
{
    return m__links;
}


void ProductgroupDataTabulation::setLinks(const std::shared_ptr<ProductgroupDataTabulationLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool ProductgroupDataTabulation::linksIsSet() const
{
    return m__linksIsSet;
}

void ProductgroupDataTabulation::unset_links()
{
    m__linksIsSet = false;
}
