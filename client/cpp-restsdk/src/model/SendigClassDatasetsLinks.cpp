...
#include "CppRestOpenAPIClient/model/SendigClassDatasetsLinks.h"
...
void SendigClassDatasetsLinks::validate()
{
    // TODO: implement validation
}

web::json::value SendigClassDatasetsLinks::toJson() const
{
...
bool SendigClassDatasetsLinks::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<SendigClassDatasetsRef> refVal_setSelf;
...
void SendigClassDatasetsLinks::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendigClassDatasetsLinks::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SendigClassDatasetsRef> SendigClassDatasetsLinks::getSelf() const
{
    return m_Self;
}


void SendigClassDatasetsLinks::setSelf(const std::shared_ptr<SendigClassDatasetsRef>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool SendigClassDatasetsLinks::selfIsSet() const
{
    return m_SelfIsSet;
}

void SendigClassDatasetsLinks::unsetSelf()
{
    m_SelfIsSet = false;
}
std::shared_ptr<SendigProductRef> SendigClassDatasetsLinks::getParentProduct() const
{
    return m_ParentProduct;
}


void SendigClassDatasetsLinks::setParentProduct(const std::shared_ptr<SendigProductRef>& value)
{
    m_ParentProduct = value;
    m_ParentProductIsSet = true;
}

bool SendigClassDatasetsLinks::parentProductIsSet() const
{
    return m_ParentProductIsSet;
}

void SendigClassDatasetsLinks::unsetParentProduct()
{
    m_ParentProductIsSet = false;
}
std::vector<std::shared_ptr<SendigDatasetRefElement>> SendigClassDatasetsLinks::getDatasets() const
{
    return m_Datasets;
}


void SendigClassDatasetsLinks::setDatasets(const std::vector<std::shared_ptr<SendigDatasetRefElement>>& value)
{
    m_Datasets = value;
    m_DatasetsIsSet = true;
}

bool SendigClassDatasetsLinks::datasetsIsSet() const
{
    return m_DatasetsIsSet;
}

void SendigClassDatasetsLinks::unsetDatasets()
{
    m_DatasetsIsSet = false;
}
