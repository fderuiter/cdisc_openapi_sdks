...
void CdashigDomainFieldRefElement::validate()
{
    // TODO: implement validation
}

web::json::value CdashigDomainFieldRefElement::toJson() const
{
...
bool CdashigDomainFieldRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigDomainFieldRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigDomainFieldRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigDomainFieldRefElement::getHref() const
{
    return m_Href;
}


void CdashigDomainFieldRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigDomainFieldRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigDomainFieldRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigDomainFieldRefElement::getTitle() const
{
    return m_Title;
}


void CdashigDomainFieldRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigDomainFieldRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigDomainFieldRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigDomainFieldRefElement::getType() const
{
    return m_Type;
}


void CdashigDomainFieldRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigDomainFieldRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigDomainFieldRefElement::unsetType()
{
    m_TypeIsSet = false;
}
