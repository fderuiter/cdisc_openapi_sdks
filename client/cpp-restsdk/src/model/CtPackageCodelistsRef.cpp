...
void CtPackageCodelistsRef::validate()
{
    // TODO: implement validation
}

web::json::value CtPackageCodelistsRef::toJson() const
{
...
bool CtPackageCodelistsRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CtPackageCodelistsRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CtPackageCodelistsRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CtPackageCodelistsRef::getHref() const
{
    return m_Href;
}


void CtPackageCodelistsRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CtPackageCodelistsRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CtPackageCodelistsRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CtPackageCodelistsRef::getTitle() const
{
    return m_Title;
}


void CtPackageCodelistsRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CtPackageCodelistsRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CtPackageCodelistsRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CtPackageCodelistsRef::getType() const
{
    return m_Type;
}


void CtPackageCodelistsRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CtPackageCodelistsRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CtPackageCodelistsRef::unsetType()
{
    m_TypeIsSet = false;
}
