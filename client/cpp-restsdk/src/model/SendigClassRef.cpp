...
void SendigClassRef::validate()
{
    // TODO: implement validation
}

web::json::value SendigClassRef::toJson() const
{
...
bool SendigClassRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SendigClassRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendigClassRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SendigClassRef::getHref() const
{
    return m_Href;
}


void SendigClassRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SendigClassRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SendigClassRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SendigClassRef::getTitle() const
{
    return m_Title;
}


void SendigClassRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SendigClassRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SendigClassRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SendigClassRef::getType() const
{
    return m_Type;
}


void SendigClassRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SendigClassRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SendigClassRef::unsetType()
{
    m_TypeIsSet = false;
}
