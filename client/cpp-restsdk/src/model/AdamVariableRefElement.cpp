...
void AdamVariableRefElement::validate()
{
    // TODO: implement validation
}

web::json::value AdamVariableRefElement::toJson() const
{
...
bool AdamVariableRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AdamVariableRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AdamVariableRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AdamVariableRefElement::getHref() const
{
    return m_Href;
}


void AdamVariableRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool AdamVariableRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void AdamVariableRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t AdamVariableRefElement::getTitle() const
{
    return m_Title;
}


void AdamVariableRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool AdamVariableRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void AdamVariableRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t AdamVariableRefElement::getType() const
{
    return m_Type;
}


void AdamVariableRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool AdamVariableRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void AdamVariableRefElement::unsetType()
{
    m_TypeIsSet = false;
}
