...
void RootSendigDatasetVariableRef::validate()
{
    // TODO: implement validation
}

web::json::value RootSendigDatasetVariableRef::toJson() const
{
...
bool RootSendigDatasetVariableRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RootSendigDatasetVariableRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RootSendigDatasetVariableRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t RootSendigDatasetVariableRef::getHref() const
{
    return m_Href;
}


void RootSendigDatasetVariableRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool RootSendigDatasetVariableRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void RootSendigDatasetVariableRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t RootSendigDatasetVariableRef::getTitle() const
{
    return m_Title;
}


void RootSendigDatasetVariableRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool RootSendigDatasetVariableRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void RootSendigDatasetVariableRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t RootSendigDatasetVariableRef::getType() const
{
    return m_Type;
}


void RootSendigDatasetVariableRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool RootSendigDatasetVariableRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void RootSendigDatasetVariableRef::unsetType()
{
    m_TypeIsSet = false;
}
