...
void XmlCdashProduct::validate()
{
    // TODO: implement validation
}

web::json::value XmlCdashProduct::toJson() const
{
...
bool XmlCdashProduct::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<CdashProduct> refVal_setSelf;
...
void XmlCdashProduct::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlCdashProduct::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<CdashProduct> XmlCdashProduct::getSelf() const
{
    return m_Self;
}


void XmlCdashProduct::setSelf(const std::shared_ptr<CdashProduct>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlCdashProduct::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlCdashProduct::unsetSelf()
{
    m_SelfIsSet = false;
}
