...
void CtTermRefElement::validate()
{
    // TODO: implement validation
}

web::json::value CtTermRefElement::toJson() const
{
...
bool CtTermRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CtTermRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CtTermRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CtTermRefElement::getHref() const
{
    return m_Href;
}


void CtTermRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CtTermRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CtTermRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CtTermRefElement::getTitle() const
{
    return m_Title;
}


void CtTermRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CtTermRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void CtTermRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CtTermRefElement::getType() const
{
    return m_Type;
}


void CtTermRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CtTermRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void CtTermRefElement::unsetType()
{
    m_TypeIsSet = false;
}
