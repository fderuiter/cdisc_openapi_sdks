...
void CdashigClassRef::validate()
{
    // TODO: implement validation
}

web::json::value CdashigClassRef::toJson() const
{
...
bool CdashigClassRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CdashigClassRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashigClassRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashigClassRef::getHref() const
{
    return m_Href;
}


void CdashigClassRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CdashigClassRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CdashigClassRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CdashigClassRef::getTitle() const
{
    return m_Title;
}


void CdashigClassRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CdashigClassRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CdashigClassRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CdashigClassRef::getType() const
{
    return m_Type;
}


void CdashigClassRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CdashigClassRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CdashigClassRef::unsetType()
{
    m_TypeIsSet = false;
}
