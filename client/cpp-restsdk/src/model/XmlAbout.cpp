...
void XmlAbout::validate()
{
    // TODO: implement validation
}

web::json::value XmlAbout::toJson() const
{
...
bool XmlAbout::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<About> refVal_setSelf;
...
void XmlAbout::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlAbout::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<About> XmlAbout::getSelf() const
{
    return m_Self;
}


void XmlAbout::setSelf(const std::shared_ptr<About>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlAbout::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlAbout::unsetSelf()
{
    m_SelfIsSet = false;
}
