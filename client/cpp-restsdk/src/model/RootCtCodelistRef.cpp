...
void RootCtCodelistRef::validate()
{
    // TODO: implement validation
}

web::json::value RootCtCodelistRef::toJson() const
{
...
bool RootCtCodelistRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RootCtCodelistRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RootCtCodelistRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t RootCtCodelistRef::getHref() const
{
    return m_Href;
}


void RootCtCodelistRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool RootCtCodelistRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void RootCtCodelistRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t RootCtCodelistRef::getTitle() const
{
    return m_Title;
}


void RootCtCodelistRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool RootCtCodelistRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void RootCtCodelistRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t RootCtCodelistRef::getType() const
{
    return m_Type;
}


void RootCtCodelistRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool RootCtCodelistRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void RootCtCodelistRef::unsetType()
{
    m_TypeIsSet = false;
}
