...
void CtPackage::validate()
{
    // TODO: implement validation
}

web::json::value CtPackage::toJson() const
{
...
bool CtPackage::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CtPackageLinks> refVal_setLinks;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("codelists"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CtPackageCodelists>> refVal_setCodelists;
...
void CtPackage::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CtPackage::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CtPackage::getName() const
{
    return m_Name;
}


void CtPackage::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool CtPackage::nameIsSet() const
{
    return m_NameIsSet;
}

void CtPackage::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t CtPackage::getLabel() const
{
    return m_Label;
}


void CtPackage::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool CtPackage::labelIsSet() const
{
    return m_LabelIsSet;
}

void CtPackage::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t CtPackage::getDescription() const
{
    return m_Description;
}


void CtPackage::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool CtPackage::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void CtPackage::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t CtPackage::getSource() const
{
    return m_Source;
}


void CtPackage::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool CtPackage::sourceIsSet() const
{
    return m_SourceIsSet;
}

void CtPackage::unsetSource()
{
    m_SourceIsSet = false;
}
utility::string_t CtPackage::getEffectiveDate() const
{
    return m_EffectiveDate;
}


void CtPackage::setEffectiveDate(const utility::string_t& value)
{
    m_EffectiveDate = value;
    m_EffectiveDateIsSet = true;
}

bool CtPackage::effectiveDateIsSet() const
{
    return m_EffectiveDateIsSet;
}

void CtPackage::unsetEffectiveDate()
{
    m_EffectiveDateIsSet = false;
}
utility::string_t CtPackage::getRegistrationStatus() const
{
    return m_RegistrationStatus;
}


void CtPackage::setRegistrationStatus(const utility::string_t& value)
{
    m_RegistrationStatus = value;
    m_RegistrationStatusIsSet = true;
}

bool CtPackage::registrationStatusIsSet() const
{
    return m_RegistrationStatusIsSet;
}

void CtPackage::unsetRegistrationStatus()
{
    m_RegistrationStatusIsSet = false;
}
utility::string_t CtPackage::getVersion() const
{
    return m_Version;
}


void CtPackage::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool CtPackage::versionIsSet() const
{
    return m_VersionIsSet;
}

void CtPackage::unsetVersion()
{
    m_VersionIsSet = false;
}
std::shared_ptr<CtPackageLinks> CtPackage::getLinks() const
{
    return m__links;
}


void CtPackage::setLinks(const std::shared_ptr<CtPackageLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool CtPackage::linksIsSet() const
{
    return m__linksIsSet;
}

void CtPackage::unset_links()
{
    m__linksIsSet = false;
}
std::vector<std::shared_ptr<CtPackageCodelists>> CtPackage::getCodelists() const
{
    return m_Codelists;
}


void CtPackage::setCodelists(const std::vector<std::shared_ptr<CtPackageCodelists>>& value)
{
    m_Codelists = value;
    m_CodelistsIsSet = true;
}

bool CtPackage::codelistsIsSet() const
{
    return m_CodelistsIsSet;
}

void CtPackage::unsetCodelists()
{
    m_CodelistsIsSet = false;
}
