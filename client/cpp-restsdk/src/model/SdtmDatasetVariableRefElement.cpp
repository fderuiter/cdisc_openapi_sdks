...
void SdtmDatasetVariableRefElement::validate()
{
    // TODO: implement validation
}

web::json::value SdtmDatasetVariableRefElement::toJson() const
{
...
bool SdtmDatasetVariableRefElement::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmDatasetVariableRefElement::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmDatasetVariableRefElement::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmDatasetVariableRefElement::getHref() const
{
    return m_Href;
}


void SdtmDatasetVariableRefElement::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmDatasetVariableRefElement::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmDatasetVariableRefElement::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmDatasetVariableRefElement::getTitle() const
{
    return m_Title;
}


void SdtmDatasetVariableRefElement::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmDatasetVariableRefElement::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmDatasetVariableRefElement::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmDatasetVariableRefElement::getType() const
{
    return m_Type;
}


void SdtmDatasetVariableRefElement::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmDatasetVariableRefElement::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmDatasetVariableRefElement::unsetType()
{
    m_TypeIsSet = false;
}
