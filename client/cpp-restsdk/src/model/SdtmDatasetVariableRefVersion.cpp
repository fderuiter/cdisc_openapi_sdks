...
void SdtmDatasetVariableRefVersion::validate()
{
    // TODO: implement validation
}

web::json::value SdtmDatasetVariableRefVersion::toJson() const
{
...
bool SdtmDatasetVariableRefVersion::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmDatasetVariableRefVersion::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmDatasetVariableRefVersion::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmDatasetVariableRefVersion::getHref() const
{
    return m_Href;
}


void SdtmDatasetVariableRefVersion::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmDatasetVariableRefVersion::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmDatasetVariableRefVersion::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmDatasetVariableRefVersion::getTitle() const
{
    return m_Title;
}


void SdtmDatasetVariableRefVersion::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmDatasetVariableRefVersion::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmDatasetVariableRefVersion::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmDatasetVariableRefVersion::getType() const
{
    return m_Type;
}


void SdtmDatasetVariableRefVersion::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmDatasetVariableRefVersion::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmDatasetVariableRefVersion::unsetType()
{
    m_TypeIsSet = false;
}
