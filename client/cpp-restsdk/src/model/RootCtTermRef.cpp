...
void RootCtTermRef::validate()
{
    // TODO: implement validation
}

web::json::value RootCtTermRef::toJson() const
{
...
bool RootCtTermRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RootCtTermRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RootCtTermRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t RootCtTermRef::getHref() const
{
    return m_Href;
}


void RootCtTermRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool RootCtTermRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void RootCtTermRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t RootCtTermRef::getTitle() const
{
    return m_Title;
}


void RootCtTermRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool RootCtTermRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void RootCtTermRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t RootCtTermRef::getType() const
{
    return m_Type;
}


void RootCtTermRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool RootCtTermRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void RootCtTermRef::unsetType()
{
    m_TypeIsSet = false;
}
