...
#include "CppRestOpenAPIClient/model/SdtmigClassesRef.h"
...
void SdtmigClassesRef::validate()
{
    // TODO: implement validation
}

web::json::value SdtmigClassesRef::toJson() const
{
...
bool SdtmigClassesRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SdtmigClassesRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SdtmigClassesRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SdtmigClassesRef::getHref() const
{
    return m_Href;
}


void SdtmigClassesRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool SdtmigClassesRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void SdtmigClassesRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t SdtmigClassesRef::getTitle() const
{
    return m_Title;
}


void SdtmigClassesRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool SdtmigClassesRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void SdtmigClassesRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t SdtmigClassesRef::getType() const
{
    return m_Type;
}


void SdtmigClassesRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool SdtmigClassesRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void SdtmigClassesRef::unsetType()
{
    m_TypeIsSet = false;
}
