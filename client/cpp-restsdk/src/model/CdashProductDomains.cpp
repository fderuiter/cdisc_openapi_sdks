...
void CdashProductDomains::validate()
{
    // TODO: implement validation
}

web::json::value CdashProductDomains::toJson() const
{
...
bool CdashProductDomains::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CdashProductDomainsLinks> refVal_setLinks;
...
void CdashProductDomains::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CdashProductDomains::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CdashProductDomains::getName() const
{
    return m_Name;
}


void CdashProductDomains::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool CdashProductDomains::nameIsSet() const
{
    return m_NameIsSet;
}

void CdashProductDomains::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t CdashProductDomains::getLabel() const
{
    return m_Label;
}


void CdashProductDomains::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool CdashProductDomains::labelIsSet() const
{
    return m_LabelIsSet;
}

void CdashProductDomains::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t CdashProductDomains::getDescription() const
{
    return m_Description;
}


void CdashProductDomains::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool CdashProductDomains::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void CdashProductDomains::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t CdashProductDomains::getSource() const
{
    return m_Source;
}


void CdashProductDomains::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool CdashProductDomains::sourceIsSet() const
{
    return m_SourceIsSet;
}

void CdashProductDomains::unsetSource()
{
    m_SourceIsSet = false;
}
utility::string_t CdashProductDomains::getEffectiveDate() const
{
    return m_EffectiveDate;
}


void CdashProductDomains::setEffectiveDate(const utility::string_t& value)
{
    m_EffectiveDate = value;
    m_EffectiveDateIsSet = true;
}

bool CdashProductDomains::effectiveDateIsSet() const
{
    return m_EffectiveDateIsSet;
}

void CdashProductDomains::unsetEffectiveDate()
{
    m_EffectiveDateIsSet = false;
}
utility::string_t CdashProductDomains::getRegistrationStatus() const
{
    return m_RegistrationStatus;
}


void CdashProductDomains::setRegistrationStatus(const utility::string_t& value)
{
    m_RegistrationStatus = value;
    m_RegistrationStatusIsSet = true;
}

bool CdashProductDomains::registrationStatusIsSet() const
{
    return m_RegistrationStatusIsSet;
}

void CdashProductDomains::unsetRegistrationStatus()
{
    m_RegistrationStatusIsSet = false;
}
utility::string_t CdashProductDomains::getVersion() const
{
    return m_Version;
}


void CdashProductDomains::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool CdashProductDomains::versionIsSet() const
{
    return m_VersionIsSet;
}

void CdashProductDomains::unsetVersion()
{
    m_VersionIsSet = false;
}
std::shared_ptr<CdashProductDomainsLinks> CdashProductDomains::getLinks() const
{
    return m__links;
}


void CdashProductDomains::setLinks(const std::shared_ptr<CdashProductDomainsLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool CdashProductDomains::linksIsSet() const
{
    return m__linksIsSet;
}

void CdashProductDomains::unset_links()
{
    m__linksIsSet = false;
}
