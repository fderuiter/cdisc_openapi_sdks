...
void CtCodelistTermsRef::validate()
{
    // TODO: implement validation
}

web::json::value CtCodelistTermsRef::toJson() const
{
...
bool CtCodelistTermsRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CtCodelistTermsRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CtCodelistTermsRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CtCodelistTermsRef::getHref() const
{
    return m_Href;
}


void CtCodelistTermsRef::setHref(const utility::string_t& value)
{
    m_Href = value;
    m_HrefIsSet = true;
}

bool CtCodelistTermsRef::hrefIsSet() const
{
    return m_HrefIsSet;
}

void CtCodelistTermsRef::unsetHref()
{
    m_HrefIsSet = false;
}
utility::string_t CtCodelistTermsRef::getTitle() const
{
    return m_Title;
}


void CtCodelistTermsRef::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool CtCodelistTermsRef::titleIsSet() const
{
    return m_TitleIsSet;
}

void CtCodelistTermsRef::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t CtCodelistTermsRef::getType() const
{
    return m_Type;
}


void CtCodelistTermsRef::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool CtCodelistTermsRef::typeIsSet() const
{
    return m_TypeIsSet;
}

void CtCodelistTermsRef::unsetType()
{
    m_TypeIsSet = false;
}
