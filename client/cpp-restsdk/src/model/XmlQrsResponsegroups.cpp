...
void XmlQrsResponsegroups::validate()
{
    // TODO: implement validation
}

web::json::value XmlQrsResponsegroups::toJson() const
{
...
bool XmlQrsResponsegroups::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("self"))))
    {
        ...
        {
            std::shared_ptr<QrsResponsegroups> refVal_setSelf;
...
void XmlQrsResponsegroups::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool XmlQrsResponsegroups::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<QrsResponsegroups> XmlQrsResponsegroups::getSelf() const
{
    return m_Self;
}


void XmlQrsResponsegroups::setSelf(const std::shared_ptr<QrsResponsegroups>& value)
{
    m_Self = value;
    m_SelfIsSet = true;
}

bool XmlQrsResponsegroups::selfIsSet() const
{
    return m_SelfIsSet;
}

void XmlQrsResponsegroups::unsetSelf()
{
    m_SelfIsSet = false;
}
