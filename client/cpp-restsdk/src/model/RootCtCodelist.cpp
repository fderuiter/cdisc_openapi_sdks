...
void RootCtCodelist::validate()
{
    // TODO: implement validation
}

web::json::value RootCtCodelist::toJson() const
{
...
bool RootCtCodelist::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("_links"))))
    {
        ...
        {
            std::shared_ptr<RootCtCodelistLinks> refVal_setLinks;
...
void RootCtCodelist::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RootCtCodelist::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<RootCtCodelistLinks> RootCtCodelist::getLinks() const
{
    return m__links;
}


void RootCtCodelist::setLinks(const std::shared_ptr<RootCtCodelistLinks>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool RootCtCodelist::linksIsSet() const
{
    return m__linksIsSet;
}

void RootCtCodelist::unset_links()
{
    m__linksIsSet = false;
}
