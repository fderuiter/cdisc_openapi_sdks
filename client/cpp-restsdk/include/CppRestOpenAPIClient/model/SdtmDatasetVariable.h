...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_SdtmDatasetVariable_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_SdtmDatasetVariable_H_
...
public:
    ...
    std::shared_ptr<SdtmDatasetVariableLinks> getLinks() const;
    bool linksIsSet() const;
    void unset_links();
    void setLinks(const std::shared_ptr<SdtmDatasetVariableLinks>& value);
...
protected:
    ...
    std::shared_ptr<SdtmDatasetVariableLinks> m__links;
    bool m__linksIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_SdtmDatasetVariable_H_ */
