...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_SdtmClassVariable_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_SdtmClassVariable_H_
...
public:
    ...
    std::shared_ptr<SdtmClassVariableLinks> getLinks() const;
    bool linksIsSet() const;
    void unset_links();
    void setLinks(const std::shared_ptr<SdtmClassVariableLinks>& value);
...
protected:
    ...
    utility::string_t m_RoleDescription;
    bool m_RoleDescriptionIsSet;
    ...
    std::shared_ptr<SdtmClassVariableLinks> m__links;
    bool m__linksIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_SdtmClassVariable_H_ */
