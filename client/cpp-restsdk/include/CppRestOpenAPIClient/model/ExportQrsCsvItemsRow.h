...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ExportQrsCsvItemsRow_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ExportQrsCsvItemsRow_H_
...
public:
    ...
    /////////////////////////////////////////////
    /// ExportQrsCsvItemsRow members


    utility::string_t getQRSMeasureName() const;
    bool qRSMeasureNameIsSet() const;
    void unsetQRS_Measure_Name();
    void setQRSMeasureName(const utility::string_t& value);

    utility::string_t getQRSMeasureLabel() const;
    bool qRSMeasureLabelIsSet() const;
    void unsetQRS_Measure_Label();
    void setQRSMeasureLabel(const utility::string_t& value);

    utility::string_t getQRSMeasureType() const;
    bool qRSMeasureTypeIsSet() const;
    void unsetQRS_Measure_Type();
    void setQRSMeasureType(const utility::string_t& value);
...
protected:
    utility::string_t m_QRS_Measure_Name;
    bool m_QRS_Measure_NameIsSet;

    utility::string_t m_QRS_Measure_Label;
    bool m_QRS_Measure_LabelIsSet;

    utility::string_t m_QRS_Measure_Type;
    bool m_QRS_Measure_TypeIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ExportQrsCsvItemsRow_H_ */
