...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_SdtmigDatasetVariable_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_SdtmigDatasetVariable_H_
...
public:
    ...
    std::shared_ptr<SdtmigDatasetVariableLinks> getLinks() const;
    bool linksIsSet() const;
    void unset_links();
    void setLinks(const std::shared_ptr<SdtmigDatasetVariableLinks>& value);
...
protected:
    ...
    std::shared_ptr<SdtmigDatasetVariableLinks> m__links;
    bool m__linksIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_SdtmigDatasetVariable_H_ */
