...
class ROOT_CDASH_DOMAIN_FIELD_LINKS
...
feature --Access
    ...
    self: detachable ROOT_CDASH_DOMAIN_FIELD_REF
      
    versions: detachable LIST [CDASH_DOMAIN_FIELD_REF_VERSION]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass ROOT_CDASH_DOMAIN_FIELD_LINKS%N")
