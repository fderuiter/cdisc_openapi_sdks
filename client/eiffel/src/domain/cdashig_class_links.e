...
feature --Access
    ...
    self: detachable CDASHIG_CLASS_REF
      
    model_class: detachable CDASH_CLASS_REF
      
    parent_product: detachable CDASHIG_PRODUCT_REF
      
    parent_class: detachable CDASHIG_CLASS_REF
      
    subclasses: detachable LIST [CDASHIG_CLASS_REF_SUBCLASS]
      
    prior_version: detachable CDASHIG_CLASS_REF
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CDASHIG_CLASS_LINKS%N")
