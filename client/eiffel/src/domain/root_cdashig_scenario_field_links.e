...
class ROOT_CDASHIG_SCENARIO_FIELD_LINKS
...
feature --Access
    ...
    self: detachable ROOT_CDASHIG_SCENARIO_FIELD_REF
      
    versions: detachable LIST [CDASHIG_SCENARIO_FIELD_REF_VERSION]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass ROOT_CDASHIG_SCENARIO_FIELD_LINKS%N")
