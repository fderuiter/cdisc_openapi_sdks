...
class ROOT_CDASHIG_DOMAIN_FIELD_LINKS
...
feature --Access
    ...
    self: detachable ROOT_CDASHIG_DOMAIN_FIELD_REF
      
    versions: detachable LIST [CDASHIG_DOMAIN_FIELD_REF_VERSION]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass ROOT_CDASHIG_DOMAIN_FIELD_LINKS%N")
