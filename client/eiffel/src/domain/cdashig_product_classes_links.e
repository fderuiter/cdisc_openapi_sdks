...
class CDASHIG_PRODUCT_CLASSES_LINKS
...
feature --Access
    ...
    self: detachable CDASHIG_PRODUCT_CLASSES_REF
      
    parent_product: detachable CDASHIG_PRODUCT_REF
      
    classes: detachable LIST [CDASHIG_CLASS_REF_ELEMENT]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CDASHIG_PRODUCT_CLASSES_LINKS%N")
