...
feature --Access
    ...
    self: detachable SDTM_CLASS_REF
      
    parent_product: detachable SDTM_PRODUCT_REF
      
    parent_class: detachable SDTM_CLASS_REF
      
    subclasses: detachable LIST [SDTM_CLASS_REF_SUBCLASS]
      
    prior_version: detachable SDTM_CLASS_REF
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass SDTM_CLASS_LINKS%N")
