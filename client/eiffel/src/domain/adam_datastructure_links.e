...
class ADAM_DATASTRUCTURE_LINKS
...
feature --Access
    ...
    self: detachable ADAM_DATASTRUCTURE_REF
      
    parent_product: detachable ADAM_PRODUCT_REF
      
    prior_version: detachable ADAM_DATASTRUCTURE_REF
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass ADAM_DATASTRUCTURE_LINKS%N")
