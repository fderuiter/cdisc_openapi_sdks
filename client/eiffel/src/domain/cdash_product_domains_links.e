...
class CDASH_PRODUCT_DOMAINS_LINKS
...
feature --Access
    ...
    self: detachable CDASH_PRODUCT_DOMAINS_REF
      
    parent_product: detachable CDASH_PRODUCT_REF
      
    domains: detachable LIST [CDASH_DOMAIN_REF_ELEMENT]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CDASH_PRODUCT_DOMAINS_LINKS%N")
