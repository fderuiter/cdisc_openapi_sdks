...
feature --Access
    ...
    self: detachable SDTMIG_CLASSES_REF
      
    prior_version: detachable SDTMIG_CLASSES_REF
      
    classes: detachable LIST [SDTMIG_CLASS_REF_ELEMENT]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass SDTMIG_CLASSES_LINKS%N")
