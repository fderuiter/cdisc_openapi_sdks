...
/*
 * OAIExportCdashDomainVariablesRow.h
 *
 * 
 */

#ifndef OAIExportCdashDomainVariablesRow_H
#define OAIExportCdashDomainVariablesRow_H
...
class OAIExportCdashDomainVariablesRow : public OAIObject {
public:
    OAIExportCdashDomainVariablesRow();
    OAIExportCdashDomainVariablesRow(QString json);
    ~OAIExportCdashDomainVariablesRow() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportCdashDomainVariablesRow)

#endif // OAIExportCdashDomainVariablesRow_H
