...
class CdashigDomainFieldTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CdashigDomainField
        //val modelInstance = CdashigDomainField()
        ...
        // to test the property `completionInstructions`
        should("test completionInstructions") {
            // uncomment below to test the property
            //modelInstance.completionInstructions shouldBe ("TODO")
        }
