...
module OpenapiClient
  class CdashigScenarioField
    ...
    attr_accessor :completion_instructions
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CdashigScenarioField` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CdashigScenarioField`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'completion_instructions')
        self.completion_instructions = attributes[:'completion_instructions']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          prompt == o.prompt &&
          completion_instructions == o.completion_instructions &&
    ...
    def hash
      [ordinal, name, label, definition, question_text, prompt, completion_instructions, implementation_notes, simple_datatype, mapping_instructions, core, _links].hash
    end
