...
module OpenapiClient
  class ExportCdashDomainVariablesRow
    ...
    attr_accessor :cdash_variable

    attr_accessor :cdash_variable_label

    attr_accessor :draft_cdash_definition

    attr_accessor :domain_specific
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ExportCdashDomainVariablesRow` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ExportCdashDomainVariablesRow`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cdash_variable')
        self.cdash_variable = attributes[:'cdash_variable']
      end

      if attributes.key?(:'cdash_variable_label')
        self.cdash_variable_label = attributes[:'cdash_variable_label']
      end

      if attributes.key?(:'draft_cdash_definition')
        self.draft_cdash_definition = attributes[:'draft_cdash_definition']
      end

      if attributes.key?(:'domain_specific')
        self.domain_specific = attributes[:'domain_specific']
      end
      ...
      if attributes.key?(:'sdtm_target')
        if (value = attributes[:'sdtm_target']).is_a?(Array)
          self.sdtm_target = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cdash_variable == o.cdash_variable &&
          cdash_variable_label == o.cdash_variable_label &&
          draft_cdash_definition == o.draft_cdash_definition &&
          domain_specific == o.domain_specific &&
          question_text == o.question_text &&
          prompt == o.prompt &&
          type == o.type &&
          sdtm_target == o.sdtm_target &&
    ...
    def hash
      [version, _class, domain, variable_order, cdash_variable, cdash_variable_label, draft_cdash_definition, domain_specific, question_text, prompt, type, sdtm_target, mapping_instructions, controlled_terminology_codelist_name, implementation_notes].hash
    end
