...
class SdtmDatasetVariableLinks(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["self", "parentProduct", "parentDataset", "rootItem", "priorVersion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": SdtmDatasetVariableRef.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "parentProduct": SdtmProductRef.from_dict(obj["parentProduct"]) if obj.get("parentProduct") is not None else None,
            "parentDataset": SdtmDatasetRef.from_dict(obj["parentDataset"]) if obj.get("parentDataset") is not None else None,
            "rootItem": RootSdtmDatasetVariableRef.from_dict(obj["rootItem"]) if obj.get("rootItem") is not None else None,
            "priorVersion": SdtmDatasetVariableRef.from_dict(obj["priorVersion"]) if obj.get("priorVersion") is not None else None
        })
        return _obj
