...
class CdashigScenarioFieldsLinks(BaseModel):
    ...
    fields: Optional[List[CdashigScenarioFieldRefElement]] = None
    __properties: ClassVar[List[str]] = ["self", "parentProduct", "parentClass", "parentDomain", "fields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": CdashigScenarioFieldsRef.from_dict(obj["self"]) if obj.get("self") is not None else None,
            ...
            "fields": [CdashigScenarioFieldRefElement.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None
        })
        return _obj
