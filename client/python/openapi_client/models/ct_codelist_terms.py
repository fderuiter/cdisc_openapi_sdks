...
class CtCodelistTerms(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["conceptId", "extensible", "name", "submissionValue", "definition", "preferredTerm", "synonyms", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": CtCodelistTermsLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
