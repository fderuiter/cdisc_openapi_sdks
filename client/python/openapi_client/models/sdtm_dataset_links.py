...
class SdtmDatasetLinks(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": SdtmDatasetRef.from_dict(obj["self"]) if obj.get("self") is not None else None,
            ...
            "priorVersion": SdtmDatasetRef.from_dict(obj["priorVersion"]) if obj.get("priorVersion") is not None else None
        })
        return _obj
