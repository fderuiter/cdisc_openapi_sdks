...
class DefaultSearchResponse(BaseModel):
    ...
    """ # noqa: E501
    hits: Optional[List[DefaultSearchResponseHitsInner]] = None
    total_hits: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalHits")
    __properties: ClassVar[List[str]] = ["hits", "totalHits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hits": [DefaultSearchResponseHitsInner.from_dict(_item) for _item in obj["hits"]] if obj.get("hits") is not None else None,
