...
class ExportQrsWorkbookItemsRow(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["Item Sequence", "Test Name", "Item Text", "Test&#39;s Codelist C-Code", "Test&#39;s Term C-Code", "Test Code&#39;s Codelist C-Code", "Test Code&#39;s Term C-Code", "Subcategory&#39;s Codelist C-Code", "Subcategory&#39;s Term C-Code", "Evaluator&#39;s Codelist C-Code", "Evaluator&#39;s Term C-Code", "Free-form Response&#39;s Datatype", "Response Group"]
