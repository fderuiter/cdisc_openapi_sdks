...
class AdamDatastructureVariables(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ordinal", "name", "label", "description", "class", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "class": obj.get("class"),
            "_links": AdamDatastructureVariablesLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
