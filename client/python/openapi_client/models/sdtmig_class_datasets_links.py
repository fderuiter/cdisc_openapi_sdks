...
class SdtmigClassDatasetsLinks(BaseModel):
    ...
    datasets: Optional[List[SdtmigDatasetRefElement]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": SdtmigClassDatasetsRef.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "parentProduct": SdtmigProductRef.from_dict(obj["parentProduct"]) if obj.get("parentProduct") is not None else None,
            "priorVersion": SdtmigClassDatasetsRef.from_dict(obj["priorVersion"]) if obj.get("priorVersion") is not None else None,
            "datasets": [SdtmigDatasetRefElement.from_dict(_item) for _item in obj["datasets"]] if obj.get("datasets") is not None else None
        })
        return _obj
