...
case class SdtmigDatasetVariableLinks (
    _self: Option[SdtmigDatasetVariableRef],
    ...
    _parentDataset: Option[SdtmigDatasetRef],
    _rootItem: Option[RootSdtmigDatasetVariableRef],
    _priorVersion: Option[SdtmigDatasetVariableRef]
)
