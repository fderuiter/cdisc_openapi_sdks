...
/*
 * OAIExportCdashigDomainVariablesRow.h
 *
 * 
 */

#ifndef OAIExportCdashigDomainVariablesRow_H
#define OAIExportCdashigDomainVariablesRow_H
...
class OAIExportCdashigDomainVariablesRow : public OAIObject {
public:
    OAIExportCdashigDomainVariablesRow();
    OAIExportCdashigDomainVariablesRow(QString json);
    ~OAIExportCdashigDomainVariablesRow() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportCdashigDomainVariablesRow)

#endif // OAIExportCdashigDomainVariablesRow_H
