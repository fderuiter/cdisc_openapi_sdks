...
/**
 * The ExportCdashigScenarioVariablesRow model module.
 * @module model/ExportCdashigScenarioVariablesRow
 * @version 1.1.0
 */
class ExportCdashigScenarioVariablesRow {
    /**
     * Constructs a new <code>ExportCdashigScenarioVariablesRow</code>.
     * @alias module:model/ExportCdashigScenarioVariablesRow
     */
    constructor() { 
        
        ExportCdashigScenarioVariablesRow.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExportCdashigScenarioVariablesRow</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExportCdashigScenarioVariablesRow} obj Optional instance to populate.
     * @return {module:model/ExportCdashigScenarioVariablesRow} The populated <code>ExportCdashigScenarioVariablesRow</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExportCdashigScenarioVariablesRow();
    ...
    /**
     * Validates the JSON data with respect to <code>ExportCdashigScenarioVariablesRow</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExportCdashigScenarioVariablesRow</code>.
     */
 ...
 */
ExportCdashigScenarioVariablesRow.prototype['Version'] = undefined;

/**
 * @member {String} Class
 */
ExportCdashigScenarioVariablesRow.prototype['Class'] = undefined;

/**
 * @member {String} Domain
 */
ExportCdashigScenarioVariablesRow.prototype['Domain'] = undefined;

/**
 * @member {String} Data Collection Scenario
 */
ExportCdashigScenarioVariablesRow.prototype['Data Collection Scenario'] = undefined;

/**
 * @member {String} Variable Order
 */
ExportCdashigScenarioVariablesRow.prototype['Variable Order'] = undefined;

/**
 * @member {String} CDASHIG Variable
 */
ExportCdashigScenarioVariablesRow.prototype['CDASHIG Variable'] = undefined;

/**
 * @member {String} CDASHIG Variable Label
 */
ExportCdashigScenarioVariablesRow.prototype['CDASHIG Variable Label'] = undefined;

/**
 * @member {String} DRAFT CDASHIG Definition
 */
ExportCdashigScenarioVariablesRow.prototype['DRAFT CDASHIG Definition'] = undefined;

/**
 * @member {String} Question Text
 */
ExportCdashigScenarioVariablesRow.prototype['Question Text'] = undefined;

/**
 * @member {String} Prompt
 */
ExportCdashigScenarioVariablesRow.prototype['Prompt'] = undefined;

/**
 * @member {String} Type
 */
ExportCdashigScenarioVariablesRow.prototype['Type'] = undefined;

/**
 * @member {String} CDASHIG Core
 */
ExportCdashigScenarioVariablesRow.prototype['CDASHIG Core'] = undefined;

/**
 * @member {String} Case Report Form Completion Instructions
 */
ExportCdashigScenarioVariablesRow.prototype['Case Report Form Completion Instructions'] = undefined;

/**
 * @member {Array.<String>} SDTMIG Target
 */
ExportCdashigScenarioVariablesRow.prototype['SDTMIG Target'] = undefined;

/**
 * @member {String} Mapping Instructions
 */
ExportCdashigScenarioVariablesRow.prototype['Mapping Instructions'] = undefined;

/**
 * @member {String} Controlled Terminology Codelist Name
 */
ExportCdashigScenarioVariablesRow.prototype['Controlled Terminology Codelist Name'] = undefined;

/**
 * @member {String} Implementation Notes
 */
ExportCdashigScenarioVariablesRow.prototype['Implementation Notes'] = undefined;
...
export default ExportCdashigScenarioVariablesRow;
