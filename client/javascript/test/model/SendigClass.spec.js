...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CdiscLibraryApi.SendigClass();
  });
  ...
  describe('SendigClass', function() {
    it('should create an instance of SendigClass', function() {
      // uncomment below and update the code to test SendigClass
      //var instance = new CdiscLibraryApi.SendigClass();
      //expect(instance).to.be.a(CdiscLibraryApi.SendigClass);
    });
