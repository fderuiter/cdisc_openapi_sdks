...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CdiscLibraryApi.CdashigClass();
  });
  ...
  describe('CdashigClass', function() {
    it('should create an instance of CdashigClass', function() {
      // uncomment below and update the code to test CdashigClass
      //var instance = new CdiscLibraryApi.CdashigClass();
      //expect(instance).to.be.a(CdiscLibraryApi.CdashigClass);
    });
