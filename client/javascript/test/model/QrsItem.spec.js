...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CdiscLibraryApi.QrsItem();
  });
  ...
  describe('QrsItem', function() {
    it('should create an instance of QrsItem', function() {
      // uncomment below and update the code to test QrsItem
      //var instance = new CdiscLibraryApi.QrsItem();
      //expect(instance).to.be.a(CdiscLibraryApi.QrsItem);
    });
