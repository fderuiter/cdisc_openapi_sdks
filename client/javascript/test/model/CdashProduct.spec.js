...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CdiscLibraryApi.CdashProduct();
  });
  ...
  describe('CdashProduct', function() {
    it('should create an instance of CdashProduct', function() {
      // uncomment below and update the code to test CdashProduct
      //var instance = new CdiscLibraryApi.CdashProduct();
      //expect(instance).to.be.a(CdiscLibraryApi.CdashProduct);
    });
