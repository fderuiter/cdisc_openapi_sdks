...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CdiscLibraryApi.CdashigProduct();
  });
  ...
  describe('CdashigProduct', function() {
    it('should create an instance of CdashigProduct', function() {
      // uncomment below and update the code to test CdashigProduct
      //var instance = new CdiscLibraryApi.CdashigProduct();
      //expect(instance).to.be.a(CdiscLibraryApi.CdashigProduct);
    });
