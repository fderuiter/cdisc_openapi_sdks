...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CdiscLibraryApi.SendigProduct();
  });
  ...
  describe('SendigProduct', function() {
    it('should create an instance of SendigProduct', function() {
      // uncomment below and update the code to test SendigProduct
      //var instance = new CdiscLibraryApi.SendigProduct();
      //expect(instance).to.be.a(CdiscLibraryApi.SendigProduct);
    });
