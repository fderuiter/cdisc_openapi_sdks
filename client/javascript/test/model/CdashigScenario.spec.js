...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CdiscLibraryApi.CdashigScenario();
  });
  ...
  describe('CdashigScenario', function() {
    it('should create an instance of CdashigScenario', function() {
      // uncomment below and update the code to test CdashigScenario
      //var instance = new CdiscLibraryApi.CdashigScenario();
      //expect(instance).to.be.a(CdiscLibraryApi.CdashigScenario);
    });
