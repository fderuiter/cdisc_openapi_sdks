...
/// tests for StudyDataTabulationModelSDTMApi
void main() {
  // final instance = StudyDataTabulationModelSDTMApi();

  group('tests for StudyDataTabulationModelSDTMApi', () {
    // Get Root of SDTM Class Variable
    //
    //Future<RootSdtmClassVariable> mdrRootSdtmClassesClassVariablesVarGet(String class_, String var_) async
    test('test mdrRootSdtmClassesClassVariablesVarGet', () async {
      // TODO
    });
    ...
    test('test mdrRootSdtmDatasetsDatasetVariablesVarGet', () async {
      // TODO
    });
    ...
    test('test mdrSdtmVersionClassesClassDatasetsGet', () async {
      // TODO
    });
    ...
    test('test mdrSdtmVersionClassesClassGet', () async {
      // TODO
    });
    ...
    test('test mdrSdtmVersionClassesClassVariablesGet', () async {
      // TODO
    });
    ...
    test('test mdrSdtmVersionClassesClassVariablesVarGet', () async {
      // TODO
    });
    ...
    test('test mdrSdtmVersionClassesGet', () async {
      // TODO
    });
    ...
    test('test mdrSdtmVersionDatasetsDatasetGet', () async {
      // TODO
    });
    ...
    test('test mdrSdtmVersionDatasetsDatasetVariablesGet', () async {
      // TODO
    });
    ...
    test('test mdrSdtmVersionDatasetsDatasetVariablesVarGet', () async {
      // TODO
    });
    ...
    test('test mdrSdtmVersionDatasetsGet', () async {
      // TODO
    });
    ...
    test('test mdrSdtmVersionGet', () async {
      // TODO
    });
