...
class ExportCdashigScenarioVariablesRow {
  /// Returns a new [ExportCdashigScenarioVariablesRow] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ExportCdashigScenarioVariablesRow &&
  ...
  /// Returns a new [ExportCdashigScenarioVariablesRow] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ExportCdashigScenarioVariablesRow? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ExportCdashigScenarioVariablesRow[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ExportCdashigScenarioVariablesRow[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ExportCdashigScenarioVariablesRow> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ExportCdashigScenarioVariablesRow>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ExportCdashigScenarioVariablesRow.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ExportCdashigScenarioVariablesRow> mapFromJson(dynamic json) {
    final map = <String, ExportCdashigScenarioVariablesRow>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ExportCdashigScenarioVariablesRow.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ExportCdashigScenarioVariablesRow-objects as value to a dart map
  static Map<String, List<ExportCdashigScenarioVariablesRow>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ExportCdashigScenarioVariablesRow>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ExportCdashigScenarioVariablesRow.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
