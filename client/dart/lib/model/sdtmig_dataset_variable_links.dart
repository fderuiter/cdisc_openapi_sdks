...
class SdtmigDatasetVariableLinks {
  /// Returns a new [SdtmigDatasetVariableLinks] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SdtmigDatasetVariableLinks &&
    other.self == self &&
  ...
  @override
  String toString() => 'SdtmigDatasetVariableLinks[self=$self, codelist=$codelist, modelClassVariable=$modelClassVariable, modelDatasetVariable=$modelDatasetVariable, parentProduct=$parentProduct, parentDataset=$parentDataset, rootItem=$rootItem, priorVersion=$priorVersion]';
  ...
  /// Returns a new [SdtmigDatasetVariableLinks] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SdtmigDatasetVariableLinks? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SdtmigDatasetVariableLinks[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SdtmigDatasetVariableLinks[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return SdtmigDatasetVariableLinks(
        self: SdtmigDatasetVariableRef.fromJson(json[r'self']),
        ...
        parentDataset: SdtmigDatasetRef.fromJson(json[r'parentDataset']),
        rootItem: RootSdtmigDatasetVariableRef.fromJson(json[r'rootItem']),
        priorVersion: SdtmigDatasetVariableRef.fromJson(json[r'priorVersion']),
      );
    }
    return null;
  }

  static List<SdtmigDatasetVariableLinks> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SdtmigDatasetVariableLinks>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SdtmigDatasetVariableLinks.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SdtmigDatasetVariableLinks> mapFromJson(dynamic json) {
    final map = <String, SdtmigDatasetVariableLinks>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SdtmigDatasetVariableLinks.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SdtmigDatasetVariableLinks-objects as value to a dart map
  static Map<String, List<SdtmigDatasetVariableLinks>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SdtmigDatasetVariableLinks>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SdtmigDatasetVariableLinks.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
