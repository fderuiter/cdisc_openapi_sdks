...
class CdashigScenarioField {
  /// Returns a new [CdashigScenarioField] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CdashigScenarioField &&
  ...
  /// Returns a new [CdashigScenarioField] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CdashigScenarioField? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CdashigScenarioField[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CdashigScenarioField[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return CdashigScenarioField(
        ...
        links: CdashigScenarioFieldLinks.fromJson(json[r'_links']),
      );
    }
    return null;
  }

  static List<CdashigScenarioField> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CdashigScenarioField>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CdashigScenarioField.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CdashigScenarioField> mapFromJson(dynamic json) {
    final map = <String, CdashigScenarioField>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CdashigScenarioField.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CdashigScenarioField-objects as value to a dart map
  static Map<String, List<CdashigScenarioField>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CdashigScenarioField>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CdashigScenarioField.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
