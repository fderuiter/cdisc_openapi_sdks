...
Protected Class SdtmProduct
	...
	#tag Property, Flags = &h0
		_links As OpenAPIClient.Models.SdtmProductLinks
	#tag EndProperty


	#tag Property, Flags = &h0
		classes() As OpenAPIClient.Models.SdtmClass
	#tag EndProperty


	#tag Property, Flags = &h0
		datasets() As OpenAPIClient.Models.SdtmDataset
	#tag EndProperty
