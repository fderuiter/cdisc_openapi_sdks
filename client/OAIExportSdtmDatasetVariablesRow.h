...
/*
 * OAIExportSdtmDatasetVariablesRow.h
 *
 * 
 */

#ifndef OAIExportSdtmDatasetVariablesRow_H
#define OAIExportSdtmDatasetVariablesRow_H
...
class OAIExportSdtmDatasetVariablesRow : public OAIObject {
public:
    OAIExportSdtmDatasetVariablesRow();
    OAIExportSdtmDatasetVariablesRow(QString json);
    ~OAIExportSdtmDatasetVariablesRow() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportSdtmDatasetVariablesRow)

#endif // OAIExportSdtmDatasetVariablesRow_H
