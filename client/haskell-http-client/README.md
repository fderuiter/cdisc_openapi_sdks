## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `CDISC Library API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the CDISC Library API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | CDISCLibrary                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | cdisc-library                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | CDISCLibraryConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | CDISCLibraryRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| CDISCLibrary.Client    | use the "dispatch" functions to send requests       |
| CDISCLibrary.Core      | core functions, config and request types            |
| CDISCLibrary.API       | construct api requests                              |
| CDISCLibrary.Model     | describes api models                                |
| CDISCLibrary.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| CDISCLibrary.ModelLens | lenses for model fields                             |
| CDISCLibrary.Logging   | logging functions and utils                         |
