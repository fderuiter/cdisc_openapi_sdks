...
module CDISCLibrary.MimeTypes where
...
-- ** MimeVndOpenxmlformatsOfficedocumentSpreadsheetmlSheet

data MimeVndOpenxmlformatsOfficedocumentSpreadsheetmlSheet = MimeVndOpenxmlformatsOfficedocumentSpreadsheetmlSheet deriving (P.Typeable)

-- | @application/vnd.openxmlformats-officedocument.spreadsheetml.sheet@
instance MimeType MimeVndOpenxmlformatsOfficedocumentSpreadsheetmlSheet where
  mimeType _ = Just $ P.fromString "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
-- instance MimeRender MimeVndOpenxmlformatsOfficedocumentSpreadsheetmlSheet T.Text where mimeRender _ = undefined
-- instance MimeUnrender MimeVndOpenxmlformatsOfficedocumentSpreadsheetmlSheet T.Text where mimeUnrender _ = undefined

-- ** MimeTextCsv

data MimeTextCsv = MimeTextCsv deriving (P.Typeable)

-- | @text/csv@
instance MimeType MimeTextCsv where
  mimeType _ = Just $ P.fromString "text/csv"
-- instance MimeRender MimeTextCsv T.Text where mimeRender _ = undefined
-- instance MimeUnrender MimeTextCsv T.Text where mimeUnrender _ = undefined
