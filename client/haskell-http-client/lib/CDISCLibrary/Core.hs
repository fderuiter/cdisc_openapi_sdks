...
module CDISCLibrary.Core where
...
-- |
data CDISCLibraryConfig = CDISCLibraryConfig
...
-- | display the config
instance P.Show CDISCLibraryConfig where
  show c =
    T.printf
...
-- | constructs a default CDISCLibraryConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"cdisc-library/0.1.0.0"@
--
newConfig :: IO CDISCLibraryConfig
newConfig = do
    logCxt <- initLogContext
    return $ CDISCLibraryConfig
        { configHost = "https://library.cdisc.org/api"
        , configUserAgent = "cdisc-library/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => CDISCLibraryConfig -> auth -> CDISCLibraryConfig
addAuthMethod config@CDISCLibraryConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: CDISCLibraryConfig -> IO CDISCLibraryConfig
...
withStderrLogging :: CDISCLibraryConfig -> IO CDISCLibraryConfig
...
withNoLogging :: CDISCLibraryConfig -> CDISCLibraryConfig
...
data CDISCLibraryRequest req contentType res accept = CDISCLibraryRequest
  { rMethod  :: NH.Method   -- ^ Method of CDISCLibraryRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of CDISCLibraryRequest
  , rParams   :: Params -- ^ params of CDISCLibraryRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (CDISCLibraryRequest req contentType res accept) NH.Method
rMethodL f CDISCLibraryRequest{..} = (\rMethod -> CDISCLibraryRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (CDISCLibraryRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f CDISCLibraryRequest{..} = (\rUrlPath -> CDISCLibraryRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (CDISCLibraryRequest req contentType res accept) Params
rParamsL f CDISCLibraryRequest{..} = (\rParams -> CDISCLibraryRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (CDISCLibraryRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f CDISCLibraryRequest{..} = (\rAuthTypes -> CDISCLibraryRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => CDISCLibraryRequest req contentType res accept -> param -> CDISCLibraryRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: CDISCLibraryRequest req contentType res accept -> param -> CDISCLibraryRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: CDISCLibraryRequest req contentType res accept -> param -> CDISCLibraryRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** CDISCLibraryRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> CDISCLibraryRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = CDISCLibraryRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     CDISCLibraryRequest req contentType res accept
  -> [NH.Header]
  -> CDISCLibraryRequest req contentType res accept
...
removeHeader :: CDISCLibraryRequest req contentType res accept -> [NH.HeaderName] -> CDISCLibraryRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => CDISCLibraryRequest req contentType res accept -> CDISCLibraryRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => CDISCLibraryRequest req contentType res accept -> CDISCLibraryRequest req contentType res accept
...
addForm :: CDISCLibraryRequest req contentType res accept -> WH.Form -> CDISCLibraryRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: CDISCLibraryRequest req contentType res accept -> NH.Part -> CDISCLibraryRequest req contentType res accept
...
_setBodyBS :: CDISCLibraryRequest req contentType res accept -> B.ByteString -> CDISCLibraryRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: CDISCLibraryRequest req contentType res accept -> BL.ByteString -> CDISCLibraryRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => CDISCLibraryRequest req contentType res accept -> P.Proxy authMethod -> CDISCLibraryRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> CDISCLibraryRequest req contentType res accept
    -> IO (CDISCLibraryRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> CDISCLibraryConfig
  -> IO (CDISCLibraryRequest req contentType res accept)
_applyAuthMethods req config@(CDISCLibraryConfig {configAuthMethods = as}) =
  foldlM go req as
  where
