...
defmodule CDISCLibraryAPI.Connection do
  ...
  @doc """
  Configure a CDISCLibraryAPI client.

  ### Parameters

  - `options`: an optional keyword list of CDISCLibraryAPI.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:cdisc_library_api, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - CDISCLibraryAPI 1.0.0 - elixir"
        )
      )
