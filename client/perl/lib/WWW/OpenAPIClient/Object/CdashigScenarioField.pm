...
#
package WWW::OpenAPIClient::Object::CdashigScenarioField;
...
__PACKAGE__->method_documentation({
    ...
    'completion_instructions' => {
        datatype => 'string',
        base_name => 'completionInstructions',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    '_links' => {
        datatype => 'CdashigScenarioFieldLinks',
        base_name => '_links',
        description => '',
        format => '',
        read_only => '',
