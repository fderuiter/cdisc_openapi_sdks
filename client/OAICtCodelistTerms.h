...
/*
 * OAICtCodelistTerms.h
 *
 * 
 */

#ifndef OAICtCodelistTerms_H
#define OAICtCodelistTerms_H
...
class OAICtCodelistTerms : public OAIObject {
public:
    OAICtCodelistTerms();
    OAICtCodelistTerms(QString json);
    ~OAICtCodelistTerms() override;
    ...
    OAICtCodelistTermsLinks getLinks() const;
    void setLinks(const OAICtCodelistTermsLinks &_links);
...
private:
    ...
    OAICtCodelistTermsLinks m__links;
    bool m__links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICtCodelistTerms)

#endif // OAICtCodelistTerms_H
