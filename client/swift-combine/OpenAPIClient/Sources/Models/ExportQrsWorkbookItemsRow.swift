//
// ExportQrsWorkbookItemsRow.swift
//
...
public struct ExportQrsWorkbookItemsRow: Codable {
    ...
    public init(itemSequence: String? = nil, testName: String? = nil, itemText: String? = nil, testsCodelistCCode: String? = nil, testsTermCCode: String? = nil, testCodesCodelistCCode: String? = nil, testCodesTermCCode: String? = nil, subcategorysCodelistCCode: String? = nil, subcategorysTermCCode: String? = nil, evaluatorsCodelistCCode: String? = nil, evaluatorsTermCCode: String? = nil, freeFormResponsesDatatype: String? = nil, responseGroup: String? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        itemSequence = try container.decodeIfPresent(String.self, forKey: .itemSequence)
        testName = try container.decodeIfPresent(String.self, forKey: .testName)
        itemText = try container.decodeIfPresent(String.self, forKey: .itemText)
        testsCodelistCCode = try container.decodeIfPresent(String.self, forKey: .testsCodelistCCode)
        testsTermCCode = try container.decodeIfPresent(String.self, forKey: .testsTermCCode)
        testCodesCodelistCCode = try container.decodeIfPresent(String.self, forKey: .testCodesCodelistCCode)
        testCodesTermCCode = try container.decodeIfPresent(String.self, forKey: .testCodesTermCCode)
        subcategorysCodelistCCode = try container.decodeIfPresent(String.self, forKey: .subcategorysCodelistCCode)
        subcategorysTermCCode = try container.decodeIfPresent(String.self, forKey: .subcategorysTermCCode)
        evaluatorsCodelistCCode = try container.decodeIfPresent(String.self, forKey: .evaluatorsCodelistCCode)
        evaluatorsTermCCode = try container.decodeIfPresent(String.self, forKey: .evaluatorsTermCCode)
        freeFormResponsesDatatype = try container.decodeIfPresent(String.self, forKey: .freeFormResponsesDatatype)
