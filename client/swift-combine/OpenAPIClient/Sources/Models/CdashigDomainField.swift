...
public struct CdashigDomainField: Codable {
    ...
    public var links: CdashigDomainFieldLinks?

    public init(ordinal: String? = nil, name: String? = nil, label: String? = nil, definition: String? = nil, questionText: String? = nil, prompt: String? = nil, completionInstructions: String? = nil, implementationNotes: String? = nil, simpleDatatype: String? = nil, mappingInstructions: String? = nil, core: String? = nil, links: CdashigDomainFieldLinks? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        links = try container.decodeIfPresent(CdashigDomainFieldLinks.self, forKey: .links)
    }
