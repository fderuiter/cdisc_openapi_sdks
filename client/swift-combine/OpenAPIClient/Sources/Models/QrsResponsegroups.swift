...
public struct QrsResponsegroups: Codable {
    ...
    public var links: QrsResponsegroupsLinks?

    public init(name: String? = nil, label: String? = nil, description: String? = nil, effectiveDate: String? = nil, untilDate: String? = nil, registrationStatus: String? = nil, version: String? = nil, qrsType: String? = nil, links: QrsResponsegroupsLinks? = nil) {
        self.name = name
        self.label = label
    ...
    public init(from decoder: Decoder) throws {
        ...
        links = try container.decodeIfPresent(QrsResponsegroupsLinks.self, forKey: .links)
    }
