(ns cdisc-library-api.api.controlled-terminology-ct-
...
(defn-spec mdr-ct-packages-get-with-http-info any?
  "
  Get CDISC Library CT Package List"
  []
  (call-api "/mdr/ct/packages" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-ct-packages-get ct-packages-spec
  "
  Get CDISC Library CT Package List"
  []
  (let [res (:data (mdr-ct-packages-get-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode ct-packages-spec res st/string-transformer)
       res)))


(defn-spec mdr-ct-packages-package-codelists-codelist-get-with-http-info any?
  "
  Get CDISC Library CT Package Codelist"
  [package string?, codelist string?]
  (check-required-params package codelist)
  (call-api "/mdr/ct/packages/{package}/codelists/{codelist}" :get
            {:path-params   {"package" package "codelist" codelist }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec mdr-ct-packages-package-codelists-codelist-get ct-codelist-spec
  "
  Get CDISC Library CT Package Codelist"
  [package string?, codelist string?]
  (let [res (:data (mdr-ct-packages-package-codelists-codelist-get-with-http-info package codelist))]
    (if (:decode-models *api-context*)
       (st/decode ct-codelist-spec res st/string-transformer)
       res)))


(defn-spec mdr-ct-packages-package-codelists-codelist-terms-get-with-http-info any?
  "
  Get CDISC Library CT Package Codelist Term List"
  [package string?, codelist string?]
  (check-required-params package codelist)
  (call-api "/mdr/ct/packages/{package}/codelists/{codelist}/terms" :get
            {:path-params   {"package" package "codelist" codelist }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-ct-packages-package-codelists-codelist-terms-get ct-codelist-terms-spec
  "
  Get CDISC Library CT Package Codelist Term List"
  [package string?, codelist string?]
  (let [res (:data (mdr-ct-packages-package-codelists-codelist-terms-get-with-http-info package codelist))]
    (if (:decode-models *api-context*)
       (st/decode ct-codelist-terms-spec res st/string-transformer)
       res)))


(defn-spec mdr-ct-packages-package-codelists-codelist-terms-term-get-with-http-info any?
  "
  Get CDISC Library CT Package Codelist Term"
  [package string?, codelist string?, term string?]
  (check-required-params package codelist term)
  (call-api "/mdr/ct/packages/{package}/codelists/{codelist}/terms/{term}" :get
            {:path-params   {"package" package "codelist" codelist "term" term }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec mdr-ct-packages-package-codelists-codelist-terms-term-get ct-term-spec
  "
  Get CDISC Library CT Package Codelist Term"
  [package string?, codelist string?, term string?]
  (let [res (:data (mdr-ct-packages-package-codelists-codelist-terms-term-get-with-http-info package codelist term))]
    (if (:decode-models *api-context*)
       (st/decode ct-term-spec res st/string-transformer)
       res)))


(defn-spec mdr-ct-packages-package-codelists-get-with-http-info any?
  "
  Get CDISC Library CT Package Codelist List"
  [package string?]
  (check-required-params package)
  (call-api "/mdr/ct/packages/{package}/codelists" :get
            {:path-params   {"package" package }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec mdr-ct-packages-package-codelists-get ct-package-codelists-spec
  "
  Get CDISC Library CT Package Codelist List"
  [package string?]
  (let [res (:data (mdr-ct-packages-package-codelists-get-with-http-info package))]
    (if (:decode-models *api-context*)
       (st/decode ct-package-codelists-spec res st/string-transformer)
       res)))


(defn-spec mdr-ct-packages-product-get-with-http-info any?
  "
  Get CDISC Library CT Package"
  [product string?]
  (check-required-params product)
  (call-api "/mdr/ct/packages/{product}" :get
...
(defn-spec mdr-ct-packages-product-get ct-package-spec
  "
  Get CDISC Library CT Package"
  [product string?]
  (let [res (:data (mdr-ct-packages-product-get-with-http-info product))]
    (if (:decode-models *api-context*)
       (st/decode ct-package-spec res st/string-transformer)
       res)))


(defn-spec mdr-root-ct-product-group-codelists-codelist-get-with-http-info any?
  "
  Get CDISC Library Root CT Codelist"
  [productGroup string?, codelist string?]
  (check-required-params productGroup codelist)
  (call-api "/mdr/root/ct/{productGroup}/codelists/{codelist}" :get
            {:path-params   {"productGroup" productGroup "codelist" codelist }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec mdr-root-ct-product-group-codelists-codelist-get root-ct-codelist-spec
  "
  Get CDISC Library Root CT Codelist"
  [productGroup string?, codelist string?]
  (let [res (:data (mdr-root-ct-product-group-codelists-codelist-get-with-http-info productGroup codelist))]
    (if (:decode-models *api-context*)
       (st/decode root-ct-codelist-spec res st/string-transformer)
       res)))


(defn-spec mdr-root-ct-product-group-codelists-codelist-terms-term-get-with-http-info any?
  "
  Get CDISC Library Root CT Term"
  [productGroup string?, codelist string?, term string?]
  (check-required-params productGroup codelist term)
  (call-api "/mdr/root/ct/{productGroup}/codelists/{codelist}/terms/{term}" :get
            {:path-params   {"productGroup" productGroup "codelist" codelist "term" term }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec mdr-root-ct-product-group-codelists-codelist-terms-term-get root-ct-term-spec
  "
  Get CDISC Library Root CT Term"
  [productGroup string?, codelist string?, term string?]
  (let [res (:data (mdr-root-ct-product-group-codelists-codelist-terms-term-get-with-http-info productGroup codelist term))]
    (if (:decode-models *api-context*)
       (st/decode root-ct-term-spec res st/string-transformer)
       res)))
