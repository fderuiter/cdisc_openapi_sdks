(ns cdisc-library-api.api.analysis-data-model-and-implementation-guide-ada-m-and-ada-mig-
...
(defn-spec mdr-adam-product-datastructures-get-with-http-info any?
  "
  Get ADaM Data Structure List"
  [product string?]
  (check-required-params product)
  (call-api "/mdr/adam/{product}/datastructures" :get
...
(defn-spec mdr-adam-product-datastructures-get adam-product-datastructures-spec
  "
  Get ADaM Data Structure List"
  [product string?]
  (let [res (:data (mdr-adam-product-datastructures-get-with-http-info product))]
    (if (:decode-models *api-context*)
       (st/decode adam-product-datastructures-spec res st/string-transformer)
       res)))


(defn-spec mdr-adam-product-datastructures-structure-get-with-http-info any?
  "
  Get ADaM Data Structure"
  [product string?, structure string?]
  (check-required-params product structure)
  (call-api "/mdr/adam/{product}/datastructures/{structure}" :get
            {:path-params   {"product" product "structure" structure }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec mdr-adam-product-datastructures-structure-get adam-datastructure-spec
  "
  Get ADaM Data Structure"
  [product string?, structure string?]
  (let [res (:data (mdr-adam-product-datastructures-structure-get-with-http-info product structure))]
    (if (:decode-models *api-context*)
       (st/decode adam-datastructure-spec res st/string-transformer)
       res)))


(defn-spec mdr-adam-product-datastructures-structure-variables-get-with-http-info any?
  "
  Get ADaM Variable List"
  [product string?, structure string?]
  (check-required-params product structure)
  (call-api "/mdr/adam/{product}/datastructures/{structure}/variables" :get
            {:path-params   {"product" product "structure" structure }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-adam-product-datastructures-structure-variables-get adam-datastructure-variables-spec
  "
  Get ADaM Variable List"
  [product string?, structure string?]
  (let [res (:data (mdr-adam-product-datastructures-structure-variables-get-with-http-info product structure))]
    (if (:decode-models *api-context*)
       (st/decode adam-datastructure-variables-spec res st/string-transformer)
       res)))


(defn-spec mdr-adam-product-datastructures-structure-variables-var-get-with-http-info any?
  "
  Get ADaM Variable"
  [product string?, structure string?, var string?]
  (check-required-params product structure var)
  (call-api "/mdr/adam/{product}/datastructures/{structure}/variables/{var}" :get
            {:path-params   {"product" product "structure" structure "var" var }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec mdr-adam-product-datastructures-structure-variables-var-get adam-variable-spec
  "
  Get ADaM Variable"
  [product string?, structure string?, var string?]
  (let [res (:data (mdr-adam-product-datastructures-structure-variables-var-get-with-http-info product structure var))]
    (if (:decode-models *api-context*)
       (st/decode adam-variable-spec res st/string-transformer)
       res)))


(defn-spec mdr-adam-product-datastructures-structure-varsets-get-with-http-info any?
  "
  Get ADaM Variable Set List"
  [product string?, structure string?]
  (check-required-params product structure)
  (call-api "/mdr/adam/{product}/datastructures/{structure}/varsets" :get
            {:path-params   {"product" product "structure" structure }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-adam-product-datastructures-structure-varsets-get adam-datastructure-varsets-spec
  "
  Get ADaM Variable Set List"
  [product string?, structure string?]
  (let [res (:data (mdr-adam-product-datastructures-structure-varsets-get-with-http-info product structure))]
    (if (:decode-models *api-context*)
       (st/decode adam-datastructure-varsets-spec res st/string-transformer)
       res)))


(defn-spec mdr-adam-product-datastructures-structure-varsets-varset-get-with-http-info any?
  "
  Get ADaM Variable Set"
  [product string?, structure string?, varset string?]
  (check-required-params product structure varset)
  (call-api "/mdr/adam/{product}/datastructures/{structure}/varsets/{varset}" :get
            {:path-params   {"product" product "structure" structure "varset" varset }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec mdr-adam-product-datastructures-structure-varsets-varset-get adam-varset-spec
  "
  Get ADaM Variable Set"
  [product string?, structure string?, varset string?]
  (let [res (:data (mdr-adam-product-datastructures-structure-varsets-varset-get-with-http-info product structure varset))]
    (if (:decode-models *api-context*)
       (st/decode adam-varset-spec res st/string-transformer)
       res)))


(defn-spec mdr-adam-product-get-with-http-info any?
  "
  Get ADaM Product"
  [product string?]
  (check-required-params product)
  (call-api "/mdr/adam/{product}" :get
            {:path-params   {"product" product }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-adam-product-get adam-product-spec
  "
  Get ADaM Product"
  [product string?]
  (let [res (:data (mdr-adam-product-get-with-http-info product))]
    (if (:decode-models *api-context*)
       (st/decode adam-product-spec res st/string-transformer)
       res)))
