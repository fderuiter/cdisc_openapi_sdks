(ns cdisc-library-api.api.measures
...
(defn-spec mdr-qrs-measure-version-get-with-http-info any?
  "
  Get QRS Product"
  [measure string?, version string?]
  (check-required-params measure version)
  (call-api "/mdr/qrs/{measure}/{version}" :get
            {:path-params   {"measure" measure "version" version }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
             :accepts       ["application/json" "application/xml" "text/csv" "application/vnd.ms-excel"]
             :auth-names    ["basicAuth"]}))

(defn-spec mdr-qrs-measure-version-get qrs-product-spec
  "
  Get QRS Product"
  [measure string?, version string?]
  (let [res (:data (mdr-qrs-measure-version-get-with-http-info measure version))]
    (if (:decode-models *api-context*)
       (st/decode qrs-product-spec res st/string-transformer)
       res)))


(defn-spec mdr-qrs-measure-version-items-get-with-http-info any?
  "
  Get QRS Item List"
  [measure string?, version string?]
  (check-required-params measure version)
  (call-api "/mdr/qrs/{measure}/{version}/items" :get
            {:path-params   {"measure" measure "version" version }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-qrs-measure-version-items-get qrs-items-spec
  "
  Get QRS Item List"
  [measure string?, version string?]
  (let [res (:data (mdr-qrs-measure-version-items-get-with-http-info measure version))]
    (if (:decode-models *api-context*)
       (st/decode qrs-items-spec res st/string-transformer)
       res)))


(defn-spec mdr-qrs-measure-version-items-item-get-with-http-info any?
  "
  Get QRS Item"
  [measure string?, version string?, item string?]
  (check-required-params measure version item)
  (call-api "/mdr/qrs/{measure}/{version}/items/{item}" :get
            {:path-params   {"measure" measure "version" version "item" item }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec mdr-qrs-measure-version-items-item-get qrs-item-spec
  "
  Get QRS Item"
  [measure string?, version string?, item string?]
  (let [res (:data (mdr-qrs-measure-version-items-item-get-with-http-info measure version item))]
    (if (:decode-models *api-context*)
       (st/decode qrs-item-spec res st/string-transformer)
       res)))


(defn-spec mdr-qrs-measure-version-responsegroups-get-with-http-info any?
  "
  Get QRS Response Group List"
  [measure string?, version string?]
  (check-required-params measure version)
  (call-api "/mdr/qrs/{measure}/{version}/responsegroups" :get
            {:path-params   {"measure" measure "version" version }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec mdr-qrs-measure-version-responsegroups-get qrs-responsegroups-spec
  "
  Get QRS Response Group List"
  [measure string?, version string?]
  (let [res (:data (mdr-qrs-measure-version-responsegroups-get-with-http-info measure version))]
    (if (:decode-models *api-context*)
       (st/decode qrs-responsegroups-spec res st/string-transformer)
       res)))


(defn-spec mdr-qrs-measure-version-responsegroups-responsegroup-get-with-http-info any?
  "
  Get QRS Response Group"
  [measure string?, version string?, responsegroup string?]
  (check-required-params measure version responsegroup)
  (call-api "/mdr/qrs/{measure}/{version}/responsegroups/{responsegroup}" :get
            {:path-params   {"measure" measure "version" version "responsegroup" responsegroup }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec mdr-qrs-measure-version-responsegroups-responsegroup-get qrs-responsegroup-spec
  "
  Get QRS Response Group"
  [measure string?, version string?, responsegroup string?]
  (let [res (:data (mdr-qrs-measure-version-responsegroups-responsegroup-get-with-http-info measure version responsegroup))]
    (if (:decode-models *api-context*)
       (st/decode qrs-responsegroup-spec res st/string-transformer)
       res)))
