...
#ifndef _SendigClasses_H_
#define _SendigClasses_H_
...
class SendigClasses : public Object {
public:
	/*! \brief Constructor.
	 */
	SendigClasses();
	SendigClasses(char* str);

	/*! \brief Destructor.
	 */
	virtual ~SendigClasses();
	...
	/*! \brief Get 
	 */
	SendigClassesLinks getLinks();

	/*! \brief Set 
	 */
	void setLinks(SendigClassesLinks  _links);
