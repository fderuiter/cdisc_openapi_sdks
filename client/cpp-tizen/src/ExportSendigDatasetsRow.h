...
#ifndef _ExportSendigDatasetsRow_H_
#define _ExportSendigDatasetsRow_H_
...
class ExportSendigDatasetsRow : public Object {
public:
	/*! \brief Constructor.
	 */
	ExportSendigDatasetsRow();
	ExportSendigDatasetsRow(char* str);

	/*! \brief Destructor.
	 */
	virtual ~ExportSendigDatasetsRow();
...
#endif /* _ExportSendigDatasetsRow_H_ */
