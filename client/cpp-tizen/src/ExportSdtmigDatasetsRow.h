...
#ifndef _ExportSdtmigDatasetsRow_H_
#define _ExportSdtmigDatasetsRow_H_
...
class ExportSdtmigDatasetsRow : public Object {
public:
	/*! \brief Constructor.
	 */
	ExportSdtmigDatasetsRow();
	ExportSdtmigDatasetsRow(char* str);
...
#endif /* _ExportSdtmigDatasetsRow_H_ */
