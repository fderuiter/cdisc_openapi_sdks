...
#ifndef _ExportCdashDomainVariablesRow_H_
#define _ExportCdashDomainVariablesRow_H_
...
class ExportCdashDomainVariablesRow : public Object {
public:
	/*! \brief Constructor.
	 */
	ExportCdashDomainVariablesRow();
	ExportCdashDomainVariablesRow(char* str);

	/*! \brief Destructor.
	 */
	virtual ~ExportCdashDomainVariablesRow();
...
#endif /* _ExportCdashDomainVariablesRow_H_ */
