...
void
AboutRef::fromJson(char* jsonStr)
{
...
void
AboutRef::setHref(std::string  href)
{
	this->href = href;
}
...
void
AboutRef::setTitle(std::string  title)
{
	this->title = title;
}
...
void
AboutRef::setType(std::string  type)
{
	this->type = type;
}
