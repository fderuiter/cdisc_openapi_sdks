...
#ifndef _SdtmClassVariable_H_
#define _SdtmClassVariable_H_
...
class SdtmClassVariable : public Object {
public:
	/*! \brief Constructor.
	 */
	SdtmClassVariable();
	SdtmClassVariable(char* str);

	/*! \brief Destructor.
	 */
	virtual ~SdtmClassVariable();
	...
	/*! \brief Get 
	 */
	SdtmClassVariableLinks getLinks();

	/*! \brief Set 
	 */
	void setLinks(SdtmClassVariableLinks  _links);
