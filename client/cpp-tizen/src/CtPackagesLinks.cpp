...
void
CtPackagesLinks::__init()
{
	//self = new CtPackagesRef();
	//new std::list()std::list> packages;
}

void
CtPackagesLinks::__cleanup()
{
	//if(self != NULL) {
	//
	//delete self;
...
void
CtPackagesLinks::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("CtPackagesRef")) {
			jsonToValue(&self, node, "CtPackagesRef", "CtPackagesRef");
		} else {
			
			CtPackagesRef* obj = static_cast<CtPackagesRef*> (&self);
...
CtPackagesLinks::CtPackagesLinks(char* json)
{
	this->fromJson(json);
}

char*
CtPackagesLinks::toJson()
{
	JsonObject *pJsonObject = json_object_new();
	JsonNode *node;
	if (isprimitive("CtPackagesRef")) {
		CtPackagesRef obj = getSelf();
		node = converttoJson(&obj, "CtPackagesRef", "");
	}
	else {
		
		CtPackagesRef obj = static_cast<CtPackagesRef> (getSelf());
		GError *mygerror;
		mygerror = NULL;
...
CtPackagesRef
CtPackagesLinks::getSelf()
{
	return self;
}

void
CtPackagesLinks::setSelf(CtPackagesRef  self)
{
	this->self = self;
}

std::list<CtPackageRefElement>
CtPackagesLinks::getPackages()
{
	return packages;
}

void
CtPackagesLinks::setPackages(std::list <CtPackageRefElement> packages)
{
