...
#ifndef _ExportCdashigDomainVariablesRow_H_
#define _ExportCdashigDomainVariablesRow_H_
...
class ExportCdashigDomainVariablesRow : public Object {
public:
	/*! \brief Constructor.
	 */
	ExportCdashigDomainVariablesRow();
	ExportCdashigDomainVariablesRow(char* str);
...
#endif /* _ExportCdashigDomainVariablesRow_H_ */
