...
void
ExportSdtmigVariablesRow::__init()
{
	//version = std::string();
...
void
ExportSdtmigVariablesRow::__cleanup()
{
	//if(version != NULL) {
	//
	//delete version;
...
void
ExportSdtmigVariablesRow::fromJson(char* jsonStr)
{
...
ExportSdtmigVariablesRow::ExportSdtmigVariablesRow(char* json)
{
	this->fromJson(json);
}

char*
ExportSdtmigVariablesRow::toJson()
{
...
std::string
ExportSdtmigVariablesRow::getVersion()
{
	return version;
}

void
ExportSdtmigVariablesRow::setVersion(std::string  version)
{
	this->version = version;
}

std::string
ExportSdtmigVariablesRow::getVariableOrder()
{
	return variableOrder;
}

void
ExportSdtmigVariablesRow::setVariableOrder(std::string  variableOrder)
{
	this->variableOrder = variableOrder;
}

std::string
ExportSdtmigVariablesRow::getRClass()
{
	return r_class;
}

void
ExportSdtmigVariablesRow::setRClass(std::string  r_class)
{
	this->r_class = r_class;
}

std::string
ExportSdtmigVariablesRow::getDatasetName()
{
	return datasetName;
}

void
ExportSdtmigVariablesRow::setDatasetName(std::string  datasetName)
{
	this->datasetName = datasetName;
}

std::string
ExportSdtmigVariablesRow::getVariableName()
{
	return variableName;
}

void
ExportSdtmigVariablesRow::setVariableName(std::string  variableName)
{
	this->variableName = variableName;
}

std::string
ExportSdtmigVariablesRow::getVariableLabel()
{
	return variableLabel;
}

void
ExportSdtmigVariablesRow::setVariableLabel(std::string  variableLabel)
{
	this->variableLabel = variableLabel;
}

std::string
ExportSdtmigVariablesRow::getType()
{
	return type;
}

void
ExportSdtmigVariablesRow::setType(std::string  type)
{
	this->type = type;
}

std::string
ExportSdtmigVariablesRow::getControlledTermsCodelistorFormat()
{
	return controlledTermsCodelistorFormat;
}

void
ExportSdtmigVariablesRow::setControlledTermsCodelistorFormat(std::string  controlledTermsCodelistorFormat)
{
	this->controlledTermsCodelistorFormat = controlledTermsCodelistorFormat;
}

std::string
ExportSdtmigVariablesRow::getRole()
{
	return role;
}

void
ExportSdtmigVariablesRow::setRole(std::string  role)
{
	this->role = role;
}

std::string
ExportSdtmigVariablesRow::getCDISCNotes()
{
	return cDISCNotes;
}

void
ExportSdtmigVariablesRow::setCDISCNotes(std::string  cDISCNotes)
{
	this->cDISCNotes = cDISCNotes;
}

std::string
ExportSdtmigVariablesRow::getCore()
{
	return core;
}

void
ExportSdtmigVariablesRow::setCore(std::string  core)
{
	this->core = core;
}
