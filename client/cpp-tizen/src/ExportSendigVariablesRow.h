...
#ifndef _ExportSendigVariablesRow_H_
#define _ExportSendigVariablesRow_H_
...
class ExportSendigVariablesRow : public Object {
public:
	/*! \brief Constructor.
	 */
	ExportSendigVariablesRow();
	ExportSendigVariablesRow(char* str);
...
#endif /* _ExportSendigVariablesRow_H_ */
