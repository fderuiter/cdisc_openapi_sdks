...
#ifndef _CdashClassField_H_
#define _CdashClassField_H_
...
class CdashClassField : public Object {
public:
	/*! \brief Constructor.
	 */
	CdashClassField();
	CdashClassField(char* str);

	/*! \brief Destructor.
	 */
	virtual ~CdashClassField();
	...
	/*! \brief Get 
	 */
	CdashClassFieldLinks getLinks();

	/*! \brief Set 
	 */
	void setLinks(CdashClassFieldLinks  _links);
