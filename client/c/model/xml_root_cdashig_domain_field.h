/*
 * xml_root_cdashig_domain_field.h
 *
 * 
 */

#ifndef _xml_root_cdashig_domain_field_H_
#define _xml_root_cdashig_domain_field_H_
...
typedef struct xml_root_cdashig_domain_field_t xml_root_cdashig_domain_field_t;

#include "root_cdashig_domain_field.h"



typedef struct xml_root_cdashig_domain_field_t {
    struct root_cdashig_domain_field_t *self; //model

    int _library_owned; // Is the library responsible for freeing this object?
} xml_root_cdashig_domain_field_t;
...
#endif /* _xml_root_cdashig_domain_field_H_ */
