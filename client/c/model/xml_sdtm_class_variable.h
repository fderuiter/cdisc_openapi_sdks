/*
 * xml_sdtm_class_variable.h
 *
 * 
 */

#ifndef _xml_sdtm_class_variable_H_
#define _xml_sdtm_class_variable_H_
...
typedef struct xml_sdtm_class_variable_t xml_sdtm_class_variable_t;

#include "sdtm_class_variable.h"



typedef struct xml_sdtm_class_variable_t {
    struct sdtm_class_variable_t *self; //model

    int _library_owned; // Is the library responsible for freeing this object?
} xml_sdtm_class_variable_t;
...
#endif /* _xml_sdtm_class_variable_H_ */
