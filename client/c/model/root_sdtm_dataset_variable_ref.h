/*
 * root_sdtm_dataset_variable_ref.h
 *
 * 
 */

#ifndef _root_sdtm_dataset_variable_ref_H_
#define _root_sdtm_dataset_variable_ref_H_
...
typedef struct root_sdtm_dataset_variable_ref_t root_sdtm_dataset_variable_ref_t;




typedef struct root_sdtm_dataset_variable_ref_t {
    char *href; // string
    char *title; // string
    char *type; // string

    int _library_owned; // Is the library responsible for freeing this object?
} root_sdtm_dataset_variable_ref_t;
...
#endif /* _root_sdtm_dataset_variable_ref_H_ */
