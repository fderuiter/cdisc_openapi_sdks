...
#ifndef _root_ct_term_ref_H_
#define _root_ct_term_ref_H_
...
typedef struct root_ct_term_ref_t root_ct_term_ref_t;




typedef struct root_ct_term_ref_t {
    char *href; // string
    char *title; // string
    char *type; // string
