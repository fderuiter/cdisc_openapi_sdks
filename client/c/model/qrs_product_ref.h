...
#ifndef _qrs_product_ref_H_
#define _qrs_product_ref_H_
...
typedef struct qrs_product_ref_t qrs_product_ref_t;




typedef struct qrs_product_ref_t {
    char *href; // string
    char *title; // string
    char *type; // string
