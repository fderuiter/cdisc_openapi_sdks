/*
 * cdashig_scenario_field_links.h
 *
 * 
 */

#ifndef _cdashig_scenario_field_links_H_
#define _cdashig_scenario_field_links_H_
...
typedef struct cdashig_scenario_field_links_t cdashig_scenario_field_links_t;
...
typedef struct cdashig_scenario_field_links_t {
    struct cdashig_scenario_field_ref_t *self; //model
    ...
    struct cdashig_scenario_ref_t *parent_scenario; //model
    struct root_cdashig_scenario_field_ref_t *root_item; //model
    struct cdashig_scenario_field_ref_t *prior_version; //model
    list_t *sdtmig_dataset_mapping_targets; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} cdashig_scenario_field_links_t;
...
#endif /* _cdashig_scenario_field_links_H_ */
