...
#ifndef _adam_varset_ref_H_
#define _adam_varset_ref_H_
...
typedef struct adam_varset_ref_t adam_varset_ref_t;




typedef struct adam_varset_ref_t {
    char *href; // string
    char *title; // string
    char *type; // string
