...
#ifndef _xml_cdash_product_H_
#define _xml_cdash_product_H_
...
typedef struct xml_cdash_product_t xml_cdash_product_t;

#include "cdash_product.h"



typedef struct xml_cdash_product_t {
    struct cdash_product_t *self; //model
