/*
 * root_cdash_domain_field.h
 *
 * 
 */

#ifndef _root_cdash_domain_field_H_
#define _root_cdash_domain_field_H_
...
typedef struct root_cdash_domain_field_t root_cdash_domain_field_t;

#include "root_cdash_domain_field_links.h"



typedef struct root_cdash_domain_field_t {
    struct root_cdash_domain_field_links_t *_links; //model
...
#endif /* _root_cdash_domain_field_H_ */
