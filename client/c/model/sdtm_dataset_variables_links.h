/*
 * sdtm_dataset_variables_links.h
 *
 * 
 */

#ifndef _sdtm_dataset_variables_links_H_
#define _sdtm_dataset_variables_links_H_
...
typedef struct sdtm_dataset_variables_links_t sdtm_dataset_variables_links_t;
...
typedef struct sdtm_dataset_variables_links_t {
    struct sdtm_dataset_variables_ref_t *self; //model
    struct sdtm_product_ref_t *parent_product; //model
    struct sdtm_class_ref_t *parent_class; //model
    struct sdtm_dataset_variables_ref_t *prior_version; //model
    list_t *dataset_variables; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} sdtm_dataset_variables_links_t;
...
#endif /* _sdtm_dataset_variables_links_H_ */
