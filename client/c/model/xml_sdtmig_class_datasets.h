/*
 * xml_sdtmig_class_datasets.h
 *
 * 
 */

#ifndef _xml_sdtmig_class_datasets_H_
#define _xml_sdtmig_class_datasets_H_
...
typedef struct xml_sdtmig_class_datasets_t xml_sdtmig_class_datasets_t;

#include "sdtmig_class_datasets.h"



typedef struct xml_sdtmig_class_datasets_t {
    struct sdtmig_class_datasets_t *self; //model

    int _library_owned; // Is the library responsible for freeing this object?
} xml_sdtmig_class_datasets_t;
...
#endif /* _xml_sdtmig_class_datasets_H_ */
