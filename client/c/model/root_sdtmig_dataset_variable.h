/*
 * root_sdtmig_dataset_variable.h
 *
 * 
 */

#ifndef _root_sdtmig_dataset_variable_H_
#define _root_sdtmig_dataset_variable_H_
...
typedef struct root_sdtmig_dataset_variable_t root_sdtmig_dataset_variable_t;

#include "root_sdtmig_dataset_variable_links.h"



typedef struct root_sdtmig_dataset_variable_t {
    struct root_sdtmig_dataset_variable_links_t *_links; //model
...
#endif /* _root_sdtmig_dataset_variable_H_ */
