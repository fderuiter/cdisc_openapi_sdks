/*
 * ct_codelist_ref_version.h
 *
 * 
 */

#ifndef _ct_codelist_ref_version_H_
#define _ct_codelist_ref_version_H_
...
typedef struct ct_codelist_ref_version_t ct_codelist_ref_version_t;




typedef struct ct_codelist_ref_version_t {
    char *href; // string
    char *title; // string
    char *type; // string

    int _library_owned; // Is the library responsible for freeing this object?
} ct_codelist_ref_version_t;
...
#endif /* _ct_codelist_ref_version_H_ */
