...
#ifndef _adam_product_ref_H_
#define _adam_product_ref_H_
...
typedef struct adam_product_ref_t adam_product_ref_t;




typedef struct adam_product_ref_t {
    char *href; // string
    char *title; // string
    char *type; // string
