/*
 * ct_package_ref_element.h
 *
 * 
 */

#ifndef _ct_package_ref_element_H_
#define _ct_package_ref_element_H_
...
typedef struct ct_package_ref_element_t ct_package_ref_element_t;




typedef struct ct_package_ref_element_t {
    char *href; // string
    char *title; // string
    char *type; // string

    int _library_owned; // Is the library responsible for freeing this object?
} ct_package_ref_element_t;
...
#endif /* _ct_package_ref_element_H_ */
