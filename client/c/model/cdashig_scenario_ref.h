/*
 * cdashig_scenario_ref.h
 *
 * 
 */

#ifndef _cdashig_scenario_ref_H_
#define _cdashig_scenario_ref_H_
...
typedef struct cdashig_scenario_ref_t cdashig_scenario_ref_t;




typedef struct cdashig_scenario_ref_t {
    char *href; // string
    char *title; // string
    char *type; // string

    int _library_owned; // Is the library responsible for freeing this object?
} cdashig_scenario_ref_t;
...
#endif /* _cdashig_scenario_ref_H_ */
