...
namespace OpenAPI {
class OAIQrsItemLinks;

class OAIQrsItem : public OAIObject {
public:
    OAIQrsItem();
    OAIQrsItem(QString json);
    ~OAIQrsItem() override;
    ...
    OAIQrsItemLinks getLinks() const;
    void setLinks(const OAIQrsItemLinks &_links);
...
Q_DECLARE_METATYPE(OpenAPI::OAIQrsItem)
