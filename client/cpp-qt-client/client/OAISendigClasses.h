...
#ifndef OAISendigClasses_H
#define OAISendigClasses_H
...
namespace OpenAPI {
class OAISendigClassesLinks;

class OAISendigClasses : public OAIObject {
public:
    OAISendigClasses();
    OAISendigClasses(QString json);
    ~OAISendigClasses() override;
    ...
    OAISendigClassesLinks getLinks() const;
    void setLinks(const OAISendigClassesLinks &_links);
...
private:
    ...
    OAISendigClassesLinks m__links;
    bool m__links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendigClasses)

#endif // OAISendigClasses_H
