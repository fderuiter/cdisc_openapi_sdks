...
/*
 * OAICdashProductClasses.h
 *
 * 
 */

#ifndef OAICdashProductClasses_H
#define OAICdashProductClasses_H
...
namespace OpenAPI {
class OAICdashProductClassesLinks;

class OAICdashProductClasses : public OAIObject {
public:
    OAICdashProductClasses();
    OAICdashProductClasses(QString json);
    ~OAICdashProductClasses() override;
    ...
    OAICdashProductClassesLinks getLinks() const;
    void setLinks(const OAICdashProductClassesLinks &_links);
...
private:
    ...
    OAICdashProductClassesLinks m__links;
    bool m__links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICdashProductClasses)

#endif // OAICdashProductClasses_H
