...
#ifndef OAICdashigProduct_H
#define OAICdashigProduct_H
...
namespace OpenAPI {
class OAICdashigProductLinks;
class OAICdashigClass;

class OAICdashigProduct : public OAIObject {
public:
    OAICdashigProduct();
    OAICdashigProduct(QString json);
    ~OAICdashigProduct() override;
    ...
    OAICdashigProductLinks getLinks() const;
    void setLinks(const OAICdashigProductLinks &_links);
    bool is__links_Set() const;
    bool is__links_Valid() const;

    QList<OAICdashigClass> getClasses() const;
    void setClasses(const QList<OAICdashigClass> &classes);
...
private:
    ...
    OAICdashigProductLinks m__links;
    bool m__links_isSet;
    bool m__links_isValid;

    QList<OAICdashigClass> m_classes;
...
Q_DECLARE_METATYPE(OpenAPI::OAICdashigProduct)

#endif // OAICdashigProduct_H
