...
/*
 * OAICdashProductDomains.h
 *
 * 
 */

#ifndef OAICdashProductDomains_H
#define OAICdashProductDomains_H
...
namespace OpenAPI {
class OAICdashProductDomainsLinks;

class OAICdashProductDomains : public OAIObject {
public:
    OAICdashProductDomains();
    OAICdashProductDomains(QString json);
    ~OAICdashProductDomains() override;
    ...
    OAICdashProductDomainsLinks getLinks() const;
    void setLinks(const OAICdashProductDomainsLinks &_links);
...
private:
    ...
    OAICdashProductDomainsLinks m__links;
    bool m__links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICdashProductDomains)

#endif // OAICdashProductDomains_H
