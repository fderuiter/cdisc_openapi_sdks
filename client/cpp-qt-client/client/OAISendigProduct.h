...
#ifndef OAISendigProduct_H
#define OAISendigProduct_H
...
namespace OpenAPI {
class OAISendigProductLinks;
class OAISendigClass;

class OAISendigProduct : public OAIObject {
public:
    OAISendigProduct();
    OAISendigProduct(QString json);
    ~OAISendigProduct() override;
    ...
    OAISendigProductLinks getLinks() const;
    void setLinks(const OAISendigProductLinks &_links);
    bool is__links_Set() const;
    bool is__links_Valid() const;

    QList<OAISendigClass> getClasses() const;
    void setClasses(const QList<OAISendigClass> &classes);
...
private:
    ...
    OAISendigProductLinks m__links;
    bool m__links_isSet;
    bool m__links_isValid;

    QList<OAISendigClass> m_classes;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendigProduct)

#endif // OAISendigProduct_H
