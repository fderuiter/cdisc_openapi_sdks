...
#ifndef OAISdtmigClasses_H
#define OAISdtmigClasses_H
...
namespace OpenAPI {
class OAISdtmigClassesLinks;

class OAISdtmigClasses : public OAIObject {
public:
    OAISdtmigClasses();
    OAISdtmigClasses(QString json);
    ~OAISdtmigClasses() override;
    ...
    OAISdtmigClassesLinks getLinks() const;
    void setLinks(const OAISdtmigClassesLinks &_links);
...
private:
    ...
    OAISdtmigClassesLinks m__links;
    bool m__links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISdtmigClasses)

#endif // OAISdtmigClasses_H
