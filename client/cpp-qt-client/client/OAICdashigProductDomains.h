...
/*
 * OAICdashigProductDomains.h
 *
 * 
 */

#ifndef OAICdashigProductDomains_H
#define OAICdashigProductDomains_H
...
namespace OpenAPI {
class OAICdashigProductDomainsLinks;

class OAICdashigProductDomains : public OAIObject {
public:
    OAICdashigProductDomains();
    OAICdashigProductDomains(QString json);
    ~OAICdashigProductDomains() override;
    ...
    OAICdashigProductDomainsLinks getLinks() const;
    void setLinks(const OAICdashigProductDomainsLinks &_links);
...
private:
    ...
    OAICdashigProductDomainsLinks m__links;
    bool m__links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICdashigProductDomains)

#endif // OAICdashigProductDomains_H
