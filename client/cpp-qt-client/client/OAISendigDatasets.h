...
#ifndef OAISendigDatasets_H
#define OAISendigDatasets_H
...
class OAISendigDatasets : public OAIObject {
public:
    OAISendigDatasets();
    OAISendigDatasets(QString json);
    ~OAISendigDatasets() override;
    ...
    OAISendigDatasetsLinks getLinks() const;
    void setLinks(const OAISendigDatasetsLinks &_links);
...
private:
    ...
    OAISendigDatasetsLinks m__links;
    bool m__links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendigDatasets)

#endif // OAISendigDatasets_H
