...
/*
 * OAICdashClassField.h
 *
 * 
 */

#ifndef OAICdashClassField_H
#define OAICdashClassField_H
...
namespace OpenAPI {
class OAICdashClassFieldLinks;

class OAICdashClassField : public OAIObject {
public:
    OAICdashClassField();
    OAICdashClassField(QString json);
    ~OAICdashClassField() override;
    ...
    OAICdashClassFieldLinks getLinks() const;
    void setLinks(const OAICdashClassFieldLinks &_links);
...
private:
    ...
    OAICdashClassFieldLinks m__links;
    bool m__links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICdashClassField)

#endif // OAICdashClassField_H
