...
/*
 * OAIExportSdtmigVariablesRow.h
 *
 * 
 */

#ifndef OAIExportSdtmigVariablesRow_H
#define OAIExportSdtmigVariablesRow_H
...
class OAIExportSdtmigVariablesRow : public OAIObject {
public:
    OAIExportSdtmigVariablesRow();
    OAIExportSdtmigVariablesRow(QString json);
    ~OAIExportSdtmigVariablesRow() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportSdtmigVariablesRow)

#endif // OAIExportSdtmigVariablesRow_H
