...
/*
 * OAICtPackageCodelists.h
 *
 * 
 */

#ifndef OAICtPackageCodelists_H
#define OAICtPackageCodelists_H
...
namespace OpenAPI {
class OAICtPackageCodelistsLinks;

class OAICtPackageCodelists : public OAIObject {
public:
    OAICtPackageCodelists();
    OAICtPackageCodelists(QString json);
    ~OAICtPackageCodelists() override;
    ...
    OAICtPackageCodelistsLinks getLinks() const;
    void setLinks(const OAICtPackageCodelistsLinks &_links);
...
private:
    ...
    OAICtPackageCodelistsLinks m__links;
    bool m__links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICtPackageCodelists)

#endif // OAICtPackageCodelists_H
