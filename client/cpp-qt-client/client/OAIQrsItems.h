...
#ifndef OAIQrsItems_H
#define OAIQrsItems_H
...
class OAIQrsItems : public OAIObject {
public:
    OAIQrsItems();
    OAIQrsItems(QString json);
    ~OAIQrsItems() override;
    ...
    OAIQrsItemsLinks getLinks() const;
    void setLinks(const OAIQrsItemsLinks &_links);
...
Q_DECLARE_METATYPE(OpenAPI::OAIQrsItems)
