...
#ifndef OAISdtmClasses_H
#define OAISdtmClasses_H
...
namespace OpenAPI {
class OAISdtmClassesLinks;

class OAISdtmClasses : public OAIObject {
public:
    OAISdtmClasses();
    OAISdtmClasses(QString json);
    ~OAISdtmClasses() override;
    ...
    OAISdtmClassesLinks getLinks() const;
    void setLinks(const OAISdtmClassesLinks &_links);
...
Q_DECLARE_METATYPE(OpenAPI::OAISdtmClasses)

#endif // OAISdtmClasses_H
