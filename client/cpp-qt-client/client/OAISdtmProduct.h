...
#ifndef OAISdtmProduct_H
#define OAISdtmProduct_H
...
class OAISdtmProduct : public OAIObject {
public:
    OAISdtmProduct();
    OAISdtmProduct(QString json);
    ~OAISdtmProduct() override;
    ...
    OAISdtmProductLinks getLinks() const;
    void setLinks(const OAISdtmProductLinks &_links);
    bool is__links_Set() const;
    bool is__links_Valid() const;

    QList<OAISdtmClass> getClasses() const;
    void setClasses(const QList<OAISdtmClass> &classes);
...
private:
    ...
    OAISdtmProductLinks m__links;
    bool m__links_isSet;
    bool m__links_isValid;

    QList<OAISdtmClass> m_classes;
...
Q_DECLARE_METATYPE(OpenAPI::OAISdtmProduct)

#endif // OAISdtmProduct_H
