...
/*
 * OAICdashigProductClasses.h
 *
 * 
 */

#ifndef OAICdashigProductClasses_H
#define OAICdashigProductClasses_H
...
namespace OpenAPI {
class OAICdashigProductClassesLinks;

class OAICdashigProductClasses : public OAIObject {
public:
    OAICdashigProductClasses();
    OAICdashigProductClasses(QString json);
    ~OAICdashigProductClasses() override;
    ...
    OAICdashigProductClassesLinks getLinks() const;
    void setLinks(const OAICdashigProductClassesLinks &_links);
...
private:
    ...
    OAICdashigProductClassesLinks m__links;
    bool m__links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICdashigProductClasses)

#endif // OAICdashigProductClasses_H
