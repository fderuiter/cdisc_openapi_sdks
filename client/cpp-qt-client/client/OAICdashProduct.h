...
#ifndef OAICdashProduct_H
#define OAICdashProduct_H
...
namespace OpenAPI {
class OAICdashProductLinks;
class OAICdashClass;
class OAICdashDomain;

class OAICdashProduct : public OAIObject {
public:
    OAICdashProduct();
    OAICdashProduct(QString json);
    ~OAICdashProduct() override;
    ...
    OAICdashProductLinks getLinks() const;
    void setLinks(const OAICdashProductLinks &_links);
    bool is__links_Set() const;
    bool is__links_Valid() const;

    QList<OAICdashClass> getClasses() const;
    void setClasses(const QList<OAICdashClass> &classes);
    bool is_classes_Set() const;
    bool is_classes_Valid() const;

    QList<OAICdashDomain> getDomains() const;
    void setDomains(const QList<OAICdashDomain> &domains);
...
private:
    ...
    OAICdashProductLinks m__links;
    bool m__links_isSet;
    bool m__links_isValid;

    QList<OAICdashClass> m_classes;
    bool m_classes_isSet;
    bool m_classes_isValid;

    QList<OAICdashDomain> m_domains;
...
Q_DECLARE_METATYPE(OpenAPI::OAICdashProduct)

#endif // OAICdashProduct_H
