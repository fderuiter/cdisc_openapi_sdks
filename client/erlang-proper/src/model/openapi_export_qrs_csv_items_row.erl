...
-export([openapi_export_qrs_csv_items_row/0]).

-export([openapi_export_qrs_csv_items_row/1]).
...
openapi_export_qrs_csv_items_row() ->
    openapi_export_qrs_csv_items_row([]).

openapi_export_qrs_csv_items_row(Fields) ->
  Default = [ {'QRS Measure Name', binary() }
            , {'QRS Measure Label', binary() }
            , {'QRS Measure Type', binary() }
            , {'Item Sequence', binary() }
            , {'Test Name', binary() }
            , {'Item Text', binary() }
