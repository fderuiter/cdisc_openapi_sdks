...
-export([openapi_export_sdtmig_datasets_row/0]).

-export([openapi_export_sdtmig_datasets_row/1]).
...
openapi_export_sdtmig_datasets_row() ->
    openapi_export_sdtmig_datasets_row([]).

openapi_export_sdtmig_datasets_row(Fields) ->
