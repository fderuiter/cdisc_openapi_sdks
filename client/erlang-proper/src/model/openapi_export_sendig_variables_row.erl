...
-export([openapi_export_sendig_variables_row/0]).

-export([openapi_export_sendig_variables_row/1]).
...
openapi_export_sendig_variables_row() ->
    openapi_export_sendig_variables_row([]).

openapi_export_sendig_variables_row(Fields) ->
