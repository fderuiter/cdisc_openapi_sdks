...
-export([openapi_cdashig_domain_field_links/0]).

-export([openapi_cdashig_domain_field_links/1]).
...
openapi_cdashig_domain_field_links() ->
    openapi_cdashig_domain_field_links([]).

openapi_cdashig_domain_field_links(Fields) ->
  Default = [ {'self', openapi_cdashig_domain_field_ref:openapi_cdashig_domain_field_ref() }
            , {'codelist', list(openapi_root_ct_codelist_ref_element:openapi_root_ct_codelist_ref_element()) }
            , {'parentProduct', openapi_cdashig_product_ref:openapi_cdashig_product_ref() }
            , {'parentDomain', openapi_cdashig_domain_ref:openapi_cdashig_domain_ref() }
            , {'rootItem', openapi_root_cdashig_domain_field_ref:openapi_root_cdashig_domain_field_ref() }
