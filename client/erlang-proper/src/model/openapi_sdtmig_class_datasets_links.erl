...
-export([openapi_sdtmig_class_datasets_links/0]).

-export([openapi_sdtmig_class_datasets_links/1]).
...
openapi_sdtmig_class_datasets_links() ->
    openapi_sdtmig_class_datasets_links([]).

openapi_sdtmig_class_datasets_links(Fields) ->
  Default = [ {'self', openapi_sdtmig_class_datasets_ref:openapi_sdtmig_class_datasets_ref() }
            , {'parentProduct', openapi_sdtmig_product_ref:openapi_sdtmig_product_ref() }
            , {'priorVersion', openapi_sdtmig_class_datasets_ref:openapi_sdtmig_class_datasets_ref() }
            , {'datasets', list(openapi_sdtmig_dataset_ref_element:openapi_sdtmig_dataset_ref_element()) }
            ],
