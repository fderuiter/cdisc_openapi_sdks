...
-export([openapi_ct_codelist_terms_links/0]).

-export([openapi_ct_codelist_terms_links/1]).
...
-type openapi_ct_codelist_terms_links() ::
  ...
  | {'terms', list(openapi_ct_term_ref_element:openapi_ct_term_ref_element()) }
  ].


openapi_ct_codelist_terms_links() ->
    openapi_ct_codelist_terms_links([]).

openapi_ct_codelist_terms_links(Fields) ->
  Default = [ {'self', openapi_ct_codelist_terms_ref:openapi_ct_codelist_terms_ref() }
            , {'parentPackage', openapi_ct_package_ref:openapi_ct_package_ref() }
            , {'rootItem', openapi_root_ct_codelist_ref:openapi_root_ct_codelist_ref() }
            , {'priorVersion', openapi_ct_codelist_terms_ref:openapi_ct_codelist_terms_ref() }
            , {'terms', list(openapi_ct_term_ref_element:openapi_ct_term_ref_element()) }
