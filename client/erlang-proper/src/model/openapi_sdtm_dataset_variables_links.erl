...
-export([openapi_sdtm_dataset_variables_links/0]).

-export([openapi_sdtm_dataset_variables_links/1]).
...
-type openapi_sdtm_dataset_variables_links() ::
  ...
  | {'datasetVariables', list(openapi_sdtm_dataset_variable_ref_element:openapi_sdtm_dataset_variable_ref_element()) }
  ].


openapi_sdtm_dataset_variables_links() ->
    openapi_sdtm_dataset_variables_links([]).

openapi_sdtm_dataset_variables_links(Fields) ->
  Default = [ {'self', openapi_sdtm_dataset_variables_ref:openapi_sdtm_dataset_variables_ref() }
            , {'parentProduct', openapi_sdtm_product_ref:openapi_sdtm_product_ref() }
            , {'parentClass', openapi_sdtm_class_ref:openapi_sdtm_class_ref() }
            , {'priorVersion', openapi_sdtm_dataset_variables_ref:openapi_sdtm_dataset_variables_ref() }
            , {'datasetVariables', list(openapi_sdtm_dataset_variable_ref_element:openapi_sdtm_dataset_variable_ref_element()) }
