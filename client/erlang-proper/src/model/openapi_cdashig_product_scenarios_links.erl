...
-export([openapi_cdashig_product_scenarios_links/0]).

-export([openapi_cdashig_product_scenarios_links/1]).
...
openapi_cdashig_product_scenarios_links() ->
    openapi_cdashig_product_scenarios_links([]).

openapi_cdashig_product_scenarios_links(Fields) ->
  Default = [ {'self', openapi_cdashig_product_scenarios_ref:openapi_cdashig_product_scenarios_ref() }
            , {'parentProduct', openapi_cdashig_product_ref:openapi_cdashig_product_ref() }
            , {'scenarios', list(openapi_cdashig_scenario_ref_element:openapi_cdashig_scenario_ref_element()) }
            ],
