...
-export([openapi_cdash_product_links/0]).

-export([openapi_cdash_product_links/1]).
...
openapi_cdash_product_links() ->
    openapi_cdash_product_links([]).

openapi_cdash_product_links(Fields) ->
  Default = [ {'self', openapi_cdash_product_ref:openapi_cdash_product_ref() }
            , {'priorVersion', openapi_cdash_product_ref:openapi_cdash_product_ref() }
            ],
