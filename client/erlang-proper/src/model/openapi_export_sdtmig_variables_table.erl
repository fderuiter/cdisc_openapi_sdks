...
-export([openapi_export_sdtmig_variables_table/0]).

-export([openapi_export_sdtmig_variables_table/1]).
...
openapi_export_sdtmig_variables_table() ->
    openapi_export_sdtmig_variables_table([]).

openapi_export_sdtmig_variables_table(Fields) ->
