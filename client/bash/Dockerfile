...
# Setup prompt
#
RUN echo 'export PS1="[CDISC Library API] \$ "' >> ~/.bashrc
RUN echo 'export PROMPT="[CDISC Library API] \$ "' >> ~/.zshrc
...
line REST client for $(tput setaf 6)CDISC Library API$(tput sgr0).\n\
\n\
