#' Create a new SdtmClassLinks
#'
#' @description
#' SdtmClassLinks Class
#'
#' @docType class
#' @title SdtmClassLinks
#' @description SdtmClassLinks Class
#' @format An \code{R6Class} generator object
#' @field item_self  \link{SdtmClassRef} [optional]
#' @field parentProduct  \link{SdtmProductRef} [optional]
#' @field parentClass  \link{SdtmClassRef} [optional]
#' @field subclasses  list(\link{SdtmClassRefSubclass}) [optional]
#' @field priorVersion  \link{SdtmClassRef} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SdtmClassLinks <- R6::R6Class(
  "SdtmClassLinks",
  public = list(
    `item_self` = NULL,
    `parentProduct` = NULL,
    ...
    #' @description
    #' Initialize a new SdtmClassLinks class.
    #'
    ...
    initialize = function(`item_self` = NULL, `parentProduct` = NULL, `parentClass` = NULL, `subclasses` = NULL, `priorVersion` = NULL, ...) {
    ...
    #'
    #' @return SdtmClassLinks as a base R list.
    #' @examples
    #' # convert array of SdtmClassLinks (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SdtmClassLinks to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SdtmClassLinksObject <- list()
      if (!is.null(self$`item_self`)) {
        SdtmClassLinksObject[["self"]] <-
          self$`item_self`$toSimpleType()
      }
      if (!is.null(self$`parentProduct`)) {
        SdtmClassLinksObject[["parentProduct"]] <-
          self$`parentProduct`$toSimpleType()
      }
      if (!is.null(self$`parentClass`)) {
        SdtmClassLinksObject[["parentClass"]] <-
          self$`parentClass`$toSimpleType()
      }
      if (!is.null(self$`subclasses`)) {
        SdtmClassLinksObject[["subclasses"]] <-
          lapply(self$`subclasses`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`priorVersion`)) {
        SdtmClassLinksObject[["priorVersion"]] <-
          self$`priorVersion`$toSimpleType()
      }
      return(SdtmClassLinksObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of SdtmClassLinks
    #'
    #' @param input_json the JSON input
    #' @return the instance of SdtmClassLinks
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`self`)) {
        `item_self_object` <- SdtmClassRef$new()
      ...
      if (!is.null(this_object$`subclasses`)) {
        self$`subclasses` <- ApiClient$new()$deserializeObj(this_object$`subclasses`, "array[SdtmClassRefSubclass]", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`priorVersion`)) {
        `priorversion_object` <- SdtmClassRef$new()
    ...
    #' @return SdtmClassLinks in JSON format
    ...
    fromJSONString = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      self$`item_self` <- SdtmClassRef$new()$fromJSON(jsonlite::toJSON(this_object$`item_self`, auto_unbox = TRUE, digits = NA))
      ...
      self$`subclasses` <- ApiClient$new()$deserializeObj(this_object$`subclasses`, "array[SdtmClassRefSubclass]", loadNamespace("openapi"))
      self$`priorVersion` <- SdtmClassRef$new()$fromJSON(jsonlite::toJSON(this_object$`priorVersion`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to SdtmClassLinks and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of SdtmClassLinks
    toString = function() {
      self$toJSONString()
    },
...
# SdtmClassLinks$unlock()
#
## Below is an example to define the print function
# SdtmClassLinks$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
