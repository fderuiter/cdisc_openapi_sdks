#' Create a new SdtmigDatasetVariable
#'
#' @description
#' SdtmigDatasetVariable Class
#'
#' @docType class
#' @title SdtmigDatasetVariable
#' @description SdtmigDatasetVariable Class
...
#' @field _links  \link{SdtmigDatasetVariableLinks} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SdtmigDatasetVariable <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new SdtmigDatasetVariable class.
    #'
    ...
    #'
    #' @return SdtmigDatasetVariable as a base R list.
    #' @examples
    #' # convert array of SdtmigDatasetVariable (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SdtmigDatasetVariable to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SdtmigDatasetVariableObject <- list()
      if (!is.null(self$`ordinal`)) {
        SdtmigDatasetVariableObject[["ordinal"]] <-
          self$`ordinal`
      }
      if (!is.null(self$`name`)) {
        SdtmigDatasetVariableObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`label`)) {
        SdtmigDatasetVariableObject[["label"]] <-
          self$`label`
      }
      if (!is.null(self$`description`)) {
        SdtmigDatasetVariableObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`role`)) {
        SdtmigDatasetVariableObject[["role"]] <-
          self$`role`
      }
      if (!is.null(self$`simpleDatatype`)) {
        SdtmigDatasetVariableObject[["simpleDatatype"]] <-
          self$`simpleDatatype`
      }
      if (!is.null(self$`core`)) {
        SdtmigDatasetVariableObject[["core"]] <-
          self$`core`
      }
      if (!is.null(self$`describedValueDomain`)) {
        SdtmigDatasetVariableObject[["describedValueDomain"]] <-
          self$`describedValueDomain`
      }
      if (!is.null(self$`valueList`)) {
        SdtmigDatasetVariableObject[["valueList"]] <-
          self$`valueList`
      }
      if (!is.null(self$`_links`)) {
        SdtmigDatasetVariableObject[["_links"]] <-
          self$`_links`$toSimpleType()
      }
      return(SdtmigDatasetVariableObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of SdtmigDatasetVariable
    #'
    #' @param input_json the JSON input
    #' @return the instance of SdtmigDatasetVariable
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`_links`)) {
        `_links_object` <- SdtmigDatasetVariableLinks$new()
    ...
    #' @return SdtmigDatasetVariable in JSON format
    ...
    fromJSONString = function(input_json) {
      ...
      self$`describedValueDomain` <- this_object$`describedValueDomain`
      self$`valueList` <- ApiClient$new()$deserializeObj(this_object$`valueList`, "array[character]", loadNamespace("openapi"))
      self$`_links` <- SdtmigDatasetVariableLinks$new()$fromJSON(jsonlite::toJSON(this_object$`_links`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to SdtmigDatasetVariable and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of SdtmigDatasetVariable
    toString = function() {
      self$toJSONString()
    },
...
# SdtmigDatasetVariable$unlock()
#
## Below is an example to define the print function
# SdtmigDatasetVariable$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SdtmigDatasetVariable$lock()
