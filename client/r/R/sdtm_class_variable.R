#' Create a new SdtmClassVariable
#'
#' @description
#' SdtmClassVariable Class
#'
#' @docType class
#' @title SdtmClassVariable
#' @description SdtmClassVariable Class
...
#' @field _links  \link{SdtmClassVariableLinks} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SdtmClassVariable <- R6::R6Class(
  "SdtmClassVariable",
  public = list(
    `ordinal` = NULL,
    `name` = NULL,
    ...
    #' @description
    #' Initialize a new SdtmClassVariable class.
    #'
    ...
    #'
    #' @return SdtmClassVariable as a base R list.
    #' @examples
    #' # convert array of SdtmClassVariable (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SdtmClassVariable to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SdtmClassVariableObject <- list()
      if (!is.null(self$`ordinal`)) {
        SdtmClassVariableObject[["ordinal"]] <-
          self$`ordinal`
      }
      if (!is.null(self$`name`)) {
        SdtmClassVariableObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`label`)) {
        SdtmClassVariableObject[["label"]] <-
          self$`label`
      }
      if (!is.null(self$`description`)) {
        SdtmClassVariableObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`role`)) {
        SdtmClassVariableObject[["role"]] <-
          self$`role`
      }
      if (!is.null(self$`roleDescription`)) {
        SdtmClassVariableObject[["roleDescription"]] <-
          self$`roleDescription`
      }
      if (!is.null(self$`simpleDatatype`)) {
        SdtmClassVariableObject[["simpleDatatype"]] <-
          self$`simpleDatatype`
      }
      if (!is.null(self$`describedValueDomain`)) {
        SdtmClassVariableObject[["describedValueDomain"]] <-
          self$`describedValueDomain`
      }
      if (!is.null(self$`_links`)) {
        SdtmClassVariableObject[["_links"]] <-
          self$`_links`$toSimpleType()
      }
      return(SdtmClassVariableObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of SdtmClassVariable
    #'
    #' @param input_json the JSON input
    #' @return the instance of SdtmClassVariable
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`_links`)) {
        `_links_object` <- SdtmClassVariableLinks$new()
    ...
    #' @return SdtmClassVariable in JSON format
    ...
    fromJSONString = function(input_json) {
      ...
      self$`simpleDatatype` <- this_object$`simpleDatatype`
      self$`describedValueDomain` <- this_object$`describedValueDomain`
      self$`_links` <- SdtmClassVariableLinks$new()$fromJSON(jsonlite::toJSON(this_object$`_links`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to SdtmClassVariable and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of SdtmClassVariable
    toString = function() {
      self$toJSONString()
    },
...
# SdtmClassVariable$unlock()
#
## Below is an example to define the print function
# SdtmClassVariable$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SdtmClassVariable$lock()
