...
#' @docType class
#' @title SdtmigClasses
#' @description SdtmigClasses Class
...
#' @field _links  \link{SdtmigClassesLinks} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SdtmigClasses <- R6::R6Class(
  "SdtmigClasses",
  public = list(
    `name` = NULL,
    `label` = NULL,
    ...
    #' @description
    #' Initialize a new SdtmigClasses class.
    #'
    #' @param name name
    #' @param label label
    ...
    #'
    #' @return SdtmigClasses as a base R list.
    #' @examples
    #' # convert array of SdtmigClasses (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SdtmigClasses to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SdtmigClassesObject <- list()
      if (!is.null(self$`name`)) {
        SdtmigClassesObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`label`)) {
        SdtmigClassesObject[["label"]] <-
          self$`label`
      }
      if (!is.null(self$`description`)) {
        SdtmigClassesObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`source`)) {
        SdtmigClassesObject[["source"]] <-
          self$`source`
      }
      if (!is.null(self$`effectiveDate`)) {
        SdtmigClassesObject[["effectiveDate"]] <-
          self$`effectiveDate`
      }
      if (!is.null(self$`registrationStatus`)) {
        SdtmigClassesObject[["registrationStatus"]] <-
          self$`registrationStatus`
      }
      if (!is.null(self$`version`)) {
        SdtmigClassesObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`_links`)) {
        SdtmigClassesObject[["_links"]] <-
          self$`_links`$toSimpleType()
      }
      return(SdtmigClassesObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of SdtmigClasses
    #'
    #' @param input_json the JSON input
    #' @return the instance of SdtmigClasses
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`_links`)) {
        `_links_object` <- SdtmigClassesLinks$new()
    ...
    #' @return SdtmigClasses in JSON format
    ...
    fromJSONString = function(input_json) {
      ...
      self$`registrationStatus` <- this_object$`registrationStatus`
      self$`version` <- this_object$`version`
      self$`_links` <- SdtmigClassesLinks$new()$fromJSON(jsonlite::toJSON(this_object$`_links`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to SdtmigClasses and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of SdtmigClasses
    toString = function() {
      self$toJSONString()
    },
...
# SdtmigClasses$unlock()
#
## Below is an example to define the print function
# SdtmigClasses$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
