#' Create a new SdtmDatasetLinks
#'
#' @description
#' SdtmDatasetLinks Class
#'
#' @docType class
#' @title SdtmDatasetLinks
#' @description SdtmDatasetLinks Class
#' @format An \code{R6Class} generator object
#' @field item_self  \link{SdtmDatasetRef} [optional]
#' @field parentProduct  \link{SdtmProductRef} [optional]
#' @field parentClass  \link{SdtmClassRef} [optional]
#' @field priorVersion  \link{SdtmDatasetRef} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SdtmDatasetLinks <- R6::R6Class(
  "SdtmDatasetLinks",
  public = list(
    `item_self` = NULL,
    `parentProduct` = NULL,
    ...
    #' @description
    #' Initialize a new SdtmDatasetLinks class.
    #'
    ...
    #'
    #' @return SdtmDatasetLinks as a base R list.
    #' @examples
    #' # convert array of SdtmDatasetLinks (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SdtmDatasetLinks to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SdtmDatasetLinksObject <- list()
      if (!is.null(self$`item_self`)) {
        SdtmDatasetLinksObject[["self"]] <-
          self$`item_self`$toSimpleType()
      }
      if (!is.null(self$`parentProduct`)) {
        SdtmDatasetLinksObject[["parentProduct"]] <-
          self$`parentProduct`$toSimpleType()
      }
      if (!is.null(self$`parentClass`)) {
        SdtmDatasetLinksObject[["parentClass"]] <-
          self$`parentClass`$toSimpleType()
      }
      if (!is.null(self$`priorVersion`)) {
        SdtmDatasetLinksObject[["priorVersion"]] <-
          self$`priorVersion`$toSimpleType()
      }
      return(SdtmDatasetLinksObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of SdtmDatasetLinks
    #'
    #' @param input_json the JSON input
    #' @return the instance of SdtmDatasetLinks
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`self`)) {
        `item_self_object` <- SdtmDatasetRef$new()
      ...
      if (!is.null(this_object$`priorVersion`)) {
        `priorversion_object` <- SdtmDatasetRef$new()
    ...
    #' @return SdtmDatasetLinks in JSON format
    ...
    fromJSONString = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      self$`item_self` <- SdtmDatasetRef$new()$fromJSON(jsonlite::toJSON(this_object$`item_self`, auto_unbox = TRUE, digits = NA))
      ...
      self$`priorVersion` <- SdtmDatasetRef$new()$fromJSON(jsonlite::toJSON(this_object$`priorVersion`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to SdtmDatasetLinks and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of SdtmDatasetLinks
    toString = function() {
      self$toJSONString()
    },
...
# SdtmDatasetLinks$unlock()
#
## Below is an example to define the print function
# SdtmDatasetLinks$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SdtmDatasetLinks$lock()
