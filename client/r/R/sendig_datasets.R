#' Create a new SendigDatasets
#'
#' @description
#' SendigDatasets Class
#'
#' @docType class
#' @title SendigDatasets
#' @description SendigDatasets Class
...
#' @field _links  \link{SendigDatasetsLinks} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SendigDatasets <- R6::R6Class(
  "SendigDatasets",
  public = list(
    `name` = NULL,
    `label` = NULL,
    ...
    #' @description
    #' Initialize a new SendigDatasets class.
    #'
    #' @param name name
    #' @param label label
    ...
    #'
    #' @return SendigDatasets as a base R list.
    #' @examples
    #' # convert array of SendigDatasets (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SendigDatasets to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SendigDatasetsObject <- list()
      if (!is.null(self$`name`)) {
        SendigDatasetsObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`label`)) {
        SendigDatasetsObject[["label"]] <-
          self$`label`
      }
      if (!is.null(self$`description`)) {
        SendigDatasetsObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`source`)) {
        SendigDatasetsObject[["source"]] <-
          self$`source`
      }
      if (!is.null(self$`effectiveDate`)) {
        SendigDatasetsObject[["effectiveDate"]] <-
          self$`effectiveDate`
      }
      if (!is.null(self$`registrationStatus`)) {
        SendigDatasetsObject[["registrationStatus"]] <-
          self$`registrationStatus`
      }
      if (!is.null(self$`version`)) {
        SendigDatasetsObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`_links`)) {
        SendigDatasetsObject[["_links"]] <-
          self$`_links`$toSimpleType()
      }
      return(SendigDatasetsObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of SendigDatasets
    #'
    #' @param input_json the JSON input
    #' @return the instance of SendigDatasets
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`_links`)) {
        `_links_object` <- SendigDatasetsLinks$new()
    ...
    #' @return SendigDatasets in JSON format
    ...
    fromJSONString = function(input_json) {
      ...
      self$`registrationStatus` <- this_object$`registrationStatus`
      self$`version` <- this_object$`version`
      self$`_links` <- SendigDatasetsLinks$new()$fromJSON(jsonlite::toJSON(this_object$`_links`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to SendigDatasets and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of SendigDatasets
    toString = function() {
      self$toJSONString()
    },
...
# SendigDatasets$unlock()
#
## Below is an example to define the print function
# SendigDatasets$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
