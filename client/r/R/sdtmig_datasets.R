#' Create a new SdtmigDatasets
#'
#' @description
#' SdtmigDatasets Class
#'
#' @docType class
#' @title SdtmigDatasets
#' @description SdtmigDatasets Class
...
#' @field _links  \link{SdtmigDatasetsLinks} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SdtmigDatasets <- R6::R6Class(
  "SdtmigDatasets",
  public = list(
    `name` = NULL,
    `label` = NULL,
    ...
    #' @description
    #' Initialize a new SdtmigDatasets class.
    #'
    #' @param name name
    #' @param label label
    ...
    #'
    #' @return SdtmigDatasets as a base R list.
    #' @examples
    #' # convert array of SdtmigDatasets (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SdtmigDatasets to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SdtmigDatasetsObject <- list()
      if (!is.null(self$`name`)) {
        SdtmigDatasetsObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`label`)) {
        SdtmigDatasetsObject[["label"]] <-
          self$`label`
      }
      if (!is.null(self$`description`)) {
        SdtmigDatasetsObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`source`)) {
        SdtmigDatasetsObject[["source"]] <-
          self$`source`
      }
      if (!is.null(self$`effectiveDate`)) {
        SdtmigDatasetsObject[["effectiveDate"]] <-
          self$`effectiveDate`
      }
      if (!is.null(self$`registrationStatus`)) {
        SdtmigDatasetsObject[["registrationStatus"]] <-
          self$`registrationStatus`
      }
      if (!is.null(self$`version`)) {
        SdtmigDatasetsObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`_links`)) {
        SdtmigDatasetsObject[["_links"]] <-
          self$`_links`$toSimpleType()
      }
      return(SdtmigDatasetsObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of SdtmigDatasets
    #'
    #' @param input_json the JSON input
    #' @return the instance of SdtmigDatasets
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`_links`)) {
        `_links_object` <- SdtmigDatasetsLinks$new()
    ...
    #' @return SdtmigDatasets in JSON format
    ...
    fromJSONString = function(input_json) {
      ...
      self$`registrationStatus` <- this_object$`registrationStatus`
      self$`version` <- this_object$`version`
      self$`_links` <- SdtmigDatasetsLinks$new()$fromJSON(jsonlite::toJSON(this_object$`_links`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to SdtmigDatasets and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of SdtmigDatasets
    toString = function() {
      self$toJSONString()
    },
...
# SdtmigDatasets$unlock()
#
## Below is an example to define the print function
# SdtmigDatasets$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
