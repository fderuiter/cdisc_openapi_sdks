#' Create a new ExportCdashigScenarioVariablesRow
#'
#' @description
#' ExportCdashigScenarioVariablesRow Class
#'
#' @docType class
#' @title ExportCdashigScenarioVariablesRow
#' @description ExportCdashigScenarioVariablesRow Class
...
#' @export
ExportCdashigScenarioVariablesRow <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ExportCdashigScenarioVariablesRow class.
    #'
    ...
    #'
    #' @return ExportCdashigScenarioVariablesRow as a base R list.
    #' @examples
    #' # convert array of ExportCdashigScenarioVariablesRow (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ExportCdashigScenarioVariablesRow to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ExportCdashigScenarioVariablesRowObject <- list()
      if (!is.null(self$`Version`)) {
        ExportCdashigScenarioVariablesRowObject[["Version"]] <-
          self$`Version`
      }
      if (!is.null(self$`Class`)) {
        ExportCdashigScenarioVariablesRowObject[["Class"]] <-
          self$`Class`
      }
      if (!is.null(self$`Domain`)) {
        ExportCdashigScenarioVariablesRowObject[["Domain"]] <-
          self$`Domain`
      }
      if (!is.null(self$`Data Collection Scenario`)) {
        ExportCdashigScenarioVariablesRowObject[["Data Collection Scenario"]] <-
          self$`Data Collection Scenario`
      }
      if (!is.null(self$`Variable Order`)) {
        ExportCdashigScenarioVariablesRowObject[["Variable Order"]] <-
          self$`Variable Order`
      }
      if (!is.null(self$`CDASHIG Variable`)) {
        ExportCdashigScenarioVariablesRowObject[["CDASHIG Variable"]] <-
          self$`CDASHIG Variable`
      }
      if (!is.null(self$`CDASHIG Variable Label`)) {
        ExportCdashigScenarioVariablesRowObject[["CDASHIG Variable Label"]] <-
          self$`CDASHIG Variable Label`
      }
      if (!is.null(self$`DRAFT CDASHIG Definition`)) {
        ExportCdashigScenarioVariablesRowObject[["DRAFT CDASHIG Definition"]] <-
          self$`DRAFT CDASHIG Definition`
      }
      if (!is.null(self$`Question Text`)) {
        ExportCdashigScenarioVariablesRowObject[["Question Text"]] <-
          self$`Question Text`
      }
      if (!is.null(self$`Prompt`)) {
        ExportCdashigScenarioVariablesRowObject[["Prompt"]] <-
          self$`Prompt`
      }
      if (!is.null(self$`Type`)) {
        ExportCdashigScenarioVariablesRowObject[["Type"]] <-
          self$`Type`
      }
      if (!is.null(self$`CDASHIG Core`)) {
        ExportCdashigScenarioVariablesRowObject[["CDASHIG Core"]] <-
          self$`CDASHIG Core`
      }
      if (!is.null(self$`Case Report Form Completion Instructions`)) {
        ExportCdashigScenarioVariablesRowObject[["Case Report Form Completion Instructions"]] <-
          self$`Case Report Form Completion Instructions`
      }
      if (!is.null(self$`SDTMIG Target`)) {
        ExportCdashigScenarioVariablesRowObject[["SDTMIG Target"]] <-
          self$`SDTMIG Target`
      }
      if (!is.null(self$`Mapping Instructions`)) {
        ExportCdashigScenarioVariablesRowObject[["Mapping Instructions"]] <-
          self$`Mapping Instructions`
      }
      if (!is.null(self$`Controlled Terminology Codelist Name`)) {
        ExportCdashigScenarioVariablesRowObject[["Controlled Terminology Codelist Name"]] <-
          self$`Controlled Terminology Codelist Name`
      }
      if (!is.null(self$`Implementation Notes`)) {
        ExportCdashigScenarioVariablesRowObject[["Implementation Notes"]] <-
          self$`Implementation Notes`
      }
      return(ExportCdashigScenarioVariablesRowObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ExportCdashigScenarioVariablesRow
    #'
    #' @param input_json the JSON input
    #' @return the instance of ExportCdashigScenarioVariablesRow
    ...
    #' @return ExportCdashigScenarioVariablesRow in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ExportCdashigScenarioVariablesRow and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ExportCdashigScenarioVariablesRow
    toString = function() {
      self$toJSONString()
    },
...
# ExportCdashigScenarioVariablesRow$unlock()
#
## Below is an example to define the print function
# ExportCdashigScenarioVariablesRow$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ExportCdashigScenarioVariablesRow$lock()
