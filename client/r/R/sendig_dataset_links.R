#' Create a new SendigDatasetLinks
#'
#' @description
#' SendigDatasetLinks Class
#'
#' @docType class
#' @title SendigDatasetLinks
#' @description SendigDatasetLinks Class
#' @format An \code{R6Class} generator object
#' @field item_self  \link{SendigDatasetRef} [optional]
...
#' @field priorVersion  \link{SendigDatasetRef} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SendigDatasetLinks <- R6::R6Class(
  "SendigDatasetLinks",
  public = list(
    `item_self` = NULL,
    `modelDataset` = NULL,
    ...
    #' @description
    #' Initialize a new SendigDatasetLinks class.
    #'
    ...
    #'
    #' @return SendigDatasetLinks as a base R list.
    #' @examples
    #' # convert array of SendigDatasetLinks (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SendigDatasetLinks to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SendigDatasetLinksObject <- list()
      if (!is.null(self$`item_self`)) {
        SendigDatasetLinksObject[["self"]] <-
          self$`item_self`$toSimpleType()
      }
      if (!is.null(self$`modelDataset`)) {
        SendigDatasetLinksObject[["modelDataset"]] <-
          self$`modelDataset`$toSimpleType()
      }
      if (!is.null(self$`parentProduct`)) {
        SendigDatasetLinksObject[["parentProduct"]] <-
          self$`parentProduct`$toSimpleType()
      }
      if (!is.null(self$`parentClass`)) {
        SendigDatasetLinksObject[["parentClass"]] <-
          self$`parentClass`$toSimpleType()
      }
      if (!is.null(self$`priorVersion`)) {
        SendigDatasetLinksObject[["priorVersion"]] <-
          self$`priorVersion`$toSimpleType()
      }
      return(SendigDatasetLinksObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of SendigDatasetLinks
    #'
    #' @param input_json the JSON input
    #' @return the instance of SendigDatasetLinks
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`self`)) {
        `item_self_object` <- SendigDatasetRef$new()
      ...
      if (!is.null(this_object$`priorVersion`)) {
        `priorversion_object` <- SendigDatasetRef$new()
    ...
    #' @return SendigDatasetLinks in JSON format
    ...
    fromJSONString = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      self$`item_self` <- SendigDatasetRef$new()$fromJSON(jsonlite::toJSON(this_object$`item_self`, auto_unbox = TRUE, digits = NA))
      ...
      self$`priorVersion` <- SendigDatasetRef$new()$fromJSON(jsonlite::toJSON(this_object$`priorVersion`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to SendigDatasetLinks and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of SendigDatasetLinks
    toString = function() {
      self$toJSONString()
    },
...
# SendigDatasetLinks$unlock()
#
## Below is an example to define the print function
# SendigDatasetLinks$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SendigDatasetLinks$lock()
