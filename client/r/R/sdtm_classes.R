...
#' @field _links  \link{SdtmClassesLinks} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SdtmClasses <- R6::R6Class(
  "SdtmClasses",
  public = list(
    `name` = NULL,
    `label` = NULL,
    ...
    #' @description
    #' Initialize a new SdtmClasses class.
    #'
    #' @param name name
    #' @param label label
    ...
    #'
    #' @return SdtmClasses as a base R list.
    #' @examples
    #' # convert array of SdtmClasses (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SdtmClasses to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SdtmClassesObject <- list()
      if (!is.null(self$`name`)) {
        SdtmClassesObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`label`)) {
        SdtmClassesObject[["label"]] <-
          self$`label`
      }
      if (!is.null(self$`description`)) {
        SdtmClassesObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`source`)) {
        SdtmClassesObject[["source"]] <-
          self$`source`
      }
      if (!is.null(self$`effectiveDate`)) {
        SdtmClassesObject[["effectiveDate"]] <-
          self$`effectiveDate`
      }
      if (!is.null(self$`registrationStatus`)) {
        SdtmClassesObject[["registrationStatus"]] <-
          self$`registrationStatus`
      }
      if (!is.null(self$`version`)) {
        SdtmClassesObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`_links`)) {
        SdtmClassesObject[["_links"]] <-
          self$`_links`$toSimpleType()
      }
      return(SdtmClassesObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of SdtmClasses
    #'
    #' @param input_json the JSON input
    #' @return the instance of SdtmClasses
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`_links`)) {
        `_links_object` <- SdtmClassesLinks$new()
    ...
    #' @return SdtmClasses in JSON format
    ...
    fromJSONString = function(input_json) {
      ...
      self$`registrationStatus` <- this_object$`registrationStatus`
      self$`version` <- this_object$`version`
      self$`_links` <- SdtmClassesLinks$new()$fromJSON(jsonlite::toJSON(this_object$`_links`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to SdtmClasses and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of SdtmClasses
    toString = function() {
      self$toJSONString()
    },
...
# SdtmClasses$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
