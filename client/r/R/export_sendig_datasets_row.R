#' Create a new ExportSendigDatasetsRow
#'
#' @description
#' ExportSendigDatasetsRow Class
#'
#' @docType class
#' @title ExportSendigDatasetsRow
#' @description ExportSendigDatasetsRow Class
...
#' @export
ExportSendigDatasetsRow <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ExportSendigDatasetsRow class.
    #'
    ...
    #'
    #' @return ExportSendigDatasetsRow as a base R list.
    #' @examples
    #' # convert array of ExportSendigDatasetsRow (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ExportSendigDatasetsRow to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ExportSendigDatasetsRowObject <- list()
      if (!is.null(self$`Version`)) {
        ExportSendigDatasetsRowObject[["Version"]] <-
          self$`Version`
      }
      if (!is.null(self$`Class`)) {
        ExportSendigDatasetsRowObject[["Class"]] <-
          self$`Class`
      }
      if (!is.null(self$`Dataset Name`)) {
        ExportSendigDatasetsRowObject[["Dataset Name"]] <-
          self$`Dataset Name`
      }
      if (!is.null(self$`Dataset Label`)) {
        ExportSendigDatasetsRowObject[["Dataset Label"]] <-
          self$`Dataset Label`
      }
      if (!is.null(self$`Structure`)) {
        ExportSendigDatasetsRowObject[["Structure"]] <-
          self$`Structure`
      }
      return(ExportSendigDatasetsRowObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ExportSendigDatasetsRow
    #'
    #' @param input_json the JSON input
    #' @return the instance of ExportSendigDatasetsRow
    ...
    #' @return ExportSendigDatasetsRow in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ExportSendigDatasetsRow and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ExportSendigDatasetsRow
    toString = function() {
      self$toJSONString()
    },
...
# ExportSendigDatasetsRow$unlock()
#
## Below is an example to define the print function
# ExportSendigDatasetsRow$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ExportSendigDatasetsRow$lock()
