...
OAICdashClassField::OAICdashClassField(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICdashClassField::OAICdashClassField() {
    this->initializeModel();
}

OAICdashClassField::~OAICdashClassField() {}

void OAICdashClassField::initializeModel() {
...
void OAICdashClassField::fromJson(QString jsonString) {
...
void OAICdashClassField::fromJsonObject(QJsonObject json) {
...
QString OAICdashClassField::asJson() const {
...
QJsonObject OAICdashClassField::asJsonObject() const {
    QJsonObject obj;
    if (m_ordinal_isSet) {
...
QString OAICdashClassField::getOrdinal() const {
    return m_ordinal;
}
void OAICdashClassField::setOrdinal(const QString &ordinal) {
    m_ordinal = ordinal;
    m_ordinal_isSet = true;
}

bool OAICdashClassField::is_ordinal_Set() const{
    return m_ordinal_isSet;
}

bool OAICdashClassField::is_ordinal_Valid() const{
    return m_ordinal_isValid;
}

QString OAICdashClassField::getName() const {
    return m_name;
}
void OAICdashClassField::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICdashClassField::is_name_Set() const{
    return m_name_isSet;
}

bool OAICdashClassField::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICdashClassField::getLabel() const {
    return m_label;
}
void OAICdashClassField::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAICdashClassField::is_label_Set() const{
    return m_label_isSet;
}

bool OAICdashClassField::is_label_Valid() const{
    return m_label_isValid;
}

QString OAICdashClassField::getDefinition() const {
    return m_definition;
}
void OAICdashClassField::setDefinition(const QString &definition) {
    m_definition = definition;
    m_definition_isSet = true;
}

bool OAICdashClassField::is_definition_Set() const{
    return m_definition_isSet;
}

bool OAICdashClassField::is_definition_Valid() const{
    return m_definition_isValid;
}

QString OAICdashClassField::getQuestionText() const {
    return m_question_text;
}
void OAICdashClassField::setQuestionText(const QString &question_text) {
    m_question_text = question_text;
    m_question_text_isSet = true;
}

bool OAICdashClassField::is_question_text_Set() const{
    return m_question_text_isSet;
}

bool OAICdashClassField::is_question_text_Valid() const{
    return m_question_text_isValid;
}

QString OAICdashClassField::getPrompt() const {
    return m_prompt;
}
void OAICdashClassField::setPrompt(const QString &prompt) {
    m_prompt = prompt;
    m_prompt_isSet = true;
}

bool OAICdashClassField::is_prompt_Set() const{
    return m_prompt_isSet;
}

bool OAICdashClassField::is_prompt_Valid() const{
    return m_prompt_isValid;
}

QString OAICdashClassField::getSimpleDatatype() const {
    return m_simple_datatype;
}
void OAICdashClassField::setSimpleDatatype(const QString &simple_datatype) {
    m_simple_datatype = simple_datatype;
    m_simple_datatype_isSet = true;
}

bool OAICdashClassField::is_simple_datatype_Set() const{
    return m_simple_datatype_isSet;
}

bool OAICdashClassField::is_simple_datatype_Valid() const{
    return m_simple_datatype_isValid;
}

QString OAICdashClassField::getImplementationNotes() const {
    return m_implementation_notes;
}
void OAICdashClassField::setImplementationNotes(const QString &implementation_notes) {
    m_implementation_notes = implementation_notes;
    m_implementation_notes_isSet = true;
}

bool OAICdashClassField::is_implementation_notes_Set() const{
    return m_implementation_notes_isSet;
}

bool OAICdashClassField::is_implementation_notes_Valid() const{
    return m_implementation_notes_isValid;
}

QString OAICdashClassField::getMappingInstructions() const {
    return m_mapping_instructions;
}
void OAICdashClassField::setMappingInstructions(const QString &mapping_instructions) {
    m_mapping_instructions = mapping_instructions;
    m_mapping_instructions_isSet = true;
}

bool OAICdashClassField::is_mapping_instructions_Set() const{
    return m_mapping_instructions_isSet;
}

bool OAICdashClassField::is_mapping_instructions_Valid() const{
    return m_mapping_instructions_isValid;
}

OAICdashClassFieldLinks OAICdashClassField::getLinks() const {
    return m__links;
}
void OAICdashClassField::setLinks(const OAICdashClassFieldLinks &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAICdashClassField::is__links_Set() const{
    return m__links_isSet;
}

bool OAICdashClassField::is__links_Valid() const{
    return m__links_isValid;
}

bool OAICdashClassField::isSet() const {
...
bool OAICdashClassField::isValid() const {
