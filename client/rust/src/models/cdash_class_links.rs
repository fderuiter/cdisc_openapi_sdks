...
pub struct CdashClassLinks {
    #[serde(rename = "self", skip_serializing_if = "Option::is_none")]
    pub param_self: Option<Box<models::CdashClassRef>>,
    ...
    pub prior_version: Option<Box<models::CdashClassRef>>,
}

impl CdashClassLinks {
    pub fn new() -> CdashClassLinks {
        CdashClassLinks {
            param_self: None,
            parent_product: None,
            prior_version: None,
