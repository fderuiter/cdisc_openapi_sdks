...
#ifndef OAISdtmDatasets_H
#define OAISdtmDatasets_H
...
namespace OpenAPI {
class OAISdtmDatasetsLinks;

class OAISdtmDatasets : public OAIObject {
public:
    OAISdtmDatasets();
    OAISdtmDatasets(QString json);
    ~OAISdtmDatasets() override;
    ...
    OAISdtmDatasetsLinks getLinks() const;
    void setLinks(const OAISdtmDatasetsLinks &_links);
...
Q_DECLARE_METATYPE(OpenAPI::OAISdtmDatasets)

#endif // OAISdtmDatasets_H
