...
#ifndef OAISdtmigDatasets_H
#define OAISdtmigDatasets_H
...
namespace OpenAPI {
class OAISdtmigDatasetsLinks;

class OAISdtmigDatasets : public OAIObject {
public:
    OAISdtmigDatasets();
    OAISdtmigDatasets(QString json);
    ~OAISdtmigDatasets() override;
    ...
    OAISdtmigDatasetsLinks getLinks() const;
    void setLinks(const OAISdtmigDatasetsLinks &_links);
...
private:
    ...
    OAISdtmigDatasetsLinks m__links;
    bool m__links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISdtmigDatasets)

#endif // OAISdtmigDatasets_H
