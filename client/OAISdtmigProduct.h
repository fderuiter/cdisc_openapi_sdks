...
#ifndef OAISdtmigProduct_H
#define OAISdtmigProduct_H
...
class OAISdtmigProduct : public OAIObject {
public:
    OAISdtmigProduct();
    OAISdtmigProduct(QString json);
    ~OAISdtmigProduct() override;
    ...
    OAISdtmigProductLinks getLinks() const;
    void setLinks(const OAISdtmigProductLinks &_links);
    bool is__links_Set() const;
    bool is__links_Valid() const;

    QList<OAISdtmigClass> getClasses() const;
    void setClasses(const QList<OAISdtmigClass> &classes);
...
private:
    ...
    OAISdtmigProductLinks m__links;
    bool m__links_isSet;
    bool m__links_isValid;

    QList<OAISdtmigClass> m_classes;
...
Q_DECLARE_METATYPE(OpenAPI::OAISdtmigProduct)

#endif // OAISdtmigProduct_H
