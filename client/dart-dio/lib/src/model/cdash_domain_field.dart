...
import 'package:openapi/src/model/cdash_domain_field_links.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'cdash_domain_field.g.dart';
...
/// * [links] 
@BuiltValue()
abstract class CdashDomainField implements Built<CdashDomainField, CdashDomainFieldBuilder> {
  ...
  @BuiltValueField(wireName: r'domainSpecific')
  ...
  CdashDomainFieldLinks? get links;

  CdashDomainField._();

  factory CdashDomainField([void updates(CdashDomainFieldBuilder b)]) = _$CdashDomainField;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CdashDomainFieldBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CdashDomainField> get serializer => _$CdashDomainFieldSerializer();
}

class _$CdashDomainFieldSerializer implements PrimitiveSerializer<CdashDomainField> {
  @override
  final Iterable<Type> types = const [CdashDomainField, _$CdashDomainField];

  @override
  final String wireName = r'CdashDomainField';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CdashDomainField object, {
    ...
    if (object.links != null) {
      ...
      yield serializers.serialize(
        object.links,
        specifiedType: const FullType(CdashDomainFieldLinks),
      );
    }
  }
  ...
  void _deserializeProperties(
    ...
    required CdashDomainFieldBuilder result,
  ...
  @override
  CdashDomainField deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CdashDomainFieldBuilder();
