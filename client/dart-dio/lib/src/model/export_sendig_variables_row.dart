...
part 'export_sendig_variables_row.g.dart';
...
/// * [core] 
@BuiltValue()
abstract class ExportSendigVariablesRow implements Built<ExportSendigVariablesRow, ExportSendigVariablesRowBuilder> {
  ...
  ExportSendigVariablesRow._();

  factory ExportSendigVariablesRow([void updates(ExportSendigVariablesRowBuilder b)]) = _$ExportSendigVariablesRow;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ExportSendigVariablesRowBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ExportSendigVariablesRow> get serializer => _$ExportSendigVariablesRowSerializer();
}

class _$ExportSendigVariablesRowSerializer implements PrimitiveSerializer<ExportSendigVariablesRow> {
  @override
  final Iterable<Type> types = const [ExportSendigVariablesRow, _$ExportSendigVariablesRow];

  @override
  final String wireName = r'ExportSendigVariablesRow';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ExportSendigVariablesRow object, {
  ...
  void _deserializeProperties(
    ...
    required ExportSendigVariablesRowBuilder result,
  ...
  @override
  ExportSendigVariablesRow deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ExportSendigVariablesRowBuilder();
