...
// checks if the CdashDomainFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CdashDomainFields{}

// CdashDomainFields struct for CdashDomainFields
type CdashDomainFields struct {
	Ordinal *string `json:"ordinal,omitempty"`
	Name *string `json:"name,omitempty"`
	Label *string `json:"label,omitempty"`
	Links *CdashDomainFieldsLinks `json:"_links,omitempty"`
}
...
func (o *CdashDomainFields) GetLinks() CdashDomainFieldsLinks {
	if o == nil || IsNil(o.Links) {
		var ret CdashDomainFieldsLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given CdashDomainFieldsLinks and assigns it to the Links field.
func (o *CdashDomainFields) SetLinks(v CdashDomainFieldsLinks) {
	o.Links = &v
}

func (o CdashDomainFields) MarshalJSON() ([]byte, error) {
...
func (o CdashDomainFields) ToMap() (map[string]interface{}, error) {
...
type NullableCdashDomainFields struct {
	value *CdashDomainFields
	isSet bool
}

func (v NullableCdashDomainFields) Get() *CdashDomainFields {
	return v.value
}

func (v *NullableCdashDomainFields) Set(val *CdashDomainFields) {
	v.value = val
	v.isSet = true
}

func (v NullableCdashDomainFields) IsSet() bool {
	return v.isSet
}

func (v *NullableCdashDomainFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCdashDomainFields(val *CdashDomainFields) *NullableCdashDomainFields {
	return &NullableCdashDomainFields{value: val, isSet: true}
}

func (v NullableCdashDomainFields) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCdashDomainFields) UnmarshalJSON(src []byte) error {
	v.isSet = true
