...
// checks if the CdashigClassScenarios type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CdashigClassScenarios{}

// CdashigClassScenarios struct for CdashigClassScenarios
type CdashigClassScenarios struct {
	Ordinal *string `json:"ordinal,omitempty"`
	Name *string `json:"name,omitempty"`
	Label *string `json:"label,omitempty"`
	Description *string `json:"description,omitempty"`
	Links *CdashigClassScenariosLinks `json:"_links,omitempty"`
}
...
func (o *CdashigClassScenarios) GetLinks() CdashigClassScenariosLinks {
	if o == nil || IsNil(o.Links) {
		var ret CdashigClassScenariosLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given CdashigClassScenariosLinks and assigns it to the Links field.
func (o *CdashigClassScenarios) SetLinks(v CdashigClassScenariosLinks) {
	o.Links = &v
}

func (o CdashigClassScenarios) MarshalJSON() ([]byte, error) {
...
func (o CdashigClassScenarios) ToMap() (map[string]interface{}, error) {
...
type NullableCdashigClassScenarios struct {
	value *CdashigClassScenarios
	isSet bool
}

func (v NullableCdashigClassScenarios) Get() *CdashigClassScenarios {
	return v.value
}

func (v *NullableCdashigClassScenarios) Set(val *CdashigClassScenarios) {
	v.value = val
	v.isSet = true
}

func (v NullableCdashigClassScenarios) IsSet() bool {
	return v.isSet
}

func (v *NullableCdashigClassScenarios) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCdashigClassScenarios(val *CdashigClassScenarios) *NullableCdashigClassScenarios {
	return &NullableCdashigClassScenarios{value: val, isSet: true}
}

func (v NullableCdashigClassScenarios) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCdashigClassScenarios) UnmarshalJSON(src []byte) error {
	v.isSet = true
