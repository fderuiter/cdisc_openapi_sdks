...
/*
 * OAIExportSendigVariablesRow.h
 *
 * 
 */

#ifndef OAIExportSendigVariablesRow_H
#define OAIExportSendigVariablesRow_H
...
class OAIExportSendigVariablesRow : public OAIObject {
public:
    OAIExportSendigVariablesRow();
    OAIExportSendigVariablesRow(QString json);
    ~OAIExportSendigVariablesRow() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportSendigVariablesRow)

#endif // OAIExportSendigVariablesRow_H
