...
object ExportCdashigDomainVariablesRow {
  given encoderExportCdashigDomainVariablesRow: Encoder[ExportCdashigDomainVariablesRow] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderExportCdashigDomainVariablesRow: Decoder[ExportCdashigDomainVariablesRow] = Decoder.instance { c =>
    for {
    ...
    } yield ExportCdashigDomainVariablesRow(
      version = version,
      `class` = `class`,
      domain = domain,
