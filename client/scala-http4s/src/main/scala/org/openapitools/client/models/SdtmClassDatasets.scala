...
case class SdtmClassDatasets(
    ...
    links: Option[SdtmClassDatasetsLinks] = None
)
  
object SdtmClassDatasets {
  given encoderSdtmClassDatasets: Encoder[SdtmClassDatasets] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderSdtmClassDatasets: Decoder[SdtmClassDatasets] = Decoder.instance { c =>
    for {
      ordinal <- c.downField("ordinal").as[Option[String]]
      name <- c.downField("name").as[Option[String]]
      label <- c.downField("label").as[Option[String]]
      description <- c.downField("description").as[Option[String]]
      links <- c.downField("_links").as[Option[SdtmClassDatasetsLinks]]
    } yield SdtmClassDatasets(
      ordinal = ordinal,
      name = name,
      label = label,
