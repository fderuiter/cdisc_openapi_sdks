...
object ExportCdashClassVariablesRow {
  given encoderExportCdashClassVariablesRow: Encoder[ExportCdashClassVariablesRow] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderExportCdashClassVariablesRow: Decoder[ExportCdashClassVariablesRow] = Decoder.instance { c =>
    for {
    ...
    } yield ExportCdashClassVariablesRow(
      version = version,
      `class` = `class`,
      domain = domain,
