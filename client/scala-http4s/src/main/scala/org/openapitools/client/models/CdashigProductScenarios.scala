...
case class CdashigProductScenarios(
    ...
    links: Option[CdashigProductScenariosLinks] = None
)
  
object CdashigProductScenarios {
  given encoderCdashigProductScenarios: Encoder[CdashigProductScenarios] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderCdashigProductScenarios: Decoder[CdashigProductScenarios] = Decoder.instance { c =>
    for {
      ...
      links <- c.downField("_links").as[Option[CdashigProductScenariosLinks]]
    } yield CdashigProductScenarios(
      name = name,
      label = label,
