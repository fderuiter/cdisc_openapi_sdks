...
case class AdamProductDatastructures(
    ...
    links: Option[AdamProductDatastructuresLinks] = None
)
  
object AdamProductDatastructures {
  given encoderAdamProductDatastructures: Encoder[AdamProductDatastructures] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderAdamProductDatastructures: Decoder[AdamProductDatastructures] = Decoder.instance { c =>
    for {
      ...
      links <- c.downField("_links").as[Option[AdamProductDatastructuresLinks]]
    } yield AdamProductDatastructures(
      name = name,
      label = label,
