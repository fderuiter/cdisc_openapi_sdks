...
case class CdashDomainFields(
    ...
    links: Option[CdashDomainFieldsLinks] = None
)
  
object CdashDomainFields {
  given encoderCdashDomainFields: Encoder[CdashDomainFields] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderCdashDomainFields: Decoder[CdashDomainFields] = Decoder.instance { c =>
    for {
      ordinal <- c.downField("ordinal").as[Option[String]]
      name <- c.downField("name").as[Option[String]]
      label <- c.downField("label").as[Option[String]]
      links <- c.downField("_links").as[Option[CdashDomainFieldsLinks]]
    } yield CdashDomainFields(
      ordinal = ordinal,
      name = name,
      label = label,
      links = links
