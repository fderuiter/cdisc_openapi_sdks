...
case class SdtmigDatasets(
    ...
    links: Option[SdtmigDatasetsLinks] = None
)
  
object SdtmigDatasets {
  given encoderSdtmigDatasets: Encoder[SdtmigDatasets] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderSdtmigDatasets: Decoder[SdtmigDatasets] = Decoder.instance { c =>
    for {
      ...
      links <- c.downField("_links").as[Option[SdtmigDatasetsLinks]]
    } yield SdtmigDatasets(
      name = name,
      label = label,
