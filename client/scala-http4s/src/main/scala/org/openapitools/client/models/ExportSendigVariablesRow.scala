...
object ExportSendigVariablesRow {
  given encoderExportSendigVariablesRow: Encoder[ExportSendigVariablesRow] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderExportSendigVariablesRow: Decoder[ExportSendigVariablesRow] = Decoder.instance { c =>
    for {
    ...
    } yield ExportSendigVariablesRow(
      version = version,
