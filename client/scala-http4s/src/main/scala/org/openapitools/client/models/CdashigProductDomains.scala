...
case class CdashigProductDomains(
    ...
    links: Option[CdashigProductDomainsLinks] = None
)
  
object CdashigProductDomains {
  given encoderCdashigProductDomains: Encoder[CdashigProductDomains] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderCdashigProductDomains: Decoder[CdashigProductDomains] = Decoder.instance { c =>
    for {
      ...
      links <- c.downField("_links").as[Option[CdashigProductDomainsLinks]]
    } yield CdashigProductDomains(
      name = name,
      label = label,
