...
case class SdtmClasses(
    ...
    links: Option[SdtmClassesLinks] = None
)
  
object SdtmClasses {
  given encoderSdtmClasses: Encoder[SdtmClasses] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderSdtmClasses: Decoder[SdtmClasses] = Decoder.instance { c =>
    for {
      ...
      links <- c.downField("_links").as[Option[SdtmClassesLinks]]
    } yield SdtmClasses(
      name = name,
      label = label,
