...
case class CdashProduct(
    ...
    links: Option[CdashProductLinks] = None,
    classes: Option[Seq[CdashClass]] = None,
    domains: Option[Seq[CdashDomain]] = None
)
  
object CdashProduct {
  given encoderCdashProduct: Encoder[CdashProduct] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderCdashProduct: Decoder[CdashProduct] = Decoder.instance { c =>
    for {
      ...
      links <- c.downField("_links").as[Option[CdashProductLinks]]
      classes <- c.downField("classes").as[Option[Seq[CdashClass]]]
      domains <- c.downField("domains").as[Option[Seq[CdashDomain]]]
    } yield CdashProduct(
      name = name,
      label = label,
