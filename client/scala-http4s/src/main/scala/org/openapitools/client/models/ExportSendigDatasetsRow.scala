...
object ExportSendigDatasetsRow {
  given encoderExportSendigDatasetsRow: Encoder[ExportSendigDatasetsRow] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderExportSendigDatasetsRow: Decoder[ExportSendigDatasetsRow] = Decoder.instance { c =>
    for {
