...
case class CtPackageCodelists(
    ...
    links: Option[CtPackageCodelistsLinks] = None
)
  
object CtPackageCodelists {
  given encoderCtPackageCodelists: Encoder[CtPackageCodelists] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderCtPackageCodelists: Decoder[CtPackageCodelists] = Decoder.instance { c =>
    for {
      ...
      links <- c.downField("_links").as[Option[CtPackageCodelistsLinks]]
    } yield CtPackageCodelists(
      name = name,
      label = label,
