...
case class CdashigClassDomains(
    ...
    links: Option[CdashigClassDomainsLinks] = None
)
  
object CdashigClassDomains {
  given encoderCdashigClassDomains: Encoder[CdashigClassDomains] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderCdashigClassDomains: Decoder[CdashigClassDomains] = Decoder.instance { c =>
    for {
      ordinal <- c.downField("ordinal").as[Option[String]]
      name <- c.downField("name").as[Option[String]]
      label <- c.downField("label").as[Option[String]]
      description <- c.downField("description").as[Option[String]]
      links <- c.downField("_links").as[Option[CdashigClassDomainsLinks]]
    } yield CdashigClassDomains(
      ordinal = ordinal,
      name = name,
      label = label,
