...
case class CdashClassDomains(
    ...
    links: Option[CdashClassDomainsLinks] = None
)
  
object CdashClassDomains {
  given encoderCdashClassDomains: Encoder[CdashClassDomains] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderCdashClassDomains: Decoder[CdashClassDomains] = Decoder.instance { c =>
    for {
      ordinal <- c.downField("ordinal").as[Option[String]]
      name <- c.downField("name").as[Option[String]]
      label <- c.downField("label").as[Option[String]]
      description <- c.downField("description").as[Option[String]]
      links <- c.downField("_links").as[Option[CdashClassDomainsLinks]]
    } yield CdashClassDomains(
      ordinal = ordinal,
      name = name,
      label = label,
