...
object ExportSdtmClassVariablesRow {
  given encoderExportSdtmClassVariablesRow: Encoder[ExportSdtmClassVariablesRow] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderExportSdtmClassVariablesRow: Decoder[ExportSdtmClassVariablesRow] = Decoder.instance { c =>
    for {
    ...
    } yield ExportSdtmClassVariablesRow(
      version = version,
