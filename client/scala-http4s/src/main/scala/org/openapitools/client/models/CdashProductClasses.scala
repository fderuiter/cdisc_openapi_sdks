...
case class CdashProductClasses(
    ...
    links: Option[CdashProductClassesLinks] = None
)
  
object CdashProductClasses {
  given encoderCdashProductClasses: Encoder[CdashProductClasses] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderCdashProductClasses: Decoder[CdashProductClasses] = Decoder.instance { c =>
    for {
      ...
      links <- c.downField("_links").as[Option[CdashProductClassesLinks]]
    } yield CdashProductClasses(
      name = name,
      label = label,
