...
case class CdashigProductClasses(
    ...
    links: Option[CdashigProductClassesLinks] = None
)
  
object CdashigProductClasses {
  given encoderCdashigProductClasses: Encoder[CdashigProductClasses] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderCdashigProductClasses: Decoder[CdashigProductClasses] = Decoder.instance { c =>
    for {
      ...
      links <- c.downField("_links").as[Option[CdashigProductClassesLinks]]
    } yield CdashigProductClasses(
      name = name,
      label = label,
