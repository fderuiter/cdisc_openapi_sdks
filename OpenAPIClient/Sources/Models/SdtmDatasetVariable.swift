...
public struct SdtmDatasetVariable: Codable {
    ...
    public var links: SdtmDatasetVariableLinks?

    public init(ordinal: String? = nil, name: String? = nil, label: String? = nil, description: String? = nil, role: String? = nil, roleDescription: String? = nil, simpleDatatype: String? = nil, describedValueDomain: String? = nil, links: SdtmDatasetVariableLinks? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        links = try container.decodeIfPresent(SdtmDatasetVariableLinks.self, forKey: .links)
    }
