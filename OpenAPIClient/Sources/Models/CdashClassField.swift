...
public struct CdashClassField: Codable {
    ...
    public var links: CdashClassFieldLinks?

    public init(ordinal: String? = nil, name: String? = nil, label: String? = nil, definition: String? = nil, questionText: String? = nil, prompt: String? = nil, simpleDatatype: String? = nil, implementationNotes: String? = nil, mappingInstructions: String? = nil, links: CdashClassFieldLinks? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        links = try container.decodeIfPresent(CdashClassFieldLinks.self, forKey: .links)
    }
