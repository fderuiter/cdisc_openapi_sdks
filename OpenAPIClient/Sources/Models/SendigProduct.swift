...
public struct SendigProduct: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        links = try container.decodeIfPresent(SendigProductLinks.self, forKey: .links)
        classes = try container.decodeIfPresent([SendigClass].self, forKey: .classes)
    }
