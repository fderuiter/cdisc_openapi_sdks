...
public struct ExportQrsCsvItemsRow: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        qRSMeasureName = try container.decodeIfPresent(String.self, forKey: .qRSMeasureName)
        qRSMeasureLabel = try container.decodeIfPresent(String.self, forKey: .qRSMeasureLabel)
        qRSMeasureType = try container.decodeIfPresent(String.self, forKey: .qRSMeasureType)
