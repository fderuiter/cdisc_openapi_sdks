...
public struct ProductsLinks: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        _self = try container.decodeIfPresent(ProductsRef.self, forKey: ._self)
        dataCollection = try container.decodeIfPresent(ProductgroupDataCollection.self, forKey: .dataCollection)
        dataTabulation = try container.decodeIfPresent(ProductgroupDataTabulation.self, forKey: .dataTabulation)
        dataAnalysis = try container.decodeIfPresent(ProductgroupDataAnalysis.self, forKey: .dataAnalysis)
        terminology = try container.decodeIfPresent(ProductgroupTerminology.self, forKey: .terminology)
        measure = try container.decodeIfPresent(ProductgroupQrs.self, forKey: .measure)
    }
