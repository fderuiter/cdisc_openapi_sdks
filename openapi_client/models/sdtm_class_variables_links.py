...
class SdtmClassVariablesLinks(BaseModel):
    ...
    class_variables: Optional[List[SdtmClassVariableRefElement]] = Field(default=None, alias="classVariables")
    __properties: ClassVar[List[str]] = ["self", "parentProduct", "priorVersion", "classVariables"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": SdtmClassVariablesRef.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "parentProduct": SdtmProductRef.from_dict(obj["parentProduct"]) if obj.get("parentProduct") is not None else None,
            "priorVersion": SdtmClassVariablesRef.from_dict(obj["priorVersion"]) if obj.get("priorVersion") is not None else None,
            "classVariables": [SdtmClassVariableRefElement.from_dict(_item) for _item in obj["classVariables"]] if obj.get("classVariables") is not None else None
        })
        return _obj
