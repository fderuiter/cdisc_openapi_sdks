...
class SdtmigProduct(BaseModel):
    ...
    classes: Optional[List[SdtmigClass]] = None
    __properties: ClassVar[List[str]] = ["name", "label", "description", "source", "effectiveDate", "registrationStatus", "version", "_links", "classes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": SdtmigProductLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "classes": [SdtmigClass.from_dict(_item) for _item in obj["classes"]] if obj.get("classes") is not None else None
        })
        return _obj
