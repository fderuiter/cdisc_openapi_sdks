...
class SdtmigProduct(BaseModel):
    ...
    links: Optional[SdtmigProductLinks] = Field(default=None, alias="_links")
    classes: Optional[conlist(SdtmigClass)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SdtmigProduct:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SdtmigProduct:
        """Create an instance of SdtmigProduct from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SdtmigProduct.parse_obj(obj)

        _obj = SdtmigProduct.parse_obj({
            "name": obj.get("name"),
            "label": obj.get("label"),
            ...
            "links": SdtmigProductLinks.from_dict(obj.get("_links")) if obj.get("_links") is not None else None,
            "classes": [SdtmigClass.from_dict(_item) for _item in obj.get("classes")] if obj.get("classes") is not None else None
        })
        return _obj
