...
class CtPackagesLinks(BaseModel):
    ...
    packages: Optional[List[CtPackageRefElement]] = None
    __properties: ClassVar[List[str]] = ["self", "packages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": CtPackagesRef.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "packages": [CtPackageRefElement.from_dict(_item) for _item in obj["packages"]] if obj.get("packages") is not None else None
        })
        return _obj
