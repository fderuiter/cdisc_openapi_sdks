...
class ExportSdtmDatasetsRow(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportSdtmDatasetsRow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportSdtmDatasetsRow:
        """Create an instance of ExportSdtmDatasetsRow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportSdtmDatasetsRow.parse_obj(obj)

        _obj = ExportSdtmDatasetsRow.parse_obj({
