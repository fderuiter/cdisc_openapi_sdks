...
class ExportAdamDatastructuresRow(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["Version", "Data Structure Name", "Dataset Name", "Dataset Label", "Dataset Description", "Class"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Dataset Label": obj.get("Dataset Label"),
            "Dataset Description": obj.get("Dataset Description"),
            "Class": obj.get("Class")
        })
        return _obj
