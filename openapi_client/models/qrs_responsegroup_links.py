...
class QrsResponsegroupLinks(BaseModel):
    ...
    responses: Optional[List[QrsResponses]] = None
    __properties: ClassVar[List[str]] = ["self", "responses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": QrsResponsegroupRef.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "responses": [QrsResponses.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
