...
class ExportSendigDatasetsRow(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportSendigDatasetsRow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportSendigDatasetsRow:
        """Create an instance of ExportSendigDatasetsRow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportSendigDatasetsRow.parse_obj(obj)

        _obj = ExportSendigDatasetsRow.parse_obj({
