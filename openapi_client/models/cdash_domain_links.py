...
class CdashDomainLinks(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["self", "parentProduct", "parentClass", "priorVersion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": CdashDomainRef.from_dict(obj["self"]) if obj.get("self") is not None else None,
            ...
            "priorVersion": CdashDomainRef.from_dict(obj["priorVersion"]) if obj.get("priorVersion") is not None else None
        })
        return _obj
