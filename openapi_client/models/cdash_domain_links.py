...
class CdashDomainLinks(BaseModel):
    """
    CdashDomainLinks
    """
    var_self: Optional[CdashDomainRef] = Field(default=None, alias="self")
    ...
    prior_version: Optional[CdashDomainRef] = Field(default=None, alias="priorVersion")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CdashDomainLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CdashDomainLinks:
        """Create an instance of CdashDomainLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CdashDomainLinks.parse_obj(obj)

        _obj = CdashDomainLinks.parse_obj({
            "var_self": CdashDomainRef.from_dict(obj.get("self")) if obj.get("self") is not None else None,
            ...
            "prior_version": CdashDomainRef.from_dict(obj.get("priorVersion")) if obj.get("priorVersion") is not None else None
        })
        return _obj
