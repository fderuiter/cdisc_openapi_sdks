...
class SendigClass(BaseModel):
    ...
    datasets: Optional[List[SendigDataset]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": SendigClassLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "datasets": [SendigDataset.from_dict(_item) for _item in obj["datasets"]] if obj.get("datasets") is not None else None
        })
        return _obj
