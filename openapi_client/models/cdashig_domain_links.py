...
class CdashigDomainLinks(BaseModel):
    """
    CdashigDomainLinks
    """ # noqa: E501
    var_self: Optional[CdashigDomainRef] = Field(default=None, alias="self")
    ...
    prior_version: Optional[CdashigDomainRef] = Field(default=None, alias="priorVersion")
    scenarios: Optional[List[CdashigScenarioRefElement]] = None
    __properties: ClassVar[List[str]] = ["self", "parentProduct", "parentClass", "priorVersion", "scenarios"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": CdashigDomainRef.from_dict(obj["self"]) if obj.get("self") is not None else None,
            ...
            "priorVersion": CdashigDomainRef.from_dict(obj["priorVersion"]) if obj.get("priorVersion") is not None else None,
            "scenarios": [CdashigScenarioRefElement.from_dict(_item) for _item in obj["scenarios"]] if obj.get("scenarios") is not None else None
        })
        return _obj
