...
class ExportQrsCsvItemsRow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportQrsCsvItemsRow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportQrsCsvItemsRow:
        """Create an instance of ExportQrsCsvItemsRow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportQrsCsvItemsRow.parse_obj(obj)

        _obj = ExportQrsCsvItemsRow.parse_obj({
            "qrs_measure_name": obj.get("QRS Measure Name"),
            "qrs_measure_label": obj.get("QRS Measure Label"),
            "qrs_measure_type": obj.get("QRS Measure Type"),
