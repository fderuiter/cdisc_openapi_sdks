...
class CdashigProductClassesLinks(BaseModel):
    """
    CdashigProductClassesLinks
    """
    var_self: Optional[CdashigProductClassesRef] = Field(default=None, alias="self")
    parent_product: Optional[CdashigProductRef] = Field(default=None, alias="parentProduct")
    classes: Optional[conlist(CdashigClassRefElement)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CdashigProductClassesLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CdashigProductClassesLinks:
        """Create an instance of CdashigProductClassesLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CdashigProductClassesLinks.parse_obj(obj)

        _obj = CdashigProductClassesLinks.parse_obj({
            "var_self": CdashigProductClassesRef.from_dict(obj.get("self")) if obj.get("self") is not None else None,
            "parent_product": CdashigProductRef.from_dict(obj.get("parentProduct")) if obj.get("parentProduct") is not None else None,
            "classes": [CdashigClassRefElement.from_dict(_item) for _item in obj.get("classes")] if obj.get("classes") is not None else None
        })
        return _obj
