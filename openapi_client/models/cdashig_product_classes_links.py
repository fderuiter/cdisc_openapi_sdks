...
class CdashigProductClassesLinks(BaseModel):
    ...
    classes: Optional[List[CdashigClassRefElement]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": CdashigProductClassesRef.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "parentProduct": CdashigProductRef.from_dict(obj["parentProduct"]) if obj.get("parentProduct") is not None else None,
            "classes": [CdashigClassRefElement.from_dict(_item) for _item in obj["classes"]] if obj.get("classes") is not None else None
        })
        return _obj
