...
class ExportSendigWorkbook(BaseModel):
    ...
    """ # noqa: E501
    variables: Optional[List[ExportSendigVariablesRow]] = None
    datasets: Optional[List[ExportSendigDatasetsRow]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "variables": [ExportSendigVariablesRow.from_dict(_item) for _item in obj["variables"]] if obj.get("variables") is not None else None,
            "datasets": [ExportSendigDatasetsRow.from_dict(_item) for _item in obj["datasets"]] if obj.get("datasets") is not None else None
        })
        return _obj
