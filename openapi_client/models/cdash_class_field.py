...
class CdashClassField(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ordinal", "name", "label", "definition", "questionText", "prompt", "simpleDatatype", "implementationNotes", "mappingInstructions", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": CdashClassFieldLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
