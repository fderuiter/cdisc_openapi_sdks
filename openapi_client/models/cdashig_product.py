...
class CdashigProduct(BaseModel):
    ...
    classes: Optional[List[CdashigClass]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": CdashigProductLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "classes": [CdashigClass.from_dict(_item) for _item in obj["classes"]] if obj.get("classes") is not None else None
        })
        return _obj
