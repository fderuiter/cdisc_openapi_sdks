...
class CdashigDomainFieldsLinks(BaseModel):
    ...
    fields: Optional[List[CdashigDomainFieldRefElement]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": CdashigDomainFieldsRef.from_dict(obj["self"]) if obj.get("self") is not None else None,
            ...
            "fields": [CdashigDomainFieldRefElement.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None
        })
        return _obj
