...
class CdashigProductDomainsLinks(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CdashigProductDomainsLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CdashigProductDomainsLinks:
        """Create an instance of CdashigProductDomainsLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CdashigProductDomainsLinks.parse_obj(obj)

        _obj = CdashigProductDomainsLinks.parse_obj({
            "var_self": CdashigProductDomainsRef.from_dict(obj.get("self")) if obj.get("self") is not None else None,
