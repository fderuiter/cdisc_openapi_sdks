...
class ExportSdtmDatasetVariablesRow(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["Version", "Variable Order", "Class", "Dataset Name", "Variable Name", "Variable Label", "Type", "Controlled Terms, Codelist or Format", "Role", "Role Description", "Description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Role": obj.get("Role"),
            "Role Description": obj.get("Role Description"),
