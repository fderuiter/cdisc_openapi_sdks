...
class CdashigDomainField(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CdashigDomainField:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CdashigDomainField:
        """Create an instance of CdashigDomainField from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CdashigDomainField.parse_obj(obj)

        _obj = CdashigDomainField.parse_obj({
            ...
            "core": obj.get("core"),
            "links": CdashigDomainFieldLinks.from_dict(obj.get("_links")) if obj.get("_links") is not None else None
        })
        return _obj
