...
class CdashDomainFieldsLinks(BaseModel):
    ...
    fields: Optional[List[CdashDomainFieldRefElement]] = None
    __properties: ClassVar[List[str]] = ["self", "parentProduct", "parentClass", "fields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": CdashDomainFieldsRef.from_dict(obj["self"]) if obj.get("self") is not None else None,
            ...
            "fields": [CdashDomainFieldRefElement.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None
        })
        return _obj
