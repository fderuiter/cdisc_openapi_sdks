...
class ExportSdtmigWorkbook(BaseModel):
    ...
    """ # noqa: E501
    variables: Optional[List[ExportSdtmigVariablesRow]] = None
    datasets: Optional[List[ExportSdtmigDatasetsRow]] = None
    __properties: ClassVar[List[str]] = ["variables", "datasets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "variables": [ExportSdtmigVariablesRow.from_dict(_item) for _item in obj["variables"]] if obj.get("variables") is not None else None,
            "datasets": [ExportSdtmigDatasetsRow.from_dict(_item) for _item in obj["datasets"]] if obj.get("datasets") is not None else None
        })
        return _obj
