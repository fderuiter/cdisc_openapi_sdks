...
class SdtmDatasetsLinks(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": SdtmDatasetsRef.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "parentProduct": SdtmProductRef.from_dict(obj["parentProduct"]) if obj.get("parentProduct") is not None else None,
            "priorVersion": SdtmDatasetsRef.from_dict(obj["priorVersion"]) if obj.get("priorVersion") is not None else None,
