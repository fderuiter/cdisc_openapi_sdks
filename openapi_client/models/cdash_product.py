...
class CdashProduct(BaseModel):
    ...
    classes: Optional[List[CdashClass]] = None
    domains: Optional[List[CdashDomain]] = None
    __properties: ClassVar[List[str]] = ["name", "label", "description", "source", "effectiveDate", "registrationStatus", "version", "_links", "classes", "domains"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": CdashProductLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "classes": [CdashClass.from_dict(_item) for _item in obj["classes"]] if obj.get("classes") is not None else None,
            "domains": [CdashDomain.from_dict(_item) for _item in obj["domains"]] if obj.get("domains") is not None else None
        })
        return _obj
