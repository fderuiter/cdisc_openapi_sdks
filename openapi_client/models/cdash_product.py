...
class CdashProduct(BaseModel):
    ...
    links: Optional[CdashProductLinks] = Field(default=None, alias="_links")
    classes: Optional[conlist(CdashClass)] = None
    domains: Optional[conlist(CdashDomain)] = None
    __properties = ["name", "label", "description", "source", "effectiveDate", "registrationStatus", "version", "_links", "classes", "domains"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CdashProduct:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CdashProduct:
        """Create an instance of CdashProduct from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CdashProduct.parse_obj(obj)

        _obj = CdashProduct.parse_obj({
            "name": obj.get("name"),
            "label": obj.get("label"),
            ...
            "links": CdashProductLinks.from_dict(obj.get("_links")) if obj.get("_links") is not None else None,
            "classes": [CdashClass.from_dict(_item) for _item in obj.get("classes")] if obj.get("classes") is not None else None,
            "domains": [CdashDomain.from_dict(_item) for _item in obj.get("domains")] if obj.get("domains") is not None else None
        })
        return _obj
