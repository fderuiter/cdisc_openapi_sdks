...
class CdashProductDomainsLinks(BaseModel):
    ...
    domains: Optional[List[CdashDomainRefElement]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": CdashProductDomainsRef.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "parentProduct": CdashProductRef.from_dict(obj["parentProduct"]) if obj.get("parentProduct") is not None else None,
            "domains": [CdashDomainRefElement.from_dict(_item) for _item in obj["domains"]] if obj.get("domains") is not None else None
        })
        return _obj
