...
class SdtmClassesLinks(BaseModel):
    ...
    classes: Optional[List[SdtmClassRefElement]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": SdtmClassesRef.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "priorVersion": SdtmClassesRef.from_dict(obj["priorVersion"]) if obj.get("priorVersion") is not None else None,
            "classes": [SdtmClassRefElement.from_dict(_item) for _item in obj["classes"]] if obj.get("classes") is not None else None
        })
        return _obj
