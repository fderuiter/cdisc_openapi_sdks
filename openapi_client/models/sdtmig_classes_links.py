...
class SdtmigClassesLinks(BaseModel):
    ...
    classes: Optional[List[SdtmigClassRefElement]] = None
    __properties: ClassVar[List[str]] = ["self", "priorVersion", "classes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": SdtmigClassesRef.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "priorVersion": SdtmigClassesRef.from_dict(obj["priorVersion"]) if obj.get("priorVersion") is not None else None,
            "classes": [SdtmigClassRefElement.from_dict(_item) for _item in obj["classes"]] if obj.get("classes") is not None else None
        })
        return _obj
