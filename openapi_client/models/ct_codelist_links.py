...
class CtCodelistLinks(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["self", "parentPackage", "rootItem", "priorVersion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": CtCodelistRef.from_dict(obj["self"]) if obj.get("self") is not None else None,
            ...
            "priorVersion": CtCodelistRef.from_dict(obj["priorVersion"]) if obj.get("priorVersion") is not None else None
        })
        return _obj
