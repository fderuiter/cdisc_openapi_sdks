...
class ProductgroupDataAnalysisLinks(BaseModel):
    ...
    adam: Optional[List[AdamProductRefElement]] = None
    __properties: ClassVar[List[str]] = ["self", "adam"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.adam:
            for _item_adam in self.adam:
                if _item_adam:
                    _items.append(_item_adam.to_dict())
            _dict['adam'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "adam": [AdamProductRefElement.from_dict(_item) for _item in obj["adam"]] if obj.get("adam") is not None else None
        })
        return _obj
