...
class ExportCdashigDomainVariablesRow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportCdashigDomainVariablesRow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportCdashigDomainVariablesRow:
        """Create an instance of ExportCdashigDomainVariablesRow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportCdashigDomainVariablesRow.parse_obj(obj)

        _obj = ExportCdashigDomainVariablesRow.parse_obj({
