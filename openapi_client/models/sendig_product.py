...
class SendigProduct(BaseModel):
    ...
    classes: Optional[List[SendigClass]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": SendigProductLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "classes": [SendigClass.from_dict(_item) for _item in obj["classes"]] if obj.get("classes") is not None else None
        })
        return _obj
