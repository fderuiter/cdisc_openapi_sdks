extends Resource
class_name CdashClassFieldLinks
...
# CdashClassFieldLinks Model


# Required: False
# isArray: false
@export var some_self: CdashClassFieldRef:
	set(value):
...
# Required: False
# isArray: false
@export var rootItem: RootCdashClassFieldRef:
	set(value):
...
# Required: False
# isArray: false
@export var priorVersion: CdashClassFieldRef:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("some_self"):
		me.some_self = CdashClassFieldRef.bzz_denormalize_single(from_dict["some_self"])
	...
	if from_dict.has("rootItem"):
		me.rootItem = RootCdashClassFieldRef.bzz_denormalize_single(from_dict["rootItem"])
	if from_dict.has("priorVersion"):
		me.priorVersion = CdashClassFieldRef.bzz_denormalize_single(from_dict["priorVersion"])
