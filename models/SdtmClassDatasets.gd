...
# Required: False
# Example: Special-Purpose Datasets
# isArray: false
...
# Required: False
# Example: This SDTM class contains a set of domains which do not conform to the Findings, Events or Interventions observation classes. The domains included are DM, CO, SE and SV. (Source: CDISC Controlled Terminology, GNRLOBSC, C103377, 2018-06-29)
# isArray: false
...
# Required: False
# isArray: false
@export var Underscorelinks: SdtmClassDatasetsLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = SdtmClassDatasetsLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
