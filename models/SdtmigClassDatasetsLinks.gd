extends Resource
class_name SdtmigClassDatasetsLinks
...
# SdtmigClassDatasetsLinks Model


# Required: False
# isArray: false
@export var some_self: SdtmigClassDatasetsRef:
	set(value):
...
# Required: False
# isArray: false
@export var priorVersion: SdtmigClassDatasetsRef:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("some_self"):
		me.some_self = SdtmigClassDatasetsRef.bzz_denormalize_single(from_dict["some_self"])
	...
	if from_dict.has("priorVersion"):
		me.priorVersion = SdtmigClassDatasetsRef.bzz_denormalize_single(from_dict["priorVersion"])
	if from_dict.has("datasets"):
		me.datasets = SdtmigDatasetRefElement.bzz_denormalize_multiple(from_dict["datasets"])
	return me
