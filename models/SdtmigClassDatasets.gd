extends Resource
class_name SdtmigClassDatasets
...
# Required: False
# isArray: false
@export var Underscorelinks: SdtmigClassDatasetsLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = SdtmigClassDatasetsLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
