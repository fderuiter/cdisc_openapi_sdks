extends Resource
class_name CdashigProductClasses
...
# Required: False
# isArray: false
@export var Underscorelinks: CdashigProductClassesLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = CdashigProductClassesLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
