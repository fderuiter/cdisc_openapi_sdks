extends Resource
class_name CdashigProductDomains
...
# Required: False
# isArray: false
@export var Underscorelinks: CdashigProductDomainsLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = CdashigProductDomainsLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
