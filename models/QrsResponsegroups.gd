...
# Required: False
# isArray: false
@export var Underscorelinks: QrsResponsegroupsLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = QrsResponsegroupsLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
