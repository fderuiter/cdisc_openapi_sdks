extends Resource
class_name CdashigDomainFields
...
# Required: False
# isArray: false
@export var Underscorelinks: CdashigDomainFieldsLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = CdashigDomainFieldsLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
