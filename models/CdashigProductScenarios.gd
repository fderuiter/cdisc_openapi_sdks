extends Resource
class_name CdashigProductScenarios
...
# Required: False
# isArray: false
@export var Underscorelinks: CdashigProductScenariosLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = CdashigProductScenariosLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
