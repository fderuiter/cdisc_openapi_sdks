...
# Required: False
# isArray: false
@export var Underscorelinks: CtPackageCodelistsLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = CtPackageCodelistsLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
