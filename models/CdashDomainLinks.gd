...
# CdashDomainLinks Model


# Required: False
# isArray: false
@export var some_self: CdashDomainRef:
	set(value):
...
# Required: False
# isArray: false
@export var priorVersion: CdashDomainRef:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("some_self"):
		me.some_self = CdashDomainRef.bzz_denormalize_single(from_dict["some_self"])
	...
	if from_dict.has("priorVersion"):
		me.priorVersion = CdashDomainRef.bzz_denormalize_single(from_dict["priorVersion"])
	return me
