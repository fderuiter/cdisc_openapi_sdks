extends Resource
class_name ProductgroupQrsLinks
...
# Required: False
# isArray: true
@export var qrs: Array:
	set(value):
		__qrs__was__set = true
		qrs = value
var __qrs__was__set := false
...
func bzz_normalize() -> Dictionary:
	...
	if self.__qrs__was__set:
		bzz_dictionary["qrs"] = self.qrs
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("qrs"):
		me.qrs = QrsRefElement.bzz_denormalize_multiple(from_dict["qrs"])
	return me
