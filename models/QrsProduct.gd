...
# Required: False
# isArray: false
@export var Underscorelinks: QrsProductLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = QrsProductLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	if from_dict.has("items"):
		me.items = QrsItem.bzz_denormalize_multiple(from_dict["items"])
	return me
