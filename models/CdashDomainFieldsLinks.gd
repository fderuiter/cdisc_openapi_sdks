extends Resource
class_name CdashDomainFieldsLinks
...
# CdashDomainFieldsLinks Model


# Required: False
# isArray: false
@export var some_self: CdashDomainFieldsRef:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("some_self"):
		me.some_self = CdashDomainFieldsRef.bzz_denormalize_single(from_dict["some_self"])
	...
	if from_dict.has("fields"):
		me.fields = CdashDomainFieldRefElement.bzz_denormalize_multiple(from_dict["fields"])
	return me
