...
# Required: False
# isArray: false
@export var Underscorelinks: QrsResponsegroupLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = QrsResponsegroupLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
