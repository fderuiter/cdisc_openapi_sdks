extends Resource
class_name AdamDatastructureVariables
...
# AdamDatastructureVariables Model
...
# Required: False
# isArray: false
@export var Underscorelinks: AdamDatastructureVariablesLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = AdamDatastructureVariablesLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
