...
# Required: False
# Example: Study Data Tabulation Model Implementation Guide: Human Clinical Trials Version 3.3 (Final)
# isArray: false
...
# Required: False
# Example: CDISC Version 3.3 (v3.3) Study Data Tabulation Model Implementation Guide for Human Clinical Trials (SDTMIG) is intended to guide the organization, structure, and format of standard clinical trial tabulation datasets submitted to a regulatory authority.
# isArray: false
...
# Required: False
# Example: Prepared by the CDISC Submission Data Standards Team
# isArray: false
...
# Required: False
# isArray: false
@export var Underscorelinks: SdtmigProductLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = SdtmigProductLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	if from_dict.has("classes"):
		me.classes = SdtmigClass.bzz_denormalize_multiple(from_dict["classes"])
	return me
