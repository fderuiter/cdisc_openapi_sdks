extends Resource
class_name SendigClassDatasets
...
# Required: False
# isArray: false
@export var Underscorelinks: SendigClassDatasetsLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = SendigClassDatasetsLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
