...
# Required: False
# isArray: false
@export var Underscorelinks: AdamProductLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = AdamProductLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	if from_dict.has("dataStructures"):
		me.dataStructures = AdamDatastructure.bzz_denormalize_multiple(from_dict["dataStructures"])
	return me
