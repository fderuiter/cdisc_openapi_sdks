extends Resource
class_name ExportQrsCsvItemsRow
...
# ExportQrsCsvItemsRow Model


# Required: False
# isArray: false
@export var QRS Measure Name: String = "":
	set(value):
		__QRS Measure Name__was__set = true
		QRS Measure Name = value
var __QRS Measure Name__was__set := false

# Required: False
# isArray: false
@export var QRS Measure Label: String = "":
	set(value):
		__QRS Measure Label__was__set = true
		QRS Measure Label = value
var __QRS Measure Label__was__set := false

# Required: False
# isArray: false
@export var QRS Measure Type: String = "":
	set(value):
		__QRS Measure Type__was__set = true
		QRS Measure Type = value
var __QRS Measure Type__was__set := false
...
func bzz_normalize() -> Dictionary:
	...
	if self.__QRS Measure Name__was__set:
		bzz_dictionary["QRS Measure Name"] = self.QRS Measure Name
	if self.__QRS Measure Label__was__set:
		bzz_dictionary["QRS Measure Label"] = self.QRS Measure Label
	if self.__QRS Measure Type__was__set:
		bzz_dictionary["QRS Measure Type"] = self.QRS Measure Type
...
static func bzz_denormalize_single(from_dict: Dictionary):
	var me := new()
	if from_dict.has("QRS Measure Name"):
		me.QRS Measure Name = from_dict["QRS Measure Name"]
	if from_dict.has("QRS Measure Label"):
		me.QRS Measure Label = from_dict["QRS Measure Label"]
	if from_dict.has("QRS Measure Type"):
		me.QRS Measure Type = from_dict["QRS Measure Type"]
