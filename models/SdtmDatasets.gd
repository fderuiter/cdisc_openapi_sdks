...
# Required: False
# isArray: false
@export var Underscorelinks: SdtmDatasetsLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = SdtmDatasetsLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
