extends Resource
class_name CdashigClassDomains
...
# Required: False
# isArray: false
@export var Underscorelinks: CdashigClassDomainsLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = CdashigClassDomainsLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
