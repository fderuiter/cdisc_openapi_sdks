...
# RootCtCodelist Model


# Required: False
# isArray: false
@export var Underscorelinks: RootCtCodelistLinks:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("Underscorelinks"):
		me.Underscorelinks = RootCtCodelistLinks.bzz_denormalize_single(from_dict["Underscorelinks"])
	return me
