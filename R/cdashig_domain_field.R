#' Create a new CdashigDomainField
#'
#' @description
#' CdashigDomainField Class
#'
#' @docType class
#' @title CdashigDomainField
#' @description CdashigDomainField Class
...
#' @field _links  \link{CdashigDomainFieldLinks} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
CdashigDomainField <- R6::R6Class(
  "CdashigDomainField",
  public = list(
    `ordinal` = NULL,
    `name` = NULL,
    ...
    #' @description
    #' Initialize a new CdashigDomainField class.
    #'
    ...
    #'
    #' @return CdashigDomainField as a base R list.
    #' @examples
    #' # convert array of CdashigDomainField (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CdashigDomainField to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      CdashigDomainFieldObject <- list()
      if (!is.null(self$`ordinal`)) {
        CdashigDomainFieldObject[["ordinal"]] <-
          self$`ordinal`
      }
      if (!is.null(self$`name`)) {
        CdashigDomainFieldObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`label`)) {
        CdashigDomainFieldObject[["label"]] <-
          self$`label`
      }
      if (!is.null(self$`definition`)) {
        CdashigDomainFieldObject[["definition"]] <-
          self$`definition`
      }
      if (!is.null(self$`questionText`)) {
        CdashigDomainFieldObject[["questionText"]] <-
          self$`questionText`
      }
      if (!is.null(self$`prompt`)) {
        CdashigDomainFieldObject[["prompt"]] <-
          self$`prompt`
      }
      if (!is.null(self$`completionInstructions`)) {
        CdashigDomainFieldObject[["completionInstructions"]] <-
          self$`completionInstructions`
      }
      if (!is.null(self$`implementationNotes`)) {
        CdashigDomainFieldObject[["implementationNotes"]] <-
          self$`implementationNotes`
      }
      if (!is.null(self$`simpleDatatype`)) {
        CdashigDomainFieldObject[["simpleDatatype"]] <-
          self$`simpleDatatype`
      }
      if (!is.null(self$`mappingInstructions`)) {
        CdashigDomainFieldObject[["mappingInstructions"]] <-
          self$`mappingInstructions`
      }
      if (!is.null(self$`core`)) {
        CdashigDomainFieldObject[["core"]] <-
          self$`core`
      }
      if (!is.null(self$`_links`)) {
        CdashigDomainFieldObject[["_links"]] <-
          self$`_links`$toSimpleType()
      }
      return(CdashigDomainFieldObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of CdashigDomainField
    #'
    #' @param input_json the JSON input
    #' @return the instance of CdashigDomainField
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`_links`)) {
        `_links_object` <- CdashigDomainFieldLinks$new()
    ...
    #' @return CdashigDomainField in JSON format
    ...
    fromJSONString = function(input_json) {
      ...
      self$`mappingInstructions` <- this_object$`mappingInstructions`
      self$`core` <- this_object$`core`
      self$`_links` <- CdashigDomainFieldLinks$new()$fromJSON(jsonlite::toJSON(this_object$`_links`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to CdashigDomainField and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of CdashigDomainField
    toString = function() {
      self$toJSONString()
    },
...
# CdashigDomainField$unlock()
#
## Below is an example to define the print function
# CdashigDomainField$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CdashigDomainField$lock()
