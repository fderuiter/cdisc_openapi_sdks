...
#' @docType class
#' @title SendigProduct
#' @description SendigProduct Class
...
#' @field _links  \link{SendigProductLinks} [optional]
#' @field classes  list(\link{SendigClass}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SendigProduct <- R6::R6Class(
  "SendigProduct",
  public = list(
    `name` = NULL,
    `label` = NULL,
    ...
    #' @description
    #' Initialize a new SendigProduct class.
    #'
    #' @param name name
    #' @param label label
    ...
    #'
    #' @return SendigProduct as a base R list.
    #' @examples
    #' # convert array of SendigProduct (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SendigProduct to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SendigProductObject <- list()
      if (!is.null(self$`name`)) {
        SendigProductObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`label`)) {
        SendigProductObject[["label"]] <-
          self$`label`
      }
      if (!is.null(self$`description`)) {
        SendigProductObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`source`)) {
        SendigProductObject[["source"]] <-
          self$`source`
      }
      if (!is.null(self$`effectiveDate`)) {
        SendigProductObject[["effectiveDate"]] <-
          self$`effectiveDate`
      }
      if (!is.null(self$`registrationStatus`)) {
        SendigProductObject[["registrationStatus"]] <-
          self$`registrationStatus`
      }
      if (!is.null(self$`version`)) {
        SendigProductObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`_links`)) {
        SendigProductObject[["_links"]] <-
          self$`_links`$toSimpleType()
      }
      if (!is.null(self$`classes`)) {
        SendigProductObject[["classes"]] <-
          lapply(self$`classes`, function(x) x$toSimpleType())
      }
      return(SendigProductObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of SendigProduct
    #'
    #' @param input_json the JSON input
    #' @return the instance of SendigProduct
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`_links`)) {
        `_links_object` <- SendigProductLinks$new()
        `_links_object`$fromJSON(jsonlite::toJSON(this_object$`_links`, auto_unbox = TRUE, digits = NA))
        self$`_links` <- `_links_object`
      }
      if (!is.null(this_object$`classes`)) {
        self$`classes` <- ApiClient$new()$deserializeObj(this_object$`classes`, "array[SendigClass]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return SendigProduct in JSON format
    ...
    fromJSONString = function(input_json) {
      ...
      self$`registrationStatus` <- this_object$`registrationStatus`
      self$`version` <- this_object$`version`
      self$`_links` <- SendigProductLinks$new()$fromJSON(jsonlite::toJSON(this_object$`_links`, auto_unbox = TRUE, digits = NA))
      self$`classes` <- ApiClient$new()$deserializeObj(this_object$`classes`, "array[SendigClass]", loadNamespace("openapi"))
      self
    },

    #' @description
    #' Validate JSON input with respect to SendigProduct and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of SendigProduct
    toString = function() {
      self$toJSONString()
    },
...
# SendigProduct$unlock()
#
## Below is an example to define the print function
# SendigProduct$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
