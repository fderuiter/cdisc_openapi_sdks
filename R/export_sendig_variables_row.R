#' Create a new ExportSendigVariablesRow
#'
#' @description
#' ExportSendigVariablesRow Class
#'
#' @docType class
#' @title ExportSendigVariablesRow
#' @description ExportSendigVariablesRow Class
...
#' @export
ExportSendigVariablesRow <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ExportSendigVariablesRow class.
    #'
    ...
    #'
    #' @return ExportSendigVariablesRow as a base R list.
    #' @examples
    #' # convert array of ExportSendigVariablesRow (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ExportSendigVariablesRow to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ExportSendigVariablesRowObject <- list()
      if (!is.null(self$`Version`)) {
        ExportSendigVariablesRowObject[["Version"]] <-
          self$`Version`
      }
      if (!is.null(self$`Variable Order`)) {
        ExportSendigVariablesRowObject[["Variable Order"]] <-
          self$`Variable Order`
      }
      if (!is.null(self$`Class`)) {
        ExportSendigVariablesRowObject[["Class"]] <-
          self$`Class`
      }
      if (!is.null(self$`Dataset Name`)) {
        ExportSendigVariablesRowObject[["Dataset Name"]] <-
          self$`Dataset Name`
      }
      if (!is.null(self$`Variable Name`)) {
        ExportSendigVariablesRowObject[["Variable Name"]] <-
          self$`Variable Name`
      }
      if (!is.null(self$`Variable Label`)) {
        ExportSendigVariablesRowObject[["Variable Label"]] <-
          self$`Variable Label`
      }
      if (!is.null(self$`Type`)) {
        ExportSendigVariablesRowObject[["Type"]] <-
          self$`Type`
      }
      if (!is.null(self$`Controlled Terms, Codelist or Format`)) {
        ExportSendigVariablesRowObject[["Controlled Terms, Codelist or Format"]] <-
          self$`Controlled Terms, Codelist or Format`
      }
      if (!is.null(self$`Role`)) {
        ExportSendigVariablesRowObject[["Role"]] <-
          self$`Role`
      }
      if (!is.null(self$`CDISC Notes`)) {
        ExportSendigVariablesRowObject[["CDISC Notes"]] <-
          self$`CDISC Notes`
      }
      if (!is.null(self$`Core`)) {
        ExportSendigVariablesRowObject[["Core"]] <-
          self$`Core`
      }
      return(ExportSendigVariablesRowObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ExportSendigVariablesRow
    #'
    #' @param input_json the JSON input
    #' @return the instance of ExportSendigVariablesRow
    ...
    #' @return ExportSendigVariablesRow in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ExportSendigVariablesRow and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ExportSendigVariablesRow
    toString = function() {
      self$toJSONString()
    },
...
# ExportSendigVariablesRow$unlock()
#
## Below is an example to define the print function
# ExportSendigVariablesRow$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ExportSendigVariablesRow$lock()
