#' Create a new SdtmigClassLinks
#'
#' @description
#' SdtmigClassLinks Class
#'
#' @docType class
#' @title SdtmigClassLinks
#' @description SdtmigClassLinks Class
#' @format An \code{R6Class} generator object
#' @field item_self  \link{SdtmigClassRef} [optional]
...
#' @field subclasses  list(\link{SdtmigClassRefSubclass}) [optional]
#' @field priorVersion  \link{SdtmigClassRef} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SdtmigClassLinks <- R6::R6Class(
  "SdtmigClassLinks",
  public = list(
    `item_self` = NULL,
    `modelClass` = NULL,
    ...
    #' @description
    #' Initialize a new SdtmigClassLinks class.
    #'
    ...
    #'
    #' @return SdtmigClassLinks as a base R list.
    #' @examples
    #' # convert array of SdtmigClassLinks (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SdtmigClassLinks to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SdtmigClassLinksObject <- list()
      if (!is.null(self$`item_self`)) {
        SdtmigClassLinksObject[["self"]] <-
          self$`item_self`$toSimpleType()
      }
      if (!is.null(self$`modelClass`)) {
        SdtmigClassLinksObject[["modelClass"]] <-
          self$`modelClass`$toSimpleType()
      }
      if (!is.null(self$`parentProduct`)) {
        SdtmigClassLinksObject[["parentProduct"]] <-
          self$`parentProduct`$toSimpleType()
      }
      if (!is.null(self$`parentClass`)) {
        SdtmigClassLinksObject[["parentClass"]] <-
          self$`parentClass`$toSimpleType()
      }
      if (!is.null(self$`subclasses`)) {
        SdtmigClassLinksObject[["subclasses"]] <-
          lapply(self$`subclasses`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`priorVersion`)) {
        SdtmigClassLinksObject[["priorVersion"]] <-
          self$`priorVersion`$toSimpleType()
      }
      return(SdtmigClassLinksObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of SdtmigClassLinks
    #'
    #' @param input_json the JSON input
    #' @return the instance of SdtmigClassLinks
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`self`)) {
        `item_self_object` <- SdtmigClassRef$new()
      ...
      if (!is.null(this_object$`subclasses`)) {
        self$`subclasses` <- ApiClient$new()$deserializeObj(this_object$`subclasses`, "array[SdtmigClassRefSubclass]", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`priorVersion`)) {
        `priorversion_object` <- SdtmigClassRef$new()
    ...
    #' @return SdtmigClassLinks in JSON format
    ...
    fromJSONString = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      self$`item_self` <- SdtmigClassRef$new()$fromJSON(jsonlite::toJSON(this_object$`item_self`, auto_unbox = TRUE, digits = NA))
      ...
      self$`subclasses` <- ApiClient$new()$deserializeObj(this_object$`subclasses`, "array[SdtmigClassRefSubclass]", loadNamespace("openapi"))
      self$`priorVersion` <- SdtmigClassRef$new()$fromJSON(jsonlite::toJSON(this_object$`priorVersion`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to SdtmigClassLinks and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of SdtmigClassLinks
    toString = function() {
      self$toJSONString()
    },
...
# SdtmigClassLinks$unlock()
#
## Below is an example to define the print function
# SdtmigClassLinks$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SdtmigClassLinks$lock()
