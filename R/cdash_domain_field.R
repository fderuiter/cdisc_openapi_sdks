...
#' @field _links  \link{CdashDomainFieldLinks} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
CdashDomainField <- R6::R6Class(
  "CdashDomainField",
  public = list(
    `ordinal` = NULL,
    `name` = NULL,
    ...
    #' @description
    #' Initialize a new CdashDomainField class.
    #'
    #' @param ordinal ordinal
    #' @param name name
    #' @param label label
    #' @param definition definition
    #' @param domainSpecific domainSpecific
    ...
    initialize = function(`ordinal` = NULL, `name` = NULL, `label` = NULL, `definition` = NULL, `domainSpecific` = NULL, `questionText` = NULL, `prompt` = NULL, `simpleDatatype` = NULL, `implementationNotes` = NULL, `mappingInstructions` = NULL, `_links` = NULL, ...) {
      if (!is.null(`ordinal`)) {
      ...
      if (!is.null(`domainSpecific`)) {
        if (!(is.character(`domainSpecific`) && length(`domainSpecific`) == 1)) {
          stop(paste("Error! Invalid data for `domainSpecific`. Must be a string:", `domainSpecific`))
        }
    ...
    #'
    #' @return CdashDomainField as a base R list.
    #' @examples
    #' # convert array of CdashDomainField (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CdashDomainField to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      CdashDomainFieldObject <- list()
      if (!is.null(self$`ordinal`)) {
        CdashDomainFieldObject[["ordinal"]] <-
          self$`ordinal`
      }
      if (!is.null(self$`name`)) {
        CdashDomainFieldObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`label`)) {
        CdashDomainFieldObject[["label"]] <-
          self$`label`
      }
      if (!is.null(self$`definition`)) {
        CdashDomainFieldObject[["definition"]] <-
          self$`definition`
      }
      if (!is.null(self$`domainSpecific`)) {
        CdashDomainFieldObject[["domainSpecific"]] <-
          self$`domainSpecific`
      }
      if (!is.null(self$`questionText`)) {
        CdashDomainFieldObject[["questionText"]] <-
          self$`questionText`
      }
      if (!is.null(self$`prompt`)) {
        CdashDomainFieldObject[["prompt"]] <-
          self$`prompt`
      }
      if (!is.null(self$`simpleDatatype`)) {
        CdashDomainFieldObject[["simpleDatatype"]] <-
          self$`simpleDatatype`
      }
      if (!is.null(self$`implementationNotes`)) {
        CdashDomainFieldObject[["implementationNotes"]] <-
          self$`implementationNotes`
      }
      if (!is.null(self$`mappingInstructions`)) {
        CdashDomainFieldObject[["mappingInstructions"]] <-
          self$`mappingInstructions`
      }
      if (!is.null(self$`_links`)) {
        CdashDomainFieldObject[["_links"]] <-
          self$`_links`$toSimpleType()
      }
      return(CdashDomainFieldObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of CdashDomainField
    #'
    #' @param input_json the JSON input
    #' @return the instance of CdashDomainField
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`domainSpecific`)) {
        self$`domainSpecific` <- this_object$`domainSpecific`
      }
      ...
      if (!is.null(this_object$`_links`)) {
        `_links_object` <- CdashDomainFieldLinks$new()
    ...
    #' @return CdashDomainField in JSON format
    ...
    fromJSONString = function(input_json) {
      ...
      self$`implementationNotes` <- this_object$`implementationNotes`
      self$`mappingInstructions` <- this_object$`mappingInstructions`
      self$`_links` <- CdashDomainFieldLinks$new()$fromJSON(jsonlite::toJSON(this_object$`_links`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to CdashDomainField and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of CdashDomainField
    toString = function() {
      self$toJSONString()
    },
...
# CdashDomainField$unlock()
#
## Below is an example to define the print function
# CdashDomainField$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CdashDomainField$lock()
