#' Create a new ExportCdashClassVariablesRow
#'
#' @description
#' ExportCdashClassVariablesRow Class
#'
#' @docType class
#' @title ExportCdashClassVariablesRow
#' @description ExportCdashClassVariablesRow Class
...
#' @export
ExportCdashClassVariablesRow <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ExportCdashClassVariablesRow class.
    #'
    ...
    #'
    #' @return ExportCdashClassVariablesRow as a base R list.
    #' @examples
    #' # convert array of ExportCdashClassVariablesRow (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ExportCdashClassVariablesRow to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ExportCdashClassVariablesRowObject <- list()
      if (!is.null(self$`Version`)) {
        ExportCdashClassVariablesRowObject[["Version"]] <-
          self$`Version`
      }
      if (!is.null(self$`Class`)) {
        ExportCdashClassVariablesRowObject[["Class"]] <-
          self$`Class`
      }
      if (!is.null(self$`Domain`)) {
        ExportCdashClassVariablesRowObject[["Domain"]] <-
          self$`Domain`
      }
      if (!is.null(self$`Variable Order`)) {
        ExportCdashClassVariablesRowObject[["Variable Order"]] <-
          self$`Variable Order`
      }
      if (!is.null(self$`CDASH Variable`)) {
        ExportCdashClassVariablesRowObject[["CDASH Variable"]] <-
          self$`CDASH Variable`
      }
      if (!is.null(self$`CDASH Variable Label`)) {
        ExportCdashClassVariablesRowObject[["CDASH Variable Label"]] <-
          self$`CDASH Variable Label`
      }
      if (!is.null(self$`DRAFT CDASH Definition`)) {
        ExportCdashClassVariablesRowObject[["DRAFT CDASH Definition"]] <-
          self$`DRAFT CDASH Definition`
      }
      if (!is.null(self$`Domain Specific`)) {
        ExportCdashClassVariablesRowObject[["Domain Specific"]] <-
          self$`Domain Specific`
      }
      if (!is.null(self$`Question Text`)) {
        ExportCdashClassVariablesRowObject[["Question Text"]] <-
          self$`Question Text`
      }
      if (!is.null(self$`Prompt`)) {
        ExportCdashClassVariablesRowObject[["Prompt"]] <-
          self$`Prompt`
      }
      if (!is.null(self$`Type`)) {
        ExportCdashClassVariablesRowObject[["Type"]] <-
          self$`Type`
      }
      if (!is.null(self$`SDTM Target`)) {
        ExportCdashClassVariablesRowObject[["SDTM Target"]] <-
          self$`SDTM Target`
      }
      if (!is.null(self$`Mapping Instructions`)) {
        ExportCdashClassVariablesRowObject[["Mapping Instructions"]] <-
          self$`Mapping Instructions`
      }
      if (!is.null(self$`Controlled Terminology Codelist Name`)) {
        ExportCdashClassVariablesRowObject[["Controlled Terminology Codelist Name"]] <-
          self$`Controlled Terminology Codelist Name`
      }
      if (!is.null(self$`Implementation Notes`)) {
        ExportCdashClassVariablesRowObject[["Implementation Notes"]] <-
          self$`Implementation Notes`
      }
      return(ExportCdashClassVariablesRowObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ExportCdashClassVariablesRow
    #'
    #' @param input_json the JSON input
    #' @return the instance of ExportCdashClassVariablesRow
    ...
    #' @return ExportCdashClassVariablesRow in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ExportCdashClassVariablesRow and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ExportCdashClassVariablesRow
    toString = function() {
      self$toJSONString()
    },
...
# ExportCdashClassVariablesRow$unlock()
#
## Below is an example to define the print function
# ExportCdashClassVariablesRow$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ExportCdashClassVariablesRow$lock()
