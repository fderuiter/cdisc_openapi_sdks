#' Create a new SdtmigDatasetLinks
#'
#' @description
#' SdtmigDatasetLinks Class
#'
#' @docType class
#' @title SdtmigDatasetLinks
#' @description SdtmigDatasetLinks Class
#' @format An \code{R6Class} generator object
#' @field item_self  \link{SdtmigDatasetRef} [optional]
...
#' @field priorVersion  \link{SdtmigDatasetRef} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SdtmigDatasetLinks <- R6::R6Class(
  "SdtmigDatasetLinks",
  public = list(
    `item_self` = NULL,
    `modelDataset` = NULL,
    ...
    #' @description
    #' Initialize a new SdtmigDatasetLinks class.
    #'
    ...
    initialize = function(`item_self` = NULL, `modelDataset` = NULL, `parentProduct` = NULL, `parentClass` = NULL, `priorVersion` = NULL, ...) {
    ...
    #'
    #' @return SdtmigDatasetLinks as a base R list.
    #' @examples
    #' # convert array of SdtmigDatasetLinks (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SdtmigDatasetLinks to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SdtmigDatasetLinksObject <- list()
      if (!is.null(self$`item_self`)) {
        SdtmigDatasetLinksObject[["self"]] <-
          self$`item_self`$toSimpleType()
      }
      if (!is.null(self$`modelDataset`)) {
        SdtmigDatasetLinksObject[["modelDataset"]] <-
          self$`modelDataset`$toSimpleType()
      }
      if (!is.null(self$`parentProduct`)) {
        SdtmigDatasetLinksObject[["parentProduct"]] <-
          self$`parentProduct`$toSimpleType()
      }
      if (!is.null(self$`parentClass`)) {
        SdtmigDatasetLinksObject[["parentClass"]] <-
          self$`parentClass`$toSimpleType()
      }
      if (!is.null(self$`priorVersion`)) {
        SdtmigDatasetLinksObject[["priorVersion"]] <-
          self$`priorVersion`$toSimpleType()
      }
      return(SdtmigDatasetLinksObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of SdtmigDatasetLinks
    #'
    #' @param input_json the JSON input
    #' @return the instance of SdtmigDatasetLinks
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`self`)) {
        `item_self_object` <- SdtmigDatasetRef$new()
      ...
      if (!is.null(this_object$`priorVersion`)) {
        `priorversion_object` <- SdtmigDatasetRef$new()
    ...
    #' @return SdtmigDatasetLinks in JSON format
    ...
    fromJSONString = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      self$`item_self` <- SdtmigDatasetRef$new()$fromJSON(jsonlite::toJSON(this_object$`item_self`, auto_unbox = TRUE, digits = NA))
      ...
      self$`priorVersion` <- SdtmigDatasetRef$new()$fromJSON(jsonlite::toJSON(this_object$`priorVersion`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to SdtmigDatasetLinks and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of SdtmigDatasetLinks
    toString = function() {
      self$toJSONString()
    },
...
# SdtmigDatasetLinks$unlock()
#
## Below is an example to define the print function
# SdtmigDatasetLinks$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SdtmigDatasetLinks$lock()
