...
#' @field _links  \link{SdtmDatasetLinks} [optional]
#' @field datasetVariables  list(\link{SdtmDatasetVariable}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SdtmDataset <- R6::R6Class(
  "SdtmDataset",
  public = list(
    `ordinal` = NULL,
    `name` = NULL,
    ...
    #' @description
    #' Initialize a new SdtmDataset class.
    #'
    ...
    #'
    #' @return SdtmDataset as a base R list.
    #' @examples
    #' # convert array of SdtmDataset (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SdtmDataset to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SdtmDatasetObject <- list()
      if (!is.null(self$`ordinal`)) {
        SdtmDatasetObject[["ordinal"]] <-
          self$`ordinal`
      }
      if (!is.null(self$`name`)) {
        SdtmDatasetObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`label`)) {
        SdtmDatasetObject[["label"]] <-
          self$`label`
      }
      if (!is.null(self$`description`)) {
        SdtmDatasetObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`datasetStructure`)) {
        SdtmDatasetObject[["datasetStructure"]] <-
          self$`datasetStructure`
      }
      if (!is.null(self$`_links`)) {
        SdtmDatasetObject[["_links"]] <-
          self$`_links`$toSimpleType()
      }
      if (!is.null(self$`datasetVariables`)) {
        SdtmDatasetObject[["datasetVariables"]] <-
          lapply(self$`datasetVariables`, function(x) x$toSimpleType())
      }
      return(SdtmDatasetObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of SdtmDataset
    #'
    #' @param input_json the JSON input
    #' @return the instance of SdtmDataset
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`_links`)) {
        `_links_object` <- SdtmDatasetLinks$new()
        `_links_object`$fromJSON(jsonlite::toJSON(this_object$`_links`, auto_unbox = TRUE, digits = NA))
        self$`_links` <- `_links_object`
      }
      if (!is.null(this_object$`datasetVariables`)) {
        self$`datasetVariables` <- ApiClient$new()$deserializeObj(this_object$`datasetVariables`, "array[SdtmDatasetVariable]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return SdtmDataset in JSON format
    ...
    fromJSONString = function(input_json) {
      ...
      self$`description` <- this_object$`description`
      self$`datasetStructure` <- this_object$`datasetStructure`
      self$`_links` <- SdtmDatasetLinks$new()$fromJSON(jsonlite::toJSON(this_object$`_links`, auto_unbox = TRUE, digits = NA))
      self$`datasetVariables` <- ApiClient$new()$deserializeObj(this_object$`datasetVariables`, "array[SdtmDatasetVariable]", loadNamespace("openapi"))
      self
    },

    #' @description
    #' Validate JSON input with respect to SdtmDataset and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of SdtmDataset
    toString = function() {
      self$toJSONString()
    },
...
# SdtmDataset$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
