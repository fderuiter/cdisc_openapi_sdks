/*
 * export_cdashig_domain_variables_row.h
 *
 * 
 */

#ifndef _export_cdashig_domain_variables_row_H_
#define _export_cdashig_domain_variables_row_H_
...
typedef struct export_cdashig_domain_variables_row_t export_cdashig_domain_variables_row_t;




typedef struct export_cdashig_domain_variables_row_t {
    char *version; // string
    char *_class; // string
    char *domain; // string
...
} export_cdashig_domain_variables_row_t;
...
#endif /* _export_cdashig_domain_variables_row_H_ */
