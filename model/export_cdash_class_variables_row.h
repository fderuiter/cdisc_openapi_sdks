/*
 * export_cdash_class_variables_row.h
 *
 * 
 */

#ifndef _export_cdash_class_variables_row_H_
#define _export_cdash_class_variables_row_H_
...
typedef struct export_cdash_class_variables_row_t export_cdash_class_variables_row_t;




typedef struct export_cdash_class_variables_row_t {
    char *version; // string
    char *_class; // string
    char *domain; // string
...
} export_cdash_class_variables_row_t;
...
#endif /* _export_cdash_class_variables_row_H_ */
