/*
 * sendig_dataset_variable_ref.h
 *
 * 
 */

#ifndef _sendig_dataset_variable_ref_H_
#define _sendig_dataset_variable_ref_H_
...
typedef struct sendig_dataset_variable_ref_t sendig_dataset_variable_ref_t;




typedef struct sendig_dataset_variable_ref_t {
    char *href; // string
    char *title; // string
    char *type; // string

    int _library_owned; // Is the library responsible for freeing this object?
} sendig_dataset_variable_ref_t;
...
#endif /* _sendig_dataset_variable_ref_H_ */
