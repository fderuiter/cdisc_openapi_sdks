/*
 * adam_datastructure_ref.h
 *
 * 
 */

#ifndef _adam_datastructure_ref_H_
#define _adam_datastructure_ref_H_
...
typedef struct adam_datastructure_ref_t adam_datastructure_ref_t;




typedef struct adam_datastructure_ref_t {
    char *href; // string
    char *title; // string
    char *type; // string

    int _library_owned; // Is the library responsible for freeing this object?
} adam_datastructure_ref_t;
...
#endif /* _adam_datastructure_ref_H_ */
