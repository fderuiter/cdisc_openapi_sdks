/*
 * xml_sendig_class_datasets.h
 *
 * 
 */

#ifndef _xml_sendig_class_datasets_H_
#define _xml_sendig_class_datasets_H_
...
typedef struct xml_sendig_class_datasets_t xml_sendig_class_datasets_t;

#include "sendig_class_datasets.h"



typedef struct xml_sendig_class_datasets_t {
    struct sendig_class_datasets_t *self; //model

    int _library_owned; // Is the library responsible for freeing this object?
} xml_sendig_class_datasets_t;
...
#endif /* _xml_sendig_class_datasets_H_ */
