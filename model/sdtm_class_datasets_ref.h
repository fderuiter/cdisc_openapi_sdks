/*
 * sdtm_class_datasets_ref.h
 *
 * 
 */

#ifndef _sdtm_class_datasets_ref_H_
#define _sdtm_class_datasets_ref_H_
...
typedef struct sdtm_class_datasets_ref_t sdtm_class_datasets_ref_t;




typedef struct sdtm_class_datasets_ref_t {
    char *href; // string
    char *title; // string
    char *type; // string

    int _library_owned; // Is the library responsible for freeing this object?
} sdtm_class_datasets_ref_t;
...
#endif /* _sdtm_class_datasets_ref_H_ */
