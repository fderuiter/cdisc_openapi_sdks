/*
 * sdtmig_dataset_links.h
 *
 * 
 */

#ifndef _sdtmig_dataset_links_H_
#define _sdtmig_dataset_links_H_
...
typedef struct sdtmig_dataset_links_t sdtmig_dataset_links_t;
...
typedef struct sdtmig_dataset_links_t {
    struct sdtmig_dataset_ref_t *self; //model
    ...
    struct sdtmig_dataset_ref_t *prior_version; //model

    int _library_owned; // Is the library responsible for freeing this object?
} sdtmig_dataset_links_t;
...
#endif /* _sdtmig_dataset_links_H_ */
