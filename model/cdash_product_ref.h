...
#ifndef _cdash_product_ref_H_
#define _cdash_product_ref_H_
...
typedef struct cdash_product_ref_t cdash_product_ref_t;




typedef struct cdash_product_ref_t {
    char *href; // string
    char *title; // string
    char *type; // string
