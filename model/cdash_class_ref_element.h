/*
 * cdash_class_ref_element.h
 *
 * 
 */

#ifndef _cdash_class_ref_element_H_
#define _cdash_class_ref_element_H_
...
typedef struct cdash_class_ref_element_t cdash_class_ref_element_t;




typedef struct cdash_class_ref_element_t {
    char *href; // string
    char *title; // string
    char *type; // string

    int _library_owned; // Is the library responsible for freeing this object?
} cdash_class_ref_element_t;
...
#endif /* _cdash_class_ref_element_H_ */
