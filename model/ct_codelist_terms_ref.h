/*
 * ct_codelist_terms_ref.h
 *
 * 
 */

#ifndef _ct_codelist_terms_ref_H_
#define _ct_codelist_terms_ref_H_
...
typedef struct ct_codelist_terms_ref_t ct_codelist_terms_ref_t;




typedef struct ct_codelist_terms_ref_t {
    char *href; // string
    char *title; // string
    char *type; // string

    int _library_owned; // Is the library responsible for freeing this object?
} ct_codelist_terms_ref_t;
...
#endif /* _ct_codelist_terms_ref_H_ */
