/*
 * qrs_item_ref_element.h
 *
 * 
 */

#ifndef _qrs_item_ref_element_H_
#define _qrs_item_ref_element_H_
...
typedef struct qrs_item_ref_element_t qrs_item_ref_element_t;




typedef struct qrs_item_ref_element_t {
    char *href; // string
    char *title; // string
    char *type; // string

    int _library_owned; // Is the library responsible for freeing this object?
} qrs_item_ref_element_t;
...
#endif /* _qrs_item_ref_element_H_ */
