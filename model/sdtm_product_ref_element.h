/*
 * sdtm_product_ref_element.h
 *
 * 
 */

#ifndef _sdtm_product_ref_element_H_
#define _sdtm_product_ref_element_H_
...
typedef struct sdtm_product_ref_element_t sdtm_product_ref_element_t;




typedef struct sdtm_product_ref_element_t {
    char *href; // string
    char *title; // string
    char *type; // string

    int _library_owned; // Is the library responsible for freeing this object?
} sdtm_product_ref_element_t;
...
#endif /* _sdtm_product_ref_element_H_ */
