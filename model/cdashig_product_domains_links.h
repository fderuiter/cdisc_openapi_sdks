/*
 * cdashig_product_domains_links.h
 *
 * 
 */

#ifndef _cdashig_product_domains_links_H_
#define _cdashig_product_domains_links_H_
...
typedef struct cdashig_product_domains_links_t cdashig_product_domains_links_t;
...
typedef struct cdashig_product_domains_links_t {
    struct cdashig_product_domains_ref_t *self; //model
    struct cdashig_product_ref_t *parent_product; //model
    list_t *domains; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} cdashig_product_domains_links_t;
...
#endif /* _cdashig_product_domains_links_H_ */
