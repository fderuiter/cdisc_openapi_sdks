/*
 * adam_product_ref_element.h
 *
 * 
 */

#ifndef _adam_product_ref_element_H_
#define _adam_product_ref_element_H_
...
typedef struct adam_product_ref_element_t adam_product_ref_element_t;




typedef struct adam_product_ref_element_t {
    char *href; // string
    char *title; // string
    char *type; // string

    int _library_owned; // Is the library responsible for freeing this object?
} adam_product_ref_element_t;
...
#endif /* _adam_product_ref_element_H_ */
