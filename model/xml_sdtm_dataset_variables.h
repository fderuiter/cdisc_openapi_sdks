/*
 * xml_sdtm_dataset_variables.h
 *
 * 
 */

#ifndef _xml_sdtm_dataset_variables_H_
#define _xml_sdtm_dataset_variables_H_
...
typedef struct xml_sdtm_dataset_variables_t xml_sdtm_dataset_variables_t;

#include "sdtm_dataset_variables.h"



typedef struct xml_sdtm_dataset_variables_t {
    struct sdtm_dataset_variables_t *self; //model

    int _library_owned; // Is the library responsible for freeing this object?
} xml_sdtm_dataset_variables_t;
...
#endif /* _xml_sdtm_dataset_variables_H_ */
