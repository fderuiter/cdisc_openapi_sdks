/*
 * cdash_product_domains_links.h
 *
 * 
 */

#ifndef _cdash_product_domains_links_H_
#define _cdash_product_domains_links_H_
...
typedef struct cdash_product_domains_links_t cdash_product_domains_links_t;
...
typedef struct cdash_product_domains_links_t {
    struct cdash_product_domains_ref_t *self; //model
    struct cdash_product_ref_t *parent_product; //model
    list_t *domains; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} cdash_product_domains_links_t;
...
#endif /* _cdash_product_domains_links_H_ */
