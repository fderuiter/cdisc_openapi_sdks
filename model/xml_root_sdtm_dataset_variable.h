/*
 * xml_root_sdtm_dataset_variable.h
 *
 * 
 */

#ifndef _xml_root_sdtm_dataset_variable_H_
#define _xml_root_sdtm_dataset_variable_H_
...
typedef struct xml_root_sdtm_dataset_variable_t xml_root_sdtm_dataset_variable_t;

#include "root_sdtm_dataset_variable.h"



typedef struct xml_root_sdtm_dataset_variable_t {
    struct root_sdtm_dataset_variable_t *self; //model

    int _library_owned; // Is the library responsible for freeing this object?
} xml_root_sdtm_dataset_variable_t;
...
#endif /* _xml_root_sdtm_dataset_variable_H_ */
