/*
 * sendig_dataset_variables_links.h
 *
 * 
 */

#ifndef _sendig_dataset_variables_links_H_
#define _sendig_dataset_variables_links_H_
...
typedef struct sendig_dataset_variables_links_t sendig_dataset_variables_links_t;
...
typedef struct sendig_dataset_variables_links_t {
    struct sendig_dataset_variables_ref_t *self; //model
    ...
    struct sendig_dataset_variables_ref_t *prior_version; //model
    list_t *dataset_variables; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} sendig_dataset_variables_links_t;
...
#endif /* _sendig_dataset_variables_links_H_ */
