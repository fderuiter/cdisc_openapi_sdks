...
// checks if the CdashigClass type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CdashigClass{}

// CdashigClass struct for CdashigClass
type CdashigClass struct {
	Ordinal *string `json:"ordinal,omitempty"`
	Name *string `json:"name,omitempty"`
	Label *string `json:"label,omitempty"`
	Description *string `json:"description,omitempty"`
	Links *CdashigClassLinks `json:"_links,omitempty"`
	Domains []CdashigDomain `json:"domains,omitempty"`
	Scenarios []CdashigScenario `json:"scenarios,omitempty"`
}
...
// SetLinks gets a reference to the given CdashigClassLinks and assigns it to the Links field.
...
// SetDomains gets a reference to the given []CdashigDomain and assigns it to the Domains field.
...
// SetScenarios gets a reference to the given []CdashigScenario and assigns it to the Scenarios field.
func (o *CdashigClass) SetScenarios(v []CdashigScenario) {
	o.Scenarios = v
}

func (o CdashigClass) MarshalJSON() ([]byte, error) {
...
func (o CdashigClass) ToMap() (map[string]interface{}, error) {
...
type NullableCdashigClass struct {
	value *CdashigClass
	isSet bool
}

func (v NullableCdashigClass) Get() *CdashigClass {
	return v.value
}

func (v *NullableCdashigClass) Set(val *CdashigClass) {
	v.value = val
	v.isSet = true
}

func (v NullableCdashigClass) IsSet() bool {
	return v.isSet
}

func (v *NullableCdashigClass) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCdashigClass(val *CdashigClass) *NullableCdashigClass {
	return &NullableCdashigClass{value: val, isSet: true}
}

func (v NullableCdashigClass) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCdashigClass) UnmarshalJSON(src []byte) error {
	v.isSet = true
