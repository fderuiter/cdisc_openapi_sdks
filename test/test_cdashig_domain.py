...
from openapi_client.models.cdashig_domain import CdashigDomain  # noqa: E501

class TestCdashigDomain(unittest.TestCase):
    """CdashigDomain unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CdashigDomain:
        """Test CdashigDomain
        ...
        """
        model = CdashigDomain()  # noqa: E501
        if include_optional:
            return CdashigDomain(
                ordinal = '31',
                name = 'VS',
                label = 'Vital Signs',
                links = openapi_client.models.cdashig_domain_links.CdashigDomainLinks(
