...
from openapi_client.models.xml_sendig_class import XmlSendigClass  # noqa: E501

class TestXmlSendigClass(unittest.TestCase):
    """XmlSendigClass unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XmlSendigClass:
        """Test XmlSendigClass
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XmlSendigClass`
        """
        model = XmlSendigClass()  # noqa: E501
        if include_optional:
            return XmlSendigClass(
                var_self = openapi_client.models.sendig_class.SendigClass(
                    ordinal = '5', 
                    name = 'Findings', 
