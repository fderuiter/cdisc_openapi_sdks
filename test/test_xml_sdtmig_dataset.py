...
from openapi_client.models.xml_sdtmig_dataset import XmlSdtmigDataset  # noqa: E501

class TestXmlSdtmigDataset(unittest.TestCase):
    """XmlSdtmigDataset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XmlSdtmigDataset:
        """Test XmlSdtmigDataset
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XmlSdtmigDataset`
        """
        model = XmlSdtmigDataset()  # noqa: E501
        if include_optional:
            return XmlSdtmigDataset(
                var_self = openapi_client.models.sdtmig_dataset.SdtmigDataset(
                    ordinal = '24', 
                    name = 'LB', 
