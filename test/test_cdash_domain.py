...
from openapi_client.models.cdash_domain import CdashDomain  # noqa: E501

class TestCdashDomain(unittest.TestCase):
    """CdashDomain unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CdashDomain:
        """Test CdashDomain
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CdashDomain`
        """
        model = CdashDomain()  # noqa: E501
        if include_optional:
            return CdashDomain(
                ordinal = '4',
                name = 'DM',
                label = 'Demographics',
                links = openapi_client.models.cdash_domain_links.CdashDomainLinks(
