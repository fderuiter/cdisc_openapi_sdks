...
from openapi_client.models.cdashig_scenario import CdashigScenario  # noqa: E501

class TestCdashigScenario(unittest.TestCase):
    """CdashigScenario unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CdashigScenario:
        """Test CdashigScenario
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CdashigScenario`
        """
        model = CdashigScenario()  # noqa: E501
        if include_optional:
            return CdashigScenario(
                ordinal = '19',
                domain = 'Vital Signs',
                scenario = 'VS - Implementation Options: HorizontalGeneric',
                links = openapi_client.models.cdashig_scenario_links.CdashigScenarioLinks(
