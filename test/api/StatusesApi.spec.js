...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CdiscLibraryApi.StatusesApi();
  });
  ...
  describe('StatusesApi', function() {
    ...
    describe('mdrMaintenanceGet', function() {
      it('should call mdrMaintenanceGet successfully', function(done) {
        //uncomment below and update the code to test mdrMaintenanceGet
        //instance.mdrMaintenanceGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
