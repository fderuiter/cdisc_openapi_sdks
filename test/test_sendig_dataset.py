...
from openapi_client.models.sendig_dataset import SendigDataset  # noqa: E501

class TestSendigDataset(unittest.TestCase):
    """SendigDataset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendigDataset:
        """Test SendigDataset
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendigDataset`
        """
        model = SendigDataset()  # noqa: E501
        if include_optional:
            return SendigDataset(
                ...
                links = openapi_client.models.sendig_dataset_links.SendigDatasetLinks(
