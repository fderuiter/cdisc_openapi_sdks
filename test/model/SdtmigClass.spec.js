...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CdiscLibraryApi.SdtmigClass();
  });
  ...
  describe('SdtmigClass', function() {
    it('should create an instance of SdtmigClass', function() {
      // uncomment below and update the code to test SdtmigClass
      //var instance = new CdiscLibraryApi.SdtmigClass();
      //expect(instance).to.be.a(CdiscLibraryApi.SdtmigClass);
    });
