...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CdiscLibraryApi.SdtmigProduct();
  });
  ...
  describe('SdtmigProduct', function() {
    it('should create an instance of SdtmigProduct', function() {
      // uncomment below and update the code to test SdtmigProduct
      //var instance = new CdiscLibraryApi.SdtmigProduct();
      //expect(instance).to.be.a(CdiscLibraryApi.SdtmigProduct);
    });
