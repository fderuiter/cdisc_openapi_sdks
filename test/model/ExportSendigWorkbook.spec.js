...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CdiscLibraryApi.ExportSendigWorkbook();
  });
  ...
  describe('ExportSendigWorkbook', function() {
    it('should create an instance of ExportSendigWorkbook', function() {
      // uncomment below and update the code to test ExportSendigWorkbook
      //var instance = new CdiscLibraryApi.ExportSendigWorkbook();
      //expect(instance).to.be.a(CdiscLibraryApi.ExportSendigWorkbook);
    });
