...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CdiscLibraryApi.CdashigScenarioFields();
  });
  ...
  describe('CdashigScenarioFields', function() {
    it('should create an instance of CdashigScenarioFields', function() {
      // uncomment below and update the code to test CdashigScenarioFields
      //var instance = new CdiscLibraryApi.CdashigScenarioFields();
      //expect(instance).to.be.a(CdiscLibraryApi.CdashigScenarioFields);
    });
