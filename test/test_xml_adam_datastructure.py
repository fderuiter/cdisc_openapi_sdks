...
from openapi_client.models.xml_adam_datastructure import XmlAdamDatastructure  # noqa: E501

class TestXmlAdamDatastructure(unittest.TestCase):
    """XmlAdamDatastructure unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XmlAdamDatastructure:
        """Test XmlAdamDatastructure
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XmlAdamDatastructure`
        """
        model = XmlAdamDatastructure()  # noqa: E501
        if include_optional:
            return XmlAdamDatastructure(
                var_self = openapi_client.models.adam_datastructure.AdamDatastructure(
                    ordinal = '1', 
                    name = 'ADSL', 
    ...
    def testXmlAdamDatastructure(self):
        """Test XmlAdamDatastructure"""
