...
from openapi_client.models.xml_adam_varset import XmlAdamVarset  # noqa: E501

class TestXmlAdamVarset(unittest.TestCase):
    """XmlAdamVarset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XmlAdamVarset:
        """Test XmlAdamVarset
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XmlAdamVarset`
        """
        model = XmlAdamVarset()  # noqa: E501
        if include_optional:
            return XmlAdamVarset(
                var_self = openapi_client.models.adam_varset.AdamVarset(
                    ordinal = '1', 
                    name = 'ADSL', 
