...
from openapi_client.models.adam_variable import AdamVariable  # noqa: E501

class TestAdamVariable(unittest.TestCase):
    """AdamVariable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdamVariable:
        """Test AdamVariable
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdamVariable`
        """
        model = AdamVariable()  # noqa: E501
        if include_optional:
            return AdamVariable(
                ordinal = '5',
                name = 'SITEGRy',
                ...
                value_list = TODO,
                links = openapi_client.models.adam_variable_links.AdamVariableLinks(
