...
from openapi_client.models.sdtm_class_variables import SdtmClassVariables  # noqa: E501

class TestSdtmClassVariables(unittest.TestCase):
    """SdtmClassVariables unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SdtmClassVariables:
        """Test SdtmClassVariables
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SdtmClassVariables`
        """
        model = SdtmClassVariables()  # noqa: E501
        if include_optional:
            return SdtmClassVariables(
                ...
                links = openapi_client.models.sdtm_class_variables_links.SdtmClassVariablesLinks(
    ...
    def testSdtmClassVariables(self):
        """Test SdtmClassVariables"""
